...
<Tip>
Want to explore Voltaire in your browser? Open the <a href="/playground">Playground</a>.
</Tip>

## Simple, Intuitive API

Voltaire's API mirrors Ethereum specifications with namespace-based methods:

```typescript
import { Address, Wei, Gwei, Ether } from 'tevm';
import * as Hex from 'tevm/Hex';
import * as Bytes32 from 'tevm/Bytes32';
...
console.log(Address.toHex(addr));        // "0x742d35cc..."
console.log(Address.toChecksummed(addr)); // "0x742d35Cc..."

// Denominations - type-safe ETH value handling
const value = Wei(1000000000000000000n);
console.log(Wei.toEther(value));  // 1n
console.log(Wei.toGwei(value));   // 1000000000n
...
// Fixed-size bytes
const hash = Bytes32.fromHex('0x' + '12'.repeat(32));
console.log(Bytes32.toHex(hash));
