...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/from-private-key.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/from-private-key.ts).
</Tip>
...
```zig
import { FromPrivateKey } from 'tevm/Address/AddressType'
import { hash as keccak256 } from 'tevm/crypto/Keccak256'
import { derivePublicKey } from 'tevm/crypto/Secp256k1'
import * as PrivateKey from 'tevm/primitives/PrivateKey'
