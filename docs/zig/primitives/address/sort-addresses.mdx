...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/sort-dedupe.ts`](https://github.com/evmts/voltaire/blob/main/playground/src/examples/primitives/address/sort-dedupe.ts).
</Tip>
