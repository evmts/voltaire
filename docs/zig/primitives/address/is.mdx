---
title: Address.is
description: Type guard for runtime validation of AddressType values
---


<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/is-address.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/is-address.ts).
</Tip>
