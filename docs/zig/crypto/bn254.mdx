...
```zig
import * as BN254 from 'tevm/crypto/bn254';
...
```zig
import * as Fp from 'tevm/crypto/bn254/Fp';
...
```zig
import * as Fr from 'tevm/crypto/bn254/Fr';
...
```zig
import * as Fp2 from 'tevm/crypto/bn254/Fp2';
...
```zig
import * as G1 from 'tevm/crypto/bn254/G1';
...
```zig
import * as G2 from 'tevm/crypto/bn254/G2';
...
```zig
import * as Pairing from 'tevm/crypto/bn254/Pairing';
...
import { bn254Add, bn254Mul, bn254Pairing } from 'tevm/crypto/bn254';
...
```zig
import { FP_MOD, FR_MOD, B_G1, G1_GENERATOR_X, G1_GENERATOR_Y } from 'tevm/crypto/bn254';
