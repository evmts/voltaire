...
<Warning>
TypeScript-oriented page. In Zig, construct these method payloads (e.g., `wallet_addEthereumChain`, `wallet_switchEthereumChain`) and send with `std.http.Client` where supported.
</Warning>
