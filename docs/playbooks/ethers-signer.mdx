...
This playbook documents an ethers v6-compatible `Signer` implementation built on Voltaire primitives. It provides the same API surface as ethers v6 `Wallet` while using Voltaire's cryptographic primitives.
