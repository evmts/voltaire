...
Validate authorization structure and signature components
[View validation →](./validation)
</Card>
<Card title="Signing & Hashing" icon="signature">
Calculate signing hash, create signed authorization, and recover authority
[View signing →](./signing)
</Card>
<Card title="Gas Calculations" icon="gas-pump">
Calculate gas costs for single authorizations and lists
[View gas calculations →](./gas-calculations)
</Card>
<Card title="Processing" icon="gear">
Process single authorization or authorization lists
[View processing →](./processing)
</Card>
<Card title="Utilities" icon="wrench">
Format to string, check equality, and helper functions
[View utilities →](./utilities)
</Card>
<Card title="WASM" icon="rocket">
WASM-accelerated validation, hashing, and gas calculation
[View WASM →](./wasm)
</Card>
</CardGroup>
