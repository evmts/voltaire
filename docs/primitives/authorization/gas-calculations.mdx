...
- [Processing](./processing) - Authorization processing
- [EIP-7702](./eip7702) - Gas specification
- [Validation](./validation) - Pre-processing validation