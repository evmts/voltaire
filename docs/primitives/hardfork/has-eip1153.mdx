...
Check if transient storage opcodes (TLOAD/TSTORE) are available in this hardfork. Active since Cancun.

**Returns:** `boolean` - True if EIP-1153 is supported
...
cancun.hasEIP1153()     // true - Cancun introduced transient storage
SHANGHAI.hasEIP1153()   // false - Shanghai pre-dates transient storage
```

**Convenience alias:** `fork.supportsTransientStorage()` - Same functionality, different naming style

**Defined in:** [primitives/Hardfork/BrandedHardfork/hasEIP1153.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Hardfork/BrandedHardfork/hasEIP1153.js)

</Tab>
<Tab title="Namespace API">

## `hasEIP1153(fork: BrandedHardfork): boolean`
...
// Convenience alias
Hardfork.supportsTransientStorage(CANCUN)  // true
```
