...
Check if blob transactions (proto-danksharding) are available in this hardfork. Active since Cancun.

**Returns:** `boolean` - True if EIP-4844 is supported
...
cancun.hasEIP4844()     // true - Cancun introduced blobs
SHANGHAI.hasEIP4844()   // false - Shanghai pre-dates blobs
PRAGUE.hasEIP4844()     // true - all post-Cancun hardforks
```

**Convenience alias:** `fork.supportsBlobs()` - Same functionality, different naming style

**Defined in:** [primitives/Hardfork/BrandedHardfork/hasEIP4844.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Hardfork/BrandedHardfork/hasEIP4844.js)

</Tab>
<Tab title="Namespace API">

## `hasEIP4844(fork: BrandedHardfork): boolean`
...
import { CANCUN, SHANGHAI, PRAGUE } from '@tevm/voltaire'
...
// Convenience alias
Hardfork.supportsBlobs(CANCUN)  // true
```
