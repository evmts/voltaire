...
Get all hardfork names in chronological order (oldest to newest).

**Returns:** `string[]` - Array of hardfork names (lowercase)
...
**Defined in:** [primitives/Hardfork/BrandedHardfork/allNames.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Hardfork/BrandedHardfork/allNames.js)
