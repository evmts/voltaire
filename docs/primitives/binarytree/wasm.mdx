...
All WASM methods are compiled from [binary_tree.zig](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/binary_tree.zig) with `ReleaseSmall` optimization targeting minimal bundle size.
...
import { BinaryTree } from 'tevm/BinaryTree.wasm'
...
import * as WasmBinaryTree from 'tevm/BinaryTree.wasm'
