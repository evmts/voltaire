...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/addressToKey.js:17-22](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/addressToKey.js#L17-L22)
...
```typescript
import { BinaryTree, InvalidKeyLengthError } from 'tevm'
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/splitKey.js:19-25](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/splitKey.js#L19-L25)
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/getStemBit.js:16-23](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/getStemBit.js#L16-L23)
