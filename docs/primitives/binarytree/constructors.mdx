...
### `BinaryTree.init(allocator: Allocator) BinaryTree`

Initialize empty binary tree with empty root node.

**Parameters:**
- `allocator: Allocator` - Memory allocator for tree operations

**Returns:** `BinaryTree` - Empty tree with `.empty` root
...
**Defined in:** [primitives/BinaryTree/binary_tree.zig:129](https://github.com/evmts/voltaire/blob/main/src/primitives/BinaryTree/binary_tree.zig#L129)
