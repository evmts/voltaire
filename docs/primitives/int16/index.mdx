...
// Hex to signed
const fromHex = Int16.fromHex("0xFFFF")
Int16.toNumber(fromHex)  // -1

// Bytes (two's complement, big-endian)
const bytes = Int16.toBytes(Int16.from(-1))
// Uint8Array([0xff, 0xff])

const value = Int16.fromBytes(new Uint8Array([0x12, 0x34]))
...
const a = Int16.from(-1000)
const b = Int16.fromNumber(-1000)

// From bigint
const c = Int16.fromBigint(-1000n)

// From hex (two's complement)
const d = Int16.fromHex("0xFFFF")    // -1
const e = Int16.fromHex("0x8000")    // -32768

// From bytes (two's complement, big-endian)
const f = Int16.fromBytes(new Uint8Array([0xFF, 0xFF]))  // -1
const g = Int16.fromBytes(new Uint8Array([0x12, 0x34]))  // 4660
```
