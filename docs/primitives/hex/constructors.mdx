...
Defined in: [primitives/Hex/Hex.js:10-12](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/Hex.js#L10-L12)
...
Defined in: [primitives/Hex/BrandedHex/from.js:15-20](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/from.js#L15-L20)
Tests: [from.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/from.test.ts)
...
Defined in: [primitives/Hex/BrandedHex/fromBytes.js:12-20](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromBytes.js#L12-L20)
...
Defined in: [primitives/Hex/BrandedHex/fromNumber.js:15-21](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromNumber.js#L15-L21)
Tests: [fromNumber.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromNumber.test.ts)
...
Defined in: [primitives/Hex/BrandedHex/fromBigInt.js:14-20](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromBigInt.js#L14-L20)
Tests: [fromBigInt.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromBigInt.test.ts)
...
Hex.fromString("")            // "0x"
Hex.fromString("🔥")          // "0xf09f94a5" (UTF-8 encoding)
Hex.fromString("テスト")      // UTF-8 encoded Japanese
```
...
Tests: [fromString.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromString.test.ts)
...
Defined in: [primitives/Hex/BrandedHex/fromBoolean.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromBoolean.js)
Tests: [fromBoolean.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/fromBoolean.test.ts)
...
Defined in: [primitives/Hex/BrandedHex/random.js:14-18](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/random.js#L14-L18)
Tests: [random.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/random.test.ts)
...
Defined in: [primitives/Hex/BrandedHex/zero.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/zero.js)
Tests: [zero.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/zero.test.ts)
