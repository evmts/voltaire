...
// Generate random hex
Hex.random(1)   // "0x7f" (1 random byte)
Hex.random(4)   // "0x7f3a9c2d" (4 random bytes)
Hex.random(32)  // "0x7f3a9c2d...4b8e6f1a" (32 random bytes)
...
Hex.random(32)  // "0x7f3a9c2d...4b8e6f1a"
```
