...
Defined in: [primitives/Hex/Hex.wasm.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/Hex.wasm.ts)
...
const hex = Hex(new Uint8Array([0x12, 0x34]))
...
// Now WASM is ready
import { Hex } from '@tevm/voltaire'
const hex = Hex(bytes)  // Uses WASM immediately
```
