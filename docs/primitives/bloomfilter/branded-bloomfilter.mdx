...
- **Zero-overhead** [branded type](/concepts/branded-types) wrapping `Uint8Array`
...
Runtime-validated `Uint8Array` with bloom filter parameters. [Brand](/concepts/branded-types) prevents accidental mixing with other Uint8Arrays.

Defined in: [primitives/BloomFilter/BrandedBloomFilter/BrandedBloomFilter.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/BloomFilter/BrandedBloomFilter/BrandedBloomFilter.ts)
...
- [Branded Types](/concepts/branded-types) - Zero-overhead type branding
