...
**Defined in:** [primitives/Uint/BrandedUint256/fromAbiEncoded.ts](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/BrandedUint256/fromAbiEncoded.ts)
