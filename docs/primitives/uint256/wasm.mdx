...
```typescript
import { u256FromHex } from 'tevm/Uint256.wasm'
...
Source: [Uint256.wasm.ts:13](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/Uint256.wasm.ts#L13)
...
```typescript
import { u256ToHex } from 'tevm/Uint256.wasm'
...
Source: [Uint256.wasm.ts:22](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/Uint256.wasm.ts#L22)
...
```typescript
import { u256FromBigInt } from 'tevm/Uint256.wasm'
...
Source: [Uint256.wasm.ts:34](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/Uint256.wasm.ts#L34)
...
```typescript
import { u256ToBigInt } from 'tevm/Uint256.wasm'
...
Source: [Uint256.wasm.ts:52](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/Uint256.wasm.ts#L52)
...
```typescript
import { u256FromHex, u256ToHex, u256FromBigInt, u256ToBigInt } from 'tevm/Uint256.wasm'
...
import { u256FromHex, u256ToBigInt } from 'tevm/Uint256.wasm'

// Parse hex using WASM, then create Uint
const hex = "0xff"
const bytes = u256FromHex(hex)
const bigint = u256ToBigInt(bytes)
const uint = Uint(bigint)

// Or use built-in fromHex
const uint2 = Uint(hex)  // Equivalent, uses JS implementation
```

### Performance Testing

```typescript
import { u256FromHex, u256ToHex } from 'tevm/Uint256.wasm'
import { Uint } from 'tevm'
...
// No WASM module
import { fromHex } from 'tevm/BrandedUint256'
```
...
- **[Uint256.wasm.ts](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/Uint256.wasm.ts)** - TypeScript exports with WASM bindings
- **[Uint.zig](https://github.com/evmts/tevm/blob/main/src/primitives/Uint/Uint.zig)** - Zig source implementation
- **[loader.js](https://github.com/evmts/tevm/blob/main/src/wasm-loader/loader.js)** - Shared WASM loader
...
- [Conversions](/primitives/uint256/conversions) - JavaScript conversion methods
- [BrandedUint256](/primitives/uint256/branded-uint) - Tree-shakeable functional API
- [Uint](/primitives/uint256) - Main Uint documentation
