...
Source: [BrandedUint256.ts:1-4](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint256/BrandedUint256.ts#L1-L4)
</Tab>
</Tabs>
...
Source: [constants.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint256/constants.ts)
...
import { fromHex, plus, toHex } from '@tevm/voltaire/BrandedUint256';
