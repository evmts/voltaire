...
// Generic untyped hex
const hex: BrandedHex = Hex.from("0x1234");
...
For cryptographic hashes (32 bytes), use the `Hash` type:
...
- [Hash](/primitives/hash/index) - 32-byte cryptographic hash values
- [Signature](/primitives/signature/index) - 65-byte ECDSA signatures (r, s, v)

## Related

- [Bytes Types](/primitives/bytes/index) - All fixed-size byte variants
- [Address](/primitives/address/index) - Ethereum addresses
- [Hash](/primitives/hash/index) - Cryptographic hashes
- [Signature](/primitives/signature/index) - ECDSA signatures
