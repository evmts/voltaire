...
**Pros**: Schema validation, backward compatibility
...
- [encode()](/primitives/rlp/encode) - Encode bytes and lists to RLP
- [decode()](/primitives/rlp/decode) - Decode RLP to data structures
- [validate()](/primitives/rlp/validate) - Validate RLP encoding
