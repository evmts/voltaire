...
## `Rlp.equals(data: BrandedRlp, other: BrandedRlp): boolean`

Check if two RLP data structures are equal. Performs deep comparison.
...
const list = { type: 'list', value: [bytes] }
Rlp.equals(bytes, list)
// => false

// Instance method
const rlp1 = new Rlp(new Uint8Array([1, 2]))
const rlp2 = new Rlp(new Uint8Array([1, 2]))
rlp1.equals(rlp2)
// => true
```

**Defined in:** [primitives/Rlp/BrandedRlp/equals.js:15](https://github.com/evmts/voltaire/blob/main/src/primitives/Rlp/BrandedRlp/equals.js#L15)

</Tab>
<Tab title="Namespace API">

## `equals(data: BrandedRlp, other: BrandedRlp): boolean`
...
## `rlp.equals(a: Data, b: Data) bool`

Compare two RLP data structures for equality.

**Parameters:**
- `a: Data` - First data structure
- `b: Data` - Second data structure
...
const a = rlp.Data{ .bytes = &[_]u8{ 1, 2 } };
const b = rlp.Data{ .bytes = &[_]u8{ 1, 2 } };
const equal = rlp.equals(a, b);
// equal = true
```
...
// Empty bytes
const empty1 = { type: 'bytes', value: new Uint8Array([]) }
const empty2 = { type: 'bytes', value: new Uint8Array([]) }
