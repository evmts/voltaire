...
| Method | Description |
|--------|-------------|
| [`serialize()`](/primitives/transaction/serialize) | RLP encode transaction to bytes |
| [`deserialize()`](/primitives/transaction/deserialize) | RLP decode bytes to transaction |
| [`detectType()`](/primitives/transaction/detectType) | Detect transaction type from bytes |
| [`hash()`](/primitives/transaction/hash) | Compute transaction hash |
| [`getSigningHash()`](/primitives/transaction/getSigningHash) | Compute signing hash (what gets signed) |
| [`getSender()`](/primitives/transaction/getSender) | Recover sender address from signature |
| [`verifySignature()`](/primitives/transaction/verifySignature) | Validate signature is correct |
| [`isSigned()`](/primitives/transaction/isSigned) | Check if transaction has signature |
| [`assertSigned()`](/primitives/transaction/assertSigned) | Assert transaction is signed (throws) |
| [`getChainId()`](/primitives/transaction/getChainId) | Extract chain ID from transaction |
| [`getGasPrice()`](/primitives/transaction/getGasPrice) | Get effective gas price |
| [`hasAccessList()`](/primitives/transaction/hasAccessList) | Check if transaction has access list |
| [`getAccessList()`](/primitives/transaction/getAccessList) | Get access list from transaction |
...
| Method | Description |
|--------|-------------|
| [`getEffectiveGasPrice()`](/primitives/transaction/eip1559#getEffectiveGasPrice) | Calculate effective gas price given base fee |

### EIP-4844

| Method | Description |
|--------|-------------|
| [`getBlobGasCost()`](/primitives/transaction/eip4844#getBlobGasCost) | Calculate total blob gas cost |
