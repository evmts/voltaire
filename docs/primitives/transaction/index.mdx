...
[View serialization →](/primitives/transaction/serialize)
</Card>
<Card title="Hashing" icon="hashtag">
Compute transaction hashes and signing hashes
[View hashing →](/primitives/transaction/hash)
</Card>
<Card title="Signatures" icon="signature">
Recover sender, verify signatures, and check signing status
[View signatures →](/primitives/transaction/getSender)
</Card>
<Card title="Gas Pricing" icon="gas-pump">
Calculate effective gas price and blob gas costs
[View gas pricing →](/primitives/transaction/getGasPrice)
</Card>
<Card title="Access Lists" icon="list">
Check and retrieve access list data
[View access lists →](/primitives/transaction/hasAccessList)
</Card>
<Card title="Type Detection" icon="magnifying-glass">
Detect transaction type from bytes
[View type detection →](/primitives/transaction/detectType)
</Card>
<Card title="Utilities" icon="wrench">
Format, extract chain ID, and helper functions
[View utilities →](/primitives/transaction/format)
</Card>
</CardGroup>

### Core Methods

- **Serialization**: `serialize`, `deserialize`, `detectType`
- **Hashing**: `hash`, `getSigningHash`
- **Signatures**: `getSender`, `verifySignature`, `isSigned`, `assertSigned`
- **Gas**: `getGasPrice`, `getEffectiveGasPrice`, `getBlobGasCost`
- **Access Lists**: `hasAccessList`, `getAccessList`
- **Chain**: `getChainId`
- **Display**: `format`
