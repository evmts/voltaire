...
Gwei (gigawei) is the standard unit for gas prices and transaction fees. `Gwei.Type` is a [branded](/concepts/branded-types) `Uint256` preventing accidental unit mixing.
