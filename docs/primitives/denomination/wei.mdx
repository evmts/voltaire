...
Wei is the atomic unit of Ether. All Ethereum values are ultimately represented in Wei internally. `Wei.Type` is a [branded](/concepts/branded-types) `Uint256` preventing accidental unit mixing.
