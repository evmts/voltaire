...
[Branded](/concepts/branded-types) `Uint256` types representing Ethereum denominations. Each denomination prevents accidental unit mixing at compile time while enabling seamless conversions.
