...
const valueEther = Ether(500_000_000_000_000_000n)  // 0.5 ETH
...
const gwei = Gwei(1n)  // 1 Gwei = 1_000_000_000 Wei
```
...
const etherValue = Ether(1n)  // 1 Ether
...
const slow = Gwei(20n)      // 20 Gwei
const standard = Gwei(50n)  // 50 Gwei
const fast = Gwei(100n)     // 100 Gwei
const urgent = Gwei(200n)   // 200 Gwei
...
const wei = Wei(1_500_000_000_000_000_000n)  // 1.5 Ether in Wei
