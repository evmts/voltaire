...
<Tip>
  New to gas costs? Start with **[Fundamentals](/primitives/gasconstants/fundamentals)** to learn how EVM gas works, cost categories, and calculation patterns.
</Tip>
...
### [Fundamentals](./fundamentals.mdx)
Learn gas cost model fundamentals:
- What gas constants are and why they exist
- Gas cost categories (computational, storage, memory)
- Intrinsic transaction gas
- Hardfork changes (Berlin, London, Shanghai)
