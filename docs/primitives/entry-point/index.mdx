...
```typescript
import { EntryPoint, ENTRYPOINT_V06, ENTRYPOINT_V07 } from 'tevm/primitives/EntryPoint';
...
```typescript
import { EntryPoint } from 'tevm/primitives/EntryPoint';
...
```typescript
import { EntryPoint, ENTRYPOINT_V07 } from 'tevm/primitives/EntryPoint';
