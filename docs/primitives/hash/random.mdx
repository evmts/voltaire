...
**Defined in:** [primitives/Hash/BrandedHash/random.js:16](https://github.com/evmts/voltaire/blob/main/src/primitives/Hash/BrandedHash/random.js#L16)
...
**Returns:** `BrandedHash` - Random 32-byte hash
...
Zig uses `std.crypto.random` for cryptographically secure random bytes:
