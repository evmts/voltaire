...
Defined in: [primitives/Hash/Hash.js:14](https://github.com/evmts/voltaire/blob/main/src/primitives/Hash/Hash.js#L14)
Tests: [Hash.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hash/Hash.test.ts)
