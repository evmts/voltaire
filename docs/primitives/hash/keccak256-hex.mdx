...
## `Hash.keccak256Hex(hex: string): BrandedHash`
...
const hash = Hash.keccak256Hex('0x1234abcd')
```
...
## `Keccak256Hex({ keccak256 })(hex: string): BrandedHash`
