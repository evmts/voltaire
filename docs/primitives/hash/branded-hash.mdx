...
- **Zero-overhead** [branded type](/concepts/branded-types) wrapping `Uint8Array` (32 bytes)
...
Runtime-validated 32-byte `Uint8Array`. [Brand](/concepts/branded-types) prevents accidental mixing with other Uint8Arrays.
