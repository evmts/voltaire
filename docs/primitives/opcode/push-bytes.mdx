...
Opcode.pushBytes(0x5F)  // 0 (PUSH0 - no immediate data)
Opcode.pushBytes(0x60)  // 1 (PUSH1)
Opcode.pushBytes(0x61)  // 2 (PUSH2)
Opcode.pushBytes(0x7F)  // 32 (PUSH32)
Opcode.pushBytes(0x01)  // undefined (ADD, not a PUSH)
```
</Tab>
...
const bytes1 = Opcode.pushBytes(0x60);   // 1 (PUSH1)
const bytes32 = Opcode.pushBytes(0x7F);  // 32 (PUSH32)
```
</Tab>
</Tabs>
