...
Opcode.dupPosition(0x80)  // 1 (DUP1 duplicates top)
Opcode.dupPosition(0x81)  // 2 (DUP2 duplicates 2nd)
Opcode.dupPosition(0x8F)  // 16 (DUP16 duplicates 16th)
Opcode.dupPosition(0x01)  // undefined (ADD, not DUP)
```
</Tab>
...
const pos1 = Opcode.dupPosition(0x80);   // 1 (DUP1)
const pos16 = Opcode.dupPosition(0x8F);  // 16 (DUP16)
```
</Tab>
</Tabs>
