...
- [Reference Guide](/primitives/opcode/reference-guide) - Complete opcode reference with execution traces, stack diagrams, and examples
- [Constructors](/primitives/opcode/constructors) - Opcode constants, bytecode parsing, and jump destination analysis
- [Validation](/primitives/opcode/validation) - Opcode validation, category checks, and jump destination verification
- [Utilities](/primitives/opcode/utilities) - Metadata, stack effects, gas costs, and disassembly utilities
- [Usage Patterns](/primitives/opcode/usage-patterns) - Real-world bytecode analysis, gas estimation, and pattern detection
- [WASM Implementation](/primitives/opcode/wasm) - Performance analysis - why WASM is not implemented (pure TS is faster)
