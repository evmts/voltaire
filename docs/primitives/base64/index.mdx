...
<Tip title="New to Base64?">
Start with [Fundamentals](/primitives/base64/fundamentals) to learn the encoding algorithm, use cases, and implementation patterns.
</Tip>
...
Source: [Base64.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Base64/Base64.js)
...
<Tip title="When to use URL-safe encoding">
...
Base64 vs Hex size for 256 bytes of data:

```
Data: 256 bytes

Hex encoding:
  Size: 256 × 2 = 512 characters
  Format: 0x + pairs of hex digits

Base64 encoding:
  Size: ceil(256 / 3) × 4 = 344 characters
  Format: 4-character groups with optional padding

Savings: 512 - 344 = 168 characters (33% smaller)
```

**When to use:**
- **Base64**: Smaller output, URLs, JSON compatibility
- **Hex**: Human-readable, debugging, contract ABIs
