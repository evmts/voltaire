...
All WASM methods are compiled from [address.zig](https://github.com/evmts/tevm/blob/main/src/primitives/Address/address.zig) with `ReleaseSmall` optimization targeting minimal bundle size.
