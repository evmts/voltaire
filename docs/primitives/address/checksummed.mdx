...
// Schema class with automatic EIP-55 validation
class ChecksumAddress {
  value: string  // Validated checksummed string
  checksummed: Checksummed  // Getter for branded type
}
```

Effect.ts Schema class providing runtime validation and type safety.

Defined in: [primitives/Address/effect.ts:216](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L216)

</Tab>
</Tabs>

## ChecksumAddress Namespace
...
const checksummed = ChecksumAddress.from("0x742d35cc6634c0532925a3b844bc9e7595f51e3e")
// "0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e"

// Works with any input type
ChecksumAddress.from(69n)
ChecksumAddress.from(new Uint8Array([...]))
ChecksumAddress.from("0x742d35cc...")
```
...
// Validates EIP-55 checksum automatically
...
checksumAddr.value       // Same as checksummed
...
```typescript
import { from } from '@tevm/voltaire/BrandedAddress/ChecksumAddress'
import type { Checksummed } from '@tevm/voltaire/BrandedAddress/ChecksumAddress'

const checksummed: Checksummed = from("0x742d35cc6634c0532925a3b844bc9e7595f51e3e")
// "0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e"
```

<Note>
Tree-shakeable import includes keccak256 (~5-10 KB). For minimal bundle size without checksum validation, use `Address.toHex()` instead.
</Note>
...
ChecksumAddress.from("0x742d35cc6634c0532925a3b844bc9e7595f51e3e")
// "0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e"

ChecksumAddress.from(69n)
// "0x0000000000000000000000000000000000000045"

ChecksumAddress.from(addr)  // BrandedAddress
// "0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e"
```
...
ChecksumAddress.isValid("0x742d35cc6634c0532925a3b844bc9e7595f51e3e")
// false (all lowercase, but not matching checksum)

ChecksumAddress.isValid("0x742D35CC6634C0532925A3B844BC9E7595F51E3E")
// false (all uppercase, but not matching checksum)

// Zero address (all same case passes)
...
Address.Checksummed.isValid("0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e")
// true
...
try {
  const addr = ChecksumAddress.from("0x742d35cc...")  // Invalid checksum
} catch (e) {
  // Throws: "Invalid checksum address: EIP-55 checksum validation failed"
}
```
...
```typescript
import { isValid } from '@tevm/voltaire/BrandedAddress/ChecksumAddress'

if (isValid("0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e")) {
...
// Correct checksum
ChecksumAddress.isValid("0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed")
// true
...
## Effect.ts ChecksumAddress Class

Schema class providing runtime validation and type safety.
...
```typescript
checksumAddr.value         // "0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e"
checksumAddr.checksummed   // Same as value (getter)
```
...
// addr is Address schema instance
addr.address  // BrandedAddress (Uint8Array)
addr.toHex()  // "0x742d35cc6634c0532925a3b844bc9e7595f51e3e"
```

Defined in: [primitives/Address/effect.ts:256](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L256)

#### `isValid(str)` (static)

Validate EIP-55 checksum (static method).
...
Defined in: [primitives/Address/effect.ts:249](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L249)
...
Address.fromHex(addr.toHex()).equals(Address.fromHex(addr.toChecksummed()))
// true
```
...
<Warning>
Using `ChecksumAddress` includes keccak256 implementation (~5-10 KB). For minimal bundle size without checksum validation, use `Address.toHex()` or `Address.toLowercase()` instead.
</Warning>

**Tree-shaking:**
- `ChecksumAddress.from()` → Includes keccak256
- `ChecksumAddress.isValid()` → Includes keccak256
