...
Calculate CREATE contract address using Effect.ts Schema Address class.
...
// Direct usage
const deployer = Address.fromHex("0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e")
const contract = deployer.calculateCreateAddress(0n)
...
const ValidContract = Schema.Struct({
...
const data = {
  deployer: Address.fromHex("0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e"),
  nonce: 0n,
  contract: deployer.calculateCreateAddress(0n)
}

const validated = Schema.decodeUnknownSync(ValidContract)(data)
```

**Defined in:** [primitives/Address/effect.ts:191](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L191)
...
**Defined in:** [primitives/Address/address.zig:382](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/address.zig#L382)
...
CREATE address calculation is not exposed in the C API. Use TypeScript, Effect.ts, or Zig implementations directly.

<Tip>
The C API focuses on core primitives. For contract address derivation requiring RLP encoding and keccak256, use higher-level TypeScript or Zig APIs.
</Tip>
