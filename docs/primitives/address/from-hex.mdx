...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/from-hex.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/from-hex.ts).
</Tip>
...
**Defined in:** [primitives.h:103](https://github.com/evmts/tevm/blob/main/src/primitives.h#L103)
