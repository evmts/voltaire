...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/to-hex.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/to-hex.ts).
</Tip>
...
**Defined in:** [c_api.zig:55](https://github.com/evmts/tevm/blob/main/src/c_api.zig#L55)
