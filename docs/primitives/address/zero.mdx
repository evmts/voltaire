...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/zero.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/zero.ts).
</Tip>
...
**Defined in:** [primitives.h:65](https://github.com/evmts/tevm/blob/main/src/primitives.h#L65)
