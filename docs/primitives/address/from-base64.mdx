...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/from-base64.ts`](https://github.com/evmts/voltaire/blob/main/playground/src/examples/primitives/address/from-base64.ts).
</Tip>
