...
// Equivalent to
const alsoZero = Address("0x0000000000000000000000000000000000000000")
...
const recipient = Address(userInput)
if (!recipient.isZero()) {
...
const zero1 = Address("0x0000000000000000000000000000000000000000")
const zero2 = Address(0n)
const zero3 = Address(0)
const zero4 = Address(new Uint8Array(20))
...
```typescript
const isOne = addr.equals(Address(1n))
```
