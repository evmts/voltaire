...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/to-bytes.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/to-bytes.ts).
</Tip>
...
**Defined in:** [primitives.h:146](https://github.com/evmts/tevm/blob/main/src/primitives.h#L146)
...
- [AddressType](/primitives/address/branded-address) - Type-safe Uint8Array wrapper
