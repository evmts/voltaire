...
## `address.toUppercase(): Uppercase`

Converts address to uppercase hex string with `0x` prefix. Always returns uppercase regardless of how address was created.

**Returns:** `Uppercase` - Uppercase hex string (42 characters including `0x` prefix)
...
// Always uppercase, even if created from mixed-case
const addr2 = Address.fromHex("0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed")
console.log(addr2.toUppercase())
// "0x5AAEB6053F3E94C9B9A09F33669435E7EF1BEAED"
```

**Defined in:** [primitives/Address/BrandedAddress/toUppercase.js:15](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/BrandedAddress/toUppercase.js#L15)
...
Converts address to uppercase hex string with `0x` prefix.

**Parameters:**
- `address: BrandedAddress` - Address to convert

**Returns:** `Uppercase` - Uppercase hex string
...
## `address.toUppercase(): string`

Convert Effect.ts Address schema instance to uppercase hex string.
...
**Defined in:** [primitives/Address/effect.ts:129](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L129)

</Tab>
<Tab title="Zig">

## `address.toUppercase(allocator: Allocator): ![]u8`

Convert address to uppercase hex string. Caller owns returned memory.

**Parameters:**
- `allocator: Allocator` - Memory allocator for hex string

**Returns:** `[]u8` - Uppercase hex string with `0x` prefix (caller owns memory)
...
const upper = try addr.toUppercase(allocator);
...
// Lowercase input
const lower = Address.fromHex("0x742d35cc6634c0532925a3b844bc9e7595f251e3")
...
const fromLower = Address.fromHex(addr.toLowercase())
const fromUpper = Address.fromHex(addr.toUppercase())
const fromChecksum = Address.fromHex(addr.toChecksummed())
...
// Numeric address
const numeric = Address.fromNumber(69n)
