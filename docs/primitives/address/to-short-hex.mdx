...
// Works with Effect Schema composition
...
class User extends Schema.Class<User>("User")({
  ...
  getDisplayAddress(): string {
    return this.address.toShortHex()
  }
}
```

**Effect Schema Features:**
- Instance methods work directly on Schema classes
- Full validation with Effect Schema benefits
- Compose with other Effect primitives

**Defined in:** [primitives/Address/effect.ts:150](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L150)
