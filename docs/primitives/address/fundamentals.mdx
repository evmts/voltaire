...
<Info>
**Conceptual Guide** - For API reference and method documentation, see [Address API](/primitives/address).
</Info>
...
const factory = Address.fromHex("0x0000000000FFe8B47B3e2130213B802212439497");

// Simple contract bytecode (returns 42)
const runtimeCode = Bytecode.fromHex("0x602a60005260206000f3");
// PUSH1 0x2a PUSH1 0x00 MSTORE PUSH1 0x20 PUSH1 0x00 RETURN

// Deployment code wraps runtime code
const deployCode = Bytecode.fromHex("0x69602a60005260206000f3600052600a6016f3");
...
```typescript
// Precompile addresses
const ecRecover  = Address.fromHex("0x0000000000000000000000000000000000000001"); // ECRecover
const sha256     = Address.fromHex("0x0000000000000000000000000000000000000002"); // SHA-256
const ripemd160  = Address.fromHex("0x0000000000000000000000000000000000000003"); // RIPEMD-160
const identity   = Address.fromHex("0x0000000000000000000000000000000000000004"); // Identity
const modexp     = Address.fromHex("0x0000000000000000000000000000000000000005"); // ModExp
const ecAdd      = Address.fromHex("0x0000000000000000000000000000000000000006"); // BN254 Add
const ecMul      = Address.fromHex("0x0000000000000000000000000000000000000007"); // BN254 Mul
const ecPairing  = Address.fromHex("0x0000000000000000000000000000000000000008"); // BN254 Pairing
const blake2f    = Address.fromHex("0x0000000000000000000000000000000000000009"); // Blake2f
const pointEval  = Address.fromHex("0x000000000000000000000000000000000000000a"); // KZG Point Evaluation
```
...
const addr2 = Address.fromHex("0x742D35CC6634C0532925A3B844BC9E7595F51E3E"); // Different case
