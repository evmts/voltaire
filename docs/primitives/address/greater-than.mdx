...
const MIN_ADDRESS = Address("0x0000000000000000000000000000000000001000")
...
const minRange = Address(1000n)
const maxRange = Address(2000n)
...
const SHARDS: Shard[] = [
  {
    ...
    maxAddress: Address("0x3fffffffffffffffffffffffffffffffffffffff")
  },
  {
    id: 1,
    minAddress: Address("0x4000000000000000000000000000000000000000"),
    maxAddress: Address("0x7fffffffffffffffffffffffffffffffffffffff")
  },
  {
    id: 2,
    minAddress: Address("0x8000000000000000000000000000000000000000"),
    maxAddress: Address("0xbfffffffffffffffffffffffffffffffffffffff")
  },
  {
    id: 3,
    minAddress: Address("0xc000000000000000000000000000000000000000"),
    maxAddress: Address("0xffffffffffffffffffffffffffffffffffffffff")
  },
]
...
list.insert(Address(100n))
list.insert(Address(50n))
list.insert(Address(200n))
...
const addr1 = Address(100n)
const addr2 = Address(50n)
