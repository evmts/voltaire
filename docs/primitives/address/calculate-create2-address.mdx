...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/create2.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/create2.ts).
</Tip>
...
```typescript
import { CalculateCreate2Address } from 'tevm/Address'
