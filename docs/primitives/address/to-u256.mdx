...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/to-u256.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/to-u256.ts).
</Tip>
