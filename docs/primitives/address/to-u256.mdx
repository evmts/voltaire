...
## `address.toU256(): bigint`

Converts 20-byte address to 256-bit unsigned integer (bigint). Useful for numeric operations, sorting, and contract interactions that treat addresses as numbers.

**Returns:** `bigint` - 256-bit unsigned integer representation
...
console.log(value)
// 662570784624965186509451281704661422481108140515n

// Zero address
const zero = Address.fromHex("0x0000000000000000000000000000000000000000")
console.log(zero.toU256())
// 0n

// Max address (2^160 - 1)
const max = Address.fromHex("0xffffffffffffffffffffffffffffffffffffffff")
console.log(max.toU256())
// 1461501637330902918203684832716283019655932542975n
```

**Defined in:** [primitives/Address/BrandedAddress/toU256.js:14](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/BrandedAddress/toU256.js#L14)

</Tab>
<Tab title="Namespace API">

## `toU256(address: BrandedAddress): bigint`

Converts 20-byte address to 256-bit unsigned integer.
...
Convert address to 256-bit unsigned integer. Effect Schema API provides validation and type safety.
...
// Reversible with fromNumber
const original = 0x742d35cc6634c0532925a3b844bc9e7595f251e3n
const addr2 = Address.fromNumber(original)
console.log(addr2.toU256() === original)
// true
```

**Defined in:** [primitives/Address/effect.ts:136](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/effect.ts#L136)

</Tab>
<Tab title="Zig">

## `toU256(address: Address): u256`

Convert 20-byte address to 256-bit unsigned integer.

**Parameters:**
- `address: Address` - Address to convert

**Returns:** `u256` - 256-bit unsigned integer
...
std.debug.print("{}\n", .{value});
// 662570784624965186509451281704661422481108140515

// Reversible with fromU256
const addr2 = Address.fromU256(value);
try std.testing.expect(Address.equals(addr, addr2));
```

**Defined in:** [primitives/Address/address.zig:51](https://github.com/evmts/voltaire/blob/main/src/primitives/Address/address.zig#L51)
...
// Round trip
const addr2 = Address.fromNumber(converted)
...
const addr = Address.fromHex("0x0000000000000000000000000000000000000100")
const value = addr.toU256()
...
const nextAddr = Address.fromNumber(incremented)
const prevAddr = Address.fromNumber(decremented)
...
const addr1 = Address.fromHex("0x00000000000000000000000000000000000000ff")
const addr2 = Address.fromHex("0x000000000000000000000000000000000000ff00")
...
console.log(Address.fromNumber(combined).toHex())
// "0x000000000000000000000000000000000000ffff"

// Bitwise AND
const intersection = value1 & value2
console.log(Address.fromNumber(intersection).toHex())
...
const maxAddr = Address.fromHex("0xffffffffffffffffffffffffffffffffffffffff")
console.log(maxAddr.toU256() === MAX_ADDRESS_VALUE)
// true

// Leading zeros are preserved in address but not in bigint
const small = Address.fromHex("0x0000000000000000000000000000000000000001")
