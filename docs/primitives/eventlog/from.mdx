...
## `EventLog(params: EventLogParams): EventLog`

Primary constructor for creating event log instances.
...
// Alternative: EventLog.from() is an alias
const log2 = EventLog.from({ /* same params */ });
```

**Defined in:** [primitives/EventLog/EventLog.js](https://github.com/evmts/voltaire/blob/main/src/primitives/EventLog/EventLog.js)
