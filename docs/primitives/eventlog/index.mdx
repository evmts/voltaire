...
<Note>
EventLog supports both **Class API** (instance methods) and **Namespace API** (functional style). See [API Patterns](/concepts/api-patterns) to understand the differences and choose the right approach for your use case.
</Note>
