...
<Note>
EventLog supports both **Class API** (instance methods) and **Namespace API** (functional style). See [API Patterns](/getting-started/tree-shaking) to understand the differences and choose the right approach for your use case.
</Note>
...
const log = EventLog({
  ...
  data: Hex.from('0x0000000000000000000000000000000000000000000000000de0b6b3a7640000'),
});
