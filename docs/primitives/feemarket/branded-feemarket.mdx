...
See [eip1559.mdx#basefee](./eip1559.mdx#basefee)
...
See [eip4844.mdx#blobbasefee](./eip4844.mdx#blobbasefee)
...
```
BrandedFeeMarket/
├── BaseFee.js                   # EIP-1559 base fee constructor
├── BlobBaseFee.js               # EIP-4844 blob fee constructor
...
```typescript
// Only BaseFee and weiToGwei included in bundle
import { BaseFee, weiToGwei } from './FeeMarket.js';

const nextFee = BaseFee(30_000_000n, 30_000_000n, 1_000_000_000n);
