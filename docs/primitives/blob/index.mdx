...
[Branded](/concepts/branded-types) [`Uint8Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) representing EIP-4844 blob data (exactly 131,072 bytes = 128 KB).
...
<CardGroup cols={2}>
<Card title="toData" href="./toData">
Extract original data from blob (reads length prefix)
</Card>
<Card title="splitData" href="./splitData">
Split large data into multiple blobs
</Card>
<Card title="joinData" href="./joinData">
Join data from multiple blobs
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="toCommitment" href="./toCommitment">
Compute 48-byte KZG commitment for blob
</Card>
<Card title="toProof" href="./toProof">
Generate 48-byte KZG proof
</Card>
<Card title="toVersionedHash" href="./toVersionedHash">
Compute versioned hash (0x01 + SHA256 of commitment)
</Card>
<Card title="verify" href="./verify">
Verify KZG proof for blob and commitment
</Card>
<Card title="verifyBatch" href="./verifyBatch">
...
<CardGroup cols={2}>
<Card title="isValid" href="./isValid">
Check if data is valid blob (exactly 131,072 bytes)
</Card>
<Card title="isValidVersion" href="./isValidVersion">
...
<CardGroup cols={2}>
<Card title="calculateGas" href="./calculateGas">
Calculate blob gas cost given blob count and base fee
</Card>
<Card title="estimateBlobCount" href="./estimateBlobCount">
...
<CardGroup cols={3}>
<Card title="Blob.Commitment" href="./commitment">
Commitment validation and conversion
</Card>
<Card title="Blob.Proof" href="./proof">
Proof validation utilities
</Card>
<Card title="Blob.VersionedHash" href="./versioned-hash">
Versioned hash utilities and version extraction
</Card>
</CardGroup>
