...
[Branded](/concepts/branded-types) type representing Ethereum chain configurations. Provides chain constants, metadata, and lookup utilities for Ethereum networks. Zero-overhead design supports both tree-shakeable namespace methods and class instances.
...
Learn chain IDs, replay attack prevention, and network identification
[View fundamentals →](/primitives/chain/fundamentals)
</Card>
<Card title="Constructors" icon="rocket">
Create Chain instances from chain objects and chain IDs
[View constructors →](/primitives/chain/constructors)
</Card>
<Card title="Chain Lookup" icon="magnifying-glass">
Look up chains by ID using fromId() and byId record
[View chain lookup →](/primitives/chain/chain-lookup)
</Card>
<Card title="Metadata" icon="info-circle">
Access chain properties: name, chainId, RPC, explorers, currency
[View metadata →](/primitives/chain/metadata)
</Card>
<Card title="BrandedChain" icon="tag">
Tree-shakeable functional API for minimal bundle size
[View BrandedChain →](/primitives/chain/branded-chain)
</Card>
<Card title="Network Comparison" icon="chart-bar">
Compare gas fees, costs, and characteristics across networks
