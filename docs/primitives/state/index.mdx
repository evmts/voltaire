...
<CardGroup cols={2}>
  <Card title="StorageKey()" href="/primitives/state/storage-key">
    Factory function creating storage key from address and slot
  </Card>
  <Card title="from()" href="/primitives/state/from">
...
<CardGroup cols={2}>
  <Card title="toString()" href="/primitives/state/to-string">
    Convert to string format for map keys
  </Card>
  <Card title="fromString()" href="/primitives/state/from-string">
...
<CardGroup cols={2}>
  <Card title="equals()" href="/primitives/state/equals">
    Compare two storage keys for equality
  </Card>
  <Card title="is()" href="/primitives/state/is">
...
<CardGroup cols={1}>
  <Card title="hashCode()" href="/primitives/state/utilities">
    Compute hash code for storage key
  </Card>
</CardGroup>
