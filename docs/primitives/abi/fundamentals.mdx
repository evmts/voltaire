...
- [Event](/primitives/abi/event) - Event log handling
- [Error](/primitives/abi/error) - Custom error encoding
- [Constructor](/primitives/abi/constructor) - Constructor parameters
