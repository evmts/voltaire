...
[Branded](/getting-started/branded-types) array of ABI items (functions, events, errors, constructors). Zero-overhead design supports both tree-shakeable namespace methods and class instances, following the same pattern as [Address](/primitives/address).
...
- [Fundamentals](fundamentals) - Learn ABI encoding structure, function selectors, and data layout
- [Types](types) - Complete ABI type system: Abi, Parameter, AbiType, Item types, and type utilities

### Item Types

- [Function](function) - Function encoding/decoding, selectors, signatures, and result handling
- [Event](event) - Event log encoding/decoding, topic generation, and event filtering
- [Error](error) - Custom error encoding/decoding with type-safe parameter handling
- [Constructor](constructor) - Constructor parameter encoding for contract deployment

### Encoding & Decoding

- [Encoding](encoding) - Low-level ABI encoding patterns and algorithms
- [Decoding](decoding) - Low-level ABI decoding patterns and algorithms

### Advanced

- [BrandedAbi](branded-abi) - Tree-shakeable functional API with data-first patterns
- [WASM](wasm) - WebAssembly-accelerated encoding/decoding implementation
- [Usage Patterns](usage-patterns) - Common patterns: contract calls, log parsing, type inference
...
- [Hash](/primitives/hash) - Keccak256 hashing used for selectors and signatures
