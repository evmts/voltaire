...
- **Zero-overhead** [branded type](/getting-started/branded-types) wrapping `bigint`
...
Runtime-validated bigint constrained to `0 <= value <= 2^256-1`. [Brand](/getting-started/branded-types) prevents accidental mixing with regular bigints.
