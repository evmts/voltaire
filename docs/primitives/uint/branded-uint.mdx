...
- **Zero-overhead** [branded type](/concepts/branded-types) wrapping `bigint`
...
Runtime-validated bigint constrained to `0 <= value <= 2^256-1`. [Brand](/concepts/branded-types) prevents accidental mixing with regular bigints.
