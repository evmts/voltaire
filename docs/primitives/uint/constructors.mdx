...
Source: [UintConstructor.ts:69](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/UintConstructor.ts#L69)
...
Source: [from.ts:18](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint/from.ts#L18)
...
Source: [fromHex.ts:17](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint/fromHex.ts#L17)
...
Source: [fromBigInt.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint/fromBigInt.ts)
...
Source: [fromNumber.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint/fromNumber.ts)
...
Source: [fromBytes.ts:16](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint/fromBytes.ts#L16)
...
Source: [fromAbiEncoded.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Uint/BrandedUint/fromAbiEncoded.ts)
...
const bytes: Bytesless than 32> = new Uint8Array(32)
