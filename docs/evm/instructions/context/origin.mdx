...
const originAddr = Address.from('0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb');
...
const err = origin(frame, Address.from('0x0000000000000000000000000000000000000000'));
