---
title: "PUSH27 (0x7A)"
description: "Push 27-byte immediate value onto stack"
---
...
```typescript
import { handler_0x7A_PUSH27 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x7A_PUSH27(frame: BrandedFrame): EvmError | null {
