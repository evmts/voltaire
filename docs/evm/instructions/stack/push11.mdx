---
title: "PUSH11 (0x6A)"
description: "Push 11-byte immediate value onto stack"
---
...
```typescript
import { handler_0x6A_PUSH11 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x6A_PUSH11(frame: BrandedFrame): EvmError | null {
