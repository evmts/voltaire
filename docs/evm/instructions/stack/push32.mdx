---
title: "PUSH32 (0x7F)"
description: "Push 32-byte immediate value onto stack"
---
...
```typescript
import { handler_0x7F_PUSH32 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x7F_PUSH32(frame: BrandedFrame): EvmError | null {
