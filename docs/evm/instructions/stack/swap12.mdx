---
title: "SWAP12 (0x9B)"
description: "Swap top with 13th stack item"
---
...
```typescript
import { handler_0x9B_SWAP12 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x9B_SWAP12(frame: BrandedFrame): EvmError | null {
