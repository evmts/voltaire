---
title: "SWAP7 (0x96)"
description: "Swap top with 8th stack item"
---
...
```typescript
import { handler_0x96_SWAP7 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x96_SWAP7(frame: BrandedFrame): EvmError | null {
