---
title: "PUSH26 (0x79)"
description: "Push 26-byte immediate value onto stack"
---
...
```typescript
import { handler_0x79_PUSH26 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x79_PUSH26(frame: BrandedFrame): EvmError | null {
