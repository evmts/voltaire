---
title: "PUSH14 (0x6D)"
description: "Push 14-byte immediate value onto stack"
---
...
```typescript
import { handler_0x6D_PUSH14 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x6D_PUSH14(frame: BrandedFrame): EvmError | null {
