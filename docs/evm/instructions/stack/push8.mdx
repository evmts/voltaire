---
title: "PUSH8 (0x67)"
description: "Push 8-byte immediate value onto stack"
---
...
```typescript
import { handler_0x67_PUSH8 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x67_PUSH8(frame: BrandedFrame): EvmError | null {
