---
title: "PUSH21 (0x74)"
description: "Push 21-byte immediate value onto stack"
---
...
```typescript
import { handler_0x74_PUSH21 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x74_PUSH21(frame: BrandedFrame): EvmError | null {
