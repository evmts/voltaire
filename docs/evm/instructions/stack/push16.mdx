---
title: "PUSH16 (0x6F)"
description: "Push 16-byte immediate value onto stack"
---
...
```typescript
import { handler_0x6F_PUSH16 } from 'tevm/evm/stack/handlers';
 ...
 */
export function handler_0x6F_PUSH16(frame: BrandedFrame): EvmError | null {
