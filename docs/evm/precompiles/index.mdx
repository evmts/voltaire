...
```typescript
import { execute, PrecompileAddress } from 'tevm/precompiles';
import { Hardfork } from 'tevm/primitives/Hardfork';
...
See [BENCHMARKING.md](https://github.com/evmts/tevm/blob/main/BENCHMARKING.md) for detailed results.
