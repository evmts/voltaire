...
const base = Hex.from('0x' + 'ab'.repeat(256)); // Signature (256 bytes)
const exponent = Hex.from('0x010001'); // Public exponent 65537 (3 bytes)
const modulus = Hex.from('0x' + 'cd'.repeat(256)); // RSA modulus (256 bytes)
