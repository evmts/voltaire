...
The Ethereum Virtual Machine is a stack-based virtual machine that executes smart contract bytecode. Tevm provides low-level implementations of all EVM opcodes and precompiled contracts in both TypeScript and Zig, enabling high-performance execution for EVM-compatible chains.
...
See [BENCHMARKING.md](https://github.com/evmts/tevm/blob/main/BENCHMARKING.md) for performance data.
...
See [CONTRIBUTING.md](https://github.com/evmts/tevm/blob/main/CONTRIBUTING.md)
