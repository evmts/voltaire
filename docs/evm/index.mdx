...
pub fn executeInstruction(opcode: u8, stack: *Stack, memory: *Memory) !void {
    switch (opcode) {
        0x01 => try evm.instructions.arithmetic.add(stack),
        0x02 => try evm.instructions.arithmetic.mul(stack),
        0x10 => try evm.instructions.comparison.lt(stack),
        // ... 160+ more opcodes
