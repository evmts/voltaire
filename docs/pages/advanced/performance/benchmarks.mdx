...
|------|------------|------|------|
| 1 KB | 0.12 μs | 0.14 μs | 0.28 μs |
| 32 KB | 1.8 μs | 2.1 μs | 4.2 μs |
| 1 MB | 45 μs | 52 μs | 98 μs |
| 16 MB | 720 μs | 850 μs | 1600 μs |
...
|--------------|---------------------|--------|
| Register-based VM | +20-30% | 🚧 In Progress |
| JIT compilation | +50-100% | 📋 Planned |
| Parallel execution | +200-400% | 🔬 Research |
| Custom allocator | +5-10% | 🚧 In Progress |
| SIMD operations | +10-15% | 📋 Planned |
...
|-----------|------------|------|------|
| Uniswap V2 Swap | 180 μs | 210 μs | 450 μs |
| Compound Supply | 220 μs | 260 μs | 580 μs |
| Aave Borrow | 340 μs | 390 μs | 820 μs |
| Curve Exchange | 450 μs | 520 μs | 1100 μs |

### NFT Operations

| Operation | Guillotine | Revm | Geth |
|-----------|------------|------|------|
| ERC-721 Transfer | 85 μs | 95 μs | 210 μs |
| ERC-1155 Batch | 420 μs | 480 μs | 980 μs |
| Mint with Metadata | 150 μs | 170 μs | 380 μs |
...
- **[Memory Management](/advanced/performance/memory)** - Memory optimization
