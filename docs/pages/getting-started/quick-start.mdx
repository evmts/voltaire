...
That’s it! You’ve initialized the EVM, installed code into state, and executed a call using the real API.
...
| `DUP1` | `0x80` | 3 | 1 → 2 | Duplicate top |
| `SWAP1` | `0x90` | 3 | 2 → 2 | Swap top two |
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginTop: '2rem' }}>
  <a href="/getting-started/basic-example" style={{
    ...
    <h3 style={{ margin: '0 0 0.5rem 0' }}>📘 Basic Example</h3>
  ...
  <a href="/usage/basic-execution" style={{
    ...
    <h3 style={{ margin: '0 0 0.5rem 0' }}>⚙️ Execution Modes</h3>
    <p style={{ margin: 0, color: 'var(--vocs-color_text2)' }}>
  ...
  <a href="#TODO" style={{
    ...
    <h3 style={{ margin: '0 0 0.5rem 0' }}>📚 API Reference</h3>
    <p style={{ margin: 0, color: 'var(--vocs-color_text2)' }}>
