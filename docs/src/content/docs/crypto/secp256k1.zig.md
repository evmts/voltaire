---
title: Elliptic Curve Operations for Ethereum
description: Low-level secp256k1 elliptic curve operations including affine point arithmetic, signature validation, and address recovery.
---
