...
```typescript
import { Ripemd160 } from 'tevm/crypto/ripemd160';

// Hash bytes - constructor returns branded Ripemd160 type
const data = new Uint8Array([1, 2, 3, 4, 5]);
const hash = Ripemd160(data);
// BrandedRipemd160 (Uint8Array(20))

// Hash string (UTF-8 encoded automatically)
const stringHash = Ripemd160('hello');
// BrandedRipemd160

// Constructor accepts both Uint8Array and strings
const directHash = Ripemd160('hello');
// BrandedRipemd160 [same as stringHash]
```
</Tab>

<Tab title="Bitcoin Address">
```typescript
import { Sha256 } from 'tevm/crypto/sha256';
import { Ripemd160 } from 'tevm/crypto/ripemd160';
import * as Hex from 'tevm/primitives/Hex';

// Bitcoin P2PKH address derivation (simplified)
const publicKey = Hex('0x04' + '9876...'); // 65-byte uncompressed secp256k1 public key
...
// BrandedRipemd160 (Uint8Array(20)) [public key hash]
...
### `Ripemd160(data: Uint8Array | string): BrandedRipemd160`

Compute RIPEMD160 hash using constructor pattern.
...
**Returns:** BrandedRipemd160 - 20-byte hash with branded type

**Example:**
```typescript
// Hash bytes
const hash1 = Ripemd160(new Uint8Array([1, 2, 3]));
console.log(hash1.length); // 20

// Hash string
const hash2 = Ripemd160('hello');
console.log(hash2.length); // 20
```

---

### `Ripemd160.hash(data: Uint8Array | string): BrandedRipemd160`

Alternative namespace API for computing RIPEMD160 hash.

**Parameters:**
- `data`: Input data to hash (Uint8Array or string)

**Returns:** BrandedRipemd160 - 20-byte branded hash

**Example:**
```typescript
// Equivalent to Ripemd160(data) constructor
const hash = Ripemd160.hash('message digest');
// BrandedRipemd160
```
...
```typescript
// Branded 20-byte RIPEMD160 hash for type safety
export type BrandedRipemd160 = Uint8Array & { readonly __tag: "Ripemd160" };
```
...
Ripemd160("abcdefghijklmnopqrstuvwxyz")
// Uint8Array(20) [
...
```typescript
import { Ripemd160Wasm } from 'tevm/crypto/ripemd160.wasm';
...
function createPubKeyHash(publicKey: Uint8Array): BrandedRipemd160 {
  // Bitcoin uses SHA256 followed by RIPEMD160
  const sha256Hash = Sha256(publicKey);      // BrandedSha256
  const pubKeyHash = Ripemd160(sha256Hash);  // BrandedRipemd160
...
function createScriptHash(redeemScript: Uint8Array): BrandedRipemd160 {
  const sha256Hash = Sha256(redeemScript);   // BrandedSha256
  const scriptHash = Ripemd160(sha256Hash);  // BrandedRipemd160
