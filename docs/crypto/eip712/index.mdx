...
```typescript
import * as EIP712 from 'tevm/crypto/eip712';
...
import { HashTypedData, HashDomain, HashStruct, EncodeData,
         HashType, EncodeValue } from 'tevm/crypto/eip712';
...
```typescript
import { HashTypedData } from 'tevm/crypto/eip712';
import { hash as keccak256Wasm } from 'tevm/crypto/keccak256/wasm';
import { sign as secp256k1Wasm } from 'tevm/crypto/secp256k1/wasm';
