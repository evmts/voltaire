...
<Info>
Source: [bls12_381.zig](https://github.com/evmts/voltaire/blob/main/src/crypto/bls12_381.zig)

Tests: [bls12_g2_operations.test.ts](https://github.com/evmts/voltaire/blob/main/src/precompiles/bls12_g2_operations.test.ts)
</Info>
