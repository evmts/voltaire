...
Tevm provides Keccak256 with **two implementation options**:
...
const hash1 = Keccak256.hash(data);      // Default (WASM)
const hash2 = Keccak256Ts.hash(data);    // TypeScript
const hash3 = Keccak256Wasm.hash(data);  // Explicit WASM
```
