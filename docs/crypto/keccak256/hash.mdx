...
const storageSlot: BrandedBytes32 = Bytes32.from(0);
...
type BytesType = typeof storageSlot; // BrandedBytes32
```
...
**Migration steps:**
1. Replace `Hash.keccak256()` with `Keccak256.hash()`
2. Replace `BrandedHash` type with `Keccak256Hash`
...
const genericHash: Bytes32.BrandedBytes32 = Bytes32.from(anyHash);
```
