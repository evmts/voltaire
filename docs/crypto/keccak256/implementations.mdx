...
- **Pros:** Full Tevm features, 2-4x faster than pure JS
...
**Use when:**
- Only need Keccak256 (not other Tevm functions)
...
- No dependencies on other Tevm modules
...
### WASM Unified (200KB)
Full Tevm primitives and crypto:
