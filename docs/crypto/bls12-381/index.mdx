...
**Current Reality**: Only available on consensus layer (Beacon Chain). For execution layer zkSNARKs, use [BN254 precompiles](/precompiles/bn254) (0x06-0x08) which ARE on mainnet.
...
- [Precompiles: BLS12-381](/precompiles/bls12-381) - EIP-2537 implementation (NOT on mainnet)
