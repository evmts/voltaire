...
const seed = Hex.from('0x9d61b19deffd5a60ba844af492ec2cc44449c5697b326919703bac031cae7f60');
...
const seed = Hex.from('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef');
...
Currently, Ed25519 is available only through the TypeScript/WASM interface. Native Zig implementation uses `std.crypto.sign.Ed25519` for future FFI support.
...
const seed = Hex.from('0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890');
const { secretKey, publicKey } = Ed25519.keypairFromSeed(seed);
...
const seed = Hex.from('0xfedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321');
const { secretKey, publicKey } = Ed25519.keypairFromSeed(seed);

// Empty message
const emptyMsg = Hex.from('0x');
