...
// Empty message
const sig0 = Ed25519.sign(new Uint8Array(0), secretKey);
assert(Ed25519.verify(sig0, new Uint8Array(0), publicKey));
...
// Long message (1 MB)
const msg2 = new Uint8Array(1024 * 1024);
const sig2 = Ed25519.sign(msg2, secretKey);
assert(Ed25519.verify(sig2, msg2, publicKey));
```
