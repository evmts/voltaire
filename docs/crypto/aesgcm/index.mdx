...
<Info>
Source: [aes_gcm.zig](https://github.com/evmts/voltaire/blob/main/src/crypto/aes_gcm.zig)

Tests: [aes_gcm.test.ts](https://github.com/evmts/voltaire/blob/main/src/crypto/aes_gcm.test.ts)
</Info>
...
- [AES-GCM (Effect)](https://voltaire-effect.tevm.sh/crypto/aesgcm) - Effect.ts integration with Schema validation
