...
<Tip>
Try it live: open the <a href="/playground">Playground</a> or run <code>bun run docs:playground:build</code> to embed it locally under the docs.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Playground" icon="flask" href="/playground">
    Experiment interactively with Tevm primitives in your browser
  </Card>
