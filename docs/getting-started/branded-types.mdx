...
Branded types provide modern type safety with runtime validation without the need for a library like Zod. They use [type-level tags](https://news.ycombinator.com/item?id=40146751) that make structurally identical types distinguishable to TypeScript's type checker.
