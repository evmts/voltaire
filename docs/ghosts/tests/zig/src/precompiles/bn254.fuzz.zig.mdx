---
title: '[Zig] src/precompiles/bn254.fuzz.zig'
source: 'src/precompiles/bn254.fuzz.zig'
---

> Auto-generated from Zig tests in: src/precompiles/bn254.fuzz.zig

### fuzz bn254Add arbitrary input
...
### fuzz bn254Add structured points
...
### fuzz bn254Add point at infinity
...
### fuzz bn254Add input length variations
...
### fuzz bn254Add field boundary values
...
### fuzz bn254Mul structured input
...
### fuzz bn254Mul scalar variations
...
### fuzz bn254Mul input length variations
...
### fuzz bn254Mul field boundary points
...
### fuzz bn254Pairing arbitrary input
...
### fuzz bn254Pairing length validation
...
### fuzz bn254Pairing multiple pairs
...
### fuzz bn254Pairing gas calculation
...
### fuzz bn254Pairing invalid lengths
...
### fuzz bn254Pairing output format
...
### fuzz bn254Pairing large pair count
...
### fuzz bn254Pairing memory stress
