---
title: '[Zig] src/precompiles/bls12.fuzz.zig'
source: 'src/precompiles/bls12.fuzz.zig'
---

> Auto-generated from Zig tests in: src/precompiles/bls12.fuzz.zig

### fuzz bls12_g1_add arbitrary input
...
### fuzz bls12_g1_add structured points
...
### fuzz bls12_g1_add point at infinity
...
### fuzz bls12_g1_add input length validation
...
### fuzz bls12_g1_add field boundary values
...
### fuzz bls12_g1_mul arbitrary input
...
### fuzz bls12_g1_mul structured input
...
### fuzz bls12_g1_mul scalar variations
...
### fuzz bls12_g1_mul large scalars
...
### fuzz bls12_g1_mul input length validation
...
### fuzz bls12_g2_add arbitrary input
...
### fuzz bls12_g2_add structured points
...
### fuzz bls12_g2_add input length validation
...
### fuzz bls12_g2_mul arbitrary input
...
### fuzz bls12_g2_mul structured input
...
### fuzz bls12_g2_mul input length validation
...
### fuzz bls12_pairing arbitrary input
...
### fuzz bls12_pairing length validation
...
### fuzz bls12_pairing single pair
...
### fuzz bls12_pairing multiple pairs
...
### fuzz bls12_pairing gas calculation
...
### fuzz bls12_pairing empty input
...
### fuzz bls12_pairing output format
...
### fuzz bls12_pairing determinism
...
### fuzz bls12_map_fp_to_g1 arbitrary input
...
### fuzz bls12_map_fp_to_g1 structured input
...
### fuzz bls12_map_fp_to_g1 input length validation
...
### fuzz bls12_map_fp_to_g1 field element boundaries
...
### fuzz bls12_map_fp_to_g1 gas limits
...
### fuzz bls12_map_fp_to_g1 determinism
...
### fuzz bls12_map_fp2_to_g2 arbitrary input
...
### fuzz bls12_map_fp2_to_g2 structured input
...
### fuzz bls12_map_fp2_to_g2 input length validation
...
### fuzz bls12_map_fp2_to_g2 fp2 element boundaries
...
### fuzz bls12_map_fp2_to_g2 gas limits
...
### fuzz bls12_map_fp2_to_g2 determinism
