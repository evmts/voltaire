---
title: '[Zig] src/crypto/blake2.fuzz.zig'
source: 'src/crypto/blake2.fuzz.zig'
---

> Auto-generated from Zig tests in: src/crypto/blake2.fuzz.zig

### fuzz blake2b compression basic
...
### fuzz blake2b compression determinism
...
### fuzz blake2b compression arbitrary rounds
...
### fuzz blake2b compression counter values
...
### fuzz blake2b compression final flag
...
### fuzz blake2b compression empty input
...
### fuzz blake2b compression large rounds
...
### fuzz blake2b compression zero rounds
...
### fuzz blake2b compression all bits set
...
### fuzz blake2b compression alternating bits
...
### fuzz Blake2.compress wrapper invalid input length
...
### fuzz Blake2.compress wrapper invalid output length
...
### fuzz Blake2.compress wrapper determinism
...
### fuzz Blake2.compress wrapper rounds extraction
...
### fuzz Blake2.compress wrapper final flag
...
### fuzz blake2b G function all indices
...
### fuzz blake2b round function all round indices
...
### fuzz blake2b compression sequence consistency
