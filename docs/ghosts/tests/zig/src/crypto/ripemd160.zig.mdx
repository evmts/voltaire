...
### RIPEMD160: output is always exactly 20 bytes (type-enforced)
...
### RIPEMD160: Ripemd160.hash output pointer is exactly 20 bytes
...
### RIPEMD160: unauditedHash returns exactly 20 bytes
...
### RIPEMD160: empty input produces 20-byte output
...
### RIPEMD160: large input produces 20-byte output
...
### RIPEMD160: streaming hash produces same 20-byte output
