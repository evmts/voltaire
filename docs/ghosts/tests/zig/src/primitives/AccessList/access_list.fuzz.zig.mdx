---
title: '[Zig] src/primitives/AccessList/access_list.fuzz.zig'
source: 'src/primitives/AccessList/access_list.fuzz.zig'
---

> Auto-generated from Zig tests in: src/primitives/AccessList/access_list.fuzz.zig

### fuzz calculateAccessListGasCost
...
### fuzz deduplicateAccessList multiple addresses
...
### fuzz encodeAccessList determinism
...
### fuzz arbitrary address membership
...
### fuzz arbitrary storage key membership
...
### fuzz duplicate storage keys in entry
