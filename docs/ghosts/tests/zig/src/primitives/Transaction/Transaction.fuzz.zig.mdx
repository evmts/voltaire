---
title: '[Zig] src/primitives/Transaction/Transaction.fuzz.zig'
source: 'src/primitives/Transaction/Transaction.fuzz.zig'
---

> Auto-generated from Zig tests in: src/primitives/Transaction/Transaction.fuzz.zig

### fuzz detectTransactionType
...
### fuzz encodeLegacyForSigning contract creation
...
### fuzz encodeEip1559ForSigning with access list
...
### fuzz computeLegacyTransactionHash
...
### fuzz computeEip4844TransactionHash
...
### fuzz computeEip7702TransactionHash
...
### fuzz legacy transaction encoding determinism
...
### fuzz eip1559 transaction encoding determinism
...
### fuzz signature field boundaries
