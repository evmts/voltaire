---
title: '[Zig] src/primitives/Opcode/opcode_info.zig'
source: 'src/primitives/Opcode/opcode_info.zig'
---

> Auto-generated from Zig tests in: src/primitives/Opcode/opcode_info.zig

### opcode info array has correct size
...
### common opcodes have expected values
...
### comparison and bitwise opcodes metadata
...
### environmental information opcodes metadata
...
### block information opcodes metadata
...
### stack memory and storage opcodes metadata
...
### system operation opcodes metadata
...
### boundary opcodes STOP and SELFDESTRUCT
...
### stack input output validation for all opcode categories
...
### min stack required for DUP operations
...
### min stack required for SWAP operations
...
### min stack required for regular operations
...
### max stack after operations with outputs
...
### max stack after operations without outputs
...
### hardfork specific opcodes are documented
...
### gas costs for dynamic opcodes have base costs
