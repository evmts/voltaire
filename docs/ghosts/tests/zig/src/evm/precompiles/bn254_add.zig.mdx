---
title: '[Zig] src/evm/precompiles/bn254_add.zig'
source: 'src/evm/precompiles/bn254_add.zig'
---

> Auto-generated from Zig tests in: src/evm/precompiles/bn254_add.zig
...
### bn254Add - input too long padded correctly
...
### bn254Add - output size validation
...
### bn254Add - geth cdetrio1 empty input
...
### bn254Add - geth cdetrio2 single point
...
### bn254Add - geth cdetrio3 partial input
...
### bn254Add - geth cdetrio4 invalid point not on curve
...
### bn254Add - geth cdetrio5 generator point addition
...
### bn254Add - geth cdetrio6 large x coordinate
...
### bn254Add - geth cdetrio7 another valid addition
...
### bn254Add - geth cdetrio8 valid addition with large coordinates
...
### bn254Add - geth cdetrio9 same point addition
...
### bn254Add - geth cdetrio10 point doubling
...
### bn254Add - geth cdetrio11 invalid x larger than field modulus
...
### bn254Add - geth cdetrio12 invalid y larger than field modulus
...
### bn254Add - geth cdetrio13 coordinates at field modulus
...
### bn254Add - geth cdetrio14 zero point with valid point
