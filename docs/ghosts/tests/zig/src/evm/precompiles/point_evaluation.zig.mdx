---
title: '[Zig] src/evm/precompiles/point_evaluation.zig'
source: 'src/evm/precompiles/point_evaluation.zig'
---

> Auto-generated from Zig tests in: src/evm/precompiles/point_evaluation.zig

### point_evaluation - gas cost constant
...
### point_evaluation - invalid input length too short
...
### point_evaluation - invalid input length too long
...
### point_evaluation - invalid input length zero
...
### point_evaluation - versioned hash mismatch
...
### point_evaluation - correct proof case 0 (point at infinity)
...
### point_evaluation - correct proof case 1
...
### point_evaluation - incorrect proof returns zero output
...
### point_evaluation - invalid commitment malformed
...
### point_evaluation - all zero input
...
### point_evaluation - all ones input
...
### point_evaluation - versioned hash wrong version byte
...
### point_evaluation - output format validation
...
### point_evaluation - gas usage always constant
...
### point_evaluation - exact gas limit allowed
...
### point_evaluation - high gas limit accepted
...
### point_evaluation - memory allocation success
...
### point_evaluation - input components boundaries
