---
title: '[Zig] src/evm/precompiles/bls12_map_fp_to_g1.zig'
source: 'src/evm/precompiles/bls12_map_fp_to_g1.zig'
---

> Auto-generated from Zig tests in: src/evm/precompiles/bls12_map_fp_to_g1.zig

### map fp to g1 - out of gas
...
### map fp to g1 - invalid input length too short
...
### map fp to g1 - invalid input length too long
...
### map fp to g1 - invalid input length zero
...
### map fp to g1 - zero field element
...
### map fp to g1 - maximum field element
...
### map fp to g1 - gas cost validation
...
### map fp to g1 - output size validation
