---
title: '[TS/JS] examples/multicall/Multicall.test.ts'
source: 'examples/multicall/Multicall.test.ts'
---

> Auto-generated from test file: examples/multicall/Multicall.test.ts
