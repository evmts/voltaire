---
title: '[TS/JS] examples/primitives/chain/examples.test.ts'
source: 'examples/primitives/chain/examples.test.ts'
---

> Auto-generated from test file: examples/primitives/chain/examples.test.ts
