---
title: '[TS/JS] examples/primitives/uint/examples.test.ts'
source: 'examples/primitives/uint/examples.test.ts'
---

> Auto-generated from test file: examples/primitives/uint/examples.test.ts
