---
title: '[TS/JS] examples/primitives/bloomfilter/examples.test.ts'
source: 'examples/primitives/bloomfilter/examples.test.ts'
---

> Auto-generated from test file: examples/primitives/bloomfilter/examples.test.ts
