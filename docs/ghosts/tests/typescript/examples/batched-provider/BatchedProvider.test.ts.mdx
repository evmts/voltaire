---
title: '[TS/JS] examples/batched-provider/BatchedProvider.test.ts'
source: 'examples/batched-provider/BatchedProvider.test.ts'
---

> Auto-generated from test file: examples/batched-provider/BatchedProvider.test.ts
