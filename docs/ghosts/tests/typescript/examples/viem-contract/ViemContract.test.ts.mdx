---
title: '[TS/JS] examples/viem-contract/ViemContract.test.ts'
source: 'examples/viem-contract/ViemContract.test.ts'
---

> Auto-generated from test file: examples/viem-contract/ViemContract.test.ts
