---
title: '[TS/JS] voltaire-effect/src/contract/EventStreamError.test.ts'
source: 'voltaire-effect/src/contract/EventStreamError.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/contract/EventStreamError.test.ts
