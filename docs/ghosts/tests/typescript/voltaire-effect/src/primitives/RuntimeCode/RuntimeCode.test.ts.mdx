---
title: '[TS/JS] voltaire-effect/src/primitives/RuntimeCode/RuntimeCode.test.ts'
source: 'voltaire-effect/src/primitives/RuntimeCode/RuntimeCode.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/RuntimeCode/RuntimeCode.test.ts
