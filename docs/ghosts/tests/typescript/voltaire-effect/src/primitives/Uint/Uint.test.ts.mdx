---
title: '[TS/JS] voltaire-effect/src/primitives/Uint/Uint.test.ts'
source: 'voltaire-effect/src/primitives/Uint/Uint.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Uint/Uint.test.ts
