---
title: '[TS/JS] voltaire-effect/src/primitives/BlockNumber/BlockNumber.test.ts'
source: 'voltaire-effect/src/primitives/BlockNumber/BlockNumber.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/BlockNumber/BlockNumber.test.ts
