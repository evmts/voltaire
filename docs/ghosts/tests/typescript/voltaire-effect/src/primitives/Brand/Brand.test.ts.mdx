---
title: '[TS/JS] voltaire-effect/src/primitives/Brand/Brand.test.ts'
source: 'voltaire-effect/src/primitives/Brand/Brand.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Brand/Brand.test.ts
