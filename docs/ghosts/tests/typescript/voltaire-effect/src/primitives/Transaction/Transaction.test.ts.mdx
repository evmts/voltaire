---
title: '[TS/JS] voltaire-effect/src/primitives/Transaction/Transaction.test.ts'
source: 'voltaire-effect/src/primitives/Transaction/Transaction.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Transaction/Transaction.test.ts
