---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/encodeFunctionResult.test.ts'
source: 'voltaire-effect/src/primitives/Abi/encodeFunctionResult.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/encodeFunctionResult.test.ts
