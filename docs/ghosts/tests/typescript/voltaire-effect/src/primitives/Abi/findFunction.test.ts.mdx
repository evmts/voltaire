---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/findFunction.test.ts'
source: 'voltaire-effect/src/primitives/Abi/findFunction.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/findFunction.test.ts
