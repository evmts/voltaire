---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/encodeFunctionData.test.ts'
source: 'voltaire-effect/src/primitives/Abi/encodeFunctionData.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/encodeFunctionData.test.ts
