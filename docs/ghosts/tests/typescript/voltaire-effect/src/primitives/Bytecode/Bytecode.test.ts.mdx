---
title: '[TS/JS] voltaire-effect/src/primitives/Bytecode/Bytecode.test.ts'
source: 'voltaire-effect/src/primitives/Bytecode/Bytecode.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Bytecode/Bytecode.test.ts
