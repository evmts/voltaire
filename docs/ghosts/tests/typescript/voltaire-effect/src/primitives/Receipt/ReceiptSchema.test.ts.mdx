---
title: '[TS/JS] voltaire-effect/src/primitives/Receipt/ReceiptSchema.test.ts'
source: 'voltaire-effect/src/primitives/Receipt/ReceiptSchema.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Receipt/ReceiptSchema.test.ts
