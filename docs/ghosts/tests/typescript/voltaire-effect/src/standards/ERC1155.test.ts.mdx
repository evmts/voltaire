---
title: '[TS/JS] voltaire-effect/src/standards/ERC1155.test.ts'
source: 'voltaire-effect/src/standards/ERC1155.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/standards/ERC1155.test.ts
