---
title: '[TS/JS] voltaire-effect/src/standards/errors.test.ts'
source: 'voltaire-effect/src/standards/errors.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/standards/errors.test.ts
