---
title: '[TS/JS] voltaire-effect/src/standards/ERC165.test.ts'
source: 'voltaire-effect/src/standards/ERC165.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/standards/ERC165.test.ts
