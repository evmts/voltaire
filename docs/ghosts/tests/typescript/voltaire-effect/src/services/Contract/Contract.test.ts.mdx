---
title: '[TS/JS] voltaire-effect/src/services/Contract/Contract.test.ts'
source: 'voltaire-effect/src/services/Contract/Contract.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Contract/Contract.test.ts
