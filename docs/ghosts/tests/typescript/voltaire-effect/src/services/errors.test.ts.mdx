---
title: '[TS/JS] voltaire-effect/src/services/errors.test.ts'
source: 'voltaire-effect/src/services/errors.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/errors.test.ts
