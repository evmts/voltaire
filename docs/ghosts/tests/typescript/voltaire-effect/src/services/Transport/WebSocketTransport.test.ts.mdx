---
title: '[TS/JS] voltaire-effect/src/services/Transport/WebSocketTransport.test.ts'
source: 'voltaire-effect/src/services/Transport/WebSocketTransport.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Transport/WebSocketTransport.test.ts
