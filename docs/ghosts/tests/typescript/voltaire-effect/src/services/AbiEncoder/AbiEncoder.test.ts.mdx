---
title: '[TS/JS] voltaire-effect/src/services/AbiEncoder/AbiEncoder.test.ts'
source: 'voltaire-effect/src/services/AbiEncoder/AbiEncoder.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/AbiEncoder/AbiEncoder.test.ts
