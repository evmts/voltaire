---
title: '[TS/JS] voltaire-effect/src/services/BlockStream/BlockStream.test.ts'
source: 'voltaire-effect/src/services/BlockStream/BlockStream.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/BlockStream/BlockStream.test.ts
