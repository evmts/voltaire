---
title: '[TS/JS] voltaire-effect/src/services/Signer/actions/switchChain.test.ts'
source: 'voltaire-effect/src/services/Signer/actions/switchChain.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Signer/actions/switchChain.test.ts
