---
title: '[TS/JS] voltaire-effect/src/services/Signer/Signer.test.ts'
source: 'voltaire-effect/src/services/Signer/Signer.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Signer/Signer.test.ts
