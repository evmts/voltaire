---
title: '[TS/JS] voltaire-effect/src/services/Signer/actions/addChain.test.ts'
source: 'voltaire-effect/src/services/Signer/actions/addChain.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Signer/actions/addChain.test.ts
