---
title: '[TS/JS] voltaire-effect/src/services/Provider/actions/readContract.test.ts'
source: 'voltaire-effect/src/services/Provider/actions/readContract.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Provider/actions/readContract.test.ts
