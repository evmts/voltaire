---
title: '[TS/JS] voltaire-effect/src/jsonrpc/schemas/schemas.test.ts'
source: 'voltaire-effect/src/jsonrpc/schemas/schemas.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/jsonrpc/schemas/schemas.test.ts
