---
title: '[TS/JS] voltaire-effect/src/jsonrpc/JsonRpc.test.ts'
source: 'voltaire-effect/src/jsonrpc/JsonRpc.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/jsonrpc/JsonRpc.test.ts
