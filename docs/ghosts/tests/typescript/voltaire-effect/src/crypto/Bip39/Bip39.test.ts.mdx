---
title: '[TS/JS] voltaire-effect/src/crypto/Bip39/Bip39.test.ts'
source: 'voltaire-effect/src/crypto/Bip39/Bip39.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/crypto/Bip39/Bip39.test.ts
