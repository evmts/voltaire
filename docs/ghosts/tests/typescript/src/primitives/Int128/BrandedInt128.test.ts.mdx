---
title: '[TS/JS] src/primitives/Int128/BrandedInt128.test.ts'
source: 'src/primitives/Int128/BrandedInt128.test.ts'
---

> Auto-generated from test file: src/primitives/Int128/BrandedInt128.test.ts
