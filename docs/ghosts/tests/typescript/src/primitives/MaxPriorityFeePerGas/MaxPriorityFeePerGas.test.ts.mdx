---
title: '[TS/JS] src/primitives/MaxPriorityFeePerGas/MaxPriorityFeePerGas.test.ts'
source: 'src/primitives/MaxPriorityFeePerGas/MaxPriorityFeePerGas.test.ts'
---

> Auto-generated from test file: src/primitives/MaxPriorityFeePerGas/MaxPriorityFeePerGas.test.ts
