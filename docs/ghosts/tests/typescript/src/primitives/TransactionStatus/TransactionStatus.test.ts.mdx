---
title: '[TS/JS] src/primitives/TransactionStatus/TransactionStatus.test.ts'
source: 'src/primitives/TransactionStatus/TransactionStatus.test.ts'
---

> Auto-generated from test file: src/primitives/TransactionStatus/TransactionStatus.test.ts
