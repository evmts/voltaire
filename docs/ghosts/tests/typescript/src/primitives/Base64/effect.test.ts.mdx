---
title: '[TS/JS] src/primitives/Base64/effect.test.ts'
source: 'src/primitives/Base64/effect.test.ts'
---

> Auto-generated from test file: src/primitives/Base64/effect.test.ts
