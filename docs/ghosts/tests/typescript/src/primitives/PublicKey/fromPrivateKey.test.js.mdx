---
title: '[TS/JS] src/primitives/PublicKey/fromPrivateKey.test.js'
source: 'src/primitives/PublicKey/fromPrivateKey.test.js'
---

> Auto-generated from test file: src/primitives/PublicKey/fromPrivateKey.test.js
