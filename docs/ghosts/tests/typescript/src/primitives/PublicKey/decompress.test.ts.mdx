---
title: '[TS/JS] src/primitives/PublicKey/decompress.test.ts'
source: 'src/primitives/PublicKey/decompress.test.ts'
---

> Auto-generated from test file: src/primitives/PublicKey/decompress.test.ts
