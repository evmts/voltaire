---
title: '[TS/JS] src/primitives/NetworkId/NetworkId.test.ts'
source: 'src/primitives/NetworkId/NetworkId.test.ts'
---

> Auto-generated from test file: src/primitives/NetworkId/NetworkId.test.ts
