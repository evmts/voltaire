---
title: '[TS/JS] src/primitives/Abi/decodeLog.test.ts'
source: 'src/primitives/Abi/decodeLog.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/decodeLog.test.ts
