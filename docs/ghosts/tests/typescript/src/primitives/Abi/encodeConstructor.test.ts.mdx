---
title: '[TS/JS] src/primitives/Abi/encodeConstructor.test.ts'
source: 'src/primitives/Abi/encodeConstructor.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/encodeConstructor.test.ts
