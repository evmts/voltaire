---
title: '[TS/JS] src/primitives/Abi/constructor/Constructor.test.ts'
source: 'src/primitives/Abi/constructor/Constructor.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/constructor/Constructor.test.ts
