---
title: '[TS/JS] src/primitives/Abi/constructor/encodeParams.test.ts'
source: 'src/primitives/Abi/constructor/encodeParams.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/constructor/encodeParams.test.ts
