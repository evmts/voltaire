---
title: '[TS/JS] src/primitives/Abi/function/encodeResult.test.ts'
source: 'src/primitives/Abi/function/encodeResult.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/function/encodeResult.test.ts
