---
title: '[TS/JS] src/primitives/Abi/function/errors.test.ts'
source: 'src/primitives/Abi/function/errors.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/function/errors.test.ts
