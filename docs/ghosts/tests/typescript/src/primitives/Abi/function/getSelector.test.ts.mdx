---
title: '[TS/JS] src/primitives/Abi/function/getSelector.test.ts'
source: 'src/primitives/Abi/function/getSelector.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/function/getSelector.test.ts
