---
title: '[TS/JS] src/primitives/Abi/Item/isConstructor.test.ts'
source: 'src/primitives/Abi/Item/isConstructor.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/Item/isConstructor.test.ts
