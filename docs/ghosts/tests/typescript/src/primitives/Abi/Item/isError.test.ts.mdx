---
title: '[TS/JS] src/primitives/Abi/Item/isError.test.ts'
source: 'src/primitives/Abi/Item/isError.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/Item/isError.test.ts
