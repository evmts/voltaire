---
title: '[TS/JS] src/primitives/Abi/Item/isEvent.test.ts'
source: 'src/primitives/Abi/Item/isEvent.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/Item/isEvent.test.ts
