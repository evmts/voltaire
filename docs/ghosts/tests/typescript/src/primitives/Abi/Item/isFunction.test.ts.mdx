---
title: '[TS/JS] src/primitives/Abi/Item/isFunction.test.ts'
source: 'src/primitives/Abi/Item/isFunction.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/Item/isFunction.test.ts
