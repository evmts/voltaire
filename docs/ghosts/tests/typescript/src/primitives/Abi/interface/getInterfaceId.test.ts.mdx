---
title: '[TS/JS] src/primitives/Abi/interface/getInterfaceId.test.ts'
source: 'src/primitives/Abi/interface/getInterfaceId.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/interface/getInterfaceId.test.ts
