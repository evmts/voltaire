---
title: '[TS/JS] src/primitives/Abi/event/decodeLog.test.ts'
source: 'src/primitives/Abi/event/decodeLog.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/event/decodeLog.test.ts
