---
title: '[TS/JS] src/primitives/Abi/event/Event.test.ts'
source: 'src/primitives/Abi/event/Event.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/event/Event.test.ts
