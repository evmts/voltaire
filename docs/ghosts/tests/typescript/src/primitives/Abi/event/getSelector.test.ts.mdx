---
title: '[TS/JS] src/primitives/Abi/event/getSelector.test.ts'
source: 'src/primitives/Abi/event/getSelector.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/event/getSelector.test.ts
