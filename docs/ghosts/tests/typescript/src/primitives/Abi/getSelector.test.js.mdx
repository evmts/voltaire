---
title: '[TS/JS] src/primitives/Abi/getSelector.test.js'
source: 'src/primitives/Abi/getSelector.test.js'
---

> Auto-generated from test file: src/primitives/Abi/getSelector.test.js
