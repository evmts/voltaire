---
title: '[TS/JS] src/primitives/Abi/function.test.ts'
source: 'src/primitives/Abi/function.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/function.test.ts
