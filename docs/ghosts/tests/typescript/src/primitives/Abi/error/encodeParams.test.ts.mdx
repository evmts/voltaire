---
title: '[TS/JS] src/primitives/Abi/error/encodeParams.test.ts'
source: 'src/primitives/Abi/error/encodeParams.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/error/encodeParams.test.ts
