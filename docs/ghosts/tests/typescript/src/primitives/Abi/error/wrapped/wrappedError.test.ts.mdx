---
title: '[TS/JS] src/primitives/Abi/error/wrapped/wrappedError.test.ts'
source: 'src/primitives/Abi/error/wrapped/wrappedError.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/error/wrapped/wrappedError.test.ts
