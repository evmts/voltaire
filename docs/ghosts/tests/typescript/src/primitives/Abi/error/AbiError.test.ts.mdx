---
title: '[TS/JS] src/primitives/Abi/error/AbiError.test.ts'
source: 'src/primitives/Abi/error/AbiError.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/error/AbiError.test.ts
