---
title: '[TS/JS] src/primitives/ContractResult/ContractResult.test.ts'
source: 'src/primitives/ContractResult/ContractResult.test.ts'
---

> Auto-generated from test file: src/primitives/ContractResult/ContractResult.test.ts
