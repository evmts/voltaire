---
title: '[TS/JS] src/primitives/GasEstimate/GasEstimate.test.ts'
source: 'src/primitives/GasEstimate/GasEstimate.test.ts'
---

> Auto-generated from test file: src/primitives/GasEstimate/GasEstimate.test.ts
