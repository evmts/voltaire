---
title: '[TS/JS] src/primitives/Withdrawal/Withdrawal.test.ts'
source: 'src/primitives/Withdrawal/Withdrawal.test.ts'
---

> Auto-generated from test file: src/primitives/Withdrawal/Withdrawal.test.ts
