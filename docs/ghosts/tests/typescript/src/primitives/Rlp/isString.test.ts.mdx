---
title: '[TS/JS] src/primitives/Rlp/isString.test.ts'
source: 'src/primitives/Rlp/isString.test.ts'
---

> Auto-generated from test file: src/primitives/Rlp/isString.test.ts
