---
title: '[TS/JS] src/primitives/PrivateKey/toPublicKey.test.js'
source: 'src/primitives/PrivateKey/toPublicKey.test.js'
---

> Auto-generated from test file: src/primitives/PrivateKey/toPublicKey.test.js
