---
title: '[TS/JS] src/primitives/Opcode/Opcode.additional.test.ts'
source: 'src/primitives/Opcode/Opcode.additional.test.ts'
---

> Auto-generated from test file: src/primitives/Opcode/Opcode.additional.test.ts
