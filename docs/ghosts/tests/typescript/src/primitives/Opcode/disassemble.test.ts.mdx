---
title: '[TS/JS] src/primitives/Opcode/disassemble.test.ts'
source: 'src/primitives/Opcode/disassemble.test.ts'
---

> Auto-generated from test file: src/primitives/Opcode/disassemble.test.ts
