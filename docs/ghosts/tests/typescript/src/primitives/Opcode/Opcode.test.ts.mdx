---
title: '[TS/JS] src/primitives/Opcode/Opcode.test.ts'
source: 'src/primitives/Opcode/Opcode.test.ts'
---

> Auto-generated from test file: src/primitives/Opcode/Opcode.test.ts
