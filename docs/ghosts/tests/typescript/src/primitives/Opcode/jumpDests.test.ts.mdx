---
title: '[TS/JS] src/primitives/Opcode/jumpDests.test.ts'
source: 'src/primitives/Opcode/jumpDests.test.ts'
---

> Auto-generated from test file: src/primitives/Opcode/jumpDests.test.ts
