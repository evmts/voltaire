---
title: '[TS/JS] src/primitives/AccessList/effect.test.ts'
source: 'src/primitives/AccessList/effect.test.ts'
---

> Auto-generated from test file: src/primitives/AccessList/effect.test.ts
