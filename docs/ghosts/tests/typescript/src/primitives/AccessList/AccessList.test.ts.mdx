---
title: '[TS/JS] src/primitives/AccessList/AccessList.test.ts'
source: 'src/primitives/AccessList/AccessList.test.ts'
---

> Auto-generated from test file: src/primitives/AccessList/AccessList.test.ts
