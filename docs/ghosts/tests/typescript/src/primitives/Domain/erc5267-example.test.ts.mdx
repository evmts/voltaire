---
title: '[TS/JS] src/primitives/Domain/erc5267-example.test.ts'
source: 'src/primitives/Domain/erc5267-example.test.ts'
---

> Auto-generated from test file: src/primitives/Domain/erc5267-example.test.ts
