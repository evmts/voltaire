---
title: '[TS/JS] src/primitives/Storage/from.test.ts'
source: 'src/primitives/Storage/from.test.ts'
---

> Auto-generated from test file: src/primitives/Storage/from.test.ts
