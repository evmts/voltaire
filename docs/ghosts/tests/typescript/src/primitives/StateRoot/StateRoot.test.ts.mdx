---
title: '[TS/JS] src/primitives/StateRoot/StateRoot.test.ts'
source: 'src/primitives/StateRoot/StateRoot.test.ts'
---

> Auto-generated from test file: src/primitives/StateRoot/StateRoot.test.ts
