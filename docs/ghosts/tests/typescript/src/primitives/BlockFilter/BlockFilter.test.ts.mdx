---
title: '[TS/JS] src/primitives/BlockFilter/BlockFilter.test.ts'
source: 'src/primitives/BlockFilter/BlockFilter.test.ts'
---

> Auto-generated from test file: src/primitives/BlockFilter/BlockFilter.test.ts
