---
title: '[TS/JS] src/primitives/Blob/effect.test.ts'
source: 'src/primitives/Blob/effect.test.ts'
---

> Auto-generated from test file: src/primitives/Blob/effect.test.ts
