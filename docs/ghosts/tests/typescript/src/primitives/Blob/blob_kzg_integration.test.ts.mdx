---
title: '[TS/JS] src/primitives/Blob/blob_kzg_integration.test.ts'
source: 'src/primitives/Blob/blob_kzg_integration.test.ts'
---

> Auto-generated from test file: src/primitives/Blob/blob_kzg_integration.test.ts
