---
title: '[TS/JS] src/primitives/Transaction/EIP4844/getBlobGasCost.test.ts'
source: 'src/primitives/Transaction/EIP4844/getBlobGasCost.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/EIP4844/getBlobGasCost.test.ts
