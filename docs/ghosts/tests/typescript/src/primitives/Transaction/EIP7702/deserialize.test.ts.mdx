---
title: '[TS/JS] src/primitives/Transaction/EIP7702/deserialize.test.ts'
source: 'src/primitives/Transaction/EIP7702/deserialize.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/EIP7702/deserialize.test.ts
