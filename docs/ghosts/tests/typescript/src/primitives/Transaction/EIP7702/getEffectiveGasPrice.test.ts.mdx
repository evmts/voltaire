---
title: '[TS/JS] src/primitives/Transaction/EIP7702/getEffectiveGasPrice.test.ts'
source: 'src/primitives/Transaction/EIP7702/getEffectiveGasPrice.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/EIP7702/getEffectiveGasPrice.test.ts
