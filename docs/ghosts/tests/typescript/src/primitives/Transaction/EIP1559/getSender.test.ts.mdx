---
title: '[TS/JS] src/primitives/Transaction/EIP1559/getSender.test.ts'
source: 'src/primitives/Transaction/EIP1559/getSender.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/EIP1559/getSender.test.ts
