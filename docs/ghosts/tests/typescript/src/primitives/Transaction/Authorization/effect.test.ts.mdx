---
title: '[TS/JS] src/primitives/Transaction/Authorization/effect.test.ts'
source: 'src/primitives/Transaction/Authorization/effect.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Authorization/effect.test.ts
