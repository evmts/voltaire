---
title: '[TS/JS] src/primitives/Transaction/isContractCreation.test.ts'
source: 'src/primitives/Transaction/isContractCreation.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/isContractCreation.test.ts
