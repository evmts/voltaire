---
title: '[TS/JS] src/primitives/Transaction/validateGasPrice.test.ts'
source: 'src/primitives/Transaction/validateGasPrice.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/validateGasPrice.test.ts
