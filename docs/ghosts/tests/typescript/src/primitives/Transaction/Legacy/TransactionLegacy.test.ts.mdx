---
title: '[TS/JS] src/primitives/Transaction/Legacy/TransactionLegacy.test.ts'
source: 'src/primitives/Transaction/Legacy/TransactionLegacy.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Legacy/TransactionLegacy.test.ts
