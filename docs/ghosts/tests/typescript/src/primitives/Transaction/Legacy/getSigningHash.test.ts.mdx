---
title: '[TS/JS] src/primitives/Transaction/Legacy/getSigningHash.test.ts'
source: 'src/primitives/Transaction/Legacy/getSigningHash.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Legacy/getSigningHash.test.ts
