---
title: '[TS/JS] src/primitives/Transaction/Legacy/serialize.test.ts'
source: 'src/primitives/Transaction/Legacy/serialize.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Legacy/serialize.test.ts
