---
title: '[TS/JS] src/primitives/Transaction/Legacy/deserialize.test.ts'
source: 'src/primitives/Transaction/Legacy/deserialize.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Legacy/deserialize.test.ts
