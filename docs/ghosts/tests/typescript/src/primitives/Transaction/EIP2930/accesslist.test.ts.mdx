---
title: '[TS/JS] src/primitives/Transaction/EIP2930/accesslist.test.ts'
source: 'src/primitives/Transaction/EIP2930/accesslist.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/EIP2930/accesslist.test.ts
