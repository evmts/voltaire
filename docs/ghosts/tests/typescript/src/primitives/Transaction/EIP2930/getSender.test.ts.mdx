---
title: '[TS/JS] src/primitives/Transaction/EIP2930/getSender.test.ts'
source: 'src/primitives/Transaction/EIP2930/getSender.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/EIP2930/getSender.test.ts
