---
title: '[TS/JS] src/primitives/Bytes32/Bytes32.test.ts'
source: 'src/primitives/Bytes32/Bytes32.test.ts'
---

> Auto-generated from test file: src/primitives/Bytes32/Bytes32.test.ts
