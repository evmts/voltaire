---
title: '[TS/JS] src/primitives/Address/toAbiEncoded.test.ts'
source: 'src/primitives/Address/toAbiEncoded.test.ts'
---

> Auto-generated from test file: src/primitives/Address/toAbiEncoded.test.ts
