---
title: '[TS/JS] src/primitives/Address/toLowercase.test.ts'
source: 'src/primitives/Address/toLowercase.test.ts'
---

> Auto-generated from test file: src/primitives/Address/toLowercase.test.ts
