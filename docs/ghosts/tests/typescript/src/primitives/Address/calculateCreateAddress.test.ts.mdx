---
title: '[TS/JS] src/primitives/Address/calculateCreateAddress.test.ts'
source: 'src/primitives/Address/calculateCreateAddress.test.ts'
---

> Auto-generated from test file: src/primitives/Address/calculateCreateAddress.test.ts
