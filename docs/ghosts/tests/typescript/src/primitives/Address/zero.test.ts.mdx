---
title: '[TS/JS] src/primitives/Address/zero.test.ts'
source: 'src/primitives/Address/zero.test.ts'
---

> Auto-generated from test file: src/primitives/Address/zero.test.ts
