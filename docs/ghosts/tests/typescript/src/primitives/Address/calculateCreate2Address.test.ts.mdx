---
title: '[TS/JS] src/primitives/Address/calculateCreate2Address.test.ts'
source: 'src/primitives/Address/calculateCreate2Address.test.ts'
---

> Auto-generated from test file: src/primitives/Address/calculateCreate2Address.test.ts
