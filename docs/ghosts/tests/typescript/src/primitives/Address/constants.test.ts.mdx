---
title: '[TS/JS] src/primitives/Address/constants.test.ts'
source: 'src/primitives/Address/constants.test.ts'
---

> Auto-generated from test file: src/primitives/Address/constants.test.ts
