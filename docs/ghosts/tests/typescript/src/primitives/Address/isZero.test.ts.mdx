---
title: '[TS/JS] src/primitives/Address/isZero.test.ts'
source: 'src/primitives/Address/isZero.test.ts'
---

> Auto-generated from test file: src/primitives/Address/isZero.test.ts
