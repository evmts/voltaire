---
title: '[TS/JS] src/primitives/Address/fromAbiEncoded.test.ts'
source: 'src/primitives/Address/fromAbiEncoded.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromAbiEncoded.test.ts
