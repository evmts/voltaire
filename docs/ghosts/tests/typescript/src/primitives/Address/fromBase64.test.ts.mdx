---
title: '[TS/JS] src/primitives/Address/fromBase64.test.ts'
source: 'src/primitives/Address/fromBase64.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromBase64.test.ts
