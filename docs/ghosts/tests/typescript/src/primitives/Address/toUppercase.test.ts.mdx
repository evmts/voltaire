---
title: '[TS/JS] src/primitives/Address/toUppercase.test.ts'
source: 'src/primitives/Address/toUppercase.test.ts'
---

> Auto-generated from test file: src/primitives/Address/toUppercase.test.ts
