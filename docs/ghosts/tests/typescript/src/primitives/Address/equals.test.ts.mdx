---
title: '[TS/JS] src/primitives/Address/equals.test.ts'
source: 'src/primitives/Address/equals.test.ts'
---

> Auto-generated from test file: src/primitives/Address/equals.test.ts
