---
title: '[TS/JS] src/primitives/Address/Address.test.ts'
source: 'src/primitives/Address/Address.test.ts'
---

> Auto-generated from test file: src/primitives/Address/Address.test.ts
