---
title: '[TS/JS] src/primitives/Address/toBytes.test.ts'
source: 'src/primitives/Address/toBytes.test.ts'
---

> Auto-generated from test file: src/primitives/Address/toBytes.test.ts
