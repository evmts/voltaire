---
title: '[TS/JS] src/primitives/Address/from.test.ts'
source: 'src/primitives/Address/from.test.ts'
---

> Auto-generated from test file: src/primitives/Address/from.test.ts
