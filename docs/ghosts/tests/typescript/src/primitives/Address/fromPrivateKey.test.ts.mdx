---
title: '[TS/JS] src/primitives/Address/fromPrivateKey.test.ts'
source: 'src/primitives/Address/fromPrivateKey.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromPrivateKey.test.ts
