---
title: '[TS/JS] src/primitives/Address/greaterThan.test.ts'
source: 'src/primitives/Address/greaterThan.test.ts'
---

> Auto-generated from test file: src/primitives/Address/greaterThan.test.ts
