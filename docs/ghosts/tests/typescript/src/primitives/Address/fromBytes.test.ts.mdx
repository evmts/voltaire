---
title: '[TS/JS] src/primitives/Address/fromBytes.test.ts'
source: 'src/primitives/Address/fromBytes.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromBytes.test.ts
