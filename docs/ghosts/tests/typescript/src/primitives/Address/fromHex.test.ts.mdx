---
title: '[TS/JS] src/primitives/Address/fromHex.test.ts'
source: 'src/primitives/Address/fromHex.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromHex.test.ts
