---
title: '[TS/JS] src/primitives/Address/effect.test.ts'
source: 'src/primitives/Address/effect.test.ts'
---

> Auto-generated from test file: src/primitives/Address/effect.test.ts
