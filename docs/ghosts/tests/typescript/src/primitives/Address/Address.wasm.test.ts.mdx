---
title: '[TS/JS] src/primitives/Address/Address.wasm.test.ts'
source: 'src/primitives/Address/Address.wasm.test.ts'
---

> Auto-generated from test file: src/primitives/Address/Address.wasm.test.ts
