---
title: '[TS/JS] src/primitives/Address/polyfills.test.ts'
source: 'src/primitives/Address/polyfills.test.ts'
---

> Auto-generated from test file: src/primitives/Address/polyfills.test.ts
