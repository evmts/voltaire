---
title: '[TS/JS] src/primitives/Address/fromPublicKey.test.ts'
source: 'src/primitives/Address/fromPublicKey.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromPublicKey.test.ts
