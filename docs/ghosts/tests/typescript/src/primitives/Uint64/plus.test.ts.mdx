---
title: '[TS/JS] src/primitives/Uint64/plus.test.ts'
source: 'src/primitives/Uint64/plus.test.ts'
---

> Auto-generated from test file: src/primitives/Uint64/plus.test.ts
