---
title: '[TS/JS] src/primitives/Epoch/Epoch.test.ts'
source: 'src/primitives/Epoch/Epoch.test.ts'
---

> Auto-generated from test file: src/primitives/Epoch/Epoch.test.ts
