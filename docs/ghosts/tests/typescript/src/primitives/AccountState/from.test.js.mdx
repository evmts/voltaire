---
title: '[TS/JS] src/primitives/AccountState/from.test.js'
source: 'src/primitives/AccountState/from.test.js'
---

> Auto-generated from test file: src/primitives/AccountState/from.test.js
