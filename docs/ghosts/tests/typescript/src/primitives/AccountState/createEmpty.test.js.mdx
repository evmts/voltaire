---
title: '[TS/JS] src/primitives/AccountState/createEmpty.test.js'
source: 'src/primitives/AccountState/createEmpty.test.js'
---

> Auto-generated from test file: src/primitives/AccountState/createEmpty.test.js
