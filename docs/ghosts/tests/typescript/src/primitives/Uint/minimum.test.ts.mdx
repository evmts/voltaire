---
title: '[TS/JS] src/primitives/Uint/minimum.test.ts'
source: 'src/primitives/Uint/minimum.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/minimum.test.ts
