---
title: '[TS/JS] src/primitives/Uint/utilities.test.ts'
source: 'src/primitives/Uint/utilities.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/utilities.test.ts
