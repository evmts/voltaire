---
title: '[TS/JS] src/primitives/Uint/popCount.test.ts'
source: 'src/primitives/Uint/popCount.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/popCount.test.ts
