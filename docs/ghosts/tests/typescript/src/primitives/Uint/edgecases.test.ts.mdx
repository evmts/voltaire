---
title: '[TS/JS] src/primitives/Uint/edgecases.test.ts'
source: 'src/primitives/Uint/edgecases.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/edgecases.test.ts
