---
title: '[TS/JS] src/primitives/Uint/Uint256.wasm.test.ts'
source: 'src/primitives/Uint/Uint256.wasm.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/Uint256.wasm.test.ts
