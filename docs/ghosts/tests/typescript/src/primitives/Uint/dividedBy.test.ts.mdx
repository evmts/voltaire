---
title: '[TS/JS] src/primitives/Uint/dividedBy.test.ts'
source: 'src/primitives/Uint/dividedBy.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/dividedBy.test.ts
