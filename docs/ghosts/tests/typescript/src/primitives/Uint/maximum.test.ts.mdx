---
title: '[TS/JS] src/primitives/Uint/maximum.test.ts'
source: 'src/primitives/Uint/maximum.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/maximum.test.ts
