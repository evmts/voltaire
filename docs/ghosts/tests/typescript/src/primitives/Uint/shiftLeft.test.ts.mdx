---
title: '[TS/JS] src/primitives/Uint/shiftLeft.test.ts'
source: 'src/primitives/Uint/shiftLeft.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/shiftLeft.test.ts
