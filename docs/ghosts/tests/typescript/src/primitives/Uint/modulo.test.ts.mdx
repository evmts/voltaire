---
title: '[TS/JS] src/primitives/Uint/modulo.test.ts'
source: 'src/primitives/Uint/modulo.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/modulo.test.ts
