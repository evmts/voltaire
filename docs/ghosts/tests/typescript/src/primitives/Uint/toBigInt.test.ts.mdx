---
title: '[TS/JS] src/primitives/Uint/toBigInt.test.ts'
source: 'src/primitives/Uint/toBigInt.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/toBigInt.test.ts
