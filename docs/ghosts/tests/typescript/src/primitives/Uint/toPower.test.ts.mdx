---
title: '[TS/JS] src/primitives/Uint/toPower.test.ts'
source: 'src/primitives/Uint/toPower.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/toPower.test.ts
