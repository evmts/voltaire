---
title: '[TS/JS] src/primitives/Uint/notEquals.test.ts'
source: 'src/primitives/Uint/notEquals.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/notEquals.test.ts
