---
title: '[TS/JS] src/primitives/Uint/greaterThan.test.ts'
source: 'src/primitives/Uint/greaterThan.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/greaterThan.test.ts
