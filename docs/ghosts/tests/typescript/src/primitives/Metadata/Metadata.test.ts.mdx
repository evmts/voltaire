---
title: '[TS/JS] src/primitives/Metadata/Metadata.test.ts'
source: 'src/primitives/Metadata/Metadata.test.ts'
---

> Auto-generated from test file: src/primitives/Metadata/Metadata.test.ts
