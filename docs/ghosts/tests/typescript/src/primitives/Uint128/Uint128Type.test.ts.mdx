---
title: '[TS/JS] src/primitives/Uint128/Uint128Type.test.ts'
source: 'src/primitives/Uint128/Uint128Type.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/Uint128Type.test.ts
