---
title: '[TS/JS] src/primitives/Uint128/isPowerOf2.test.ts'
source: 'src/primitives/Uint128/isPowerOf2.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/isPowerOf2.test.ts
