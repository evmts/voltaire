---
title: '[TS/JS] src/primitives/Proof/Proof.test.ts'
source: 'src/primitives/Proof/Proof.test.ts'
---

> Auto-generated from test file: src/primitives/Proof/Proof.test.ts
