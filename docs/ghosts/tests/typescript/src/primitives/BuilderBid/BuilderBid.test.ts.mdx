---
title: '[TS/JS] src/primitives/BuilderBid/BuilderBid.test.ts'
source: 'src/primitives/BuilderBid/BuilderBid.test.ts'
---

> Auto-generated from test file: src/primitives/BuilderBid/BuilderBid.test.ts
