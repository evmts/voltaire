---
title: '[TS/JS] src/primitives/Signature/tuple.test.ts'
source: 'src/primitives/Signature/tuple.test.ts'
---

> Auto-generated from test file: src/primitives/Signature/tuple.test.ts
