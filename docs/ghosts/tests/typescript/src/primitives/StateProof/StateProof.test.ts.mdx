---
title: '[TS/JS] src/primitives/StateProof/StateProof.test.ts'
source: 'src/primitives/StateProof/StateProof.test.ts'
---

> Auto-generated from test file: src/primitives/StateProof/StateProof.test.ts
