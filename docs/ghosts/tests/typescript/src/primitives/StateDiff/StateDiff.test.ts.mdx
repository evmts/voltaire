---
title: '[TS/JS] src/primitives/StateDiff/StateDiff.test.ts'
source: 'src/primitives/StateDiff/StateDiff.test.ts'
---

> Auto-generated from test file: src/primitives/StateDiff/StateDiff.test.ts
