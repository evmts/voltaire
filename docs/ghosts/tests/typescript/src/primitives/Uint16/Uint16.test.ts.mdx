---
title: '[TS/JS] src/primitives/Uint16/Uint16.test.ts'
source: 'src/primitives/Uint16/Uint16.test.ts'
---

> Auto-generated from test file: src/primitives/Uint16/Uint16.test.ts
