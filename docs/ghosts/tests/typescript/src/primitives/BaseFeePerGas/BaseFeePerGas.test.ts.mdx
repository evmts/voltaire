---
title: '[TS/JS] src/primitives/BaseFeePerGas/BaseFeePerGas.test.ts'
source: 'src/primitives/BaseFeePerGas/BaseFeePerGas.test.ts'
---

> Auto-generated from test file: src/primitives/BaseFeePerGas/BaseFeePerGas.test.ts
