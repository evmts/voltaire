---
title: '[TS/JS] src/primitives/SignedData/SignedData.test.ts'
source: 'src/primitives/SignedData/SignedData.test.ts'
---

> Auto-generated from test file: src/primitives/SignedData/SignedData.test.ts
