---
title: '[TS/JS] src/primitives/ChainHead/ChainHead.test.ts'
source: 'src/primitives/ChainHead/ChainHead.test.ts'
---

> Auto-generated from test file: src/primitives/ChainHead/ChainHead.test.ts
