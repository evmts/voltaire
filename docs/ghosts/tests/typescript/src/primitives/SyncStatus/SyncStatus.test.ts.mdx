---
title: '[TS/JS] src/primitives/SyncStatus/SyncStatus.test.ts'
source: 'src/primitives/SyncStatus/SyncStatus.test.ts'
---

> Auto-generated from test file: src/primitives/SyncStatus/SyncStatus.test.ts
