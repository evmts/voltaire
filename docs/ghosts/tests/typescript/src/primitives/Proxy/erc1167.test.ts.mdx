---
title: '[TS/JS] src/primitives/Proxy/erc1167.test.ts'
source: 'src/primitives/Proxy/erc1167.test.ts'
---

> Auto-generated from test file: src/primitives/Proxy/erc1167.test.ts
