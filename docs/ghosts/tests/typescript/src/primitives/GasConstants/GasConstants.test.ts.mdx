---
title: '[TS/JS] src/primitives/GasConstants/GasConstants.test.ts'
source: 'src/primitives/GasConstants/GasConstants.test.ts'
---

> Auto-generated from test file: src/primitives/GasConstants/GasConstants.test.ts
