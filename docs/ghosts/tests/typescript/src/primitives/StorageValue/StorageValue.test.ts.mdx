---
title: '[TS/JS] src/primitives/StorageValue/StorageValue.test.ts'
source: 'src/primitives/StorageValue/StorageValue.test.ts'
---

> Auto-generated from test file: src/primitives/StorageValue/StorageValue.test.ts
