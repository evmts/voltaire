---
title: '[TS/JS] src/primitives/EncodedData/EncodedData.test.ts'
source: 'src/primitives/EncodedData/EncodedData.test.ts'
---

> Auto-generated from test file: src/primitives/EncodedData/EncodedData.test.ts
