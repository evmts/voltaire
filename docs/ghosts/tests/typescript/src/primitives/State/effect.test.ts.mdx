---
title: '[TS/JS] src/primitives/State/effect.test.ts'
source: 'src/primitives/State/effect.test.ts'
---

> Auto-generated from test file: src/primitives/State/effect.test.ts
