---
title: '[TS/JS] src/primitives/BlockBody/BlockBody.test.ts'
source: 'src/primitives/BlockBody/BlockBody.test.ts'
---

> Auto-generated from test file: src/primitives/BlockBody/BlockBody.test.ts
