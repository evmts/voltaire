---
title: '[TS/JS] src/primitives/Selector/from.test.ts'
source: 'src/primitives/Selector/from.test.ts'
---

> Auto-generated from test file: src/primitives/Selector/from.test.ts
