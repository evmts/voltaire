---
title: '[TS/JS] src/primitives/Selector/toHex.test.ts'
source: 'src/primitives/Selector/toHex.test.ts'
---

> Auto-generated from test file: src/primitives/Selector/toHex.test.ts
