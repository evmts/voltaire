---
title: '[TS/JS] src/primitives/Gas/gasPriceFrom.test.ts'
source: 'src/primitives/Gas/gasPriceFrom.test.ts'
---

> Auto-generated from test file: src/primitives/Gas/gasPriceFrom.test.ts
