---
title: '[TS/JS] src/primitives/EffectiveGasPrice/EffectiveGasPrice.test.ts'
source: 'src/primitives/EffectiveGasPrice/EffectiveGasPrice.test.ts'
---

> Auto-generated from test file: src/primitives/EffectiveGasPrice/EffectiveGasPrice.test.ts
