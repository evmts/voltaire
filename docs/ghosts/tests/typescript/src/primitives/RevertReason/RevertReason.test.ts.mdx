---
title: '[TS/JS] src/primitives/RevertReason/RevertReason.test.ts'
source: 'src/primitives/RevertReason/RevertReason.test.ts'
---

> Auto-generated from test file: src/primitives/RevertReason/RevertReason.test.ts
