---
title: '[TS/JS] src/primitives/FunctionSignature/FunctionSignature.test.ts'
source: 'src/primitives/FunctionSignature/FunctionSignature.test.ts'
---

> Auto-generated from test file: src/primitives/FunctionSignature/FunctionSignature.test.ts
