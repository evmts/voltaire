---
title: '[TS/JS] src/primitives/EventLog/rpc.test.ts'
source: 'src/primitives/EventLog/rpc.test.ts'
---

> Auto-generated from test file: src/primitives/EventLog/rpc.test.ts
