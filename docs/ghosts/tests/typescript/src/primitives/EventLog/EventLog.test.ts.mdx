---
title: '[TS/JS] src/primitives/EventLog/EventLog.test.ts'
source: 'src/primitives/EventLog/EventLog.test.ts'
---

> Auto-generated from test file: src/primitives/EventLog/EventLog.test.ts
