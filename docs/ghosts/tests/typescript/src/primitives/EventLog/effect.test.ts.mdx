---
title: '[TS/JS] src/primitives/EventLog/effect.test.ts'
source: 'src/primitives/EventLog/effect.test.ts'
---

> Auto-generated from test file: src/primitives/EventLog/effect.test.ts
