---
title: '[TS/JS] src/primitives/Denomination/gwei-fromWei.test.ts'
source: 'src/primitives/Denomination/gwei-fromWei.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/gwei-fromWei.test.ts
