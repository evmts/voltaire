---
title: '[TS/JS] src/primitives/Denomination/wei-fromEther.test.ts'
source: 'src/primitives/Denomination/wei-fromEther.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/wei-fromEther.test.ts
