---
title: '[TS/JS] src/primitives/Denomination/wei-toU256.test.ts'
source: 'src/primitives/Denomination/wei-toU256.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/wei-toU256.test.ts
