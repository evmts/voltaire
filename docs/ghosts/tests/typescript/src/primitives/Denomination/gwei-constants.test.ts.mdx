---
title: '[TS/JS] src/primitives/Denomination/gwei-constants.test.ts'
source: 'src/primitives/Denomination/gwei-constants.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/gwei-constants.test.ts
