---
title: '[TS/JS] src/primitives/Denomination/wei-from.test.ts'
source: 'src/primitives/Denomination/wei-from.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/wei-from.test.ts
