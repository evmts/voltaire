---
title: '[TS/JS] src/primitives/Uint32/Uint32.test.ts'
source: 'src/primitives/Uint32/Uint32.test.ts'
---

> Auto-generated from test file: src/primitives/Uint32/Uint32.test.ts
