---
title: '[TS/JS] src/primitives/Receipt/Receipt.test.ts'
source: 'src/primitives/Receipt/Receipt.test.ts'
---

> Auto-generated from test file: src/primitives/Receipt/Receipt.test.ts
