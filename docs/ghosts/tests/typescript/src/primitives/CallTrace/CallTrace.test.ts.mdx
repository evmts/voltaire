---
title: '[TS/JS] src/primitives/CallTrace/CallTrace.test.ts'
source: 'src/primitives/CallTrace/CallTrace.test.ts'
---

> Auto-generated from test file: src/primitives/CallTrace/CallTrace.test.ts
