---
title: '[TS/JS] src/primitives/Hex/toBoolean.test.ts'
source: 'src/primitives/Hex/toBoolean.test.ts'
---

> Auto-generated from test file: src/primitives/Hex/toBoolean.test.ts
