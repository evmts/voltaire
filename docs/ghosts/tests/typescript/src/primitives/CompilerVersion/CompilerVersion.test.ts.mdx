---
title: '[TS/JS] src/primitives/CompilerVersion/CompilerVersion.test.ts'
source: 'src/primitives/CompilerVersion/CompilerVersion.test.ts'
---

> Auto-generated from test file: src/primitives/CompilerVersion/CompilerVersion.test.ts
