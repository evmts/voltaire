---
title: '[TS/JS] src/primitives/Chain/getHardforkBlock.test.ts'
source: 'src/primitives/Chain/getHardforkBlock.test.ts'
---

> Auto-generated from test file: src/primitives/Chain/getHardforkBlock.test.ts
