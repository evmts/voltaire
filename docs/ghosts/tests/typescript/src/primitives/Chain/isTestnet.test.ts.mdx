---
title: '[TS/JS] src/primitives/Chain/isTestnet.test.ts'
source: 'src/primitives/Chain/isTestnet.test.ts'
---

> Auto-generated from test file: src/primitives/Chain/isTestnet.test.ts
