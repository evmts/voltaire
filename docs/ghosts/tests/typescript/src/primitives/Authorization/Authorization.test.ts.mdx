---
title: '[TS/JS] src/primitives/Authorization/Authorization.test.ts'
source: 'src/primitives/Authorization/Authorization.test.ts'
---

> Auto-generated from test file: src/primitives/Authorization/Authorization.test.ts
