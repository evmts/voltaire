---
title: '[TS/JS] src/primitives/Bytecode/effect.test.ts'
source: 'src/primitives/Bytecode/effect.test.ts'
---

> Auto-generated from test file: src/primitives/Bytecode/effect.test.ts
