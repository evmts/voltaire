---
title: '[TS/JS] src/primitives/Bytecode/fuzz.test.ts'
source: 'src/primitives/Bytecode/fuzz.test.ts'
---

> Auto-generated from test file: src/primitives/Bytecode/fuzz.test.ts
