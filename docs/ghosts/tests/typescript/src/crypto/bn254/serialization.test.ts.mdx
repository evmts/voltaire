---
title: '[TS/JS] src/crypto/bn254/serialization.test.ts'
source: 'src/crypto/bn254/serialization.test.ts'
---

> Auto-generated from test file: src/crypto/bn254/serialization.test.ts
