---
title: '[TS/JS] src/crypto/bn254/serializeG2.test.ts'
source: 'src/crypto/bn254/serializeG2.test.ts'
---

> Auto-generated from test file: src/crypto/bn254/serializeG2.test.ts
