---
title: '[TS/JS] src/crypto/Secp256k1/isValidPublicKey.test.ts'
source: 'src/crypto/Secp256k1/isValidPublicKey.test.ts'
---

> Auto-generated from test file: src/crypto/Secp256k1/isValidPublicKey.test.ts
