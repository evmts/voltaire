---
title: '[TS/JS] src/crypto/Secp256k1/derivePublicKey.test.ts'
source: 'src/crypto/Secp256k1/derivePublicKey.test.ts'
---

> Auto-generated from test file: src/crypto/Secp256k1/derivePublicKey.test.ts
