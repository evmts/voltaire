---
title: '[TS/JS] src/integration/cross-module.test.ts'
source: 'src/integration/cross-module.test.ts'
---

> Auto-generated from test file: src/integration/cross-module.test.ts
