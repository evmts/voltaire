---
title: '[TS/JS] src/precompiles/bls12_g2_operations.test.ts'
source: 'src/precompiles/bls12_g2_operations.test.ts'
---

> Auto-generated from test file: src/precompiles/bls12_g2_operations.test.ts
