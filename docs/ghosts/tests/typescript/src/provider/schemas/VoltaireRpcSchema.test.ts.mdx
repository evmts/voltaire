---
title: '[TS/JS] src/provider/schemas/VoltaireRpcSchema.test.ts'
source: 'src/provider/schemas/VoltaireRpcSchema.test.ts'
---

> Auto-generated from test file: src/provider/schemas/VoltaireRpcSchema.test.ts
