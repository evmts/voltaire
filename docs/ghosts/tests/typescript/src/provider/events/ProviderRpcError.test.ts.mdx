---
title: '[TS/JS] src/provider/events/ProviderRpcError.test.ts'
source: 'src/provider/events/ProviderRpcError.test.ts'
---

> Auto-generated from test file: src/provider/events/ProviderRpcError.test.ts
