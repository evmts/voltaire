---
title: '[TS/JS] src/provider/eip6963/announce.test.ts'
source: 'src/provider/eip6963/announce.test.ts'
---

> Auto-generated from test file: src/provider/eip6963/announce.test.ts
