---
title: '[TS/JS] src/provider/eip6963/validators.test.ts'
source: 'src/provider/eip6963/validators.test.ts'
---

> Auto-generated from test file: src/provider/eip6963/validators.test.ts
