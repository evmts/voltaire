---
title: '[TS/JS] src/provider/EIP1193Provider.test.ts'
source: 'src/provider/EIP1193Provider.test.ts'
---

> Auto-generated from test file: src/provider/EIP1193Provider.test.ts
