---
title: '[TS/JS] src/jsonrpc/eth/getTransactionByHash/eth_getTransactionByHash.test.ts'
source: 'src/jsonrpc/eth/getTransactionByHash/eth_getTransactionByHash.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getTransactionByHash/eth_getTransactionByHash.test.ts
