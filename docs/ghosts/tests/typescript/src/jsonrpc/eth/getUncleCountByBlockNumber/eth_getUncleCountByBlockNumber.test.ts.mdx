---
title: '[TS/JS] src/jsonrpc/eth/getUncleCountByBlockNumber/eth_getUncleCountByBlockNumber.test.ts'
source: 'src/jsonrpc/eth/getUncleCountByBlockNumber/eth_getUncleCountByBlockNumber.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getUncleCountByBlockNumber/eth_getUncleCountByBlockNumber.test.ts
