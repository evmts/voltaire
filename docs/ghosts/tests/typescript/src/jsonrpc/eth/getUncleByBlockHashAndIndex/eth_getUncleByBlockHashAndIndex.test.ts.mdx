---
title: '[TS/JS] src/jsonrpc/eth/getUncleByBlockHashAndIndex/eth_getUncleByBlockHashAndIndex.test.ts'
source: 'src/jsonrpc/eth/getUncleByBlockHashAndIndex/eth_getUncleByBlockHashAndIndex.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getUncleByBlockHashAndIndex/eth_getUncleByBlockHashAndIndex.test.ts
