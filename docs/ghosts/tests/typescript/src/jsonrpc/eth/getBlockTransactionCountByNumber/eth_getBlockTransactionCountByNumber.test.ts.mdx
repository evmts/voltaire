---
title: '[TS/JS] src/jsonrpc/eth/getBlockTransactionCountByNumber/eth_getBlockTransactionCountByNumber.test.ts'
source: 'src/jsonrpc/eth/getBlockTransactionCountByNumber/eth_getBlockTransactionCountByNumber.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getBlockTransactionCountByNumber/eth_getBlockTransactionCountByNumber.test.ts
