---
title: '[TS/JS] src/jsonrpc/eth/getUncleByBlockNumberAndIndex/eth_getUncleByBlockNumberAndIndex.test.ts'
source: 'src/jsonrpc/eth/getUncleByBlockNumberAndIndex/eth_getUncleByBlockNumberAndIndex.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getUncleByBlockNumberAndIndex/eth_getUncleByBlockNumberAndIndex.test.ts
