---
title: '[TS/JS] src/jsonrpc/eth/sendTransaction/eth_sendTransaction.test.ts'
source: 'src/jsonrpc/eth/sendTransaction/eth_sendTransaction.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/sendTransaction/eth_sendTransaction.test.ts
