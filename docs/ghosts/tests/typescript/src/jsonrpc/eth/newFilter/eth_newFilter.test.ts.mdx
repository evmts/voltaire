---
title: '[TS/JS] src/jsonrpc/eth/newFilter/eth_newFilter.test.ts'
source: 'src/jsonrpc/eth/newFilter/eth_newFilter.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/newFilter/eth_newFilter.test.ts
