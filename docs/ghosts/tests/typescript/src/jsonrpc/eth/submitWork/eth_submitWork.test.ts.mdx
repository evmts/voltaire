---
title: '[TS/JS] src/jsonrpc/eth/submitWork/eth_submitWork.test.ts'
source: 'src/jsonrpc/eth/submitWork/eth_submitWork.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/submitWork/eth_submitWork.test.ts
