---
title: '[TS/JS] src/jsonrpc/BatchRequest/BatchRequest.test.ts'
source: 'src/jsonrpc/BatchRequest/BatchRequest.test.ts'
---

> Auto-generated from test file: src/jsonrpc/BatchRequest/BatchRequest.test.ts
