---
title: '[TS/JS] src/jsonrpc/BatchResponse/BatchResponse.test.ts'
source: 'src/jsonrpc/BatchResponse/BatchResponse.test.ts'
---

> Auto-generated from test file: src/jsonrpc/BatchResponse/BatchResponse.test.ts
