---
title: '[TS/JS] src/evm/arithmetic/0x02_MUL.test.ts'
source: 'src/evm/arithmetic/0x02_MUL.test.ts'
---

> Auto-generated from test file: src/evm/arithmetic/0x02_MUL.test.ts
