---
title: '[TS/JS] src/evm/arithmetic/0x0a_EXP.test.ts'
source: 'src/evm/arithmetic/0x0a_EXP.test.ts'
---

> Auto-generated from test file: src/evm/arithmetic/0x0a_EXP.test.ts
