---
title: '[TS/JS] src/evm/arithmetic/0x0b_SIGNEXTEND.test.ts'
source: 'src/evm/arithmetic/0x0b_SIGNEXTEND.test.ts'
---

> Auto-generated from test file: src/evm/arithmetic/0x0b_SIGNEXTEND.test.ts
