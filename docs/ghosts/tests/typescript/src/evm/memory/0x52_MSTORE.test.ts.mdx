---
title: '[TS/JS] src/evm/memory/0x52_MSTORE.test.ts'
source: 'src/evm/memory/0x52_MSTORE.test.ts'
---

> Auto-generated from test file: src/evm/memory/0x52_MSTORE.test.ts
