---
title: '[TS/JS] src/evm/comparison/0x11_GT.test.ts'
source: 'src/evm/comparison/0x11_GT.test.ts'
---

> Auto-generated from test file: src/evm/comparison/0x11_GT.test.ts
