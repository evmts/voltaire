---
title: '[TS/JS] src/evm/comparison/0x12_SLT.test.ts'
source: 'src/evm/comparison/0x12_SLT.test.ts'
---

> Auto-generated from test file: src/evm/comparison/0x12_SLT.test.ts
