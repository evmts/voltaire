---
title: '[TS/JS] src/evm/comparison/0x15_ISZERO.test.ts'
source: 'src/evm/comparison/0x15_ISZERO.test.ts'
---

> Auto-generated from test file: src/evm/comparison/0x15_ISZERO.test.ts
