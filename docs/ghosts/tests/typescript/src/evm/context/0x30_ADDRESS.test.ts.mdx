---
title: '[TS/JS] src/evm/context/0x30_ADDRESS.test.ts'
source: 'src/evm/context/0x30_ADDRESS.test.ts'
---

> Auto-generated from test file: src/evm/context/0x30_ADDRESS.test.ts
