---
title: '[TS/JS] src/evm/context/0x35_CALLDATALOAD.test.ts'
source: 'src/evm/context/0x35_CALLDATALOAD.test.ts'
---

> Auto-generated from test file: src/evm/context/0x35_CALLDATALOAD.test.ts
