---
title: '[TS/JS] src/evm/context/0x37_CALLDATACOPY.test.ts'
source: 'src/evm/context/0x37_CALLDATACOPY.test.ts'
---

> Auto-generated from test file: src/evm/context/0x37_CALLDATACOPY.test.ts
