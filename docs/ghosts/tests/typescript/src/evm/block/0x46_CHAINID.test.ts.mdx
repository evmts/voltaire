---
title: '[TS/JS] src/evm/block/0x46_CHAINID.test.ts'
source: 'src/evm/block/0x46_CHAINID.test.ts'
---

> Auto-generated from test file: src/evm/block/0x46_CHAINID.test.ts
