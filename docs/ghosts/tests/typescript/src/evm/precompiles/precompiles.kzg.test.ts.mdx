---
title: '[TS/JS] src/evm/precompiles/precompiles.kzg.test.ts'
source: 'src/evm/precompiles/precompiles.kzg.test.ts'
---

> Auto-generated from test file: src/evm/precompiles/precompiles.kzg.test.ts
