---
title: '[TS/JS] docs/skills/ethers-interface.test.ts'
source: 'docs/skills/ethers-interface.test.ts'
---

> Auto-generated from test file: docs/skills/ethers-interface.test.ts
