---
title: '[TS/JS] docs/skills/transaction-simulation.test.ts'
source: 'docs/skills/transaction-simulation.test.ts'
---

> Auto-generated from test file: docs/skills/transaction-simulation.test.ts
