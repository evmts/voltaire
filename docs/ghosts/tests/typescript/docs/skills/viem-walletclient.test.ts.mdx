---
title: '[TS/JS] docs/skills/viem-walletclient.test.ts'
source: 'docs/skills/viem-walletclient.test.ts'
---

> Auto-generated from test file: docs/skills/viem-walletclient.test.ts
