---
title: '[TS/JS] docs/playbooks/viem-contract.test.ts'
source: 'docs/playbooks/viem-contract.test.ts'
---

> Auto-generated from test file: docs/playbooks/viem-contract.test.ts
