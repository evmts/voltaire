---
title: '[TS/JS] docs/playbooks/viem-walletclient.test.ts'
source: 'docs/playbooks/viem-walletclient.test.ts'
---

> Auto-generated from test file: docs/playbooks/viem-walletclient.test.ts
