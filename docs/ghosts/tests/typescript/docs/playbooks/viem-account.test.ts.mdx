---
title: '[TS/JS] docs/playbooks/viem-account.test.ts'
source: 'docs/playbooks/viem-account.test.ts'
---

> Auto-generated from test file: docs/playbooks/viem-account.test.ts
