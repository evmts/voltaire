---
title: '[TS/JS] docs/playbooks/viem-testclient.test.ts'
source: 'docs/playbooks/viem-testclient.test.ts'
---

> Auto-generated from test file: docs/playbooks/viem-testclient.test.ts
