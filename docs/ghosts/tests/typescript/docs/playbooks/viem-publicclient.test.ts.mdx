---
title: '[TS/JS] docs/playbooks/viem-publicclient.test.ts'
source: 'docs/playbooks/viem-publicclient.test.ts'
---

> Auto-generated from test file: docs/playbooks/viem-publicclient.test.ts
