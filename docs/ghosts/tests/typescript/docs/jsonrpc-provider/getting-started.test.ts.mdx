---
title: '[TS/JS] docs/jsonrpc-provider/getting-started.test.ts'
source: 'docs/jsonrpc-provider/getting-started.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/getting-started.test.ts
