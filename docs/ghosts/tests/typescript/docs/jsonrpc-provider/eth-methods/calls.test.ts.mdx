---
title: '[TS/JS] docs/jsonrpc-provider/eth-methods/calls.test.ts'
source: 'docs/jsonrpc-provider/eth-methods/calls.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/eth-methods/calls.test.ts
