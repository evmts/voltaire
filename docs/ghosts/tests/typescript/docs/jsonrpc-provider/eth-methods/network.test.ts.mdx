---
title: '[TS/JS] docs/jsonrpc-provider/eth-methods/network.test.ts'
source: 'docs/jsonrpc-provider/eth-methods/network.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/eth-methods/network.test.ts
