---
title: '[TS/JS] docs/jsonrpc-provider/eth-methods/index.test.ts'
source: 'docs/jsonrpc-provider/eth-methods/index.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/eth-methods/index.test.ts
