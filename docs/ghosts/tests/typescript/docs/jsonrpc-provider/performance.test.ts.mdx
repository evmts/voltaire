---
title: '[TS/JS] docs/jsonrpc-provider/performance.test.ts'
source: 'docs/jsonrpc-provider/performance.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/performance.test.ts
