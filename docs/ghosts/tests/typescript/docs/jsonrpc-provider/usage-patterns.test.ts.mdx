---
title: '[TS/JS] docs/jsonrpc-provider/usage-patterns.test.ts'
source: 'docs/jsonrpc-provider/usage-patterns.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/usage-patterns.test.ts
