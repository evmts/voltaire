---
title: '[TS/JS] docs/jsonrpc-provider/type-system.test.ts'
source: 'docs/jsonrpc-provider/type-system.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/type-system.test.ts
