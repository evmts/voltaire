---
title: '[TS/JS] docs/crypto/bn254/precompiles.test.ts'
source: 'docs/crypto/bn254/precompiles.test.ts'
---

> Auto-generated from test file: docs/crypto/bn254/precompiles.test.ts
