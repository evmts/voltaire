---
title: '[TS/JS] docs/crypto/kzg/performance.test.ts'
source: 'docs/crypto/kzg/performance.test.ts'
---

> Auto-generated from test file: docs/crypto/kzg/performance.test.ts
