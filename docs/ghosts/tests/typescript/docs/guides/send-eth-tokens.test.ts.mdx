---
title: '[TS/JS] docs/guides/send-eth-tokens.test.ts'
source: 'docs/guides/send-eth-tokens.test.ts'
---

> Auto-generated from test file: docs/guides/send-eth-tokens.test.ts
