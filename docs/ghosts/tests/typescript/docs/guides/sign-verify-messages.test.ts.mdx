---
title: '[TS/JS] docs/guides/sign-verify-messages.test.ts'
source: 'docs/guides/sign-verify-messages.test.ts'
---

> Auto-generated from test file: docs/guides/sign-verify-messages.test.ts
