---
title: '[TS/JS] docs/guides/wallet-generation.test.ts'
source: 'docs/guides/wallet-generation.test.ts'
---

> Auto-generated from test file: docs/guides/wallet-generation.test.ts
