---
title: '[TS/JS] docs/guides/event-listening.test.ts'
source: 'docs/guides/event-listening.test.ts'
---

> Auto-generated from test file: docs/guides/event-listening.test.ts
