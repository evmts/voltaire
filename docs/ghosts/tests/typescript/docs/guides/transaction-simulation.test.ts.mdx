---
title: '[TS/JS] docs/guides/transaction-simulation.test.ts'
source: 'docs/guides/transaction-simulation.test.ts'
---

> Auto-generated from test file: docs/guides/transaction-simulation.test.ts
