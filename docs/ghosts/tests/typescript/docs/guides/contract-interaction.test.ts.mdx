---
title: '[TS/JS] docs/guides/contract-interaction.test.ts'
source: 'docs/guides/contract-interaction.test.ts'
---

> Auto-generated from test file: docs/guides/contract-interaction.test.ts
