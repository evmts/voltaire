---
title: '[TS/JS] docs/zig/public/lib/primitives/Hex/validate.test.ts'
source: 'docs/zig/public/lib/primitives/Hex/validate.test.ts'
---

> Auto-generated from test file: docs/zig/public/lib/primitives/Hex/validate.test.ts
