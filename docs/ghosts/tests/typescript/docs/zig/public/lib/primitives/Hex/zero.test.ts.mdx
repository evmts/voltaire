---
title: '[TS/JS] docs/zig/public/lib/primitives/Hex/zero.test.ts'
source: 'docs/zig/public/lib/primitives/Hex/zero.test.ts'
---

> Auto-generated from test file: docs/zig/public/lib/primitives/Hex/zero.test.ts
