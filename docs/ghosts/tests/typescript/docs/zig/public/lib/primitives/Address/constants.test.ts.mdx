---
title: '[TS/JS] docs/zig/public/lib/primitives/Address/constants.test.ts'
source: 'docs/zig/public/lib/primitives/Address/constants.test.ts'
---

> Auto-generated from test file: docs/zig/public/lib/primitives/Address/constants.test.ts
