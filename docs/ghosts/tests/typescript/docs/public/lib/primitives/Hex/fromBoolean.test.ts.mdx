---
title: '[TS/JS] docs/public/lib/primitives/Hex/fromBoolean.test.ts'
source: 'docs/public/lib/primitives/Hex/fromBoolean.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/fromBoolean.test.ts
