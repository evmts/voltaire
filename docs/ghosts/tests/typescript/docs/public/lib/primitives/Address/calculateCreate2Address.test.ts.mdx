---
title: '[TS/JS] docs/public/lib/primitives/Address/calculateCreate2Address.test.ts'
source: 'docs/public/lib/primitives/Address/calculateCreate2Address.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/calculateCreate2Address.test.ts
