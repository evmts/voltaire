---
title: '[TS/JS] docs/public/lib/primitives/Address/uint8array-methods.test.ts'
source: 'docs/public/lib/primitives/Address/uint8array-methods.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/uint8array-methods.test.ts
