---
title: '[TS/JS] docs/public/lib/primitives/Address/constants.test.ts'
source: 'docs/public/lib/primitives/Address/constants.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/constants.test.ts
