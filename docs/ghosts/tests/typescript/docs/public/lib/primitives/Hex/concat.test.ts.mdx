---
title: '[TS/JS] docs/public/lib/primitives/Hex/concat.test.ts'
source: 'docs/public/lib/primitives/Hex/concat.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/concat.test.ts
