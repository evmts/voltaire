---
title: '[TS/JS] docs/public/lib/primitives/Hex/HexType.test.ts'
source: 'docs/public/lib/primitives/Hex/HexType.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/HexType.test.ts
