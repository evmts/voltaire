---
title: '[TS/JS] docs/public/lib/primitives/Address/from.test.ts'
source: 'docs/public/lib/primitives/Address/from.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/from.test.ts
