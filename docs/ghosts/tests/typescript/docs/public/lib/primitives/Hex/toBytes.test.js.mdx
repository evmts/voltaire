---
title: '[TS/JS] docs/public/lib/primitives/Hex/toBytes.test.js'
source: 'docs/public/lib/primitives/Hex/toBytes.test.js'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/toBytes.test.js
