---
title: '[TS/JS] docs/public/lib/primitives/Hex/Hex.test.ts'
source: 'docs/public/lib/primitives/Hex/Hex.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/Hex.test.ts
