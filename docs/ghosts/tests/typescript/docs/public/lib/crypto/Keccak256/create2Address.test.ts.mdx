---
title: '[TS/JS] docs/public/lib/crypto/Keccak256/create2Address.test.ts'
source: 'docs/public/lib/crypto/Keccak256/create2Address.test.ts'
---

> Auto-generated from test file: docs/public/lib/crypto/Keccak256/create2Address.test.ts
