---
title: '[TS/JS] docs/primitives/blob/index.test.ts'
source: 'docs/primitives/blob/index.test.ts'
---

> Auto-generated from test file: docs/primitives/blob/index.test.ts
