---
title: '[TS/JS] docs/primitives/authorization/index.test.ts'
source: 'docs/primitives/authorization/index.test.ts'
---

> Auto-generated from test file: docs/primitives/authorization/index.test.ts
