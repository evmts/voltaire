---
title: '[TS/JS] docs/primitives/bytecode/instruction-types.test.ts'
source: 'docs/primitives/bytecode/instruction-types.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/instruction-types.test.ts
