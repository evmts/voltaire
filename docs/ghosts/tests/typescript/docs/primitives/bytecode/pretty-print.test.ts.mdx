---
title: '[TS/JS] docs/primitives/bytecode/pretty-print.test.ts'
source: 'docs/primitives/bytecode/pretty-print.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/pretty-print.test.ts
