---
title: '[TS/JS] docs/primitives/bytecode/analyze-stack.test.ts'
source: 'docs/primitives/bytecode/analyze-stack.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/analyze-stack.test.ts
