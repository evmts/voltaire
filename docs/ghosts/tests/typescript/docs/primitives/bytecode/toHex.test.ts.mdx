---
title: '[TS/JS] docs/primitives/bytecode/toHex.test.ts'
source: 'docs/primitives/bytecode/toHex.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/toHex.test.ts
