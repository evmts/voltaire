---
title: '[TS/JS] docs/primitives/bytecode/hasMetadata.test.ts'
source: 'docs/primitives/bytecode/hasMetadata.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/hasMetadata.test.ts
