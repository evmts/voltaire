---
title: '[TS/JS] docs/primitives/bytecode/size.test.ts'
source: 'docs/primitives/bytecode/size.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/size.test.ts
