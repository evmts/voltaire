---
title: '[TS/JS] docs/primitives/bytecode/fundamentals.test.ts'
source: 'docs/primitives/bytecode/fundamentals.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/fundamentals.test.ts
