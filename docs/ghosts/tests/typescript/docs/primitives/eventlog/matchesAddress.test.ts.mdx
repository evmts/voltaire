---
title: '[TS/JS] docs/primitives/eventlog/matchesAddress.test.ts'
source: 'docs/primitives/eventlog/matchesAddress.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/matchesAddress.test.ts
