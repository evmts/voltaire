---
title: '[TS/JS] docs/primitives/eventlog/matchesTopics.test.ts'
source: 'docs/primitives/eventlog/matchesTopics.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/matchesTopics.test.ts
