---
title: '[TS/JS] docs/primitives/eventlog/getIndexed.test.ts'
source: 'docs/primitives/eventlog/getIndexed.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/getIndexed.test.ts
