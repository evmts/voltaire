---
title: '[TS/JS] docs/primitives/eventlog/create.test.ts'
source: 'docs/primitives/eventlog/create.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/create.test.ts
