---
title: '[TS/JS] docs/primitives/eventlog/from.test.ts'
source: 'docs/primitives/eventlog/from.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/from.test.ts
