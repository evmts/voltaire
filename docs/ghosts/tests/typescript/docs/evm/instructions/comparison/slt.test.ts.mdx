---
title: '[TS/JS] docs/evm/instructions/comparison/slt.test.ts'
source: 'docs/evm/instructions/comparison/slt.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/comparison/slt.test.ts
