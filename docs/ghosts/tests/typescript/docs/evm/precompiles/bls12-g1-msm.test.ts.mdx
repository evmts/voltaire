---
title: '[TS/JS] docs/evm/precompiles/bls12-g1-msm.test.ts'
source: 'docs/evm/precompiles/bls12-g1-msm.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/bls12-g1-msm.test.ts
