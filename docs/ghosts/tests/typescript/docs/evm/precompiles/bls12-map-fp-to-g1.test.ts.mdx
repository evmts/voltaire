---
title: '[TS/JS] docs/evm/precompiles/bls12-map-fp-to-g1.test.ts'
source: 'docs/evm/precompiles/bls12-map-fp-to-g1.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/bls12-map-fp-to-g1.test.ts
