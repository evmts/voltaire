---
title: '[TS/JS] docs/evm/precompiles/bls12-g1-add.test.ts'
source: 'docs/evm/precompiles/bls12-g1-add.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/bls12-g1-add.test.ts
