---
title: '[TS/JS] docs/evm/precompiles/modexp.test.ts'
source: 'docs/evm/precompiles/modexp.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/modexp.test.ts
