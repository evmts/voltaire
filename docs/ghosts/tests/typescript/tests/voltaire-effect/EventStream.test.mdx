...
description: Test examples for EventStreamService showing backfill, watch, and event decoding functionality.
---
...
Provides EventStreamService from TransportService.
...
import { EventStream } from "voltaire-effect/contract/EventStream"
import { EventStreamService } from "voltaire-effect/contract/EventStreamService"
