...
test "differential: opcodes-dup" {
    const allocator = testing.allocator;
    var testor = try DifferentialTestor.init(allocator);
    defer testor.deinit();

    var cwd = std.fs.cwd();
    const bc_path = "src/evm/fixtures/opcodes-dup/bytecode.txt";
    const cd_path = "src/evm/fixtures/opcodes-dup/calldata.txt";
...
test "differential: opcodes-swap" {
    const allocator = testing.allocator;
    var testor = try DifferentialTestor.init(allocator);
    defer testor.deinit();

    var cwd = std.fs.cwd();
    const bc_path = "src/evm/fixtures/opcodes-swap/bytecode.txt";
    const cd_path = "src/evm/fixtures/opcodes-swap/calldata.txt";
...
test "differential: opcodes-push-pop" {
    const allocator = testing.allocator;
    var testor = try DifferentialTestor.init(allocator);
    defer testor.deinit();

    var cwd = std.fs.cwd();
    const bc_path = "src/evm/fixtures/opcodes-push-pop/bytecode.txt";
    const cd_path = "src/evm/fixtures/opcodes-push-pop/calldata.txt";
