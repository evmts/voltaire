...
test "PUSH4 (0x63): Push 4 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        ...
        const result = try helpers.executeOpcode(0x63, test_vm.evm, test_frame.frame);
...
test "PUSH5 (0x64): Push 5 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x64, test_vm.evm, test_frame.frame);
...
test "PUSH6 (0x65): Push 6 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x65, test_vm.evm, test_frame.frame);
...
test "PUSH7 (0x66): Push 7 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x66, test_vm.evm, test_frame.frame);
...
test "PUSH8 (0x67): Push 8 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x67, test_vm.evm, test_frame.frame);
...
test "PUSH9 (0x68): Push 9 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x68, test_vm.evm, test_frame.frame);
...
test "PUSH10 (0x69): Push 10 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x69, test_vm.evm, test_frame.frame);
...
test "PUSH11 (0x6A): Push 11 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x6A, test_vm.evm, test_frame.frame);
...
test "PUSH12 (0x6B): Push 12 bytes onto stack" {
    ...
    for (expected_values) |expected| {
        const pc = test_frame.frame.pc;
        const result = try helpers.executeOpcode(0x6B, test_vm.evm, test_frame.frame);
...
test "PUSH13 (0x6C): Push 13 bytes onto stack" {
    ...
    const result = try helpers.executeOpcode(0x6C, test_vm.evm, test_frame.frame);
...
test "PUSH4-PUSH12: Gas consumption" {
    ...
    for (opcodes) |op| {
        ...
        const result = try helpers.executeOpcode(op.opcode, test_vm.evm, test_frame.frame);
...
test "PUSH operations: Boundary conditions with truncated data" {
    ...
    const result1 = try helpers.executeOpcode(0x63, test_vm.evm, test_frame.frame);
    ...
    const result2 = try helpers.executeOpcode(0x67, test_vm.evm, test_frame.frame);
...
test "PUSH operations: Sequential pushes filling stack" {
    ...
    _ = try helpers.executeOpcode(0x63, test_vm.evm, test_frame.frame);
    ...
    const overflow_result = helpers.executeOpcode(0x63, test_vm.evm, test_frame.frame);
...
test "PUSH operations: Verify big-endian byte order" {
    ...
    _ = try helpers.executeOpcode(0x67, test_vm.evm, test_frame.frame);
