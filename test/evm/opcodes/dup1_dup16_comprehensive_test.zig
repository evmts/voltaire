...
test "DUP1 (0x80): Duplicate 1st stack item" {
    ...
    // Execute DUP1
    const result = try helpers.executeOpcode(0x80, test_vm.evm, test_frame.frame);
...
test "DUP2 (0x81): Duplicate 2nd stack item" {
    ...
    // Execute DUP2
    test_frame.frame.pc = 4;
    const result = try helpers.executeOpcode(0x81, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
...
test "DUP3-DUP5: Various duplications" {
    ...
    var result = try helpers.executeOpcode(0x82, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
    ...
    result = try helpers.executeOpcode(0x83, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
    ...
    helpers.printStack(test_frame.frame);
    result = try helpers.executeOpcode(0x84, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
...
test "DUP6-DUP10: Mid-range duplications" {
    ...
    test_frame.frame.pc = 0;
    helpers.printStack(test_frame.frame);
    const result = try helpers.executeOpcode(0x85, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
    ...
    test_frame.frame.pc = 1;
    _ = try helpers.executeOpcode(0x86, test_vm.evm, test_frame.frame);
    ...
    test_frame.frame.pc = 2;
    _ = try helpers.executeOpcode(0x87, test_vm.evm, test_frame.frame);
    ...
    _ = try helpers.executeOpcode(0x88, test_vm.evm, test_frame.frame);
    ...
    test_frame.frame.pc = 4;
    _ = try helpers.executeOpcode(0x89, test_vm.evm, test_frame.frame);
...
test "DUP11-DUP16: High-range duplications" {
    ...
    test_frame.frame.pc = 0;
    _ = try helpers.executeOpcode(0x8A, test_vm.evm, test_frame.frame);
    try helpers.expectStackValue(test_frame.frame, 0, 0x600);

    // Execute DUP12 (position 12 contains 0x600)
    test_frame.frame.pc = 1;
    _ = try helpers.executeOpcode(0x8B, test_vm.evm, test_frame.frame);
    try helpers.expectStackValue(test_frame.frame, 0, 0x600);

    // Execute DUP13 (position 13 contains 0x600)
    test_frame.frame.pc = 2;
    _ = try helpers.executeOpcode(0x8C, test_vm.evm, test_frame.frame);
    try helpers.expectStackValue(test_frame.frame, 0, 0x600);

    // Execute DUP14 - position 14 is 0x600
    test_frame.frame.pc = 3;
    _ = try helpers.executeOpcode(0x8D, test_vm.evm, test_frame.frame);
    try helpers.expectStackValue(test_frame.frame, 0, 0x600);

    // Execute DUP15 - position 15 from top
    test_frame.frame.pc = 4;
    _ = try helpers.executeOpcode(0x8E, test_vm.evm, test_frame.frame);
    try helpers.expectStackValue(test_frame.frame, 0, 0x600);

    // Execute DUP16 - position 16 from top
    test_frame.frame.pc = 5;
    _ = try helpers.executeOpcode(0x8F, test_vm.evm, test_frame.frame);
...
test "DUP16 (0x8F): Duplicate 16th stack item (maximum)" {
    ...
    const result = try helpers.executeOpcode(0x8F, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result.bytes_consumed);
...
test "DUP operations: Stack underflow" {
    ...
    var result = helpers.executeOpcode(0x80, test_vm.evm, test_frame.frame);
    ...
    // DUP1 should succeed
    const result2 = try helpers.executeOpcode(0x80, test_vm.evm, test_frame.frame);
    try testing.expectEqual(@as(usize, 1), result2.bytes_consumed);

    // DUP2 should succeed with 2 items on stack
    test_frame.frame.pc = 1;
    const result3 = try helpers.executeOpcode(0x81, test_vm.evm, test_frame.frame);
    ...
    test_frame.frame.pc = 2;
    _ = try helpers.executeOpcode(0x85, test_vm.evm, test_frame.frame);

    // DUP16 should fail (only 7 items on stack)
    test_frame.frame.pc = 3;
    result = helpers.executeOpcode(0x8F, test_vm.evm, test_frame.frame);
    try testing.expectError(helpers.ExecutionError.Error.StackUnderflow, result);
}
...
test "DUP operations: Sequential duplications" {
    ...
    _ = try helpers.executeOpcode(0x81, test_vm.evm, test_frame.frame);
    ...
    _ = try helpers.executeOpcode(0x84, test_vm.evm, test_frame.frame);
...
test "DUP operations: Boundary test with exact stack size" {
    ...
    const result = helpers.executeOpcode(0x8F, test_vm.evm, test_frame.frame);
    try testing.expectError(helpers.ExecutionError.Error.StackUnderflow, result);
}
