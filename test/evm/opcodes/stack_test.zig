...
test "PUSH0: append zero value" {
    ...
    // Execute PUSH0
    _ = try test_helpers.executeOpcode(0x5F, test_vm.evm, test_frame.frame);
...
test "PUSH1: append 1 byte value" {
    ...
    // Execute PUSH1
    const result = try test_helpers.executeOpcode(0x60, test_vm.evm, test_frame.frame);
...
test "PUSH2: append 2 byte value" {
    ...
    // Execute PUSH2
    const result = try test_helpers.executeOpcode(0x61, test_vm.evm, test_frame.frame);
...
test "PUSH32: append 32 byte value" {
    ...
    // Execute PUSH32
    const result = try test_helpers.executeOpcode(0x7F, test_vm.evm, test_frame.frame);
...
test "POP: remove top stack item" {
    ...
    // Execute POP
    _ = try test_helpers.executeOpcode(0x50, test_vm.evm, test_frame.frame);
...
test "DUP1: duplicate top stack item" {
    ...
    // Execute DUP1
    _ = try test_helpers.executeOpcode(0x80, test_vm.evm, test_frame.frame);
...
test "DUP2: duplicate second stack item" {
    ...
    // Execute DUP2
    _ = try test_helpers.executeOpcode(0x81, test_vm.evm, test_frame.frame);
...
test "DUP16: duplicate 16th stack item" {
    ...
    // Execute DUP16
    _ = try test_helpers.executeOpcode(0x8F, test_vm.evm, test_frame.frame);
...
test "SWAP1: swap top two stack items" {
    ...
    // Execute SWAP1
    _ = try test_helpers.executeOpcode(0x90, test_vm.evm, test_frame.frame);
...
test "SWAP2: swap 1st and 3rd stack items" {
    ...
    // Execute SWAP2
    _ = try test_helpers.executeOpcode(0x91, test_vm.evm, test_frame.frame);
...
test "SWAP16: swap 1st and 17th stack items" {
    ...
    // Execute SWAP16
    _ = try test_helpers.executeOpcode(0x9F, test_vm.evm, test_frame.frame);
...
test "POP: stack underflow" {
    ...
    const result = test_helpers.executeOpcode(0x50, test_vm.evm, test_frame.frame);
...
test "DUP1: stack underflow" {
    ...
    const result = test_helpers.executeOpcode(0x80, test_vm.evm, test_frame.frame);
    try testing.expectError(ExecutionError.Error.StackUnderflow, result);
}
...
test "DUP16: insufficient stack items" {
    ...
    const result = test_helpers.executeOpcode(0x8F, test_vm.evm, test_frame.frame);
    try testing.expectError(ExecutionError.Error.StackUnderflow, result);
}
...
test "SWAP1: stack underflow" {
    ...
    const result = test_helpers.executeOpcode(0x90, test_vm.evm, test_frame.frame);
    try testing.expectError(ExecutionError.Error.StackUnderflow, result);
}
...
test "PUSH1: stack overflow" {
    ...
    const result = test_helpers.executeOpcode(0x60, test_vm.evm, test_frame.frame);
