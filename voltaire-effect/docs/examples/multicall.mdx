...
import type { MulticallCall } from 'voltaire-effect/services'
...
const tokens = [
  ...
  { symbol: 'DAI', address: '0x6B175474E89094C44Da98b954EesDeCD5E0c7D9' as const, decimals: 18 },
...
Handle both batch-level and per-call failures:
...
- [Multicall Service](/services/multicall) — Full MulticallService API
