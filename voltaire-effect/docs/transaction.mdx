...
```typescript
import { Effect, Stream } from 'effect';
import { TransactionStreamService } from 'voltaire-effect/services';
...
import { TransactionStream, HttpTransport, WebSocketTransport } from 'voltaire-effect/services';
...
- [BlockStream](/services/block-stream) - Block streaming with reorg detection
- [EventStream](/contract) - Contract event streaming
