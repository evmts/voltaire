...
- [BlockStream Service](/services/block-stream) — Stream blocks with reorg detection
- [TransactionStream Service](/services/transaction-stream) — Track transaction lifecycle
- [Event Streaming Example](/examples/event-streaming) — Stream contract events
- [Effect Error Management](https://effect.website/docs/error-management/two-error-types/) — Effect error handling
- [Voltaire Stream](https://voltaire.tevm.sh/stream) — Core stream documentation
