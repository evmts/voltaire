...
// Schema
const stop = Schema.decodeSync(Opcode.Schema)(0x00)  // STOP
const add = Schema.decodeSync(Opcode.Schema)(0x01)   // ADD
const push1 = Schema.decodeSync(Opcode.Schema)(0x60) // PUSH1
