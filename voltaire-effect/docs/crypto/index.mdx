...
voltaire-effect provides Effect-based wrappers for all cryptographic operations: hashing, signatures, encryption, key derivation, and zero-knowledge proofs.
