...
[Keccak256](https://keccak.team/keccak.html) is Ethereum's primary hash function (distinct from [SHA-3](https://en.wikipedia.org/wiki/SHA-3)). Used for addresses, transaction hashes, state roots, event topics, and function selectors.
...
- [Address](/primitives/address) — Derive address from public key using Keccak256
- [Voltaire Keccak256](https://voltaire.tevm.sh/crypto/keccak256) — Core Keccak256 documentation
