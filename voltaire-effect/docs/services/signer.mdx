...
| 1 | EIP-2930 | Access list tx | `gasPrice` + `accessList` |
| 2 | EIP-1559 | Priority fee tx | `maxFeePerGas` + `maxPriorityFeePerGas` |
| 3 | EIP-4844 | Blob tx (L2 data) | `blobVersionedHashes` + `maxFeePerBlobGas` |
| 4 | EIP-7702 | Set code tx | `authorizationList` |
