...
The Provider service wraps [Ethereum JSON-RPC](https://ethereum.org/en/developers/docs/apis/json-rpc/) methods with typed errors and Effect composition.
...
- [Multicall Service](/services/multicall) — Batch multiple calls
