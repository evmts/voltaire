...
The `RawProviderService` provides direct access to EIP-1193 provider `request` method for advanced operations not covered by the standard `ProviderService`.
...
import { RawProviderService, RawProviderTransport, HttpTransport } from 'voltaire-effect/services'
...
const program = Effect.gen(function* () {
  ...
  // Call a custom method not in ProviderService
...
import { RawProviderTransport, HttpTransport } from 'voltaire-effect/services'
...
import { HttpProviderTransport } from 'voltaire-effect/services/RawProvider/HttpProviderTransport.js'
import { WebSocketProviderTransport } from 'voltaire-effect/services/RawProvider/WebSocketProviderTransport.js'
import { ForkProviderTransport } from 'voltaire-effect/services/RawProvider/ForkProviderTransport.js'
import { InMemoryProviderTransport } from 'voltaire-effect/services/RawProvider/InMemoryProviderTransport.js'
```
