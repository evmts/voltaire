...
// Effect<bigint, ParseError | RpcError | TimeoutException, Provider>

await Effect.runPromise(getBalance('0x...').pipe(Effect.provide(MainnetLayer)))
```
