import { MerkleTree } from '@tevm/voltaire'
...
export const Schema: S.Schema<MerkleTreeType, MerkleTreeType> = S.transformOrFail(
  MerkleTreeTypeSchema,
  MerkleTreeTypeSchema,
  {
    strict: true,
...
export const ProofSchema: S.Schema<MerkleProofType, MerkleProofType> = S.transformOrFail(
  MerkleProofTypeSchema,
  MerkleProofTypeSchema,
  {
    strict: true,
    decode: (t, _options, _ast) => ParseResult.succeed(t),
