import { BlockFilter } from '@tevm/voltaire'
...
const BlockFilterTypeSchema = Schema.declare<BlockFilterType>(
  (u): u is BlockFilterType => {
    ...
    return 'filterId' in u && 'type' in u && (u as BlockFilterType).type === 'block'
  },
 ...
 * @since 0.0.1
 */
export const BlockFilterSchema: Schema.Schema<BlockFilterType, BlockFilterType, never> = Schema.transformOrFail(
  BlockFilterTypeSchema,
  BlockFilterTypeSchema,
  {
    strict: true,
