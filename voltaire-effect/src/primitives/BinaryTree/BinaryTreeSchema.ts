import type { BinaryTree } from "@tevm/voltaire";
 ...
 * @since 0.0.1
 */
export const BinaryTreeSchema: Schema.Schema<BinaryTreeType, BinaryTreeType> =
	Schema.transformOrFail(BinaryTreeTypeSchema, BinaryTreeTypeSchema, {
		strict: true,
