import { Base64 as VoltaireBase64, type BrandedBase64, type BrandedBase64Url } from '@tevm/voltaire/Base64'
 ...
 * @since 0.0.1
 */
export const Schema: S.Schema<BrandedBase64, string | Uint8Array> = S.transformOrFail(
  ...
  Base64TypeSchema,
  {
    ...
    decode: (s, _options, ast) => {
      try {
        return ParseResult.succeed(VoltaireBase64.from(s as string | Uint8Array))
      } catch (e) {
 ...
 * @since 0.0.1
 */
export const UrlSchema: S.Schema<BrandedBase64Url, string | Uint8Array> = S.transformOrFail(
  S.Union(S.String, S.Uint8ArrayFromSelf),
  Base64UrlTypeSchema,
  {
    strict: true,
    decode: (s, _options, ast) => {
      try {
        return ParseResult.succeed(VoltaireBase64.fromUrlSafe(s as string | Uint8Array))
      } catch (e) {
        return ParseResult.fail(new ParseResult.Type(ast, s, (e as Error).message))
      }
    },
