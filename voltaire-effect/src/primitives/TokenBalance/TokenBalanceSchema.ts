...
const TokenBalanceTypeSchema = S.declare<TokenBalanceType>(
  (u): u is TokenBalanceType => typeof u === 'bigint' && u >= 0n && u < 2n ** 256n,
  { identifier: 'TokenBalance' }
)

export const Schema: S.Schema<TokenBalanceType, bigint | number | string> = S.transformOrFail(
...
export const FromHexSchema: S.Schema<TokenBalanceType, string> = S.transformOrFail(
  S.String,
  TokenBalanceTypeSchema,
  {
    strict: true,
