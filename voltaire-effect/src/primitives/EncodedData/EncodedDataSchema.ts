...
const EncodedDataTypeSchema = S.declare<EncodedDataType>(
  (u): u is EncodedDataType => typeof u === 'string' && (u as string).startsWith('0x'),
 ...
 * @since 0.0.1
 */
export const EncodedDataSchema: S.Schema<EncodedDataType, string | Uint8Array> = S.transformOrFail(
 ...
 * @since 0.0.1
 */
export const EncodedDataFromBytesSchema: S.Schema<EncodedDataType, Uint8Array> = S.transformOrFail(
