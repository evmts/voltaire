...
import type { Any, Legacy, EIP2930, EIP1559, EIP4844, EIP7702 } from './index.js'
...
const LegacyTypeSchema = S.declare<Legacy>(
  (u): u is Legacy => typeof u === 'object' && u !== null && 'type' in u && (u as Legacy).type === VoltaireTransaction.Type.Legacy,
  { identifier: 'Legacy' }
)
 ...
 * @since 0.0.1
 */
export const LegacySchema: S.Schema<Legacy, S.Schema.Encoded<typeof LegacySchemaInternal>> = S.transform(
  LegacySchemaInternal,
  LegacyTypeSchema,
  { strict: true, decode: (d) => d as Legacy, encode: (e) => e }
)
...
const EIP2930TypeSchema = S.declare<EIP2930>(
  (u): u is EIP2930 => typeof u === 'object' && u !== null && 'type' in u && (u as EIP2930).type === VoltaireTransaction.Type.EIP2930,
  { identifier: 'EIP2930' }
)
 ...
 * @since 0.0.1
 */
export const EIP2930Schema: S.Schema<EIP2930, S.Schema.Encoded<typeof EIP2930SchemaInternal>> = S.transform(
  EIP2930SchemaInternal,
  EIP2930TypeSchema,
  { strict: true, decode: (d) => d as EIP2930, encode: (e) => e }
)
...
const EIP1559TypeSchema = S.declare<EIP1559>(
  (u): u is EIP1559 => typeof u === 'object' && u !== null && 'type' in u && (u as EIP1559).type === VoltaireTransaction.Type.EIP1559,
  { identifier: 'EIP1559' }
)
 ...
 * @since 0.0.1
 */
export const EIP1559Schema: S.Schema<EIP1559, S.Schema.Encoded<typeof EIP1559SchemaInternal>> = S.transform(
  EIP1559SchemaInternal,
  EIP1559TypeSchema,
  { strict: true, decode: (d) => d as EIP1559, encode: (e) => e }
)
...
const EIP4844TypeSchema = S.declare<EIP4844>(
  (u): u is EIP4844 => typeof u === 'object' && u !== null && 'type' in u && (u as EIP4844).type === VoltaireTransaction.Type.EIP4844,
  { identifier: 'EIP4844' }
)
 ...
 * @since 0.0.1
 */
export const EIP4844Schema: S.Schema<EIP4844, S.Schema.Encoded<typeof EIP4844SchemaInternal>> = S.transform(
  EIP4844SchemaInternal,
  EIP4844TypeSchema,
  { strict: true, decode: (d) => d as EIP4844, encode: (e) => e }
)
...
const EIP7702TypeSchema = S.declare<EIP7702>(
  (u): u is EIP7702 => typeof u === 'object' && u !== null && 'type' in u && (u as EIP7702).type === VoltaireTransaction.Type.EIP7702,
  { identifier: 'EIP7702' }
)
 ...
 * @since 0.0.1
 */
export const EIP7702Schema: S.Schema<EIP7702, S.Schema.Encoded<typeof EIP7702SchemaInternal>> = S.transform(
  EIP7702SchemaInternal,
  EIP7702TypeSchema,
  { strict: true, decode: (d) => d as EIP7702, encode: (e) => e }
)
 ...
 * @since 0.0.1
 */
export const Schema: S.Schema<Any, S.Schema.Encoded<typeof LegacySchemaInternal> | S.Schema.Encoded<typeof EIP2930SchemaInternal> | S.Schema.Encoded<typeof EIP1559SchemaInternal> | S.Schema.Encoded<typeof EIP4844SchemaInternal> | S.Schema.Encoded<typeof EIP7702SchemaInternal>> = S.transform(
  S.Union(
    LegacySchemaInternal,
    EIP2930SchemaInternal,
    EIP1559SchemaInternal,
