...
pub fn createGoSteps(b: *std.Build) void {
    ...
    go_build_cmd.setCwd(b.path("sdks/go"));
    ...
    go_test_cmd.setCwd(b.path("sdks/go"));
    ...
    go_vet_cmd.setCwd(b.path("sdks/go"));
    ...
    go_fmt_check_cmd.setCwd(b.path("sdks/go"));
    ...
    go_fmt_cmd.setCwd(b.path("sdks/go"));
