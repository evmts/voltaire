...
const eth0 = HDWallet.HDWallet.deriveEthereum(root, 0, 0);
const privateKey0 = HDWallet.HDWallet.getPrivateKey(eth0);
...
const eth2 = HDWallet.HDWallet.deriveEthereum(root, 0, 2);
...
const root2 = HDWallet.HDWallet.fromSeed(seed2);
const eth0_2 = HDWallet.HDWallet.deriveEthereum(root2, 0, 0);
