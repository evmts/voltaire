...
const emptyHash = Blake2.hash(Bytes.zero(0), 64);
const emptyExpected = Bytes([
...
const empty32 = Blake2.hash(Bytes.zero(0), 32);
const empty32Expected = Bytes([
