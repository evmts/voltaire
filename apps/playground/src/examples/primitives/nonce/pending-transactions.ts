...
pool.showStatus();
pool.confirmTransaction(Nonce(0));
pool.showStatus();
...
pool.showStatus();
pool.confirmTransaction(Nonce(1));
pool.confirmTransaction(Nonce(2));
pool.confirmTransaction(Nonce(3));
pool.showStatus();
