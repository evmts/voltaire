...
const networkHead = Slot(8500000n);
const localHead = Slot(8499850n);
...
const attestationSlot = Slot(8600000n);
const inclusionSlots = [
	Slot(8600001n), // +1 (optimal)
	Slot(8600001n), // +1 (optimal)
	Slot(8600002n), // +2
	Slot(8600001n), // +1 (optimal)
	Slot(8600003n), // +3
...
const forkSlot = Slot(8700000n);
const forkEpoch = Slot.toEpoch(forkSlot);

const branch1Head = Slot(8700005n);
const branch2Head = Slot(8700004n);

const canonicalHead = branch1Head > branch2Head ? branch1Head : branch2Head;
const headBeforeReorg = Slot(8800100n);
const headAfterReorg = Slot(8800095n); // Moved back 5 slots
...
const targetSlot = Slot(9100000n);
