...
console.log('55 bytes length:', encoded4.length, '- First byte:', Hex.toHex(encoded4.slice(0, 1)));
...
console.log('56 bytes length:', encoded5.length, '- First bytes:', Hex.toHex(encoded5.slice(0, 2)));
