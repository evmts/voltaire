...
console.log('Batch encoded:', batchEncoded.map(e => Hex.toHex(e)));
...
console.log('First item matches:', Hex.toHex(decoded[0]) === Hex.toHex(original[0]));
...
console.log('Mixed batch encoded:', mixedEncoded.map(e => Hex.toHex(e)));
...
console.log('Large batch round-trip successful:', largeDecoded.length === largeItems.length);
