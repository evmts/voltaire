...
const uncle1: UncleType = BlockHeader.from({
	...
	nonce: new Uint8Array(8).fill(0x11),
});

const uncle2: UncleType = BlockHeader.from({
	parentHash:
		"0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3",
	ommersHash:
		"0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347",
	...
	nonce: new Uint8Array(8).fill(0x22),
});

// Main block header with references to uncles
const mainHeader = BlockHeader.from({
	parentHash:
...
const blockWithUncles = Block.from({
	header: mainHeader,
	body,
...
const postMergeBlock = Block.from({
