...
console.log('min(value, MAX):', Uint256.toNumber(Uint256.minimum(Uint256.fromNumber(100), Uint256.MAX)));
console.log('max(value, ZERO):', Uint256.toNumber(Uint256.maximum(Uint256.fromNumber(100), Uint256.ZERO)));
