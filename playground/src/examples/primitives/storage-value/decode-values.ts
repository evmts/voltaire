...
console.log("Raw storage:", StorageValue.toHex(rawStorage));

// Decode as uint256
const asUint256 = StorageValue.toUint256(rawStorage);
console.log("\nAs uint256:", asUint256);
console.log("As hex:", asUint256.toString(16));

// Decode as token amount (18 decimals)
const asTokens = Number(asUint256) / 1e18;
console.log("As tokens (18 decimals):", asTokens);
...
console.log("\nAs boolean:", decodeAsBool(rawStorage));
...
console.log("\nAddress storage:", StorageValue.toHex(addressStorage));
console.log("Decoded address:", decodeAddress(addressStorage));
...
console.log("\nBytes32:", StorageValue.toHex(bytes32Storage));
console.log(
	"As raw bytes:",
	Array.from(bytes32Storage)
...
console.log("\nTimestamp storage:", StorageValue.toHex(timestampStorage));
console.log("As Unix time:", StorageValue.toUint256(timestampStorage));
console.log("As Date:", decodeTimestamp(timestampStorage).toISOString());
...
console.log("\nPacked uint128:", StorageValue.toHex(packedStorage));
const [high, low] = decodeUint128Pair(packedStorage);
console.log("High uint128:", high);
console.log("Low uint128:", low);

// Decode string length (for dynamic strings)
const stringLengthStorage = StorageValue.from(64n); // String is 64 bytes

console.log("\nString length:", StorageValue.toHex(stringLengthStorage));
console.log("Length value:", StorageValue.toUint256(stringLengthStorage));
...
console.log("\nEnum storage:", StorageValue.toHex(enumStorage));
console.log("Enum variant:", decodeEnum(enumStorage));
...
console.log("\nBit flags:", StorageValue.toHex(flagsStorage));
console.log("Decoded flags:", decodeBitFlags(flagsStorage));
...
console.log("\nPrice storage:", StorageValue.toHex(priceStorage));
console.log("As price (8 decimals):", decodeFixedPoint(priceStorage, 8));
...
console.log("\nPercentage storage:", StorageValue.toHex(percentageStorage));
console.log("As percentage:", decodePercentage(percentageStorage));
