...
const blobReceipt = Receipt({
	...
	blockNumber: BlockNumber(19426588n), // Post-Dencun
...
// Multiple blobs
const multiBlobReceipt = Receipt({
	transactionHash: TransactionHash.fromHex(
	...
	blockNumber: BlockNumber(19426589n),
...
const expensiveBlobReceipt = Receipt({
	...
	blockNumber: BlockNumber(19426590n),
	from: Address.fromHex("0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb1"),
	to: Address.fromHex("0x1a2b3c4d5e6f7890abcdef1234567890abcdef12"),
