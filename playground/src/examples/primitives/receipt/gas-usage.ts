...
const simpleTransfer = Receipt.from({
...
const erc20Transfer = Receipt.from({
	transactionHash: TransactionHash.fromHex(
		"0x3333333333333333333333333333333333333333333333333333333333333333",
	),
	transactionIndex: TransactionIndex.from(1),
	blockHash: BlockHash.fromHex(
...
const defiInteraction = Receipt.from({
	transactionHash: TransactionHash.fromHex(
		"0x5555555555555555555555555555555555555555555555555555555555555555",
	),
	transactionIndex: TransactionIndex.from(2),
	blockHash: BlockHash.fromHex(
