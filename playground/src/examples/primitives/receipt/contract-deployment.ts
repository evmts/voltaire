...
const failedDeployment = Receipt.from({
	transactionHash: TransactionHash.fromHex(
		"0xfedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",
	),
	transactionIndex: TransactionIndex.from(15),
	blockHash: BlockHash.fromHex(
		"0x1111111111111111111111111111111111111111111111111111111111111111",
	),
	blockNumber: BlockNumber.from(15537401n),
...
// CREATE2 deployment
const create2Deployment = Receipt.from({
	transactionHash: TransactionHash.fromHex(
	...
	blockNumber: BlockNumber.from(15537402n),
	from: Address.fromHex("0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb1"),
	to: null,
