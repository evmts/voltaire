...
const expectedPublicKey1 = new Uint8Array([
...
const message1 = new Uint8Array(0);

const expectedSignature1 = new Uint8Array([
...
const expectedPublicKey2 = new Uint8Array([
...
const message2 = new Uint8Array([0x72]);

const expectedSignature2 = new Uint8Array([
...
const secretKey3 = new Uint8Array([
...
const expectedPublicKey3 = new Uint8Array([
...
const message3 = new Uint8Array([0xaf, 0x82]);

const expectedSignature3 = new Uint8Array([
