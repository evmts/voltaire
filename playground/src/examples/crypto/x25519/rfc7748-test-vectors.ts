...
const uCoordinate1 = new Uint8Array([
...
const alicePublicExpected = new Uint8Array([
...
const bobPublicExpected = new Uint8Array([
...
const sharedSecretExpected = new Uint8Array([
