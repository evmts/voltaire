...
const amount = Uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935n); // Max uint256
...
console.log("Unlimited approval:", ERC20.encodeApprove(spender, unlimited).slice(74));

// 2. Specific amount approval (safer)
const specific = Uint256(1000000000000000000000n); // 1000 tokens
console.log("1000 token approval:", ERC20.encodeApprove(spender, specific).slice(74));

// 3. Zero approval (revoke)
const zero = Uint256(0n);
console.log("Revoke approval (0):", ERC20.encodeApprove(spender, zero).slice(74));
