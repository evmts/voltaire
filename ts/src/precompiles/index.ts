 ...
 */
export function ecrecover(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 3000n;
  if (gasLimit < gas) {
 ...
 */
export function identity(input: Uint8Array, gasLimit: bigint): PrecompileResult {
 ...
 */
export function bn254Add(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 150n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bn254Mul(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 6000n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function pointEvaluation(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 50000n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bls12G1Add(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 500n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bls12G1Mul(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 12000n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bls12G1Msm(input: Uint8Array, gasLimit: bigint): PrecompileResult {
 ...
 */
export function bls12G2Add(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 800n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bls12G2Mul(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 45000n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bls12G2Msm(input: Uint8Array, gasLimit: bigint): PrecompileResult {
 ...
 */
export function bls12Pairing(input: Uint8Array, gasLimit: bigint): PrecompileResult {
 ...
 */
export function bls12MapFpToG1(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 5500n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
 ...
 */
export function bls12MapFp2ToG2(input: Uint8Array, gasLimit: bigint): PrecompileResult {
  const gas = 75000n;
  if (gasLimit < gas) {
    return { success: false, output: new Uint8Array(0), gasUsed: gas, error: "Out of gas" };
  }
