...
import { encodeRlp, decodeRlp, toHex, fromHex } from '../../src/typescript/primitives/rlp';
...
console.log('Match:', JSON.stringify(original) === JSON.stringify(decodedData) ? 'No (types differ)' : 'Types differ as expected');
