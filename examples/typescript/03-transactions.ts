...
console.log('Transaction:', JSON.stringify(legacyTx, (_, v) => typeof v === 'bigint' ? v.toString() : v, 2));
...
console.log('Transaction:', JSON.stringify(eip1559Tx, (_, v) => typeof v === 'bigint' ? v.toString() : v, 2));
...
console.log('Access list:', JSON.stringify(eip1559WithAccessList.accessList, null, 2));
...
console.log('Size increase:', (encodedWithAccess.length - eip1559Encoded.length) / 2, 'bytes');
console.log();
...
console.log('First authorization:', JSON.stringify(eip7702Tx.authorizationList[0], (_, v) => typeof v === 'bigint' ? v.toString() : v, 2));
