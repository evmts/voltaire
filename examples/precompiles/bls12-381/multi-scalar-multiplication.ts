...
console.log(`  Savings: ${savings} gas (${((savings / individualGas) * 100).toFixed(1)}%)\n`);
...
console.log(`  Savings: ${g2Savings} gas (${((g2Savings / g2IndividualGas) * 100).toFixed(1)}%)\n`);
...
console.log(`  Savings: ${individualDerivation - batchDerivation} gas (${((1 - batchDerivation / individualDerivation) * 100).toFixed(1)}%)\n`);
...
console.log(`  Savings: ${individualVerifyGas - (aggregateComputeGas + pairingGas)} gas`);
console.log(`  Reduction: ${((1 - (aggregateComputeGas + pairingGas) / individualVerifyGas) * 100).toFixed(1)}%\n`);
...
console.log(`Empty input (0 pairs): ${resultEmpty.success ? 'unexpected success' : '✓ failed'}`);
...
console.log(`Wrong length (159 bytes): ${resultWrong.success ? 'unexpected success' : '✓ failed'}`);
