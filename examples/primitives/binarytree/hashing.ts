...
console.log('   All zeros:', emptyHash.every(b => b === 0))
...
console.log('   Root hash changed:', !hash1.every((b, i) => b === emptyHash[i]))
...
console.log('     First 4 bytes:', Array.from(binaryHash.slice(0, 4)).map(b => '0x' + b.toString(16).padStart(2, '0')).join(' '))
...
console.log('   Generated', collisionHashes.size, 'hashes from 10 different trees')
