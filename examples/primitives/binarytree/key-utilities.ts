...
console.log(
	"     First bytes: 0x" +
		address[0].toString(16) +
		address[1].toString(16) +
		address[2].toString(16),
);
...
console.log(
	"     First 12 bytes (padding): all zeros:",
	key.slice(0, 12).every((b) => b === 0),
);
console.log(
	"     Byte[12] (first address byte):",
	"0x" + key[12].toString(16).padStart(2, "0"),
);
console.log(
	"     Byte[13] (second address byte):",
	"0x" + key[13].toString(16).padStart(2, "0"),
);
console.log(
	"     Byte[31] (last address byte):",
	"0x" + key[31].toString(16).padStart(2, "0"),
);
console.log("");
...
console.log(
	"   Stem byte[0]:",
	"0b" + stemExample[0].toString(2).padStart(8, "0"),
);
...
console.log(
	"   Stem byte[0]:",
	"0b" + pathStem[0].toString(2).padStart(8, "0"),
);
