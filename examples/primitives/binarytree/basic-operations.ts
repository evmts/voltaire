...
console.log(
	"   Root hash changed:",
	BinaryTree.rootHashHex(tree) !== BinaryTree.rootHashHex(tree2),
);
console.log("");
...
console.log(
	"   Value 1 [subindex 5]:",
	val1 ? "0x" + val1[0].toString(16) : "null",
);
console.log(
	"   Value 2 [subindex 10]:",
	val2 ? "0x" + val2[0].toString(16) : "null",
);
console.log("");
...
console.log(
	"   Query result:",
	notFound === null ? "null (not found)" : "found",
);
console.log("");
...
console.log(
	"   Updated value[0]:",
	updated ? "0x" + updated[0].toString(16) : "null",
);
console.log("");
