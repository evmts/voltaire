...
console.log('   Address (first 2 bytes): 0x' + aliceAddress[0].toString(16) + aliceAddress[1].toString(16))
console.log('   Tree key length:', aliceKey.length)
console.log('   Key[12] (first address byte):', '0x' + aliceKey[12].toString(16).padStart(2, '0'))
console.log('   Key[13] (second address byte):', '0x' + aliceKey[13].toString(16).padStart(2, '0'))
...
if (retrievedPacked) {
  ...
  if (newPacked) {
    ...
    console.log('   Balance increased:', newAccount.balance > current.balance - 500000000000000000n)
  }
}
console.log('')
...
for (let slot = 0; slot < 5; slot++) {
  ...
  console.log(`   Stored slot ${slot} (subindex ${slotKey[31]}): 0x${slotValue[31].toString(16)}`)
}
console.log('')
...
console.log('     Address (first 2 bytes): 0x' + bobAddress[0].toString(16) + bobAddress[1].toString(16))
...
if (aliceVerify && bobVerify) {
  ...
  console.log('   Total balance:', (alice.balance + bob.balance).toString(), 'wei')
}
console.log('')
