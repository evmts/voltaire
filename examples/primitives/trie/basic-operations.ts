...
console.log(
	`   Value after deletion: ${deleted ? Trie.toUtf8(deleted) : "null"}`,
);
...
console.log(
	`   Key [0x12, 0x34] -> ${remaining1 ? Trie.toUtf8(remaining1) : "null"}`,
);

const remaining2 = trie.get(new Uint8Array([0x56, 0x78]));
console.log(
	`   Key [0x56, 0x78] -> ${remaining2 ? Trie.toUtf8(remaining2) : "null"}`,
);
