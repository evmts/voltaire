...
console.log(
	"  Max Priority Fee:",
	eip1559Tx.maxPriorityFeePerGas / 1_000_000_000n,
	"gwei",
);
...
console.log(
	"  Effective Gas Price:",
	eip1559EffectivePrice / 1_000_000_000n,
	"gwei",
);
...
console.log(
	"  Formula:",
	Transaction.getBlobCount(blobTx),
	"× 131,072 ×",
	blobBaseFee,
	"=",
	blobCost,
...
for (const tx of transactions) {
	...
	console.log(
		`${tx.type === Transaction.Type.Legacy ? "Legacy" : tx.type === Transaction.Type.EIP1559 ? "EIP-1559" : "EIP-4844"}:`,
	);
...
console.log(
	"  Max Fee:",
	(currentBaseFee + 5_000_000_000n) / 1_000_000_000n,
	"gwei (base + 5)",
);
console.log();
...
console.log(
	"  Max Fee:",
	(currentBaseFee * 2n) / 1_000_000_000n,
	"gwei (2× base)",
);
console.log();
...
console.log(
	"  Max Fee:",
	(currentBaseFee * 3n) / 1_000_000_000n,
	"gwei (3× base)",
);
console.log();
