...
console.log("-".repeat(50));
console.log(
	"Note: This example shows the API. Real signatures require secp256k1.\n",
);
...
console.log(
	"  Value:",
	exampleSignedTx.value / 1_000_000_000_000_000_000n,
	"ETH",
);
...
console.log(
	"  2. Recover public key using secp256k1.recover(hash, r, s, yParity)",
);
...
console.log(
	"   r:",
	Hex.fromBytes(eip7702Tx.authorizationList[0].r).slice(0, 20) + "...",
);
console.log(
	"   s:",
	Hex.fromBytes(eip7702Tx.authorizationList[0].s).slice(0, 20) + "...",
);
console.log();
