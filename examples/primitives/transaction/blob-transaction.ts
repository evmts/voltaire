...
console.log(
	...
	blobTx.maxFeePerBlobGas / 1_000_000_000n,
	"gwei",
);
console.log("  Blob Count:", Transaction.getBlobCount(blobTx));
console.log(
	"  Blob Versioned Hashes:",
	Transaction.getBlobVersionedHashes(blobTx).length,
);
console.log();
...
console.log(
	"  Effective Gas Price:",
	executionGasPrice / 1_000_000_000n,
	"gwei",
);
	...
	const adjustment =
		scenario.blobs < 3
			...
			: scenario.blobs > 3
				...
				: "→ Stable";
	console.log(
		`  ${scenario.blobs} blobs: ${adjustment} (${scenario.description})`,
	);
}
console.log();
