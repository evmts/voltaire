...
console.log('  Authorization Count:', Transaction.getAuthorizationCount(eip7702Tx));
console.log();
...
console.log('  During TX: EOA.code = DELEGATECALL(' + Address.toHex(authorization.address) + ')');
...
const batchWalletAddress = Address.from('0x2222222222222222222222222222222222222222');
...
const recoveryContractAddr = Address.from('0x3333333333333333333333333333333333333333');
...
const gaslessContractAddr = Address.from('0x4444444444444444444444444444444444444444');
...
const spendingLimitAddr = Address.from('0x5555555555555555555555555555555555555555');
