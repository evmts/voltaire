...
console.log(
	"  Max Priority Fee:",
	basicTx.maxPriorityFeePerGas / 1_000_000_000n,
	"gwei",
);
console.log(
	"  Max Fee Per Gas:",
	basicTx.maxFeePerGas / 1_000_000_000n,
	"gwei",
);
...
for (const scenario of scenarios) {
	...
	console.log(
		`    Effective Gas Price: ${effectiveGasPrice / 1_000_000_000n} gwei`,
	);
	console.log(`    Actual Priority: ${actualPriority / 1_000_000_000n} gwei`);
	console.log(
		`    Formula: min(${scenario.baseFee / 1_000_000_000n} + 2, 30) = ${effectiveGasPrice / 1_000_000_000n}`,
	);
	console.log();
}
...
console.log(
	"  Max Priority Fee:",
	conservative.maxPriorityFeePerGas / 1_000_000_000n,
	"gwei",
);
...
console.log(
	"  Max Priority Fee:",
	standard.maxPriorityFeePerGas / 1_000_000_000n,
	"gwei",
);
...
console.log(
	"  Max Priority Fee:",
	aggressive.maxPriorityFeePerGas / 1_000_000_000n,
	"gwei",
);
...
console.log(
	...
	maxPossibleCost / 1_000_000_000_000_000_000n,
	"ETH",
);
