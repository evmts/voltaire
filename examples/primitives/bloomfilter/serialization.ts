...
console.log(
	`  Contains "block-1001": ${BrandedBloomFilter.contains(block1001Filter, queryItem)}`,
);
...
console.log(
	`  Both restore correctly: ${BrandedBloomFilter.toHex(fromWith) === BrandedBloomFilter.toHex(fromWithout)}`,
);
