...
console.log(
	`  Contains address1: ${merged12.contains(encoder.encode("address1"))}`,
);
console.log(
	`  Contains address2: ${merged12.contains(encoder.encode("address2"))}`,
);
console.log(
	`  Contains address3: ${merged12.contains(encoder.encode("address3"))}`,
);
...
console.log(
	`  Contains address1: ${rangeFilter.contains(encoder.encode("address1"))}`,
);
console.log(
	`  Contains address2: ${rangeFilter.contains(encoder.encode("address2"))}`,
);
console.log(
	`  Contains address3: ${rangeFilter.contains(encoder.encode("address3"))}`,
);
console.log(
	`  Contains Transfer: ${rangeFilter.contains(encoder.encode("Transfer"))}`,
);
console.log(
	`  Contains Approval: ${rangeFilter.contains(encoder.encode("Approval"))}`,
);
...
if (rangeFilter.contains(transferBytes)) {
	...
	if (block1Filter.contains(transferBytes))
		console.log("   - Block 1000 might contain Transfer");
	if (block2Filter.contains(transferBytes))
		console.log("   - Block 1001 might contain Transfer");
	if (block3Filter.contains(transferBytes))
		console.log("   - Block 1002 might contain Transfer");
