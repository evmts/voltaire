...
console.log(
	`   a AND b = ${a.bitwiseAnd(b).toString()} (0b${a.bitwiseAnd(b).toString(2)})`,
);
console.log(
	`   a OR b  = ${a.bitwiseOr(b).toString()} (0b${a.bitwiseOr(b).toString(2)})`,
);
console.log(
	`   a XOR b = ${a.bitwiseXor(b).toString()} (0b${a.bitwiseXor(b).toString(2)})`,
);
...
console.log(
	`   Left shift by 1:  ${value.shiftLeft(1).toString()} (multiply by 2)`,
);
console.log(
	`   Left shift by 2:  ${value.shiftLeft(2).toString()} (multiply by 4)`,
);
console.log(
	`   Left shift by 8:  ${value.shiftLeft(8).toString()} (multiply by 256)\n`,
);
console.log(
	`   Right shift by 1: ${value.shiftRight(1).toString()} (divide by 2)`,
);
console.log(
	`   Right shift by 2: ${value.shiftRight(2).toString()} (divide by 4)\n`,
);
...
console.log(
	`   Set bit 3: ${setBit(bits, 3).toString()} (0b${setBit(bits, 3).toString(2)})`,
);
console.log(
	`   Clear bit 7: ${clearBit(bits, 7).toString()} (0b${clearBit(bits, 7).toString(2)})`,
);
console.log(
	`   Toggle bit 5: ${toggleBit(bits, 5).toString()} (0b${toggleBit(bits, 5).toString(2)})\n`,
);
...
console.log(
	`   1 << 256 = ${one.shiftLeft(256).toString()} (shifts out, wraps to 0)`,
);
console.log(
	`   1 << 257 = ${one.shiftLeft(257).toString()} (shifts out, wraps to 0)\n`,
);
