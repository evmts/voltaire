...
console.log(`   ${partialGwei} Wei = ${truncatedGwei} Gwei (expected 1.5, got 1)`);

// 0.5 ETH in Wei
const partialEther = Wei.from(500_000_000_000_000_000n);
const truncatedEther = Wei.toEther(partialEther);
console.log(`   ${partialEther} Wei = ${truncatedEther} Ether (expected 0.5, got 0)\n`);
...
console.log(`   Lost:     ${Wei.toU256(originalWei) - Wei.toU256(backToWeiLossy)} Wei\n`);
