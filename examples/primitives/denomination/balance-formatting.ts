...
console.log(`   Difference: ${formatWeiAsEther(Wei.from(Wei.toU256(walletA) - Wei.toU256(walletB)), 6)} ETH`);
console.log(`   Total: ${formatWeiAsEther(Wei.from(Wei.toU256(walletA) + Wei.toU256(walletB)), 6)} ETH`);
