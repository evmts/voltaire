...
const transferCalldata = Hex.concat(TRANSFER_SELECTOR, encodedRecipient, encodedAmount)
...
const approveAmount = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffn // max uint256
...
console.log(`  Priority fee: ${maxPriorityFeePerGas} (${Hex.toBigInt(maxPriorityFeePerGas)}n wei)`)
