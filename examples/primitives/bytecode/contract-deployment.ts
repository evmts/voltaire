...
console.log(
	`  Raw bytes: 0x${Array.from(argData)
...
console.log(
	`  Instruction difference: ${comparison.comparison.instructionDiff}`,
);
console.log();
...
console.log(
	`  Metadata: ${sizeAnalysis.metadataSize} bytes (${((sizeAnalysis.metadataSize / sizeAnalysis.totalSize) * 100).toFixed(1)}%)`,
);
console.log(
	`  PUSH data: ${sizeAnalysis.pushDataSize} bytes (${((sizeAnalysis.pushDataSize / sizeAnalysis.totalSize) * 100).toFixed(1)}%)`,
);
console.log(
	`  Instructions: ${sizeAnalysis.instructionSize} bytes (${((sizeAnalysis.instructionSize / sizeAnalysis.totalSize) * 100).toFixed(1)}%)`,
);
console.log();
...
console.log(
	`  PUSH instructions: ${sizeAnalysis.pushInstructionCount} (${((sizeAnalysis.pushInstructionCount / sizeAnalysis.totalInstructions) * 100).toFixed(1)}%)`,
);
console.log();
