...
console.log(
	`Generated private key: ${Buffer.from(privateKey).toString("hex")}`,
);
...
console.log(
	`Decrypted private key: ${Buffer.from(decryptedKey).toString("hex")}`,
);
console.log(
	`Match: ${Buffer.from(decryptedKey).toString("hex") === Buffer.from(privateKey).toString("hex")}`,
);
...
console.log(
	`Address match: ${Address.toHex(decryptedAddress).toLowerCase() === encryptedWallet.address.toLowerCase()}\n`,
);
...
console.log(
	`Wrong password: ${isWrong ? "✗ Accepted (UNEXPECTED)" : "✓ Rejected"}\n`,
);
...
console.log(
	`Address preserved: ${reencryptedWallet.address === encryptedWallet.address}\n`,
);
