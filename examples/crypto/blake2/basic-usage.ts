...
console.log(
	`Matches RFC 7693: ${Hex.fromBytes(emptyHash) === expectedEmpty}\n`,
);
...
console.log(
	`20-byte address hash:   ${Hex.fromBytes(addressHash).slice(0, 46)}...`,
);
console.log(
	`32-byte standard hash:  ${Hex.fromBytes(standardHash).slice(0, 66)}...`,
);
console.log(
	`64-byte maximum hash:   ${Hex.fromBytes(maxHash).slice(0, 66)}...\n`,
);
