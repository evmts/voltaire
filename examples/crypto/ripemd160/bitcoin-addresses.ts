...
console.log(`Public key (65 bytes): ${Hex.fromBytes(publicKey.slice(0, 20))}...`);
...
console.log('(Would be Base58Check encoded with version byte 0x00 for mainnet)\n');
...
const redeemScript = new Uint8Array([
  0x52, // OP_2
  0x21, 0x03, ...new Uint8Array(32).fill(0xAA), // Pubkey 1
  0x21, 0x03, ...new Uint8Array(32).fill(0xBB), // Pubkey 2
  0x21, 0x03, ...new Uint8Array(32).fill(0xCC), // Pubkey 3
  0x53, // OP_3
...
console.log('(Would be Base58Check encoded with version byte 0x05 for mainnet)\n');
...
console.log(`Total address space: 2^160 ≈ ${addressSpace.toString().slice(0, 10)}...`);
...
console.log('- Example: bc1p5cyxnuxmeuwuvkwfem96lqzszd02n6xdcjrs20cac6yqjjwudpxqkedrcr');
