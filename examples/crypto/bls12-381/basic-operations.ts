...
console.log('Point is valid:', g1Multiplied.assertValidity() === undefined, '\n');
...
console.log('G2 Generator x.c0:', g2Generator.toAffine().x.c0.toString(16).slice(0, 16), '...');
console.log('G2 + 2*G2 = 3*G2:', pointToHex({
...
console.log('Result x.c0:', g2Multiplied.toAffine().x.c0.toString(16).slice(0, 16), '...');
console.log('G2 point is valid:', g2Multiplied.assertValidity() === undefined, '\n');
...
console.log('G1 compressed:', Buffer.from(g1Compressed).toString('hex').slice(0, 32), '...');
...
console.log('G2 compressed:', Buffer.from(g2Compressed).toString('hex').slice(0, 32), '...\n');
...
console.log('G2 round-trip successful:', g2Recovered.equals(g2Multiplied), '\n');
