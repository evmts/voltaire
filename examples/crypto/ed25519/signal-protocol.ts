...
console.log(
	`Identity public key: ${Hex.fromBytes(aliceIdentity.publicKey).slice(0, 40)}...`,
);
...
console.log(
	`Identity public key: ${Hex.fromBytes(bobIdentity.publicKey).slice(0, 40)}...`,
);
...
console.log(
	`Prekey signature: ${Hex.fromBytes(prekeySignature).slice(0, 40)}...`,
);
...
console.log(
	`Bob's identity:   ${Hex.fromBytes(bobIdentity.publicKey).slice(0, 20)}...`,
);
...
console.log(
	`Message signature: ${Hex.fromBytes(messageSignature).slice(0, 40)}...`,
);
...
console.log(
	`Device 2 (Desktop): ${Hex.fromBytes(device2Identity.publicKey).slice(0, 40)}...`,
);
...
console.log(
	`Device 3 (Tablet): ${Hex.fromBytes(device3Identity.publicKey).slice(0, 40)}...`,
);
...
console.log(
	`  Verified: ${Ed25519.verify(sig1, crossDeviceMsg, device1Identity.publicKey)}`,
);

console.log(`\nDevice 2 signature: ${Hex.fromBytes(sig2).slice(0, 40)}...`);
console.log(
	`  Verified: ${Ed25519.verify(sig2, crossDeviceMsg, device2Identity.publicKey)}`,
);

console.log(`\nDevice 3 signature: ${Hex.fromBytes(sig3).slice(0, 40)}...`);
console.log(
	`  Verified: ${Ed25519.verify(sig3, crossDeviceMsg, device3Identity.publicKey)}\n`,
);
...
console.log(
	`New identity: ${Hex.fromBytes(newIdentity.publicKey).slice(0, 40)}...`,
);
...
console.log(
	`Member list signature: ${Hex.fromBytes(memberListSig).slice(0, 40)}...`,
);
