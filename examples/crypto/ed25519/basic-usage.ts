...
// Valid keys
console.log(
	`Valid secret key (32 bytes): ${Ed25519.validateSecretKey(keypair.secretKey)}`,
);
console.log(
	`Valid public key (32 bytes): ${Ed25519.validatePublicKey(keypair.publicKey)}`,
);
...
console.log(
	`Invalid long key (64 bytes): ${Ed25519.validateSecretKey(invalidLong)}\n`,
);
