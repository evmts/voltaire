...
console.log(`Fee payer: ${Hex.fromBytes(transaction.feePayer).slice(0, 40)}...`);
console.log(`Recent blockhash: ${Hex.fromBytes(transaction.recentBlockhash).slice(0, 40)}...`);
...
console.log(`Signer 1: ${Hex.fromBytes(accountKeypair.publicKey).slice(0, 40)}...`);
...
// Sign transfer
const transferSig = Ed25519.sign(
  transferInstruction,
