...
console.log(
	`Short private key: ${P256.validatePrivateKey(shortKey)} (invalid)`,
);
...
console.log(
	`Wrong length public key: ${P256.validatePublicKey(invalidPubKey)} (invalid)\n`,
);
...
console.log(
	`Signature component size: ${P256.SIGNATURE_COMPONENT_SIZE} bytes (r and s)`,
);
...
console.log(
	`Signature A valid with key B: ${P256.verify(sigA, testMsgHash, publicKey2)} (cross-validation fails)\n`,
);
