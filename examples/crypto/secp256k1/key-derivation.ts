...
console.log(
	"   Keccak256(publicKey):",
	Buffer.from(publicKeyHash).toString("hex"),
);
...
console.log(
	"   Private key = 0:",
	zeroKeyValid ? "✓ Valid" : "✗ Invalid (expected)",
);
...
console.log(
	"   Private key (16 bytes):",
	shortKeyValid ? "✓ Valid" : "✗ Invalid (expected)",
);

// 6. Security demonstration
console.log("\n6. One-Way Function Property");
console.log(
	"   Private key → Public key: ✓ Easy (elliptic curve multiplication)",
);
