...
console.log('\nTransaction message:', Buffer.from(txMessage).toString('hex').slice(0, 64) + '...');
...
console.log('Matches signer:', recoveredAddress === signerAddress ? '✓ Yes' : '✗ No');
...
const isInvalid = verifyTransaction(signedTx, '0x0000000000000000000000000000000000000000');
