...
console.log(
	`15 words (160-bit): ${mnemonic15.split(" ").slice(0, 5).join(" ")}...`,
);
console.log(
	`18 words (192-bit): ${mnemonic18.split(" ").slice(0, 5).join(" ")}...`,
);
console.log(
	`21 words (224-bit): ${mnemonic21.split(" ").slice(0, 5).join(" ")}...`,
);
console.log(
	`24 words (256-bit): ${mnemonic24.split(" ").slice(0, 5).join(" ")}...\n`,
);
...
console.log(
	`Seeds match: ${Hex.fromBytes(seed) === Hex.fromBytes(seedSync)}\n`,
);
...
console.log(
	`Wrong word: ${Bip39.validateMnemonic(wrongWord) ? "✗ Accepted" : "✓ Rejected"}`,
);

// Invalid: wrong word count
const wrongCount = validMnemonic.split(" ").slice(0, 5).join(" ");
console.log(
	`Wrong count (5 words): ${Bip39.validateMnemonic(wrongCount) ? "✗ Accepted" : "✓ Rejected"}`,
);
...
console.log(
	`Wrong checksum: ${Bip39.validateMnemonic(badChecksum) ? "✗ Accepted" : "✓ Rejected"}\n`,
);
...
console.log(
	`Passphrase "password1": ${Hex.fromBytes(seedPass1).slice(0, 32)}...`,
);
console.log(
	`Passphrase "password2": ${Hex.fromBytes(seedPass2).slice(0, 32)}...`,
);
console.log(
	`Empty passphrase: ${Hex.fromBytes(seedEmptyPass).slice(0, 32)}...`,
);
...
console.log(
	`Different passphrases produce different seeds: ${Hex.fromBytes(seedPass1) !== Hex.fromBytes(seedPass2)}\n`,
);
