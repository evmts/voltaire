...
console.log(
	`Signature r: ${Hex.fromBytes(complexSignature.r).slice(0, 32)}...\n`,
);
...
console.log(
	`Different hashes: ${Hex.fromBytes(hash1) !== Hex.fromBytes(hash2)}`,
);
...
console.log(
	`Hash of all types: ${Hex.fromBytes(allTypesHash).slice(0, 32)}...\n`,
);
