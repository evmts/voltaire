...
console.log(
	"\n" + faster,
	"is",
	ratio + "x faster (with hardware acceleration)",
);
console.log();
...
console.log(
	"SHA-256 differing bits:    ",
	shaDiff,
	"/ 256 (" + (shaDiff / 2.56).toFixed(1) + "%)",
);
console.log(
	"Keccak-256 differing bits: ",
	kecDiff,
	"/ 256 (" + (kecDiff / 2.56).toFixed(1) + "%)",
);
