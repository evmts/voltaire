...
import { Bytes, Ripemd160, SHA256 } from "@tevm/voltaire";
...
const genesisPublicKey = Bytes.from([
...
const compressedPubKey = Bytes.from([
...
const testData = Bytes.from([0x00, 0x01, 0x02, 0x03, 0x04]);
const checksum1 = doubleSha256(testData);

// Change one bit
const testData2 = Bytes.from([0x00, 0x01, 0x02, 0x03, 0x05]); // Last byte changed
