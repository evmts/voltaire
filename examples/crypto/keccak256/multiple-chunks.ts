...
console.log('Equal:', Hex.fromBytes(multiHash) === Hex.fromBytes(singleHash), '\n');
...
const calldataHash = Keccak256.hashMultiple([selector, addressParam, amountParam]);
...
const element1 = new Uint8Array(32); element1[31] = 1;
const element2 = new Uint8Array(32); element2[31] = 2;
const element3 = new Uint8Array(32); element3[31] = 3;
const element4 = new Uint8Array(32); element4[31] = 4;
const element5 = new Uint8Array(32); element5[31] = 5;
