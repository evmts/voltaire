...
console.log('  000000000000000000000000742d35cc6634c0532925a3b844bc9e7595f51e3e');
console.log('  0000000000000000000000000000000000000000000000000de0b6b3a7640000\n');
...
const computedTransferSelector = Hex.fromBytes(Keccak256.selector('transfer(address,uint256)'));
...
const knownTransferTopic = '0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef';
const computedTransferTopic = Hex.fromBytes(Keccak256.topic('Transfer(address,address,uint256)'));
