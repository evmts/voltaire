...
console.log('Commitment size:', commitment.length, 'bytes (48 bytes = BLS12-381 G1 point)');
...
console.log('Different blobs produce different commitments:', areDifferent ? '✓' : '✗');
console.log();
...
for (let i = 0; i < commitments.length; i++) {
  console.log(`  Blob ${i + 1}:`, Hex.fromBytes(commitments[i]).slice(0, 20) + '...');
}
console.log();
