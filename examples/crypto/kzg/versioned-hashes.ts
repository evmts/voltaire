...
console.log(
	"Test 1 - Wrong version (0x02):",
	test1.valid ? "✗ Valid (BAD)" : "✓ Invalid",
);
...
console.log(
	"  Commitment → Hash:",
	Hex.fromBytes(testHash).slice(0, 20) + "...",
);
console.log(
	"  Parsed version:",
	"0x" + parsed.version.toString(16).padStart(2, "0"),
);
console.log(
	"  Parsed suffix:",
	Hex.fromBytes(parsed.hashSuffix).slice(0, 20) + "...",
);
console.log();
