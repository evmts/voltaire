...
console.log(
	"Version byte:",
	"0x" + versionedHash[0].toString(16).padStart(2, "0"),
);
console.log();
...
console.log(
	"  [0:32]   Versioned hash:",
	Hex.fromBytes(precompileInput.slice(0, 32)).slice(0, 20) + "...",
);
console.log(
	"  [32:64]  z:",
	Hex.fromBytes(precompileInput.slice(32, 64)).slice(0, 20) + "...",
);
console.log(
	"  [64:96]  y:",
	Hex.fromBytes(precompileInput.slice(64, 96)).slice(0, 20) + "...",
);
console.log(
	"  [96:144] commitment:",
	Hex.fromBytes(precompileInput.slice(96, 144)).slice(0, 20) + "...",
);
console.log(
	"  [144:192] proof:",
	Hex.fromBytes(precompileInput.slice(144, 192)).slice(0, 20) + "...",
);
...
console.log(
	"Precompile result:",
	precompileSuccess ? "✓ Success" : "✗ Failure",
);
console.log();
...
if (precompileSuccess) {
	...
	console.log(
		"  Bytes [0:32]:  FIELD_ELEMENTS_PER_BLOB =",
...
console.log(
	"Test 1 - Wrong versioned hash:",
	wrongHashValid ? "✓ Valid (BAD!)" : "✗ Invalid (expected)",
);
...
try {
	...
	console.log(
		"Test 2 - Wrong proof:",
		wrongProofValid ? "✓ Valid (BAD!)" : "✗ Invalid (expected)",
	);
} catch (error) {
...
console.log(
	"  3. Data Availability Sampling: Light clients verify random points",
);
console.log(
	"  4. On-chain Blob Verification: Smart contracts verify blob commitments",
);
console.log();
