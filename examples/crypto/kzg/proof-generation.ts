...
console.log('Proof with wrong y value:', invalidProof1 ? '✓ Valid (BAD!)' : '✗ Invalid (expected)');
console.log();
...
console.log('Proof with wrong commitment:', invalidProof2 ? '✓ Valid (BAD!)' : '✗ Invalid (expected)');
console.log();
...
try {
  ...
  console.log('Corrupted proof:', invalidProof3 ? '✓ Valid (BAD!)' : '✗ Invalid (expected)');
} catch (error) {
...
console.log('  5. Security: cannot forge proof without knowing τ (discrete log)');
console.log();
