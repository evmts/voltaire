# Slice Bytes - Library Comparison

A detailed comparison of how each library handles the `sliceBytes` operation in the Bytes Operations category.
...
import { Slice Bytes } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Slice Bytes(input);
