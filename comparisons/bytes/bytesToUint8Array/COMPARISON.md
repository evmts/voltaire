# Bytes To Uint8 Array - Library Comparison

A detailed comparison of how each library handles the `bytesToUint8Array` operation in the Bytes Operations category.
...
import { Bytes To Uint8 Array } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Bytes To Uint8 Array(input);
