# Bytes Length - Library Comparison

A detailed comparison of how each library handles the `bytesLength` operation in the Bytes Operations category.
...
import { Bytes Length } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Bytes Length(input);
