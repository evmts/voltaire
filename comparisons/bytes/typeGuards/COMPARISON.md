# Type Guards - Library Comparison

A detailed comparison of how each library handles the `typeGuards` operation in the Bytes Operations category.
...
import { Type Guards } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Type Guards(input);
