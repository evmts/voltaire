# Compress Public Key - Library Comparison

A detailed comparison of how each library handles the `compressPublicKey` operation in the Wallet Generation Operations category.
...
import { Compress Public Key } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Compress Public Key(input);
