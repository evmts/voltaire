# Get Abi Item - Library Comparison

A detailed comparison of how each library handles the `getAbiItem` operation in the ABI Extended Operations category.
...
import { Get Abi Item } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Get Abi Item(input);
