# To Function Selector - Library Comparison

A detailed comparison of how each library handles the `toFunctionSelector` operation in the ABI Extended Operations category.
...
import { To Function Selector } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = To Function Selector(input);
