# Solidity Packed Sha256 - Library Comparison

A detailed comparison of how each library handles the `solidityPackedSha256` operation in the Solidity Packed Operations category.
...
import { Solidity Packed Sha256 } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Solidity Packed Sha256(input);
