# Solidity Packed Keccak256 - Library Comparison

A detailed comparison of how each library handles the `solidityPackedKeccak256` operation in the Solidity Packed Operations category.
...
import { Solidity Packed Keccak256 } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Solidity Packed Keccak256(input);
