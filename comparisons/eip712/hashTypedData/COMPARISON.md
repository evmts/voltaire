# Hash Typed Data - Library Comparison

A detailed comparison of how each library handles the `hashTypedData` operation in the EIP-712 Operations category.
...
import { Hash Typed Data } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Hash Typed Data(input);
