# Hash Domain - Library Comparison

A detailed comparison of how each library handles the `hashDomain` operation in the EIP-712 Operations category.
...
import { Hash Domain } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Hash Domain(input);
