# Is Canonical Signature - Library Comparison

A detailed comparison of how each library handles the `isCanonicalSignature` operation in the Signature Utility Operations category.
...
import { Is Canonical Signature } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Is Canonical Signature(input);
