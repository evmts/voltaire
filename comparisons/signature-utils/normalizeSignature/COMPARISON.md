# Normalize Signature - Library Comparison

A detailed comparison of how each library handles the `normalizeSignature` operation in the Signature Utility Operations category.
...
import { Normalize Signature } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Normalize Signature(input);
