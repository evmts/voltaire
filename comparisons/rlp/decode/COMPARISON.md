# Decode - Library Comparison

A detailed comparison of how each library handles the `decode` operation in the RLP Operations category.
...
import { Decode } from '@tevm/primitives';
