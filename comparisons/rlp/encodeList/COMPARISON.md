# Encode List - Library Comparison

A detailed comparison of how each library handles the `encodeList` operation in the RLP Operations category.
...
import { Encode List } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Encode List(input);
