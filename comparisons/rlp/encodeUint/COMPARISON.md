# Encode Uint - Library Comparison

A detailed comparison of how each library handles the `encodeUint` operation in the RLP Operations category.
...
import { Encode Uint } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Encode Uint(input);
