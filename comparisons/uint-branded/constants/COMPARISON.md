# Constants - Library Comparison

A detailed comparison of how each library handles the `constants` operation in the Uint Branded Type Operations category.
...
import { Constants } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Constants(input);
