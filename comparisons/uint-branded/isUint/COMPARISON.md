# Is Uint - Library Comparison

A detailed comparison of how each library handles the `isUint` operation in the Uint Branded Type Operations category.
...
import { Is Uint } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Is Uint(input);
