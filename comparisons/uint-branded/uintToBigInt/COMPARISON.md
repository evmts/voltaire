# Uint To Big Int - Library Comparison

A detailed comparison of how each library handles the `uintToBigInt` operation in the Uint Branded Type Operations category.
...
import { Uint To Big Int } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Uint To Big Int(input);
