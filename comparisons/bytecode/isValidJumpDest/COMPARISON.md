# Is Valid Jump Dest - Library Comparison

A detailed comparison of how each library handles the `isValidJumpDest` operation in the Bytecode Operations category.
...
import { Is Valid Jump Dest } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Is Valid Jump Dest(input);
