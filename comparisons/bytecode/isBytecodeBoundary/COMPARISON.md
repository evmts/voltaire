# Is Bytecode Boundary - Library Comparison

A detailed comparison of how each library handles the `isBytecodeBoundary` operation in the Bytecode Operations category.
...
import { Is Bytecode Boundary } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Is Bytecode Boundary(input);
