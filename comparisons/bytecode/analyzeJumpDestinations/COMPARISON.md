# Analyze Jump Destinations - Library Comparison

A detailed comparison of how each library handles the `analyzeJumpDestinations` operation in the Bytecode Operations category.
...
import { Analyze Jump Destinations } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Analyze Jump Destinations(input);
