# Hex To U256 - Library Comparison

A detailed comparison of how each library handles the `hexToU256` operation in the Hex Operations category.
...
import { Hex To U256 } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Hex To U256(input);
