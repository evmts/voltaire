# Hex To Bytes - Library Comparison

A detailed comparison of how each library handles the `hexToBytes` operation in the Hex Operations category.
...
import { Hex To Bytes } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Hex To Bytes(input);
