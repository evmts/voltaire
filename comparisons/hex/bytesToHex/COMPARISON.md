# Bytes To Hex - Library Comparison

A detailed comparison of how each library handles the `bytesToHex` operation in the Hex Operations category.
...
import { Bytes To Hex } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Bytes To Hex(input);
