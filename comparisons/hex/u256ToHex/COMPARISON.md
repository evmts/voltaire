# U256 To Hex - Library Comparison

A detailed comparison of how each library handles the `u256ToHex` operation in the Hex Operations category.
...
import { U256 To Hex } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = U256 To Hex(input);
