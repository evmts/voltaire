# Serialize Eip1559 - Library Comparison

A detailed comparison of how each library handles the `serializeEip1559` operation in the Transaction Operations category.
...
import { Serialize Eip1559 } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Serialize Eip1559(input);
