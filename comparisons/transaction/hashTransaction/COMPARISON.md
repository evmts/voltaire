# Hash Transaction - Library Comparison

A detailed comparison of how each library handles the `hashTransaction` operation in the Transaction Operations category.
...
import { Hash Transaction } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Hash Transaction(input);
