# Serialize Legacy - Library Comparison

A detailed comparison of how each library handles the `serializeLegacy` operation in the Transaction Operations category.
...
import { Serialize Legacy } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Serialize Legacy(input);
