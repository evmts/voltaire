...
export function main(): void {
	Transaction.from(serializedLegacyTx).type;
	Transaction.from(serializedEip1559Tx).type;
	// Note: Ethers does not support EIP-7702 yet, will throw
	try {
		Transaction.from(serializedEip7702Tx).type;
	} catch {
		// Expected to fail for EIP-7702
	}
}
