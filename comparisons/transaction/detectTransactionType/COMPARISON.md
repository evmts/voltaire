# Detect Transaction Type - Library Comparison

A detailed comparison of how each library handles the `detectTransactionType` operation in the Transaction Operations category.
...
import { Detect Transaction Type } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Detect Transaction Type(input);
