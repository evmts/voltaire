# Serialize Eip7702 - Library Comparison

A detailed comparison of how each library handles the `serializeEip7702` operation in the Transaction Operations category.
...
import { Serialize Eip7702 } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Serialize Eip7702(input);
