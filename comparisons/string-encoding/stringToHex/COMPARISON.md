# String To Hex - Library Comparison

A detailed comparison of how each library handles the `stringToHex` operation in the String Encoding Operations category.
...
import { String To Hex } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = String To Hex(input);
