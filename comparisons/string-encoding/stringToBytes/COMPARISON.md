# String To Bytes - Library Comparison

A detailed comparison of how each library handles the `stringToBytes` operation in the String Encoding Operations category.
...
import { String To Bytes } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = String To Bytes(input);
