# Bytes To String - Library Comparison

A detailed comparison of how each library handles the `bytesToString` operation in the String Encoding Operations category.
...
import { Bytes To String } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Bytes To String(input);
