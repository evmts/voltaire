# Conversions - Library Comparison

A detailed comparison of how each library handles the `conversions` operation in the Uint256 Operations category.
...
import { Conversions } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Conversions(input);
