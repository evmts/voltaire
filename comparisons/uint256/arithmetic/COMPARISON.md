...
A detailed comparison of how each library handles the `arithmetic` operation in the Uint256 Operations category.
...
import { Arithmetic } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Arithmetic(input);
