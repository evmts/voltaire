# Bitwise - Library Comparison

A detailed comparison of how each library handles the `bitwise` operation in the Uint256 Operations category.
...
import { Bitwise } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Bitwise(input);
