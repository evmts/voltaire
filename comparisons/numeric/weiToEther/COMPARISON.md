# Wei To Ether - Library Comparison

A detailed comparison of how each library handles the `weiToEther` operation in the Numeric Operations category.
...
import { Wei To Ether } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Wei To Ether(input);
