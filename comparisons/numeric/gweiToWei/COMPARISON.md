# Gwei To Wei - Library Comparison

A detailed comparison of how each library handles the `gweiToWei` operation in the Numeric Operations category.
...
import { Gwei To Wei } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Gwei To Wei(input);
