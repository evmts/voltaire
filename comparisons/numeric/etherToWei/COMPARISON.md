# Ether To Wei - Library Comparison

A detailed comparison of how each library handles the `etherToWei` operation in the Numeric Operations category.
...
import { Ether To Wei } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Ether To Wei(input);
