# Convert Unit - Library Comparison

A detailed comparison of how each library handles the `convertUnit` operation in the Numeric Operations category.
...
import { Convert Unit } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Convert Unit(input);
