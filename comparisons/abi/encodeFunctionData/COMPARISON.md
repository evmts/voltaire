# Encode Function Data - Library Comparison

A detailed comparison of how each library handles the `encodeFunctionData` operation in the ABI Operations category.
...
import { Encode Function Data } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Encode Function Data(input);
