# Decode Function Data - Library Comparison

A detailed comparison of how each library handles the `decodeFunctionData` operation in the ABI Operations category.
...
import { Decode Function Data } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Decode Function Data(input);
