# Encode Packed - Library Comparison

A detailed comparison of how each library handles the `encodePacked` operation in the ABI Operations category.
...
import { Encode Packed } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Encode Packed(input);
