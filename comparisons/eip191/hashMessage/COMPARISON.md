# Hash Message - Library Comparison

A detailed comparison of how each library handles the `hashMessage` operation in the EIP-191 Operations category.
...
import { Hash Message } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Hash Message(input);
