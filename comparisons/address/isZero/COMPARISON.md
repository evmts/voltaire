# Is Zero - Library Comparison

A detailed comparison of how each library handles the `isZero` operation in the Address Operations category.
...
import { Is Zero } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Is Zero(input);
