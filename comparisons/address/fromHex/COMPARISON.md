# From Hex - Library Comparison

A detailed comparison of how each library handles the `fromHex` operation in the Address Operations category.
...
import { From Hex } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = From Hex(input);
