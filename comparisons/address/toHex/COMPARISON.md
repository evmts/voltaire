# To Hex - Library Comparison

A detailed comparison of how each library handles the `toHex` operation in the Address Operations category.
...
import { To Hex } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = To Hex(input);
