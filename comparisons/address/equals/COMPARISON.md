# Equals - Library Comparison

A detailed comparison of how each library handles the `equals` operation in the Address Operations category.
...
import { Equals } from '@tevm/primitives';
