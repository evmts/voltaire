# Fill - Library Comparison

A detailed comparison of how each library handles the `fill` operation in the Hash32/Bytes32 Operations category.
...
import { Fill } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Fill(input);
