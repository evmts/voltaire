# Constructor - Library Comparison

A detailed comparison of how each library handles the `constructor` operation in the Hash32/Bytes32 Operations category.
...
import { Constructor } from '@tevm/primitives';
