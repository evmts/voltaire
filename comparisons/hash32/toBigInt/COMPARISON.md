# To Big Int - Library Comparison

A detailed comparison of how each library handles the `toBigInt` operation in the Hash32/Bytes32 Operations category.
...
import { To Big Int } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = To Big Int(input);
