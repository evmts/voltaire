# To Uint8 Array - Library Comparison

A detailed comparison of how each library handles the `toUint8Array` operation in the Hash32/Bytes32 Operations category.
...
import { To Uint8 Array } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = To Uint8 Array(input);
