# From Big Int - Library Comparison

A detailed comparison of how each library handles the `fromBigInt` operation in the Hash32/Bytes32 Operations category.
...
import { From Big Int } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = From Big Int(input);
