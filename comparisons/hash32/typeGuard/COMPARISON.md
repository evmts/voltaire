# Type Guard - Library Comparison

A detailed comparison of how each library handles the `typeGuard` operation in the Hash32/Bytes32 Operations category.
...
import { Type Guard } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Type Guard(input);
