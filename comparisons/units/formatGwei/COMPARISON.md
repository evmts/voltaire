# Format Gwei - Library Comparison

A detailed comparison of how each library handles the `formatGwei` operation in the Unit Conversion Operations category.
...
import { Format Gwei } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Format Gwei(input);
