# Parse Gwei - Library Comparison

A detailed comparison of how each library handles the `parseGwei` operation in the Unit Conversion Operations category.
...
import { Parse Gwei } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Parse Gwei(input);
