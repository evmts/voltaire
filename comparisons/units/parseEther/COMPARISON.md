# Parse Ether - Library Comparison

A detailed comparison of how each library handles the `parseEther` operation in the Unit Conversion Operations category.
...
import { Parse Ether } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Parse Ether(input);
