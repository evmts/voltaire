# Format Units - Library Comparison

A detailed comparison of how each library handles the `formatUnits` operation in the Unit Conversion Operations category.
...
import { Format Units } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Format Units(input);
