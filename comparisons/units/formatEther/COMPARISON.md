# Format Ether - Library Comparison

A detailed comparison of how each library handles the `formatEther` operation in the Unit Conversion Operations category.
...
import { Format Ether } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Format Ether(input);
