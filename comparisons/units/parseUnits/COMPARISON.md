# Parse Units - Library Comparison

A detailed comparison of how each library handles the `parseUnits` operation in the Unit Conversion Operations category.
...
import { Parse Units } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Parse Units(input);
