# Pad Right - Library Comparison

A detailed comparison of how each library handles the `padRight` operation in the Data Padding Operations category.
...
import { Pad Right } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Pad Right(input);
