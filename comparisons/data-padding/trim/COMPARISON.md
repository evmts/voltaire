# Trim - Library Comparison

A detailed comparison of how each library handles the `trim` operation in the Data Padding Operations category.
...
import { Trim } from '@tevm/primitives';
