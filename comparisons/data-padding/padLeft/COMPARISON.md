# Pad Left - Library Comparison

A detailed comparison of how each library handles the `padLeft` operation in the Data Padding Operations category.
...
import { Pad Left } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Pad Left(input);
