# Size - Library Comparison

A detailed comparison of how each library handles the `size` operation in the Data Padding Operations category.
...
import { Size } from '@tevm/primitives';
