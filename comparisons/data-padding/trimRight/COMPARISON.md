# Trim Right - Library Comparison

A detailed comparison of how each library handles the `trimRight` operation in the Data Padding Operations category.
...
import { Trim Right } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Trim Right(input);
