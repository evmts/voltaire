# Get Address - Library Comparison

A detailed comparison of how each library handles the `getAddress` operation in the Signer Operations category.
...
import { Get Address } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Get Address(input);
