# Sign Typed Data - Library Comparison

A detailed comparison of how each library handles the `signTypedData` operation in the Signer Operations category.
...
import { Sign Typed Data } from '@tevm/primitives';

// ✅ Let the library handle validation
const result = Sign Typed Data(input);
