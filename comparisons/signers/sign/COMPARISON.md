# Sign - Library Comparison

A detailed comparison of how each library handles the `sign` operation in the Signer Operations category.
...
import { Sign } from '@tevm/primitives';
