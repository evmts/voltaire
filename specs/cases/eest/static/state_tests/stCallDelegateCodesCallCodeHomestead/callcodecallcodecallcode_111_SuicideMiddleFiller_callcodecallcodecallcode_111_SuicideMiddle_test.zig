...
test "callcodecallcodecallcode_111_SuicideMiddle" {
    ...
    const json_path = "specs/execution-specs/tests/eest/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcodecallcodecallcode_111_SuicideMiddleFiller.json";
