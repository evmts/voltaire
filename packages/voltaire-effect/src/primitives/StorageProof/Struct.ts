...
import type { StorageProof } from "@tevm/voltaire";
 ...
 * @since 0.0.1
 */
export const Schema: S.Schema<StorageProofType, StorageProofType> =
	S.transformOrFail(StorageProofTypeSchema, StorageProofTypeSchema, {
		strict: true,
