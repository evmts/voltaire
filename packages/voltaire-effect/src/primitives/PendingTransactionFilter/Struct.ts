import { FilterId, PendingTransactionFilter } from "@tevm/voltaire";
...
export type PendingTransactionFilterType =
	PendingTransactionFilter.PendingTransactionFilterType;

const PendingTransactionFilterTypeSchema =
	S.declare<PendingTransactionFilterType>(
		(u): u is PendingTransactionFilterType => {
			if (typeof u !== "object" || u === null) return false;
			const obj = u as Record<string, unknown>;
			return (
				obj.type === "pendingTransaction" && typeof obj.filterId === "string"
			);
		},
 ...
 * @since 0.0.1
 */
export const Schema: S.Schema<PendingTransactionFilterType, string> =
	S.transformOrFail(S.String, PendingTransactionFilterTypeSchema, {
		strict: true,
