...
const MultiTokenIdTypeSchema = S.declare<MultiTokenIdType>(
	(u): u is MultiTokenIdType =>
		typeof u === "bigint" && u >= 0n && u < 2n ** 256n,
	{ identifier: "MultiTokenId" },
);

export const Schema: S.Schema<MultiTokenIdType, bigint | number | string> =
	S.transformOrFail(
...
export const FromHexSchema: S.Schema<MultiTokenIdType, string> =
	S.transformOrFail(S.String, MultiTokenIdTypeSchema, {
		strict: true,
