...
const typedData = {
  ...
  primaryType: 'Permit',
  domain: { name: 'MyToken', version: '1', chainId: 1n, verifyingContract: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48' },
  message: {
...
```typescript
import { Effect, Layer } from 'effect'
import { JsonRpcAccount, BrowserTransport, Signer, Provider, SignerService } from 'voltaire-effect'
...
const program = Effect.gen(function* () {
  ...
  return yield* signer.sendTransaction({ to: '0x70997970C51812dc3A010C7d01b50e0d17dc79C8', value: 1000000000000000000n })
