...
const LiveLayer = Layer.mergeAll(TransportLayer, ProviderLayer)
...
```typescript
import { Effect, Stream, Layer } from 'effect'
import { Contract, Provider, HttpTransport, getBlockNumber } from 'voltaire-effect'
import { makeBlockStream } from 'voltaire-effect/services'
...
import { Contract, ContractEventError, Provider, HttpTransport, withRetrySchedule } from 'voltaire-effect'
