 ...
 */
export type StreamBlock<TInclude extends BlockInclude> = TInclude extends "receipts" ? BlockType & {
    readonly receipts: readonly ReceiptType[];
} : TInclude extends "transactions" ? BlockType : Omit<BlockType, "body"> & {
 ...
 */
export interface BackfillOptions<TInclude extends BlockInclude = "header"> extends BlockStreamOptions<TInclude> {
 ...
 */
export interface WatchOptions<TInclude extends BlockInclude = "header"> extends BlockStreamOptions<TInclude> {
 ...
 */
export type BlockStreamEvent<TInclude extends BlockInclude> = BlocksEvent<TInclude> | ReorgEvent<TInclude>;
/**
...
export interface BlockStream {
     ...
     * ```
     */
    backfill<TInclude extends BlockInclude = "header">(options: BackfillOptions<TInclude>): AsyncGenerator<BlocksEvent<TInclude>>;
    /**
     ...
     * ```
     */
    watch<TInclude extends BlockInclude = "header">(options?: WatchOptions<TInclude>): AsyncGenerator<BlockStreamEvent<TInclude>>;
}
/**
 ...
 */
export type BlockStreamFactory = (options: BlockStreamConstructorOptions) => BlockStream;
//# sourceMappingURL=BlockStreamType.d.ts.map