 ...
 */
import { InvalidFieldError, InvalidIconError, InvalidProviderError, InvalidRdnsError, InvalidUuidError, MissingFieldError, } from "./errors.js";
/**
 * UUIDv4 format regex
 * @type {RegExp}
 */
 ...
 * @type {RegExp}
 */
export const DATA_URI_REGEX = /^data:image\/(png|jpeg|gif|webp|svg\+xml);base64,/;
/**
