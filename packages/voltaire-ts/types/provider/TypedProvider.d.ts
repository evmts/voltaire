 ...
 * ```
 */
export interface TypedProvider<TRpcSchema extends RpcSchema = RpcSchema, TEventMap extends Record<string, (...args: any[]) => void> = EIP1193EventMap> {
    /**
     ...
     * ```
     */
    on<TEvent extends keyof TEventMap>(event: TEvent, listener: TEventMap[TEvent]): this;
    /**
     ...
     */
    removeListener<TEvent extends keyof TEventMap>(event: TEvent, listener: TEventMap[TEvent]): this;
}
/**
...
//# sourceMappingURL=TypedProvider.d.ts.map