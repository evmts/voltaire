 ...
 * ```
 */
export type EIP1193RequestFn<TRpcSchema extends RpcSchema> = <TMethod extends RpcMethodNames<TRpcSchema>>(args: RequestArguments<TRpcSchema, TMethod>, options?: EIP1193RequestOptions) => Promise<RpcMethodReturnType<TRpcSchema, TMethod>>;
//# sourceMappingURL=EIP1193RequestFn.d.ts.map