            ...
            switch (method) {
                ...
                case "eth_getBalance":
                    if (!params || params.length < 2) {
                        throw new ProviderRpcError(EIP1193ErrorCode.Unauthorized, "Invalid params");
                    }
                    // biome-ignore lint/suspicious/noExplicitAny: mock return type
                ...
                case "eth_call":
                    ...
                    return "0xabcdef";
                default:
                    throw new ProviderRpcError(EIP1193ErrorCode.UnsupportedMethod, `Method ${method} not supported`);
            }
        },
        on: (event, listener) => {
