...
export function getPlatform() {
    ...
    if (!mappedPlatform || !mappedArch) {
        throw new Error(`Unsupported platform: ${platform}-${arch}. Supported: darwin-arm64, darwin-x64, linux-arm64, linux-x64, win32-x64`);
    }
 ...
 */
export function getNativeExtension() {
    const platform = process.platform;
    switch (platform) {
        case "darwin":
            return "dylib";
 ...
 */
export function getNativeLibPath(moduleName = "voltaire_native", subpath) {
