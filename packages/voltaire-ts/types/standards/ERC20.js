 ...
 */
export function encodeTransferFrom(from, to, amount) {
 ...
 */
export function encodeBalanceOf(account) {
    // Convert address (20 bytes) to hex and pad to 32 bytes
 ...
 */
export function decodeDecimals(data) {
 ...
 */
export function decodeTotalSupplyResult(data) {
    return decodeUint256(data);
}
/**
 * Decode name() return value (string)
 */
export function decodeNameResult(data) {
    return decodeString(data);
}
/**
 * Decode symbol() return value (string)
 */
export function decodeSymbolResult(data) {
    return decodeString(data);
}
/**
 * Decode decimals() return value (uint8)
 */
export function decodeDecimalsResult(data) {
