 ...
 * ```
 */
export declare function wrapWithTimeout<TArgs extends unknown[], TReturn>(fn: (...args: TArgs) => Promise<TReturn>, ms: number, message?: string): (...args: TArgs) => Promise<TReturn>;
/**
 ...
 * ```
 */
export declare function executeWithTimeout<T>(fn: () => Promise<T>, timeoutMs: number, maxRetries?: number): Promise<T>;
