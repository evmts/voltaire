 ...
 */
export function from({ bytecode = new Uint8Array(0), gas = 1000000n, caller = /** @type {import("../../primitives/Address/AddressType.js").AddressType} */ (new Uint8Array(20)), address = /** @type {import("../../primitives/Address/AddressType.js").AddressType} */ (new Uint8Array(20)), value = 0n, calldata = new Uint8Array(0), isStatic = false, stack = [], gasRemaining, }) {
