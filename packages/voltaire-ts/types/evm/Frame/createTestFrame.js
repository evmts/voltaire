...
export function createTestFrame(options = {}) {
    const defaultCaller = Address.from("0x0000000000000000000000000000000000000001");
    const defaultAddress = Address.from("0x0000000000000000000000000000000000000002");
    return from({
