...
export function mcopy(frame) {
    ...
    if (len !== 0n) {
        ...
        const destU64 = dest <= Number.MAX_SAFE_INTEGER ? Number(dest) : Number.MAX_SAFE_INTEGER;
        const srcU64 = src <= Number.MAX_SAFE_INTEGER ? Number(src) : Number.MAX_SAFE_INTEGER;
        const lenU64 = len <= Number.MAX_SAFE_INTEGER ? Number(len) : Number.MAX_SAFE_INTEGER;
    ...
    if (dest > Number.MAX_SAFE_INTEGER ||
