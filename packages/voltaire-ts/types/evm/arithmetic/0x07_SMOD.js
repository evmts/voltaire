...
export function smod(frame) {
    ...
    if (second === 0n) {
        ...
        // Remainder operation
        const remainder = topSigned % secondSigned;
        // Convert back to unsigned
        result = toUnsigned256(remainder);
    }
