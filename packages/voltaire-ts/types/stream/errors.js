...
export class UnrecoverableReorgError extends Error {
    reorgDepth;
    trackedDepth;
    name = "UnrecoverableReorgError";
    constructor(reorgDepth, trackedDepth) {
        super(`Unrecoverable reorg: depth ${reorgDepth} exceeds tracked history of ${trackedDepth} blocks`);
        this.reorgDepth = reorgDepth;
        this.trackedDepth = trackedDepth;
    }
}
