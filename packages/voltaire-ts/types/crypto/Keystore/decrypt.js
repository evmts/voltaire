...
import { DecryptionError, InvalidMacError, InvalidPbkdf2IterationsError, InvalidScryptNError, UnsupportedKdfError, UnsupportedVersionError, } from "./errors.js";
...
export function decrypt(keystore, password) {
    try {
        ...
        return /** @type {import('../../primitives/PrivateKey/PrivateKeyType.js').PrivateKeyType} */ (privateKey);
    }
    catch (error) {
