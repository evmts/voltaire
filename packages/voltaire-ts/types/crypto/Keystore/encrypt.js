...
import { EncryptionError, InvalidPbkdf2IterationsError, InvalidScryptNError, } from "./errors.js";
...
export async function encrypt(privateKey, password, options = {}) {
    try {
        const { kdf = "scrypt", uuid = generateUuid(), iv = crypto.getRandomValues(new Uint8Array(16)), salt = crypto.getRandomValues(new Uint8Array(32)), scryptN = 262144, scryptR = 8, scryptP = 1, pbkdf2C = 262144, includeAddress = false, } = options;
        void includeAddress;
