...
(function (Blake2Wasm) {
     ...
     * ```
     */
    function hash(data, outputLength = 64) {
     ...
     * ```
     */
    function hashString(str, outputLength = 64) {
        return hash(str, outputLength);
    }
    Blake2Wasm.hashString = hashString;
})(Blake2Wasm || (Blake2Wasm = {}));
