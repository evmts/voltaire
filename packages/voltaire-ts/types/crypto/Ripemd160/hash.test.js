...
describe("Ripemd160 hash function", () => {
    describe("official test vectors", () => {
        ...
        it("should hash mixed case alphanumeric", () => {
            const input = new TextEncoder().encode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
            const result = hash(input);
            const expected = new Uint8Array([
        ...
        it("should hash repeated digits (80 bytes)", () => {
            const input = new TextEncoder().encode("12345678901234567890123456789012345678901234567890123456789012345678901234567890");
            const result = hash(input);
            const expected = new Uint8Array([
