...
export function pairingCheck(pairs) {
    ...
    throw new PairingError("Full pairing not implemented in pure JS. Use native blst bindings for production.");
}
/**
 ...
 * @throws {PairingError}
 */
export function verifyAggregateSignature(aggregatedSignature, aggregatedPublicKey, messagePoint) {
