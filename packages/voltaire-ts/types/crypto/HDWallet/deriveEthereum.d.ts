 ...
 * ```
 */
export function deriveEthereum(key: import("./ExtendedKeyType.js").BrandedExtendedKey, account?: number, index?: number): import("./ExtendedKeyType.js").BrandedExtendedKey;
//# sourceMappingURL=deriveEthereum.d.ts.map