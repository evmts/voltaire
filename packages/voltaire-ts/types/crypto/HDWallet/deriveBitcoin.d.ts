 ...
 * @returns {import('./ExtendedKeyType.js').BrandedExtendedKey} Derived extended key for Bitcoin address
 ...
 * ```
 */
export function deriveBitcoin(key: import("./ExtendedKeyType.js").BrandedExtendedKey, account?: number, index?: number): import("./ExtendedKeyType.js").BrandedExtendedKey;
//# sourceMappingURL=deriveBitcoin.d.ts.map