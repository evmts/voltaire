...
describe("SHA256 toHex function", () => {
    describe("basic conversion", () => {
        it("should convert hash to hex string", () => {
            ...
            expect(hex).toBe("0xba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad");
        });
        it("should handle empty hash", () => {
            const hashResult = hash(new Uint8Array([]));
            const hex = toHex(hashResult);
            expect(hex).toBe("0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
        });
    ...
    describe("real hash outputs", () => {
        it("should convert hash of 'hello world'", () => {
            ...
            const hashResult = hash(input);
            const hex = toHex(hashResult);
            expect(hex).toBe("0xb94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde9");
        });
