...
export function scalarMultiply(scalar) {
    ...
    try {
        ...
        if (result[0] !== 0x04) {
            throw new Secp256k1Error("Invalid point format after scalar multiplication", {
        ...
        return /** @type {import('./Secp256k1PublicKeyType.js').Secp256k1PublicKeyType} */ (result.slice(1));
    }
    catch (error) {
