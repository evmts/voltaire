...
export function randomPrivateKey() {
    ...
    if (typeof globalThis.crypto !== "undefined" &&
        ...
        throw new Secp256k1Error("Failed to generate valid private key after 100 attempts", {
            code: -32000,
            context: { attempts: 100 },
            docsPath: "/crypto/secp256k1/random-private-key#error-handling",
        });
    }
    throw new Secp256k1Error("crypto.getRandomValues not available - cannot generate secure private key", {
        code: -32000,
        docsPath: "/crypto/secp256k1/random-private-key#error-handling",
    });
}
