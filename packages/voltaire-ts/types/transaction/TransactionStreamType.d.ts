 ...
 */
export type TransactionStreamEvent = PendingTransactionEvent | ConfirmedTransactionEvent | DroppedTransactionEvent;
/**
...
export interface TransactionStream {
     ...
     * ```
     */
    watchPending(options?: WatchPendingOptions): AsyncGenerator<PendingTransactionEvent>;
    /**
     ...
     * ```
     */
    watchConfirmed(options?: WatchConfirmedOptions): AsyncGenerator<ConfirmedTransactionEvent>;
    /**
     ...
     * ```
     */
    track(txHash: TransactionHashType | `0x${string}`, options?: TrackOptions): AsyncGenerator<TransactionStreamEvent>;
}
/**
 ...
 */
export type TransactionStreamFactory = (options: TransactionStreamConstructorOptions) => TransactionStream;
//# sourceMappingURL=TransactionStreamType.d.ts.map