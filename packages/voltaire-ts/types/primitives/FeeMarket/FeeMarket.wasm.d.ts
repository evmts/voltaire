 ...
 * ```
 */
export declare function isWasmFeeMarketAvailable(): boolean;
/**
 ...
 * ```
 */
export declare function getFeeMarketImplementationStatus(): {
    available: boolean;
    reason: string;
...
//# sourceMappingURL=FeeMarket.wasm.d.ts.map