 ...
 * ```
 */
export function calculateBlobTxFee(params: import("./BlobTxFeeParams.js").BlobTxFeeParams): import("./BlobTxFee.js").BlobTxFee;
//# sourceMappingURL=calculateBlobTxFee.d.ts.map