 ...
 */
export type EventLogType<TAddress extends BrandedAddress = BrandedAddress, TTopics extends readonly HashType[] = readonly HashType[]> = {
 ...
 */
export type Filter<TAddress extends BrandedAddress | BrandedAddress[] | undefined = BrandedAddress | BrandedAddress[] | undefined, TTopics extends readonly (HashType | HashType[] | null)[] | undefined = readonly (HashType | HashType[] | null)[] | undefined> = {
...
//# sourceMappingURL=EventLogType.d.ts.map