...
declare function getTopic0<T extends BrandedEventLog>(log: T): import("../Hash/HashType.js").HashType | undefined;
declare function getIndexedTopics<T extends BrandedEventLog>(log: T): readonly import("../Hash/HashType.js").HashType[];
declare function getSignature<T extends BrandedEventLog>(log: T): import("../Hash/HashType.js").HashType | undefined;
declare function getIndexed<T extends BrandedEventLog>(log: T): readonly import("../Hash/HashType.js").HashType[];
...
declare function filterLogs<T extends BrandedEventLog>(logs: readonly T[], filter: import("./EventLogType.js").Filter): T[];
declare function filter<T extends BrandedEventLog>(logs: readonly T[], filter: import("./EventLogType.js").Filter): T[];
...
export {};
//# sourceMappingURL=EventLogConstructor.d.ts.map