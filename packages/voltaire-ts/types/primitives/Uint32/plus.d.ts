 ...
 * @returns {import('./Uint32Type.js').Uint32Type} Sum (uint + b) mod 2^32
 * @throws {never}
 * @example
 * ```javascript
 ...
 * ```
 */
export function plus(uint: import("./Uint32Type.js").Uint32Type, b: import("./Uint32Type.js").Uint32Type): import("./Uint32Type.js").Uint32Type;
