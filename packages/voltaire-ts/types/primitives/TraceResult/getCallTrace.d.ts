 ...
 * ```
 */
export function getCallTrace(result: import("./TraceResultType.js").TraceResultType): import("../CallTrace/CallTraceType.js").CallTraceType | undefined;
//# sourceMappingURL=getCallTrace.d.ts.map