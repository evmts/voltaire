...
export declare const Uint8Type: {
    from: typeof from;
    ...
    MAX: import("./Uint8Type.js").Uint8Type;
    MIN: import("./Uint8Type.js").Uint8Type;
    ZERO: import("./Uint8Type.js").Uint8Type;
    ONE: import("./Uint8Type.js").Uint8Type;
    SIZE: number;
};
