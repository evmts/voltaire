 ...
 * @returns {import('./Uint8Type.js').Uint8Type} Right-shifted value
 * @throws {never}
 * @example
 * ```javascript
 ...
 * ```
 */
export function shiftRight(uint: import("./Uint8Type.js").Uint8Type, shift: number): import("./Uint8Type.js").Uint8Type;
