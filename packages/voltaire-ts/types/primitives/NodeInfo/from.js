...
export function from(value) {
    if (!value || typeof value !== "object") {
        throw new InvalidFormatError(`Node info must be an object, got ${typeof value}`, {
            value,
    ...
    if (typeof value.listenAddr !== "string") {
        throw new InvalidFormatError("Node info must have 'listenAddr' string field", {
            value,
    ...
    if (typeof value.ports.discovery !== "number" ||
        typeof value.ports.listener !== "number") {
        throw new InvalidFormatError("Node info ports must have 'discovery' and 'listener' number fields", {
            value: value.ports,
    ...
    if (!value.protocols || typeof value.protocols !== "object") {
        throw new InvalidFormatError("Node info must have 'protocols' object field", {
            value,
