...
describe("AccountState.createEmpty", () => {
    ...
    describe("constant validation", () => {
        it("EMPTY_CODE_HASH is keccak256 of empty string", () => {
            expect(EMPTY_CODE_HASH).toBe("0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470");
        });
        it("EMPTY_TRIE_HASH is keccak256 of RLP empty array", () => {
            expect(EMPTY_TRIE_HASH).toBe("0x56e81f171bcc55a6ff8345e692c0f86e5b47e5b60e2d8c5ab6c7c9fa0e32d3c5");
        });
    });
