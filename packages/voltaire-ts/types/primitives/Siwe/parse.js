...
import { InvalidFieldError, InvalidSiweMessageError, MissingFieldError, SiweParseError, } from "./errors.js";
/**
...
export function parse(text) {
    try {
        ...
        const normalizedText = text.replace(/0x[0-9a-fA-F]{40}/, (match) => match.toLowerCase());
        ...
        /** @type {import('./SiweMessageType.js').SiweMessageType} */
        const message = {
