 ...
 */
export type SiweMessageType<TDomain extends string = string, TAddress extends BrandedAddress = BrandedAddress, TUri extends string = string, TVersion extends string = string, TChainId extends number = number> = {
 ...
 * @deprecated Use SiweMessageType instead
 */
export type BrandedMessage<TDomain extends string = string, TAddress extends BrandedAddress = BrandedAddress, TUri extends string = string, TVersion extends string = string, TChainId extends number = number> = SiweMessageType<TDomain, TAddress, TUri, TVersion, TChainId>;
//# sourceMappingURL=SiweMessageType.d.ts.map