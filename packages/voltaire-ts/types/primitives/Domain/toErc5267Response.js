...
export function toErc5267Response(domain) {
    const fields = getFieldsBitmap(domain);
    // Default empty 32-byte salt
    ...
    return {
        ...
        chainId: domain.chainId !== undefined ? BigInt(domain.chainId) : 0n,
        verifyingContract: domain.verifyingContract ?? zeroAddress,
        salt: domain.salt ?? emptySalt,
        extensions: [],
    };
}
