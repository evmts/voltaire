...
export function from(domain) {
    ...
    if (!domain.name &&
        ...
        !domain.salt) {
        throw new InvalidDomainError("Domain must have at least one field defined", { value: domain });
    }
    ...
    if (domain.chainId !== undefined) {
        result = {
            ...result,
            chainId: typeof domain.chainId === "number"
    ...
    if (domain.verifyingContract !== undefined) {
        result = {
            ...result,
            verifyingContract: typeof domain.verifyingContract === "string"
    ...
    if (domain.salt !== undefined) {
        result = {
            ...result,
            salt: typeof domain.salt === "string" ? Hash.from(domain.salt) : domain.salt,
        };
    }
