 ...
 * @returns {import('./Uint16Type.js').Uint16Type} Left-shifted value (masked to 16 bits)
 * @throws {never}
 * @example
 * ```javascript
 ...
 * ```
 */
export function shiftLeft(uint: import("./Uint16Type.js").Uint16Type, shift: number): import("./Uint16Type.js").Uint16Type;
