 ...
 * @returns {import('./Uint16Type.js').Uint16Type} Bitwise NOT result
 * @throws {never}
 * @example
 * ```javascript
 ...
 * ```
 */
export function bitwiseNot(uint: import("./Uint16Type.js").Uint16Type): import("./Uint16Type.js").Uint16Type;
