 ...
 * ```
 */
export function fromRpc(rpc: RpcBlock): import("./BlockType.js").BlockType;
export type RpcBlockHeader = import("../BlockHeader/fromRpc.js").RpcBlockHeader;
export type RpcBlockBody = import("../BlockBody/fromRpc.js").RpcBlockBody;
export type RpcBlock = RpcBlockHeader & RpcBlockBody & {
    hash: string;
    size: string;
    totalDifficulty?: string;
};
