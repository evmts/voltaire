...
describe("toHex", () => {
    describe("conversion", () => {
        it("converts hash to hex string with 0x prefix", () => {
            ...
            expect(hex).toBe("0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef");
        });
        ...
        it("preserves byte order", () => {
            ...
            const hash = fromBytes(bytes);
            const hex = toHex(hash);
            expect(hex).toBe("0x0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20");
        });
    });
    describe("roundtrip", () => {
