...
describe("clone", () => {
    describe("cloning", () => {
        it("creates copy of hash", () => {
            const original = fromHex("0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef");
    ...
    describe("deep copy", () => {
        ...
        it("preserves byte values exactly", () => {
            const original = fromHex("0x0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20");
            const copy = clone(original);
            for (let i = 0; i < 32; i++) {
    ...
    describe("edge cases", () => {
        ...
        it("handles repeated cloning", () => {
            let hash = fromHex("0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef");
            for (let i = 0; i < 10; i++) {
                hash = clone(hash);
            }
