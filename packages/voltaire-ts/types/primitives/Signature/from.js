...
export function from(value) {
    ...
    if (value instanceof Uint8Array) {
        ...
        throw new InvalidSignatureFormatError(`Invalid signature length: ${value.length} bytes`, {
            value: value.length,
    ...
    if (value && typeof value === "object" && "r" in value && "s" in value) {
        ...
        throw new InvalidSignatureFormatError(`Invalid algorithm for ECDSA signature: ${algorithm}`, {
            value: algorithm,
