 ...
 */
Hex.from = (value) => HexFuncs.from(value);
/**
 ...
 * ```
 */
Hex.fromBytes = (value) => HexFuncs.fromBytes(value);
/**
 ...
 * ```
 */
Hex.fromNumber = (value, size) => HexFuncs.fromNumber(value, size);
/**
 ...
 * ```
 */
Hex.fromBigInt = (value, size) => HexFuncs.fromBigInt(value, size);
/**
 ...
 * ```
 */
Hex.fromString = (value) => HexFuncs.fromString(value);
/**
 ...
 * ```
 */
Hex.fromBoolean = (value) => HexFuncs.fromBoolean(value);
// ============================================================================
