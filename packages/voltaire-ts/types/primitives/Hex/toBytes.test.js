...
describe("Hex.toBytes", () => {
    describe("basic conversion", () => {
        ...
        it("converts large hex string", () => {
            const h = hex("0x000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f");
    ...
    describe("known decodings", () => {
        ...
        it("converts Ethereum address", () => {
            ...
            expect(bytes).toEqual(new Uint8Array([
                ...
                0x03, 0xe5, 0x34, 0x15, 0xd3, 0x7a, 0xa9, 0x60, 0x45,
            ]));
        });
        it("converts keccak256 hash", () => {
            const bytes = toBytes(hex("0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470"));
            expect(bytes).toEqual(new Uint8Array([
