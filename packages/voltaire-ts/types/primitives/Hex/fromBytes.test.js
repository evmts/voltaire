...
describe("Hex.fromBytes", () => {
    describe("basic conversion", () => {
        ...
        it("converts large byte array", () => {
            ...
            expect(fromBytes(bytes)).toBe("0x000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f");
        });
    });
    describe("padding", () => {
    ...
    describe("known encodings", () => {
        ...
        it("converts address bytes", () => {
            ...
            expect(fromBytes(bytes)).toBe("0xd8da6bf26964af9d7eed9e03e53415d37aa96045");
        });
        it("converts hash bytes", () => {
            ...
            expect(fromBytes(bytes)).toBe("0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470");
        });
    });
