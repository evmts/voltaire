...
export function from(typedData) {
    ...
    if (!typedData.types.EIP712Domain) {
        throw new InvalidTypedDataError("TypedData types must include EIP712Domain", { value: typedData });
    }
    // Validate primaryType exists in types
    if (!typedData.types[typedData.primaryType]) {
        throw new InvalidTypedDataError(`TypedData primaryType '${typedData.primaryType}' not found in types`, { value: typedData });
    }
