 ...
 * const result = Uint128.bitwiseAnd(a, b); // 0x0f
 * ```
 */
export function bitwiseAnd(uint: import("./Uint128Type.js").Uint128Type, b: import("./Uint128Type.js").Uint128Type): import("./Uint128Type.js").Uint128Type;
