 ...
 */
export function isSuccess(status: import("./TransactionStatusType.js").TransactionStatusType): status is {
    readonly type: "success";
    readonly gasUsed: import("../Uint/Uint256Type.js").Uint256Type;
};
