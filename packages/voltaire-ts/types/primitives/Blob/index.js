...
import { BYTES_PER_FIELD_ELEMENT, COMMITMENT_VERSION_KZG, FIELD_ELEMENTS_PER_BLOB, GAS_PER_BLOB, MAX_PER_TRANSACTION, SIZE, TARGET_GAS_PER_BLOCK, } from "./constants.js";
import { BlobArrayLengthMismatchError, BlobNotImplementedError, InvalidBlobCountError, InvalidBlobSizeError, InvalidCommitmentSizeError, InvalidProofSizeError, } from "./errors.js";
...
// Type-safe wrappers
const calculateGas = _calculateGas;
const estimateBlobCount = _estimateBlobCount;
const from = _from;
const fromData = _fromData;
const isValid = _isValid;
const isValidVersion = _isValidVersion;
const joinData = _joinData;
const splitData = _splitData;
const toData = _toData;
const ToCommitment = _ToCommitment;
const ToProof = _ToProof;
const ToVersionedHash = _ToVersionedHash;
const Verify = _Verify;
const VerifyBatch = _VerifyBatch;
// Import KZG functions from crypto module
// Note: KZG is native-only, these will throw in WASM/browser environments
import { blobToKzgCommitment, computeBlobKzgProof, verifyBlobKzgProof, } from "../../crypto/KZG/index.js";
 ...
 */
export const verifyBatch = ((blobs, commitments, proofs) => {
