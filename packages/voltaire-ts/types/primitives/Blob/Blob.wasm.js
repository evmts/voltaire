 ...
 * ```
 */
export function fromDataWasm(data) {
 ...
 * ```
 */
export function toDataWasm(blob) {
 ...
 * ```
 */
export function isValidWasm(blobLen) {
 ...
 * ```
 */
export function calculateGasWasm(blobCount) {
 ...
 * ```
 */
export function estimateBlobCountWasm(dataSize) {
 ...
 * ```
 */
export function calculateGasPriceWasm(excessBlobGas) {
 ...
 * ```
 */
export function calculateExcessGasWasm(parentExcess, parentUsed) {
 ...
 */
export function isWasmBlobAvailable() {
    try {
        loader.getExports();
        return true;
    }
