...
/** @type {{ computeBlobKzgProof: (blob: Uint8Array, commitment: Uint8Array) => Uint8Array }} */ { computeBlobKzgProof, }) {
    return /** @param {import('./BlobType.js').BrandedBlob} blob @param {import('./BlobType.js').Commitment} commitment */ function toProof(blob, commitment) {
        ...
        try {
            ...
            throw new PrimitiveError(`Failed to compute KZG proof: ${error instanceof Error ? error.message : String(error)}`, {
                code: -32000,
                docsPath: "/primitives/blob/to-proof#error-handling",
