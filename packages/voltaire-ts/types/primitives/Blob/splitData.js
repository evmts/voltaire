import { BYTES_PER_FIELD_ELEMENT, FIELD_ELEMENTS_PER_BLOB, MAX_PER_TRANSACTION, } from "./constants.js";
...
export function splitData(data) {
    ...
    if (blobCount > MAX_PER_TRANSACTION) {
        throw new InvalidBlobDataSizeError(`Data too large: requires ${blobCount} blobs (max ${MAX_PER_TRANSACTION})`, {
            value: data.length,
