...
/** @type {{verifyBlobKzgProof: (blob: Uint8Array, commitment: Uint8Array, proof: Uint8Array) => boolean}} */ { verifyBlobKzgProof, }) {
    return /** @param {Uint8Array} blob @param {Uint8Array} commitment @param {Uint8Array} proof */ function verify(blob, commitment, proof) {
        ...
        try {
            ...
            throw new PrimitiveError(`Failed to verify KZG proof: ${error instanceof Error ? error.message : String(error)}`, {
                code: -32000,
                docsPath: "/primitives/blob/verify#error-handling",
