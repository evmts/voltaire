 ...
 * @since 0.0.0
 * @param {import("./AuthorizationType.js").AuthorizationType} _auth - Authorization
 ...
 * ```
 */
export function getGasCost(_auth: import("./AuthorizationType.js").AuthorizationType, isEmpty: boolean): bigint;
