...
export function merge(filter1, filter2) {
    if (filter1.m !== filter2.m || filter1.k !== filter2.k) {
        throw new InvalidBloomFilterParameterError("Cannot merge filters with different parameters", {
    ...
    if (filter1.length !== filter2.length) {
        throw new InvalidBloomFilterParameterError("Cannot merge filters with different sizes", {
