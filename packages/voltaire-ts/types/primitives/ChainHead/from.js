...
export function from(value) {
    ...
    if (!value.number || !value.hash || value.timestamp === undefined) {
        throw new Error("ChainHead requires number, hash, and timestamp properties");
    }
    ...
    if (typeof value.hash === "string") {
        ...
        hash =
            /** @type {import('../BlockHash/BlockHashType.js').BlockHashType} */ (bytes);
    }
    else {
        hash = value.hash;
    }
    return /** @type {import('./ChainHeadType.js').ChainHeadType} */ ({
        number: 
        /** @type {import('../BlockNumber/BlockNumberType.js').BlockNumberType} */ (BigInt(value.number)),
        hash: hash,
        timestamp: /** @type {import('../Uint/Uint256Type.js').Uint256Type} */ (BigInt(value.timestamp)),
        difficulty: value.difficulty !== undefined
            ? /** @type {import('../Uint/Uint256Type.js').Uint256Type} */ (BigInt(value.difficulty))
            : undefined,
        totalDifficulty: value.totalDifficulty !== undefined
