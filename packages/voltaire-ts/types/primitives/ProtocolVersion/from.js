...
export function from(value) {
    if (typeof value !== "string") {
        throw new InvalidFormatError(`Protocol version must be a string, got ${typeof value}`, {
            value,
    ...
    if (parts.length !== 2) {
        throw new InvalidFormatError(`Protocol version must be in format 'protocol/version', got ${value}`, {
            value,
    ...
    if (!protocol || !version) {
        throw new InvalidFormatError(`Protocol version components cannot be empty, got ${value}`, {
            value,
