...
export function toString(protocolVersion) {
    return _toString.call(from(protocolVersion));
}
export function equals(protocolVersion1, protocolVersion2) {
    return _equals.call(from(protocolVersion1), from(protocolVersion2));
}
export function compare(protocolVersion1, protocolVersion2) {
