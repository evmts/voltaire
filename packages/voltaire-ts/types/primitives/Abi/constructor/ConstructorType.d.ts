 ...
 */
export type ConstructorType<TStateMutability extends StateMutability = StateMutability, TInputs extends readonly Parameter[] = readonly Parameter[]> = {
    type: "constructor";
 ...
 */
export interface ConstructorInstance<TStateMutability extends StateMutability = StateMutability, TInputs extends readonly Parameter[] = readonly Parameter[]> extends ConstructorType<TStateMutability, TInputs> {
