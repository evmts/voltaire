...
describe("decodeData", () => {
    ...
    describe("selector matching", () => {
        ...
        it("distinguishes between different selectors", () => {
            ...
            /** @type {*} */ (testAbi[0]), ["0x0000000000000000000000000000000000000000", 100n]);
            const approveCalldata = Function.encodeParams(
            /** @type {*} */ (testAbi[2]), ["0x0000000000000000000000000000000000000000", 100n]);
            expect(transferCalldata.slice(0, 4)).not.toEqual(approveCalldata.slice(0, 4));
    ...
    describe("real-world scenarios", () => {
        ...
        it("handles multiple functions with similar names", () => {
            ...
            const transferCalldata = Function.encodeParams(
            /** @type {*} */ (abi[1]), ["0x0000000000000000000000000000000000000001", 100n]);
