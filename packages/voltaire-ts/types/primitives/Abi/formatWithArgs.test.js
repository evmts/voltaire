...
describe("formatWithArgs", () => {
    describe("function formatting", () => {
        it("formats function call with arguments", () => {
            ...
            expect(formatted).toBe("transfer(0x742d35cc6634c0532925a3b844bc9e7595f251e3, 1000)");
        });
        ...
        it("formats function with single argument", () => {
            ...
            expect(formatted).toBe("balanceOf(0x742d35cc6634c0532925a3b844bc9e7595f251e3)");
        });
        it("formats function with multiple arguments", () => {
            ...
            expect(formatted).toBe("approve(0x742d35cc6634c0532925a3b844bc9e7595f251e3, 500)");
        });
    });
    ...
    describe("argument types", () => {
        ...
        it("formats address arguments", () => {
            ...
            expect(formatted).toBe("transfer(0x742d35cc6634c0532925a3b844bc9e7595f251e3)");
        });
    ...
    describe("edge cases", () => {
        ...
        it("handles zero address argument", () => {
            ...
            expect(formatted).toBe("burn(0x0000000000000000000000000000000000000000)");
        });
    ...
    describe("real-world examples", () => {
        it("formats ERC20 transfer call", () => {
            ...
            expect(formatted).toBe("transfer(0xd8da6bf26964af9d7eed9e03e53415d37aa96045, 1000000000000000000)");
        });
