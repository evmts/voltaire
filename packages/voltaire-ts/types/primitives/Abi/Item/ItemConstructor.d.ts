...
export interface ItemConstructor {
     ...
     */
    getItem<TAbi extends readonly ItemType[], TName extends string, TType extends ItemType["type"] | undefined = undefined>(abi: TAbi, name: TName, type?: TType): Extract<TAbi[number], {
        name: TName;
    }> | undefined;
}
//# sourceMappingURL=ItemConstructor.d.ts.map