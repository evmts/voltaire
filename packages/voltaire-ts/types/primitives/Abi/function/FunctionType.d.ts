 ...
 */
export type FunctionType<TName extends string = string, TStateMutability extends StateMutability = StateMutability, TInputs extends readonly Parameter[] = readonly Parameter[], TOutputs extends readonly Parameter[] = readonly Parameter[]> = {
    type: "function";
    name: TName;
 ...
 */
export type ExtractNames<TAbi extends readonly Item[]> = Extract<TAbi[number], {
    type: "function";
}>["name"];
/**
 * Get a specific function from an ABI by name
 */
export type Get<TAbi extends readonly Item[], TName extends string> = Extract<TAbi[number], {
    type: "function";
    name: TName;
}>;
