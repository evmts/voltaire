...
describe("GetSelector", () => {
    ...
    describe("event selectors", () => {
        it("computes selector for Transfer event", () => {
            ...
            expect(selector).toBe("0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef");
        });
    ...
    describe("event vs function selectors", () => {
        ...
        it("uses full hash for events", () => {
            ...
            expect(eventSelector.length).toBe(66);
            expect(eventSelector).toBe("0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef");
        });
    ...
    describe("edge cases", () => {
        ...
        it("handles many parameters", () => {
            const selector = getSelector("test(uint256,uint256,uint256,uint256,uint256)");
            expect(selector).toMatch(/^0x[0-9a-f]{8}$/);
        });
