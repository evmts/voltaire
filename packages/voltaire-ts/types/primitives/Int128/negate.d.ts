 ...
 * @returns {import('./Int128Type.js').BrandedInt128} Negated value with wrapping
 * @example
 * ```javascript
 ...
 * ```
 */
export function negate(value: import("./Int128Type.js").BrandedInt128): import("./Int128Type.js").BrandedInt128;
