 ...
 * @returns {import('./Int128Type.js').BrandedInt128} Maximum value
 * @example
 * ```javascript
 ...
 * ```
 */
export function maximum(a: import("./Int128Type.js").BrandedInt128, b: import("./Int128Type.js").BrandedInt128): import("./Int128Type.js").BrandedInt128;
