 ...
 * ```
 */
export function Int128(value: number | bigint | string): BrandedInt128;
...
export type BrandedInt128 = import("./Int128Type.js").BrandedInt128;
...
//# sourceMappingURL=Int128.d.ts.map