...
function hexToBytes(hex, expectedLength) {
    ...
    if (clean.length !== expectedLength * 2) {
        throw new InvalidBuilderBidError(`Expected ${expectedLength} bytes (${expectedLength * 2} hex chars), got ${clean.length / 2} bytes`, { value: hex });
    }
...
export function from(value) {
    ...
    if (value.parentHash instanceof Uint8Array) {
        ...
        throw new InvalidBuilderBidError("parentHash must be Uint8Array or hex string", { value: value.parentHash });
    }
    // Parse blockHash
    let blockHash;
    if (value.blockHash instanceof Uint8Array) {
        ...
        throw new InvalidBuilderBidError("blockHash must be Uint8Array or hex string", { value: value.blockHash });
    }
    ...
    if (value.builderPubkey instanceof Uint8Array) {
        ...
        throw new InvalidBuilderBidError("builderPubkey must be Uint8Array or hex string", { value: value.builderPubkey });
    }
    ...
    if (value.proposerPubkey instanceof Uint8Array) {
        ...
        throw new InvalidBuilderBidError("proposerPubkey must be Uint8Array or hex string", { value: value.proposerPubkey });
    }
    ...
    if (value.proposerFeeRecipient instanceof Uint8Array) {
        if (value.proposerFeeRecipient.length !== 20) {
            throw new InvalidBuilderBidError("proposerFeeRecipient must be 20 bytes", { value: value.proposerFeeRecipient });
        }
        ...
        throw new InvalidBuilderBidError("proposerFeeRecipient must be Uint8Array or hex string", { value: value.proposerFeeRecipient });
    }
    // Parse gasLimit
    ...
    if (value.signature instanceof Uint8Array) {
        ...
        throw new InvalidBuilderBidError("signature must be Uint8Array or hex string", { value: value.signature });
    }
    return {
        slot,
        parentHash,
