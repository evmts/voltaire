...
export function from(value) {
    ...
    if (typeof value === "object" && value !== null) {
        return /** @type {import('./SyncStatusType.js').SyncProgress} */ ({
            startingBlock: 
            /** @type {import('../BlockNumber/BlockNumberType.js').BlockNumberType} */ (BigInt(value.startingBlock)),
            currentBlock: 
            /** @type {import('../BlockNumber/BlockNumberType.js').BlockNumberType} */ (BigInt(value.currentBlock)),
            highestBlock: 
            /** @type {import('../BlockNumber/BlockNumberType.js').BlockNumberType} */ (BigInt(value.highestBlock)),
            pulledStates: value.pulledStates !== undefined
                ? /** @type {import('../Uint/Uint256Type.js').Uint256Type} */ (BigInt(value.pulledStates))
                : undefined,
            knownStates: value.knownStates !== undefined
                ? /** @type {import('../Uint/Uint256Type.js').Uint256Type} */ (BigInt(value.knownStates))
                : undefined,
        });
    }
