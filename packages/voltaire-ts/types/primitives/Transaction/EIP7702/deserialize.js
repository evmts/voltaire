...
import { decodeAccessList, decodeAddress, decodeAuthorizationList, decodeBigint, } from "../utils.js";
/**
...
export function deserialize(data) {
    if (data.length === 0 || data[0] !== Type.EIP7702) {
        throw new DecodingError("Invalid EIP-7702 transaction: missing or wrong type byte", {
            code: -32602,
    ...
    if (fields.length !== 13) {
        throw new DecodingError(`Invalid EIP-7702 transaction: expected 13 fields, got ${fields.length}`, {
            code: -32602,
    ...
    const yParityBytes = /** @type {{ type: "bytes"; value: Uint8Array }} */ (fields[10]).value;
