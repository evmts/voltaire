...
export function deserialize(data) {
    if (data.length === 0 || data[0] !== Type.EIP1559) {
        throw new DecodingError("Invalid EIP-1559 transaction: missing or wrong type byte", {
            code: -32602,
    ...
    if (fields.length !== 12) {
        throw new DecodingError(`Invalid EIP-1559 transaction: expected 12 fields, got ${fields.length}`, {
            code: -32602,
    ...
    const yParityBytes = /** @type {{ type: "bytes"; value: Uint8Array }} */ (fields[9]).value;
