...
export { deserialize, getBlobGasCost, getEffectiveGasPrice, getSender, getSigningHash, hash, serialize, verifySignature, };
/**
...
TransactionEIP4844.deserialize = (bytes) => TransactionEIP4844(deserialize(bytes));
