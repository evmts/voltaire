 ...
 * @returns {(tx: import('./TransactionEIP2930Type.js').TransactionEIP2930Type) => boolean} Function that verifies signature
 *
...
}): (tx: import("./TransactionEIP2930Type.js").TransactionEIP2930Type) => boolean;
