...
import { encodeAccessList, encodeAddress, encodeBigintCompact, } from "../utils.js";
/**
 ...
 * @returns {(tx: import('./TransactionEIP2930Type.js').TransactionEIP2930Type) => Uint8Array} Function that computes signing hash
 *
