 ...
 * @returns {(tx: import('./TransactionEIP2930Type.js').TransactionEIP2930Type) => Uint8Array} Function that computes transaction hash
 *
...
}): (tx: import("./TransactionEIP2930Type.js").TransactionEIP2930Type) => Uint8Array;
