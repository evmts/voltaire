...
export function deserialize(data) {
    if (data.length === 0 || data[0] !== Type.EIP2930) {
        throw new DecodingError("Invalid EIP-2930 transaction: missing or wrong type byte", {
            code: -32602,
    ...
    if (fields.length !== 11) {
        throw new DecodingError(`Invalid EIP-2930 transaction: expected 11 fields, got ${fields.length}`, {
            code: -32602,
    ...
    const dataBytes = /** @type {{ type: "bytes"; value: Uint8Array }} */ (fields[6]).value;
    const accessListField = fields[7];
    if (!accessListField || accessListField.type !== "list") {
        throw new InvalidFormatError("Invalid EIP-2930 transaction: expected list for accessList", {
            code: -32602,
    ...
    const yParityBytes = /** @type {{ type: "bytes"; value: Uint8Array }} */ (fields[8]).value;
