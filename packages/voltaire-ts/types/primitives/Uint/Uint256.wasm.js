...
import { UintInvalidLengthError, UintNegativeError, UintOverflowError, } from "./errors.js";
/**
 ...
 */
export function u256FromBigInt(value) {
    if (value < 0n) {
 ...
 * @throws {UintInvalidLengthError} If value is not 32 bytes
 */
export function u256ToBigInt(value) {
    if (value.length !== 32) {
        throw new UintInvalidLengthError("U256 value must be 32 bytes", {
            value,
            expected: "32 bytes",
