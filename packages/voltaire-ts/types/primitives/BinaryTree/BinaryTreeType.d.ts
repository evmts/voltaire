...
export type InternalNode = Extract<Node, {
    type: "internal";
}>;
export type StemNode = Extract<Node, {
    type: "stem";
}>;
export type LeafNode = Extract<Node, {
    type: "leaf";
}>;
export type EmptyNode = Extract<Node, {
    type: "empty";
}>;
/**
...
//# sourceMappingURL=BinaryTreeType.d.ts.map