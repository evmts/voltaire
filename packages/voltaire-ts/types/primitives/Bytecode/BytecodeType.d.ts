 ...
 */
export type BrandedBytecodeHex = string & {
    readonly [brand]: "BytecodeHex";
};
/**
 * Branded ABI type
 */
export type BrandedAbi = ReadonlyArray<ABIItem> & {
    readonly [brand]: "Abi";
};
/**
 ...
 */
export type TerminatorType = "stop" | "return" | "revert" | "invalid" | "selfdestruct" | "jump" | "jumpi" | "fallthrough";
/**
...
//# sourceMappingURL=BytecodeType.d.ts.map