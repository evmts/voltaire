 ...
 * ```
 */
export function analyzeJumpDestinations(bytecode) {
 ...
 * ```
 */
export function isBytecodeBoundary(bytecode, position) {
 ...
 * ```
 */
export function isValidJumpDest(bytecode, position) {
 ...
 * ```
 */
export function validate(bytecode) {
