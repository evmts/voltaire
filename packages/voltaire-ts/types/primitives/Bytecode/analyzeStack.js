// @ts-nocheck
import { getName } from "../Opcode/getName.js";
import { getStackInput } from "../Opcode/getStackInput.js";
import { getStackOutput } from "../Opcode/getStackOutput.js";
// @ts-nocheck
...
export function analyzeStack(bytecode, options = {}) {
    const { initialDepth = 0, maxDepth = 1024, analyzePaths = false, maxPaths = 100, failFast = false, } = options;
    void maxPaths;
