 ...
 * @returns {(address: import('./AddressType.js').AddressType) => import('./ChecksumAddress.js').Checksummed} Function that converts Address to checksummed hex string
 *
 * @example
 * ```typescript
...
}): (address: import("./AddressType.js").AddressType) => import("./ChecksumAddress.js").Checksummed;
//# sourceMappingURL=toChecksummed.d.ts.map