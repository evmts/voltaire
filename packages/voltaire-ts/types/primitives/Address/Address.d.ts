 ...
 * ```
 */
export function Address(value: number | bigint | string | Uint8Array): import("./AddressClass.js").Address;
export namespace Address {
     ...
     * ```
     */
    function from(value: number | bigint | string | Uint8Array): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromBase64(value: string): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromHex(value: string): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromBytes(value: Uint8Array): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromNumber(value: number | bigint): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromPublicKey(x: bigint, y: bigint): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromPrivateKey(value: Uint8Array): import("./AddressClass.js").Address;
    /**
     ...
     * ```
     */
    function fromAbiEncoded(value: Uint8Array): import("./AddressClass.js").Address;
    let toHex: typeof BrandedAddress.toHex;
    let toChecksummed: (address: import("./AddressType.js").AddressType) => import("./ChecksumAddress.js").Checksummed;
    let toLowercase: typeof BrandedAddress.toLowercase;
    let toUppercase: typeof BrandedAddress.toUppercase;
    let toU256: typeof BrandedAddress.toU256;
    let toAbiEncoded: typeof BrandedAddress.toAbiEncoded;
    let toShortHex: typeof BrandedAddress.toShortHex;
    let isZero: typeof BrandedAddress.isZero;
    let equals: typeof BrandedAddress.equals;
    let isValid: typeof BrandedAddress.isValid;
    let isValidChecksum: (str: string) => boolean;
    let is: typeof BrandedAddress.is;
    /**
     * Returns the zero address (0x0000000000000000000000000000000000000000)
     *
     * @see https://voltaire.tevm.sh/primitives/address for Address documentation
     * @since 0.0.0
     * @returns {import('./AddressType.js').AddressType} Zero address
     ...
     * ```
     */
    function zero(): import("./AddressType.js").AddressType;
    /**
     ...
     * ```
     */
    function of(...items: number[]): import("./AddressType.js").AddressType;
    let compare: typeof BrandedAddress.compare;
    let lessThan: typeof BrandedAddress.lessThan;
    let greaterThan: typeof BrandedAddress.greaterThan;
    /**
     * Calculates the CREATE contract address (keccak256(rlp([sender, nonce]))[12:32])
     *
     * @see https://voltaire.tevm.sh/primitives/address for Address documentation
     * @since 0.0.0
     * @param {import('./AddressType.js').AddressType} address - Deployer address
     ...
     * ```
     */
    function calculateCreateAddress(address: import("./AddressType.js").AddressType, nonce: bigint): import("./AddressType.js").AddressType;
    /**
     ...
     * ```
     */
    function calculateCreate2Address(address: import("./AddressType.js").AddressType, salt: bigint | Uint8Array, initCode: Uint8Array): import("./AddressType.js").AddressType;
    let SIZE: 20;
}
