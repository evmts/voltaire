import { InvalidAddressError, InvalidChecksumError, InvalidValueError, } from "./errors.js";
...
export function assert(value, options = {}) {
    ...
    if (strict && typeof value === "string") {
        ...
        if (hasLower && hasUpper) {
            ...
            if (!keccak256) {
                throw new InvalidValueError("keccak256 required for strict checksum validation of mixed-case addresses", {
                    value,
            ...
            if (inputChecksum !== expectedChecksum) {
                throw new InvalidChecksumError(`Invalid checksum: expected ${expectedChecksum}, got ${inputChecksum}`, { value, expected: expectedChecksum });
            }
        }
    }
    // Convert to bytes
