import { InvalidFormatError, InvalidLengthError, PrimitiveError, ValidationError, } from "../errors/index.js";
/**
...
export class InvalidHexFormatError extends InvalidFormatError {
    ...
    constructor(message, options) {
        super(message || "Invalid hex format for address", {
            ...
            docsPath: options?.docsPath || "/primitives/address/fundamentals#error-handling",
            cause: options?.cause,
        });
...
export class InvalidHexStringError extends InvalidFormatError {
    ...
    constructor(message, options) {
        super(message || "Invalid hex string", {
            code: options?.code ?? -32602,
            value: options?.value,
            expected: options?.expected || "Valid hexadecimal characters (0-9, a-f, A-F)",
            context: options?.context,
            docsPath: options?.docsPath || "/primitives/address/fundamentals#error-handling",
            cause: options?.cause,
        });
...
export class InvalidAbiEncodedPaddingError extends ValidationError {
     ...
     */
    constructor(message, options) {
        super(message || "ABI-encoded address has non-zero padding in first 12 bytes", {
            code: options?.code ?? -32602,
            value: options?.value,
