...
export function fromHex(hex) {
    return loader.addressFromHex(hex);
}
/**
...
export function calculateCreateAddress(sender, nonce) {
    return loader.calculateCreateAddress(sender, Number(nonce));
}
/**
...
export function calculateCreate2Address(sender, salt, initCode) {
    return loader.calculateCreate2Address(sender, salt, initCode);
}
/**
 ...
 * ```
 */
export function fromAbiEncoded(encoded) {
 ...
 * ```
 */
export function toShortHex(address, sliceLength = 4) {
    const hex = loader.addressToHex(address);
