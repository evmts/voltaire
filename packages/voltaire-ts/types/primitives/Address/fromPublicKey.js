    ...
    return function fromPublicKey(xOrPublicKey, y) {
        ...
        if (xOrPublicKey instanceof Uint8Array) {
            if (xOrPublicKey.length !== 64) {
                throw new InvalidAddressLengthError(`Invalid public key length: expected 64 bytes, got ${xOrPublicKey.length}`, {
            ...
            if (typeof y !== "bigint") {
                throw new InvalidValueError("When x is bigint, y coordinate must also be provided as bigint", {
                    value: typeof y,
                    expected: "bigint",
                    code: -32602,
                });
        ...
        return /** @type {import('./AddressType.js').AddressType} */ (hash.slice(12));
    };
}
