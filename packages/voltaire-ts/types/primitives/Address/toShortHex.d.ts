 ...
 * ```
 */
export function toShortHex(address: import("./AddressType.js").AddressType, prefixLength?: number, suffixLength?: number): string;
//# sourceMappingURL=toShortHex.d.ts.map