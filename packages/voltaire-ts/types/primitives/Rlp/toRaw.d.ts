 ...
 * @since 0.0.0
 * @param {import('./RlpType.js').BrandedRlp} data - RLP data structure to convert
 ...
 * ```
 */
export function toRaw(data: import("./RlpType.js").BrandedRlp): Uint8Array | any[];
//# sourceMappingURL=toRaw.d.ts.map