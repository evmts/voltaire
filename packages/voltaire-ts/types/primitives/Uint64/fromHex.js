...
import { Uint64InvalidHexError, Uint64NegativeError, Uint64OverflowError, } from "./errors.js";
/**
...
export function fromHex(hex) {
    if (typeof hex !== "string") {
        throw new Uint64InvalidHexError(`Uint64.fromHex requires string, got ${typeof hex}`, { value: hex });
    }
