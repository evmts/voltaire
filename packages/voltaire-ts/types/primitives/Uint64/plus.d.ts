 ...
 * @returns {import('./Uint64Type.js').Uint64Type} Sum (uint + b) mod 2^64
 * @throws {never}
 * @example
 * ```javascript
 ...
 * ```
 */
export function plus(uint: import("./Uint64Type.js").Uint64Type, b: import("./Uint64Type.js").Uint64Type): import("./Uint64Type.js").Uint64Type;
