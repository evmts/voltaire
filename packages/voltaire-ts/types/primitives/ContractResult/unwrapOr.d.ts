 ...
 * ```
 */
export function unwrapOr(result: import("./ContractResultType.js").ContractResultType, defaultValue: import("../ReturnData/ReturnDataType.js").ReturnDataType): import("../ReturnData/ReturnDataType.js").ReturnDataType;
