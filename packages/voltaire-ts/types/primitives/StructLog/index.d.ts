 ...
 * ```
 */
export declare function from(data: Omit<StructLogType, typeof import("../../brand.js").brand>): StructLogType;
/**
 ...
 * ```
 */
export declare function toOpStep(log: StructLogType): OpStepType;
