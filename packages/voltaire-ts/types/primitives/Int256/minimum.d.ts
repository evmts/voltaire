 ...
 * @returns {import('./Int256Type.js').BrandedInt256} Minimum value
 * @example
 * ```javascript
 ...
 * ```
 */
export function minimum(a: import("./Int256Type.js").BrandedInt256, b: import("./Int256Type.js").BrandedInt256): import("./Int256Type.js").BrandedInt256;
