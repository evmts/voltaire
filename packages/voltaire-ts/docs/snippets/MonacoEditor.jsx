	...
	useEffect(() => {
		...
		function setupCodeExecution(editor, runButton, clearButton, consoleOutput) {
			...
			function clearConsole() {
				consoleOutput.innerHTML =
					'<div style="color: #666; font-style: italic;">Console output will appear here...</div>';
			}
		...
		async function initMonaco() {
			...
			try {
				...
				const editorContainer =
					mountRef.current.querySelector("#editor-container");
        ...
        `;
				...
				const clearButton = mountRef.current.querySelector(
				...
				if (editorContainer) {
					editorContainer.innerHTML =
						'<div style="padding: 2rem; text-align: center; color: #999;">Failed to load editor</div>';
				}
			}
		}
