...
| `UnsafeIntegerError` | `UnsafeIntegerError` | `HEX_UNSAFE_INTEGER` | Exceeds MAX_SAFE_INTEGER |
...
- [Hex (Effect)](https://voltaire-effect.tevm.sh/primitives/hex) - Effect.ts integration with Schema validation
