...
<Info>
Source: [kzg_trusted_setup.zig](https://github.com/evmts/voltaire/blob/main/src/crypto/kzg_trusted_setup.zig) • [c_kzg.zig](https://github.com/evmts/voltaire/blob/main/src/crypto/c_kzg.zig)
