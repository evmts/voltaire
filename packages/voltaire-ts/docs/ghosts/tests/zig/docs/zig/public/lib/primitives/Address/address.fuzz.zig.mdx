---
title: '[Zig] docs/zig/public/lib/primitives/Address/address.fuzz.zig'
source: 'docs/zig/public/lib/primitives/Address/address.fuzz.zig'
---

> Auto-generated from Zig tests in: docs/zig/public/lib/primitives/Address/address.fuzz.zig

### fuzz fromHex parsing
...
### fuzz toU256 and fromU256 roundtrip
...
### fuzz isValidChecksum validation
...
### fuzz toUppercase and toLowercase
...
### fuzz toAbiEncoded and fromAbiEncoded roundtrip
...
### fuzz fromAbiEncoded invalid lengths
...
### fuzz areAddressesEqual string comparison
...
### fuzz calculateCreateAddress determinism
...
### fuzz calculateCreateAddress nonce variations
...
### fuzz calculateCreate2Address determinism
...
### fuzz calculateCreate2Address with getCreate2Address
...
### fuzz fromPublicKey consistency
...
### fuzz formatWithCase consistency
...
### fuzz address comparison transitivity
...
### fuzz hex string case insensitivity
