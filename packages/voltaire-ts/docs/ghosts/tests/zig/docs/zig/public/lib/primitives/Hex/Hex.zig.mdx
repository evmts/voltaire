---
title: '[Zig] docs/zig/public/lib/primitives/Hex/Hex.zig'
source: 'docs/zig/public/lib/primitives/Hex/Hex.zig'
---

> Auto-generated from Zig tests in: docs/zig/public/lib/primitives/Hex/Hex.zig
