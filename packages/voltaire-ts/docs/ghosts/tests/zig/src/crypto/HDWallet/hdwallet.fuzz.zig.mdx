---
title: '[Zig] src/crypto/HDWallet/hdwallet.fuzz.zig'
source: 'src/crypto/HDWallet/hdwallet.fuzz.zig'
---

> Auto-generated from Zig tests in: src/crypto/HDWallet/hdwallet.fuzz.zig

### fuzz seed entropy patterns
...
### fuzz seed with specific byte patterns
...
### fuzz hardened bit manipulation
...
### fuzz mnemonic with special characters
...
### fuzz mnemonic buffer boundaries
...
### fuzz extended key with invalid base58
...
### fuzz key extraction from invalid wallet
...
### fuzz public key derivation from invalid private key
...
### fuzz rapid allocation and deallocation
...
### fuzz parent-child relationship
...
### fuzz hardened vs normal derivation
