---
title: '[Zig] src/crypto/secp256k1.fuzz.zig'
source: 'src/crypto/secp256k1.fuzz.zig'
---

> Auto-generated from Zig tests in: src/crypto/secp256k1.fuzz.zig
...
### fuzz signature validation edge cases
...
### fuzz recover pubkey with random inputs
...
### fuzz recover pubkey with invalid lengths
...
### fuzz recover pubkey with malformed v values
...
### fuzz recover address with invalid recovery id
...
### fuzz point addition never panics
...
### fuzz point doubling never panics
...
### fuzz point negation never panics
...
### fuzz scalar multiplication never panics
...
### fuzz signature roundtrip property
...
### fuzz address recovery consistency
