---
title: '[Zig] src/crypto/c_kzg.zig'
source: 'src/crypto/c_kzg.zig'
---

> Auto-generated from Zig tests in: src/crypto/c_kzg.zig

### c_kzg constants are defined correctly
...
### c_kzg error handling - file not found
...
### c_kzg error handling - operations without trusted setup
...
### c_kzg blob to commitment - deterministic
...
### c_kzg compute proof - deterministic
...
### c_kzg verify proof - valid proof
...
### c_kzg verify proof - invalid proof
...
### c_kzg verify proof - wrong commitment
...
### c_kzg verify proof - wrong y value
...
### c_kzg integration - full workflow
...
### c_kzg edge case - zero evaluation point
...
### c_kzg multiple blobs with same trusted setup
...
### c_kzg proof consistency across multiple calls
