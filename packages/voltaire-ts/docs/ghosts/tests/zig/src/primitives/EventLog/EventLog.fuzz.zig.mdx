---
title: '[Zig] src/primitives/EventLog/EventLog.fuzz.zig'
source: 'src/primitives/EventLog/EventLog.fuzz.zig'
---

> Auto-generated from Zig tests in: src/primitives/EventLog/EventLog.fuzz.zig

### fuzz parseEventLog arbitrary topics
...
### fuzz parseEventLog indexed parameters
...
### fuzz parseEventLog malformed data
...
### fuzz parseEventLog missing topics
...
### fuzz parseEventLog anonymous event
...
### fuzz parseEventLog mixed parameters
...
### fuzz parseEventLog dynamic indexed types
...
### fuzz parseEventLog address extraction
...
### fuzz parseEventLog uint256 topics
...
### fuzz filterLogsByTopics arbitrary filters
...
### fuzz filterLogsByTopics multiple logs
...
### fuzz filterLogsByTopics null wildcard
...
### fuzz EventLog large data field
...
### fuzz parseEventLog encoding roundtrip
...
### fuzz parseEventLog malformed address topic
...
### fuzz EventLog complete metadata
...
### fuzz parseEventLog determinism
