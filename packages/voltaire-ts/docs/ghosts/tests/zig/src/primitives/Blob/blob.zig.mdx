...
### fakeExponential never returns zero (minimum is 1)
...
### fakeExponential with zero factor returns minimum 1
...
### calculateBlobGasPrice never returns zero
...
### fakeExponential handles large values without overflow
