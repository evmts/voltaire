---
title: '[Zig] src/primitives/EventLog/logs.zig'
source: 'src/primitives/EventLog/logs.zig'
---

> Auto-generated from Zig tests in: src/primitives/EventLog/logs.zig

### Log creation and field access
...
### Log with empty topics and data
