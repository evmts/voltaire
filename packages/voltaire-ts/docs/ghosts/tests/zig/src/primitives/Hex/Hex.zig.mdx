---
title: '[Zig] src/primitives/Hex/Hex.zig'
source: 'src/primitives/Hex/Hex.zig'
---

> Auto-generated from Zig tests in: src/primitives/Hex/Hex.zig
...
### trimLeftZeros with all zeros preserves one byte
...
### trimLeftZeros with single zero preserves it
...
### trimLeftZeros with empty slice returns empty
