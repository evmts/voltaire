---
title: '[Zig] src/primitives/Uint/numeric.fuzz.zig'
source: 'src/primitives/Uint/numeric.fuzz.zig'
---

> Auto-generated from Zig tests in: src/primitives/Uint/numeric.fuzz.zig
...
### fuzz parseUnits decimal precision
...
### fuzz parseUnits with leading decimal
...
### fuzz parseUnits whitespace handling
...
### fuzz parseUnits multiple decimals
...
### fuzz formatUnits custom decimals
...
### fuzz convertUnits precision loss
...
### fuzz Unit toMultiplier consistency
...
### fuzz parse format roundtrip ether
...
### fuzz parse format roundtrip gwei
...
### fuzz parseUnits formatUnits roundtrip
...
### fuzz formatUnits extreme values
...
### fuzz parseUnits invalid formats
...
### fuzz parseUnits special characters
