...
### Proof.verifyWithDepth - validates proof length matches expected depth
...
### Proof.verifyWithDepth - accepts empty proof with depth 0
...
### Proof.verifyWithDepth - four-leaf tree requires depth 2
