---
title: '[Zig] src/evm/precompiles/bn254_mul.zig'
source: 'src/evm/precompiles/bn254_mul.zig'
---

> Auto-generated from Zig tests in: src/evm/precompiles/bn254_mul.zig
...
### bn254Mul - input too long padded correctly
...
### bn254Mul - output size validation
...
### bn254Mul - geth cdetrio1 empty input
...
### bn254Mul - geth cdetrio2 zero scalar
...
### bn254Mul - geth cdetrio3 scalar 1
...
### bn254Mul - geth cdetrio4 scalar 2
...
### bn254Mul - geth cdetrio5 invalid point not on curve
...
### bn254Mul - geth cdetrio6 generator multiply by group order
...
### bn254Mul - geth cdetrio7 large scalar
...
### bn254Mul - geth cdetrio8 large x coordinate multiplication
...
### bn254Mul - geth cdetrio9 multiply by field order
...
### bn254Mul - geth cdetrio10 invalid coordinate at field modulus
...
### bn254Mul - geth cdetrio11 invalid coordinate exceeds field modulus
...
### bn254Mul - geth cdetrio12 partial input zero padded
...
### bn254Mul - geth cdetrio13 truncated valid point
...
### bn254Mul - geth cdetrio14 scalar between group and field order
...
### bn254Mul - geth cdetrio15 explicit zero scalar from geth
