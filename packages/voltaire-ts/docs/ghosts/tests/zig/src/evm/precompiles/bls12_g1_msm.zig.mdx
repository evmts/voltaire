---
title: '[Zig] src/evm/precompiles/bls12_g1_msm.zig'
source: 'src/evm/precompiles/bls12_g1_msm.zig'
---

> Auto-generated from Zig tests in: src/evm/precompiles/bls12_g1_msm.zig

### bls12_g1_msm - gas cost with one pair
...
### bls12_g1_msm - gas cost with two pairs
...
### bls12_g1_msm - gas cost with four pairs
...
### bls12_g1_msm - gas cost with eight pairs
...
### bls12_g1_msm - gas cost with sixteen pairs
...
### bls12_g1_msm - gas cost with thirty-two pairs
...
### bls12_g1_msm - gas cost with sixty-four pairs
...
### bls12_g1_msm - gas cost with one hundred twenty-eight pairs
...
### bls12_g1_msm - discount calculation validation
...
### bls12_g1_msm - empty input error
...
### bls12_g1_msm - invalid input length not multiple of 160
...
### bls12_g1_msm - single point times scalar
...
### bls12_g1_msm - multiple points all at infinity
...
### bls12_g1_msm - multiple points with zero scalars
...
### bls12_g1_msm - invalid point not on curve
...
### bls12_g1_msm - output size validation
...
### bls12_g1_msm - gas discount effect
