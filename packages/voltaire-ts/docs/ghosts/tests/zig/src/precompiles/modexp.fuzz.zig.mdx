---
title: '[Zig] src/precompiles/modexp.fuzz.zig'
source: 'src/precompiles/modexp.fuzz.zig'
---

> Auto-generated from Zig tests in: src/precompiles/modexp.fuzz.zig

### fuzz modexp with arbitrary inputs
...
### fuzz modexp malformed length encoding
...
### fuzz modexp zero modulus handling
...
### fuzz modexp huge exponent DoS resistance
...
### fuzz modexp with truncated data
...
### fuzz modexp output buffer sizing
...
### fuzz modexp hardfork gas consistency
...
### fuzz modexp edge case: input exactly 96 bytes
...
### fuzz modexp mathematical properties
...
### fuzz modexp gas limit exhaustion
...
### fuzz modexp large value handling
...
### fuzz modexp memory allocation limits
