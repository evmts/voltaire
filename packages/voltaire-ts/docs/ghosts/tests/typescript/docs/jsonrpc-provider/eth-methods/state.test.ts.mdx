---
title: '[TS/JS] docs/jsonrpc-provider/eth-methods/state.test.ts'
source: 'docs/jsonrpc-provider/eth-methods/state.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/eth-methods/state.test.ts
