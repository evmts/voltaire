---
title: '[TS/JS] docs/jsonrpc-provider/eth-methods/blocks.test.ts'
source: 'docs/jsonrpc-provider/eth-methods/blocks.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/eth-methods/blocks.test.ts
