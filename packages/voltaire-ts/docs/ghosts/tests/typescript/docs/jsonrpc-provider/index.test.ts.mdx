---
title: '[TS/JS] docs/jsonrpc-provider/index.test.ts'
source: 'docs/jsonrpc-provider/index.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/index.test.ts
