---
title: '[TS/JS] docs/jsonrpc-provider/wallet-methods.test.ts'
source: 'docs/jsonrpc-provider/wallet-methods.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/wallet-methods.test.ts
