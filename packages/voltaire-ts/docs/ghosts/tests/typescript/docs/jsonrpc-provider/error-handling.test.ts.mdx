---
title: '[TS/JS] docs/jsonrpc-provider/error-handling.test.ts'
source: 'docs/jsonrpc-provider/error-handling.test.ts'
---

> Auto-generated from test file: docs/jsonrpc-provider/error-handling.test.ts
