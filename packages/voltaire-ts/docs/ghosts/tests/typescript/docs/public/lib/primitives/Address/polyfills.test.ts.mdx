---
title: '[TS/JS] docs/public/lib/primitives/Address/polyfills.test.ts'
source: 'docs/public/lib/primitives/Address/polyfills.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/polyfills.test.ts
