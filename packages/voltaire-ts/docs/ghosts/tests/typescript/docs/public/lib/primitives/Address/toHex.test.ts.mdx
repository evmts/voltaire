---
title: '[TS/JS] docs/public/lib/primitives/Address/toHex.test.ts'
source: 'docs/public/lib/primitives/Address/toHex.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/toHex.test.ts
