---
title: '[TS/JS] docs/public/lib/primitives/Hex/validate.test.ts'
source: 'docs/public/lib/primitives/Hex/validate.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/validate.test.ts
