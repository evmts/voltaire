---
title: '[TS/JS] docs/public/lib/primitives/Address/calculateCreateAddress.test.ts'
source: 'docs/public/lib/primitives/Address/calculateCreateAddress.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Address/calculateCreateAddress.test.ts
