---
title: '[TS/JS] docs/public/lib/primitives/Hex/zero.test.ts'
source: 'docs/public/lib/primitives/Hex/zero.test.ts'
---

> Auto-generated from test file: docs/public/lib/primitives/Hex/zero.test.ts
