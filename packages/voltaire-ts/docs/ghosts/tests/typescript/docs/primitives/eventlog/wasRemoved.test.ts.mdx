---
title: '[TS/JS] docs/primitives/eventlog/wasRemoved.test.ts'
source: 'docs/primitives/eventlog/wasRemoved.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/wasRemoved.test.ts
