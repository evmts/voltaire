---
title: '[TS/JS] docs/primitives/eventlog/getTopic0.test.ts'
source: 'docs/primitives/eventlog/getTopic0.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/getTopic0.test.ts
