---
title: '[TS/JS] docs/primitives/bytecode/getNextPc.test.ts'
source: 'docs/primitives/bytecode/getNextPc.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/getNextPc.test.ts
