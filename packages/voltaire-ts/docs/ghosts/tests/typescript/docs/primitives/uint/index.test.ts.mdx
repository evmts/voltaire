---
title: '[TS/JS] docs/primitives/uint/index.test.ts'
source: 'docs/primitives/uint/index.test.ts'
---

> Auto-generated from test file: docs/primitives/uint/index.test.ts
