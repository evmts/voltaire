---
title: '[TS/JS] docs/primitives/bytecode/formatInstruction.test.ts'
source: 'docs/primitives/bytecode/formatInstruction.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/formatInstruction.test.ts
