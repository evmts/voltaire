---
title: '[TS/JS] docs/primitives/bytecode/index.test.ts'
source: 'docs/primitives/bytecode/index.test.ts'
---

> Auto-generated from test file: docs/primitives/bytecode/index.test.ts
