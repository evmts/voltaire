---
title: '[TS/JS] docs/primitives/eventlog/index.test.ts'
source: 'docs/primitives/eventlog/index.test.ts'
---

> Auto-generated from test file: docs/primitives/eventlog/index.test.ts
