---
title: '[TS/JS] docs/crypto/kzg/trusted-setup.test.ts'
source: 'docs/crypto/kzg/trusted-setup.test.ts'
---

> Auto-generated from test file: docs/crypto/kzg/trusted-setup.test.ts
