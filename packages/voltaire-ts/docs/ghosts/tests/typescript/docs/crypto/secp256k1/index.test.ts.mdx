---
title: '[TS/JS] docs/crypto/secp256k1/index.test.ts'
source: 'docs/crypto/secp256k1/index.test.ts'
---

> Auto-generated from test file: docs/crypto/secp256k1/index.test.ts
