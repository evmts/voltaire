---
title: '[TS/JS] docs/getting-started/llm-optimized.test.ts'
source: 'docs/getting-started/llm-optimized.test.ts'
---

> Auto-generated from test file: docs/getting-started/llm-optimized.test.ts
