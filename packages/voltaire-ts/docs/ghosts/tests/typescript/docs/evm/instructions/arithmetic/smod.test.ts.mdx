---
title: '[TS/JS] docs/evm/instructions/arithmetic/smod.test.ts'
source: 'docs/evm/instructions/arithmetic/smod.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/arithmetic/smod.test.ts
