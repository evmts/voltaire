---
title: '[TS/JS] docs/evm/instructions/arithmetic/mul.test.ts'
source: 'docs/evm/instructions/arithmetic/mul.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/arithmetic/mul.test.ts
