---
title: '[TS/JS] docs/evm/precompiles/index.test.ts'
source: 'docs/evm/precompiles/index.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/index.test.ts
