---
title: '[TS/JS] docs/evm/instructions/bitwise/xor.test.ts'
source: 'docs/evm/instructions/bitwise/xor.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/bitwise/xor.test.ts
