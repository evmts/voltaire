---
title: '[TS/JS] docs/evm/instructions/arithmetic/add.test.ts'
source: 'docs/evm/instructions/arithmetic/add.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/arithmetic/add.test.ts
