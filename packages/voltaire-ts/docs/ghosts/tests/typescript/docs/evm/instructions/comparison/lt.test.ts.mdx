---
title: '[TS/JS] docs/evm/instructions/comparison/lt.test.ts'
source: 'docs/evm/instructions/comparison/lt.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/comparison/lt.test.ts
