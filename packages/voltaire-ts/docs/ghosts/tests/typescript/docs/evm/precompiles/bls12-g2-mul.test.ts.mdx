---
title: '[TS/JS] docs/evm/precompiles/bls12-g2-mul.test.ts'
source: 'docs/evm/precompiles/bls12-g2-mul.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/bls12-g2-mul.test.ts
