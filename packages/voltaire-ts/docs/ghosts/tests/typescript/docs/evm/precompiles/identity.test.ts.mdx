---
title: '[TS/JS] docs/evm/precompiles/identity.test.ts'
source: 'docs/evm/precompiles/identity.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/identity.test.ts
