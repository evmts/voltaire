---
title: '[TS/JS] docs/evm/instructions/bitwise/or.test.ts'
source: 'docs/evm/instructions/bitwise/or.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/bitwise/or.test.ts
