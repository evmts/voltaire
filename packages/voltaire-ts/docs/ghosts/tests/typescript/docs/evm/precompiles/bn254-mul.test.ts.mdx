---
title: '[TS/JS] docs/evm/precompiles/bn254-mul.test.ts'
source: 'docs/evm/precompiles/bn254-mul.test.ts'
---

> Auto-generated from test file: docs/evm/precompiles/bn254-mul.test.ts
