---
title: '[TS/JS] docs/evm/instructions/comparison/gt.test.ts'
source: 'docs/evm/instructions/comparison/gt.test.ts'
---

> Auto-generated from test file: docs/evm/instructions/comparison/gt.test.ts
