---
title: '[TS/JS] voltaire-effect/src/services/Provider/ens/ens.test.ts'
source: 'voltaire-effect/src/services/Provider/ens/ens.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Provider/ens/ens.test.ts
