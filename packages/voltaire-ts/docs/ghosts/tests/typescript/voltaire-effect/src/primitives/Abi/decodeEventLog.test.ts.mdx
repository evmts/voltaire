---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/decodeEventLog.test.ts'
source: 'voltaire-effect/src/primitives/Abi/decodeEventLog.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/decodeEventLog.test.ts
