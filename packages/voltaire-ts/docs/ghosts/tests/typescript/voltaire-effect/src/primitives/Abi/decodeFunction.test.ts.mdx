---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/decodeFunction.test.ts'
source: 'voltaire-effect/src/primitives/Abi/decodeFunction.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/decodeFunction.test.ts
