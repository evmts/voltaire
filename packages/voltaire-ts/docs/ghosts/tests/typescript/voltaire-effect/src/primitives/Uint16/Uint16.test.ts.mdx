---
title: '[TS/JS] voltaire-effect/src/primitives/Uint16/Uint16.test.ts'
source: 'voltaire-effect/src/primitives/Uint16/Uint16.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Uint16/Uint16.test.ts
