---
title: '[TS/JS] voltaire-effect/src/services/TransactionSerializer/TransactionSerializer.test.ts'
source: 'voltaire-effect/src/services/TransactionSerializer/TransactionSerializer.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/TransactionSerializer/TransactionSerializer.test.ts
