---
title: '[TS/JS] voltaire-effect/src/services/Ccip/Ccip.test.ts'
source: 'voltaire-effect/src/services/Ccip/Ccip.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Ccip/Ccip.test.ts
