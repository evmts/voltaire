---
title: '[TS/JS] voltaire-effect/src/services/RateLimiter/RateLimiter.test.ts'
source: 'voltaire-effect/src/services/RateLimiter/RateLimiter.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/RateLimiter/RateLimiter.test.ts
