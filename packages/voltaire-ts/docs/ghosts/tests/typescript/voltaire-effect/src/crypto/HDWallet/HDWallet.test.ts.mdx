---
title: '[TS/JS] voltaire-effect/src/crypto/HDWallet/HDWallet.test.ts'
source: 'voltaire-effect/src/crypto/HDWallet/HDWallet.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/crypto/HDWallet/HDWallet.test.ts
