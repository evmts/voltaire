---
title: '[TS/JS] voltaire-effect/src/services/Signer/actions/requestPermissions.test.ts'
source: 'voltaire-effect/src/services/Signer/actions/requestPermissions.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Signer/actions/requestPermissions.test.ts
