---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/format.test.ts'
source: 'voltaire-effect/src/primitives/Abi/format.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/format.test.ts
