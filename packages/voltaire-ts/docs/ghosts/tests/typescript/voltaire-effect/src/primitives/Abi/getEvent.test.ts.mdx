---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/getEvent.test.ts'
source: 'voltaire-effect/src/primitives/Abi/getEvent.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/getEvent.test.ts
