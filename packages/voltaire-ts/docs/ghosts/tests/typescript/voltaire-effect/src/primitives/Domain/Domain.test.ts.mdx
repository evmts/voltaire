---
title: '[TS/JS] voltaire-effect/src/primitives/Domain/Domain.test.ts'
source: 'voltaire-effect/src/primitives/Domain/Domain.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Domain/Domain.test.ts
