---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/getFunctionSignature.test.ts'
source: 'voltaire-effect/src/primitives/Abi/getFunctionSignature.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/getFunctionSignature.test.ts
