---
title: '[TS/JS] voltaire-effect/src/primitives/Permit/Permit.test.ts'
source: 'voltaire-effect/src/primitives/Permit/Permit.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Permit/Permit.test.ts
