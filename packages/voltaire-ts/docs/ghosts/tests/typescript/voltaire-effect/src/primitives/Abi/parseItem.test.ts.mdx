---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/parseItem.test.ts'
source: 'voltaire-effect/src/primitives/Abi/parseItem.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/parseItem.test.ts
