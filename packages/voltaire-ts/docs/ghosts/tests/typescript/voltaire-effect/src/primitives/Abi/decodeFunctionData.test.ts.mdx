---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/decodeFunctionData.test.ts'
source: 'voltaire-effect/src/primitives/Abi/decodeFunctionData.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/decodeFunctionData.test.ts
