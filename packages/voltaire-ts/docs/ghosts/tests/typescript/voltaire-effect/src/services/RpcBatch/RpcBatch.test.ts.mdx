---
title: '[TS/JS] voltaire-effect/src/services/RpcBatch/RpcBatch.test.ts'
source: 'voltaire-effect/src/services/RpcBatch/RpcBatch.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/RpcBatch/RpcBatch.test.ts
