---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/parse.test.ts'
source: 'voltaire-effect/src/primitives/Abi/parse.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/parse.test.ts
