---
title: '[TS/JS] voltaire-effect/src/primitives/InitCode/InitCode.test.ts'
source: 'voltaire-effect/src/primitives/InitCode/InitCode.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/InitCode/InitCode.test.ts
