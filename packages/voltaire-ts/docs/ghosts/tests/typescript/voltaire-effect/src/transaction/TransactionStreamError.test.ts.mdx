---
title: '[TS/JS] voltaire-effect/src/transaction/TransactionStreamError.test.ts'
source: 'voltaire-effect/src/transaction/TransactionStreamError.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/transaction/TransactionStreamError.test.ts
