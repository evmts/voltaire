---
title: '[TS/JS] voltaire-effect/src/primitives/CallData/CallData.test.ts'
source: 'voltaire-effect/src/primitives/CallData/CallData.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/CallData/CallData.test.ts
