---
title: '[TS/JS] voltaire-effect/src/primitives/ContractCode/ContractCode.test.ts'
source: 'voltaire-effect/src/primitives/ContractCode/ContractCode.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/ContractCode/ContractCode.test.ts
