---
title: '[TS/JS] voltaire-effect/src/services/Transport/HttpTransportConfig.test.ts'
source: 'voltaire-effect/src/services/Transport/HttpTransportConfig.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Transport/HttpTransportConfig.test.ts
