---
title: '[TS/JS] voltaire-effect/src/services/Account/toAccount.test.ts'
source: 'voltaire-effect/src/services/Account/toAccount.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Account/toAccount.test.ts
