---
title: '[TS/JS] voltaire-effect/src/primitives/BlockBody/BlockBody.test.ts'
source: 'voltaire-effect/src/primitives/BlockBody/BlockBody.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/BlockBody/BlockBody.test.ts
