---
title: '[TS/JS] voltaire-effect/src/primitives/Base64/Base64.test.ts'
source: 'voltaire-effect/src/primitives/Base64/Base64.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Base64/Base64.test.ts
