---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/encodeError.test.ts'
source: 'voltaire-effect/src/primitives/Abi/encodeError.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/encodeError.test.ts
