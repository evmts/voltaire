---
title: '[TS/JS] voltaire-effect/src/jsonrpc/errors.test.ts'
source: 'voltaire-effect/src/jsonrpc/errors.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/jsonrpc/errors.test.ts
