---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/encodeFunction.test.ts'
source: 'voltaire-effect/src/primitives/Abi/encodeFunction.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/encodeFunction.test.ts
