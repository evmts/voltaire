---
title: '[TS/JS] voltaire-effect/src/primitives/TypedData/TypedData.test.ts'
source: 'voltaire-effect/src/primitives/TypedData/TypedData.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/TypedData/TypedData.test.ts
