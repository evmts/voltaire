---
title: '[TS/JS] voltaire-effect/src/primitives/RevertReason/RevertReason.test.ts'
source: 'voltaire-effect/src/primitives/RevertReason/RevertReason.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/RevertReason/RevertReason.test.ts
