---
title: '[TS/JS] voltaire-effect/src/contract/EventStream.test.ts'
source: 'voltaire-effect/src/contract/EventStream.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/contract/EventStream.test.ts
