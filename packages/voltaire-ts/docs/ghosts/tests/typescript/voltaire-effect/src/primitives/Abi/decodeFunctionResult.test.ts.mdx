---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/decodeFunctionResult.test.ts'
source: 'voltaire-effect/src/primitives/Abi/decodeFunctionResult.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/decodeFunctionResult.test.ts
