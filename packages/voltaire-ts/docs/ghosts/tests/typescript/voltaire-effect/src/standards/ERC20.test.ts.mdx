---
title: '[TS/JS] voltaire-effect/src/standards/ERC20.test.ts'
source: 'voltaire-effect/src/standards/ERC20.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/standards/ERC20.test.ts
