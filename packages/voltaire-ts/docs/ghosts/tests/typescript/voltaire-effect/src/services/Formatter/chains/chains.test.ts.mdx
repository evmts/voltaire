---
title: '[TS/JS] voltaire-effect/src/services/Formatter/chains/chains.test.ts'
source: 'voltaire-effect/src/services/Formatter/chains/chains.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Formatter/chains/chains.test.ts
