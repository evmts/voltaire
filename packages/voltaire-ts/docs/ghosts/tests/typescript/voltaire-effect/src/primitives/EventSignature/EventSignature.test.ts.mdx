---
title: '[TS/JS] voltaire-effect/src/primitives/EventSignature/EventSignature.test.ts'
source: 'voltaire-effect/src/primitives/EventSignature/EventSignature.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/EventSignature/EventSignature.test.ts
