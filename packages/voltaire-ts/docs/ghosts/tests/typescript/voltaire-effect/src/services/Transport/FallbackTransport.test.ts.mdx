---
title: '[TS/JS] voltaire-effect/src/services/Transport/FallbackTransport.test.ts'
source: 'voltaire-effect/src/services/Transport/FallbackTransport.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Transport/FallbackTransport.test.ts
