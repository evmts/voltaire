---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/findEvent.test.ts'
source: 'voltaire-effect/src/primitives/Abi/findEvent.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/findEvent.test.ts
