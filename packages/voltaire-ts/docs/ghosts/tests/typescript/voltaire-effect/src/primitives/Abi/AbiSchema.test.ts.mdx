---
title: '[TS/JS] voltaire-effect/src/primitives/Abi/AbiSchema.test.ts'
source: 'voltaire-effect/src/primitives/Abi/AbiSchema.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/primitives/Abi/AbiSchema.test.ts
