---
title: '[TS/JS] voltaire-effect/src/services/Account/fromMnemonic.test.ts'
source: 'voltaire-effect/src/services/Account/fromMnemonic.test.ts'
---

> Auto-generated from test file: voltaire-effect/src/services/Account/fromMnemonic.test.ts
