---
title: '[TS/JS] examples/viem-publicclient/PublicClient.test.ts'
source: 'examples/viem-publicclient/PublicClient.test.ts'
---

> Auto-generated from test file: examples/viem-publicclient/PublicClient.test.ts
