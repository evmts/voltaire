---
title: '[TS/JS] examples/primitives/denomination/examples.test.ts'
source: 'examples/primitives/denomination/examples.test.ts'
---

> Auto-generated from test file: examples/primitives/denomination/examples.test.ts
