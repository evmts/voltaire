---
title: '[TS/JS] examples/primitives/hex/examples.test.ts'
source: 'examples/primitives/hex/examples.test.ts'
---

> Auto-generated from test file: examples/primitives/hex/examples.test.ts
