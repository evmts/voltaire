---
title: '[TS/JS] examples/primitives/bytecode/examples.test.ts'
source: 'examples/primitives/bytecode/examples.test.ts'
---

> Auto-generated from test file: examples/primitives/bytecode/examples.test.ts
