---
title: '[TS/JS] examples/viem-account/Account.test.ts'
source: 'examples/viem-account/Account.test.ts'
---

> Auto-generated from test file: examples/viem-account/Account.test.ts
