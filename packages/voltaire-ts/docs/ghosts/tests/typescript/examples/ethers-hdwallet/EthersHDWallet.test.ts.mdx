---
title: '[TS/JS] examples/ethers-hdwallet/EthersHDWallet.test.ts'
source: 'examples/ethers-hdwallet/EthersHDWallet.test.ts'
---

> Auto-generated from test file: examples/ethers-hdwallet/EthersHDWallet.test.ts
