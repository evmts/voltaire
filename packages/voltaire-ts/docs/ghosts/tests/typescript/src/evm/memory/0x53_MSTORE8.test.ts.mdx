---
title: '[TS/JS] src/evm/memory/0x53_MSTORE8.test.ts'
source: 'src/evm/memory/0x53_MSTORE8.test.ts'
---

> Auto-generated from test file: src/evm/memory/0x53_MSTORE8.test.ts
