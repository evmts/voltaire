---
title: '[TS/JS] src/evm/comparison/0x13_SGT.test.ts'
source: 'src/evm/comparison/0x13_SGT.test.ts'
---

> Auto-generated from test file: src/evm/comparison/0x13_SGT.test.ts
