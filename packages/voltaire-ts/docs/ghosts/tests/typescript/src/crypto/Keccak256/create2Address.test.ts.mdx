---
title: '[TS/JS] src/crypto/Keccak256/create2Address.test.ts'
source: 'src/crypto/Keccak256/create2Address.test.ts'
---

> Auto-generated from test file: src/crypto/Keccak256/create2Address.test.ts
