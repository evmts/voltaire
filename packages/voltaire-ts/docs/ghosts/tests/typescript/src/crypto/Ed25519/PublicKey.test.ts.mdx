---
title: '[TS/JS] src/crypto/Ed25519/PublicKey.test.ts'
source: 'src/crypto/Ed25519/PublicKey.test.ts'
---

> Auto-generated from test file: src/crypto/Ed25519/PublicKey.test.ts
