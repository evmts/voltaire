---
title: '[TS/JS] src/provider/eip6963/subscribe.test.ts'
source: 'src/provider/eip6963/subscribe.test.ts'
---

> Auto-generated from test file: src/provider/eip6963/subscribe.test.ts
