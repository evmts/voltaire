---
title: '[TS/JS] src/jsonrpc/eth/call/eth_call.test.ts'
source: 'src/jsonrpc/eth/call/eth_call.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/call/eth_call.test.ts
