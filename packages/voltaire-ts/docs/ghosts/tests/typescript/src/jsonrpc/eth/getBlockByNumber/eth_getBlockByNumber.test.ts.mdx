---
title: '[TS/JS] src/jsonrpc/eth/getBlockByNumber/eth_getBlockByNumber.test.ts'
source: 'src/jsonrpc/eth/getBlockByNumber/eth_getBlockByNumber.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getBlockByNumber/eth_getBlockByNumber.test.ts
