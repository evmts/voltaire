---
title: '[TS/JS] src/jsonrpc/eth/getBalance/eth_getBalance.test.ts'
source: 'src/jsonrpc/eth/getBalance/eth_getBalance.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getBalance/eth_getBalance.test.ts
