---
title: '[TS/JS] src/jsonrpc/eth/submitHashrate/eth_submitHashrate.test.ts'
source: 'src/jsonrpc/eth/submitHashrate/eth_submitHashrate.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/submitHashrate/eth_submitHashrate.test.ts
