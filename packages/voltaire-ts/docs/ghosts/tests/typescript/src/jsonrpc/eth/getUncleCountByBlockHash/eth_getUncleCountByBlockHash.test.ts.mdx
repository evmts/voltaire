---
title: '[TS/JS] src/jsonrpc/eth/getUncleCountByBlockHash/eth_getUncleCountByBlockHash.test.ts'
source: 'src/jsonrpc/eth/getUncleCountByBlockHash/eth_getUncleCountByBlockHash.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/getUncleCountByBlockHash/eth_getUncleCountByBlockHash.test.ts
