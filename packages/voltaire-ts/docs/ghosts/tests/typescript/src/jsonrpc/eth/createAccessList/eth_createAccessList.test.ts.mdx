---
title: '[TS/JS] src/jsonrpc/eth/createAccessList/eth_createAccessList.test.ts'
source: 'src/jsonrpc/eth/createAccessList/eth_createAccessList.test.ts'
---

> Auto-generated from test file: src/jsonrpc/eth/createAccessList/eth_createAccessList.test.ts
