---
title: '[TS/JS] src/primitives/Address/index.test.ts'
source: 'src/primitives/Address/index.test.ts'
---

> Auto-generated from test file: src/primitives/Address/index.test.ts
