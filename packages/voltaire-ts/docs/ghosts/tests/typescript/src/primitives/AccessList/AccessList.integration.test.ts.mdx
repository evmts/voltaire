---
title: '[TS/JS] src/primitives/AccessList/AccessList.integration.test.ts'
source: 'src/primitives/AccessList/AccessList.integration.test.ts'
---

> Auto-generated from test file: src/primitives/AccessList/AccessList.integration.test.ts
