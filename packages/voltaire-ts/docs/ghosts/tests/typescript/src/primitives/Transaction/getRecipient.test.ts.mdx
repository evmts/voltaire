---
title: '[TS/JS] src/primitives/Transaction/getRecipient.test.ts'
source: 'src/primitives/Transaction/getRecipient.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/getRecipient.test.ts
