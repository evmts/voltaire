---
title: '[TS/JS] src/primitives/Transaction/Legacy/getChainId.test.ts'
source: 'src/primitives/Transaction/Legacy/getChainId.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Legacy/getChainId.test.ts
