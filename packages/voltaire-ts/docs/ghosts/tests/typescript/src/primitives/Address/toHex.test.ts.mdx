---
title: '[TS/JS] src/primitives/Address/toHex.test.ts'
source: 'src/primitives/Address/toHex.test.ts'
---

> Auto-generated from test file: src/primitives/Address/toHex.test.ts
