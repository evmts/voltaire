---
title: '[TS/JS] src/primitives/Uint128/bitwiseAnd.test.ts'
source: 'src/primitives/Uint128/bitwiseAnd.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/bitwiseAnd.test.ts
