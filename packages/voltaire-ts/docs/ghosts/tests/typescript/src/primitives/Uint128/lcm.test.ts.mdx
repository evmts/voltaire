---
title: '[TS/JS] src/primitives/Uint128/lcm.test.ts'
source: 'src/primitives/Uint128/lcm.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/lcm.test.ts
