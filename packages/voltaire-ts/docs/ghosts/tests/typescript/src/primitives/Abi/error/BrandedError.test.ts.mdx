---
title: '[TS/JS] src/primitives/Abi/error/BrandedError.test.ts'
source: 'src/primitives/Abi/error/BrandedError.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/error/BrandedError.test.ts
