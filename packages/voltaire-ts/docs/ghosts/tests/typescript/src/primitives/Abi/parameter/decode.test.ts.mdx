---
title: '[TS/JS] src/primitives/Abi/parameter/decode.test.ts'
source: 'src/primitives/Abi/parameter/decode.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/parameter/decode.test.ts
