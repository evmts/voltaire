---
title: '[TS/JS] src/primitives/Abi/error/standards/ERC1155Errors.test.ts'
source: 'src/primitives/Abi/error/standards/ERC1155Errors.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/error/standards/ERC1155Errors.test.ts
