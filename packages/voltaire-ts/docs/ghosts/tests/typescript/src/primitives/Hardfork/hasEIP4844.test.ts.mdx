---
title: '[TS/JS] src/primitives/Hardfork/hasEIP4844.test.ts'
source: 'src/primitives/Hardfork/hasEIP4844.test.ts'
---

> Auto-generated from test file: src/primitives/Hardfork/hasEIP4844.test.ts
