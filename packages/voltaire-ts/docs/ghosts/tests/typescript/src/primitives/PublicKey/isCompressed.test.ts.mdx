---
title: '[TS/JS] src/primitives/PublicKey/isCompressed.test.ts'
source: 'src/primitives/PublicKey/isCompressed.test.ts'
---

> Auto-generated from test file: src/primitives/PublicKey/isCompressed.test.ts
