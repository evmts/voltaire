---
title: '[TS/JS] src/primitives/ChainId/constants.test.ts'
source: 'src/primitives/ChainId/constants.test.ts'
---

> Auto-generated from test file: src/primitives/ChainId/constants.test.ts
