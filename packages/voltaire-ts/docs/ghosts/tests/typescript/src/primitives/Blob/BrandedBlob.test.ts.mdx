---
title: '[TS/JS] src/primitives/Blob/BrandedBlob.test.ts'
source: 'src/primitives/Blob/BrandedBlob.test.ts'
---

> Auto-generated from test file: src/primitives/Blob/BrandedBlob.test.ts
