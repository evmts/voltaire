---
title: '[TS/JS] src/primitives/CallData/CallData.test.ts'
source: 'src/primitives/CallData/CallData.test.ts'
---

> Auto-generated from test file: src/primitives/CallData/CallData.test.ts
