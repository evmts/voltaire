---
title: '[TS/JS] src/primitives/Abi/formatWithArgs.test.js'
source: 'src/primitives/Abi/formatWithArgs.test.js'
---

> Auto-generated from test file: src/primitives/Abi/formatWithArgs.test.js
