---
title: '[TS/JS] src/primitives/ChainId/from.test.ts'
source: 'src/primitives/ChainId/from.test.ts'
---

> Auto-generated from test file: src/primitives/ChainId/from.test.ts
