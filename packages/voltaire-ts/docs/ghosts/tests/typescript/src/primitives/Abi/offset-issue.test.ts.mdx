---
title: '[TS/JS] src/primitives/Abi/offset-issue.test.ts'
source: 'src/primitives/Abi/offset-issue.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/offset-issue.test.ts
