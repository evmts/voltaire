---
title: '[TS/JS] src/primitives/Denomination/wei-fromGwei.test.ts'
source: 'src/primitives/Denomination/wei-fromGwei.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/wei-fromGwei.test.ts
