---
title: '[TS/JS] src/primitives/Address/compare.test.ts'
source: 'src/primitives/Address/compare.test.ts'
---

> Auto-generated from test file: src/primitives/Address/compare.test.ts
