---
title: '[TS/JS] src/primitives/Bytes/isBytes.test.ts'
source: 'src/primitives/Bytes/isBytes.test.ts'
---

> Auto-generated from test file: src/primitives/Bytes/isBytes.test.ts
