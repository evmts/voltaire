---
title: '[TS/JS] src/primitives/Hex/validate.test.ts'
source: 'src/primitives/Hex/validate.test.ts'
---

> Auto-generated from test file: src/primitives/Hex/validate.test.ts
