---
title: '[TS/JS] src/primitives/Bytes/Bytes64/Bytes64.test.ts'
source: 'src/primitives/Bytes/Bytes64/Bytes64.test.ts'
---

> Auto-generated from test file: src/primitives/Bytes/Bytes64/Bytes64.test.ts
