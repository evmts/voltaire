---
title: '[TS/JS] src/primitives/MultiTokenId/MultiTokenId.test.ts'
source: 'src/primitives/MultiTokenId/MultiTokenId.test.ts'
---

> Auto-generated from test file: src/primitives/MultiTokenId/MultiTokenId.test.ts
