---
title: '[TS/JS] src/primitives/Hex/HexType.test.ts'
source: 'src/primitives/Hex/HexType.test.ts'
---

> Auto-generated from test file: src/primitives/Hex/HexType.test.ts
