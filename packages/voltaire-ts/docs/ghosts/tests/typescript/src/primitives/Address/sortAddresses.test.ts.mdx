---
title: '[TS/JS] src/primitives/Address/sortAddresses.test.ts'
source: 'src/primitives/Address/sortAddresses.test.ts'
---

> Auto-generated from test file: src/primitives/Address/sortAddresses.test.ts
