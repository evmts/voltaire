---
title: '[TS/JS] src/primitives/ChainId/ChainId.test.ts'
source: 'src/primitives/ChainId/ChainId.test.ts'
---

> Auto-generated from test file: src/primitives/ChainId/ChainId.test.ts
