---
title: '[TS/JS] src/primitives/AccountState/isEOA.test.js'
source: 'src/primitives/AccountState/isEOA.test.js'
---

> Auto-generated from test file: src/primitives/AccountState/isEOA.test.js
