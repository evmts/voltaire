---
title: '[TS/JS] src/primitives/Domain/Domain.test.ts'
source: 'src/primitives/Domain/Domain.test.ts'
---

> Auto-generated from test file: src/primitives/Domain/Domain.test.ts
