---
title: '[TS/JS] src/primitives/TraceConfig/TraceConfig.test.ts'
source: 'src/primitives/TraceConfig/TraceConfig.test.ts'
---

> Auto-generated from test file: src/primitives/TraceConfig/TraceConfig.test.ts
