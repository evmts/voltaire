---
title: '[TS/JS] src/primitives/Address/toShortHex.test.ts'
source: 'src/primitives/Address/toShortHex.test.ts'
---

> Auto-generated from test file: src/primitives/Address/toShortHex.test.ts
