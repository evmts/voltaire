---
title: '[TS/JS] src/primitives/Authorization/sign.test.ts'
source: 'src/primitives/Authorization/sign.test.ts'
---

> Auto-generated from test file: src/primitives/Authorization/sign.test.ts
