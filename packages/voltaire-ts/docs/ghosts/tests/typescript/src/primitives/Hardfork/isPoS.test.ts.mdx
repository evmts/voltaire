---
title: '[TS/JS] src/primitives/Hardfork/isPoS.test.ts'
source: 'src/primitives/Hardfork/isPoS.test.ts'
---

> Auto-generated from test file: src/primitives/Hardfork/isPoS.test.ts
