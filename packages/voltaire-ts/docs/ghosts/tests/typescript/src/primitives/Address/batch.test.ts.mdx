---
title: '[TS/JS] src/primitives/Address/batch.test.ts'
source: 'src/primitives/Address/batch.test.ts'
---

> Auto-generated from test file: src/primitives/Address/batch.test.ts
