---
title: '[TS/JS] src/primitives/Uint16/Uint16Type.test.ts'
source: 'src/primitives/Uint16/Uint16Type.test.ts'
---

> Auto-generated from test file: src/primitives/Uint16/Uint16Type.test.ts
