---
title: '[TS/JS] src/primitives/Chain/supportsHardfork.test.ts'
source: 'src/primitives/Chain/supportsHardfork.test.ts'
---

> Auto-generated from test file: src/primitives/Chain/supportsHardfork.test.ts
