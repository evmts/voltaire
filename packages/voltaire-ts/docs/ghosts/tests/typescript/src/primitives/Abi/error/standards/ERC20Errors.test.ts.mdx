---
title: '[TS/JS] src/primitives/Abi/error/standards/ERC20Errors.test.ts'
source: 'src/primitives/Abi/error/standards/ERC20Errors.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/error/standards/ERC20Errors.test.ts
