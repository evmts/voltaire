---
title: '[TS/JS] src/primitives/ChainId/getChainName.test.ts'
source: 'src/primitives/ChainId/getChainName.test.ts'
---

> Auto-generated from test file: src/primitives/ChainId/getChainName.test.ts
