---
title: '[TS/JS] src/primitives/Abi/decodeData.test.js'
source: 'src/primitives/Abi/decodeData.test.js'
---

> Auto-generated from test file: src/primitives/Abi/decodeData.test.js
