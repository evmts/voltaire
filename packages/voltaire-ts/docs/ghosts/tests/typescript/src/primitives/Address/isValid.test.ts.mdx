---
title: '[TS/JS] src/primitives/Address/isValid.test.ts'
source: 'src/primitives/Address/isValid.test.ts'
---

> Auto-generated from test file: src/primitives/Address/isValid.test.ts
