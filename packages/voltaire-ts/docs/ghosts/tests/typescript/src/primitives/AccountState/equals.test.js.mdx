---
title: '[TS/JS] src/primitives/AccountState/equals.test.js'
source: 'src/primitives/AccountState/equals.test.js'
---

> Auto-generated from test file: src/primitives/AccountState/equals.test.js
