---
title: '[TS/JS] src/primitives/Rlp/encodeBatch.test.ts'
source: 'src/primitives/Rlp/encodeBatch.test.ts'
---

> Auto-generated from test file: src/primitives/Rlp/encodeBatch.test.ts
