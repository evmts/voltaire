---
title: '[TS/JS] src/primitives/PublicKey/toAddress.test.js'
source: 'src/primitives/PublicKey/toAddress.test.js'
---

> Auto-generated from test file: src/primitives/PublicKey/toAddress.test.js
