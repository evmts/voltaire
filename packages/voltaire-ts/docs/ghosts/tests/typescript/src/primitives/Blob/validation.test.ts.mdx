---
title: '[TS/JS] src/primitives/Blob/validation.test.ts'
source: 'src/primitives/Blob/validation.test.ts'
---

> Auto-generated from test file: src/primitives/Blob/validation.test.ts
