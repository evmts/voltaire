---
title: '[TS/JS] src/primitives/Denomination/wei-constants.test.ts'
source: 'src/primitives/Denomination/wei-constants.test.ts'
---

> Auto-generated from test file: src/primitives/Denomination/wei-constants.test.ts
