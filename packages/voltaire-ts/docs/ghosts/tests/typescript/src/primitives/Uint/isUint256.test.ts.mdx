---
title: '[TS/JS] src/primitives/Uint/isUint256.test.ts'
source: 'src/primitives/Uint/isUint256.test.ts'
---

> Auto-generated from test file: src/primitives/Uint/isUint256.test.ts
