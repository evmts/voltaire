---
title: '[TS/JS] src/primitives/Uint128/gcd.test.ts'
source: 'src/primitives/Uint128/gcd.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/gcd.test.ts
