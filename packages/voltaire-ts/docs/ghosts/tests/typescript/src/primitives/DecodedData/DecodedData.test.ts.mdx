---
title: '[TS/JS] src/primitives/DecodedData/DecodedData.test.ts'
source: 'src/primitives/DecodedData/DecodedData.test.ts'
---

> Auto-generated from test file: src/primitives/DecodedData/DecodedData.test.ts
