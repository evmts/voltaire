---
title: '[TS/JS] src/primitives/Chain/metadata.test.ts'
source: 'src/primitives/Chain/metadata.test.ts'
---

> Auto-generated from test file: src/primitives/Chain/metadata.test.ts
