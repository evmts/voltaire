---
title: '[TS/JS] src/primitives/Abi/event/getSignature.test.ts'
source: 'src/primitives/Abi/event/getSignature.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/event/getSignature.test.ts
