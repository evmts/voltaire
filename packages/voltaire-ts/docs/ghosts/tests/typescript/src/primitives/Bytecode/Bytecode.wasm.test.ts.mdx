---
title: '[TS/JS] src/primitives/Bytecode/Bytecode.wasm.test.ts'
source: 'src/primitives/Bytecode/Bytecode.wasm.test.ts'
---

> Auto-generated from test file: src/primitives/Bytecode/Bytecode.wasm.test.ts
