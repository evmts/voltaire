---
title: '[TS/JS] src/primitives/Address/assert.test.ts'
source: 'src/primitives/Address/assert.test.ts'
---

> Auto-generated from test file: src/primitives/Address/assert.test.ts
