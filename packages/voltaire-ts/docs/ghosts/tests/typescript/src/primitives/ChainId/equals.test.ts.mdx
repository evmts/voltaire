---
title: '[TS/JS] src/primitives/ChainId/equals.test.ts'
source: 'src/primitives/ChainId/equals.test.ts'
---

> Auto-generated from test file: src/primitives/ChainId/equals.test.ts
