---
title: '[TS/JS] src/primitives/Authorization/calculateGasCost.test.ts'
source: 'src/primitives/Authorization/calculateGasCost.test.ts'
---

> Auto-generated from test file: src/primitives/Authorization/calculateGasCost.test.ts
