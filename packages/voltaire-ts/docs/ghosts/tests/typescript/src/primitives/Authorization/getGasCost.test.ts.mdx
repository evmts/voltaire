---
title: '[TS/JS] src/primitives/Authorization/getGasCost.test.ts'
source: 'src/primitives/Authorization/getGasCost.test.ts'
---

> Auto-generated from test file: src/primitives/Authorization/getGasCost.test.ts
