---
title: '[TS/JS] src/primitives/MaxFeePerGas/MaxFeePerGas.test.ts'
source: 'src/primitives/MaxFeePerGas/MaxFeePerGas.test.ts'
---

> Auto-generated from test file: src/primitives/MaxFeePerGas/MaxFeePerGas.test.ts
