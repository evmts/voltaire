---
title: '[TS/JS] src/primitives/Address/LowercaseAddress.test.ts'
source: 'src/primitives/Address/LowercaseAddress.test.ts'
---

> Auto-generated from test file: src/primitives/Address/LowercaseAddress.test.ts
