---
title: '[TS/JS] src/primitives/Transaction/isContractCall.test.ts'
source: 'src/primitives/Transaction/isContractCall.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/isContractCall.test.ts
