---
title: '[TS/JS] src/primitives/Domain/ERC5267.test.ts'
source: 'src/primitives/Domain/ERC5267.test.ts'
---

> Auto-generated from test file: src/primitives/Domain/ERC5267.test.ts
