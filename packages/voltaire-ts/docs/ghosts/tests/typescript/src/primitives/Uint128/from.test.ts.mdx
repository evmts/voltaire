---
title: '[TS/JS] src/primitives/Uint128/from.test.ts'
source: 'src/primitives/Uint128/from.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/from.test.ts
