---
title: '[TS/JS] src/primitives/PackedUserOperation/PackedUserOperation.test.ts'
source: 'src/primitives/PackedUserOperation/PackedUserOperation.test.ts'
---

> Auto-generated from test file: src/primitives/PackedUserOperation/PackedUserOperation.test.ts
