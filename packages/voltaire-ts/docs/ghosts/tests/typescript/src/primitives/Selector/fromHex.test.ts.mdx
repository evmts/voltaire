---
title: '[TS/JS] src/primitives/Selector/fromHex.test.ts'
source: 'src/primitives/Selector/fromHex.test.ts'
---

> Auto-generated from test file: src/primitives/Selector/fromHex.test.ts
