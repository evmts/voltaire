---
title: '[TS/JS] src/primitives/PublicKey/PublicKeyType.test.ts'
source: 'src/primitives/PublicKey/PublicKeyType.test.ts'
---

> Auto-generated from test file: src/primitives/PublicKey/PublicKeyType.test.ts
