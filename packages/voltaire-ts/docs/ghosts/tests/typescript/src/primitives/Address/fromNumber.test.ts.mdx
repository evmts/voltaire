---
title: '[TS/JS] src/primitives/Address/fromNumber.test.ts'
source: 'src/primitives/Address/fromNumber.test.ts'
---

> Auto-generated from test file: src/primitives/Address/fromNumber.test.ts
