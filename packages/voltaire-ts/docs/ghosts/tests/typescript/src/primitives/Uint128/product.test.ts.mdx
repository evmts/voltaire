---
title: '[TS/JS] src/primitives/Uint128/product.test.ts'
source: 'src/primitives/Uint128/product.test.ts'
---

> Auto-generated from test file: src/primitives/Uint128/product.test.ts
