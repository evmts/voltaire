---
title: '[TS/JS] src/primitives/Uint64/greaterThan.test.ts'
source: 'src/primitives/Uint64/greaterThan.test.ts'
---

> Auto-generated from test file: src/primitives/Uint64/greaterThan.test.ts
