---
title: '[TS/JS] src/primitives/Address/UppercaseAddress.test.ts'
source: 'src/primitives/Address/UppercaseAddress.test.ts'
---

> Auto-generated from test file: src/primitives/Address/UppercaseAddress.test.ts
