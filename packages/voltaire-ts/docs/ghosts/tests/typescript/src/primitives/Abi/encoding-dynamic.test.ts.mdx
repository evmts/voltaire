---
title: '[TS/JS] src/primitives/Abi/encoding-dynamic.test.ts'
source: 'src/primitives/Abi/encoding-dynamic.test.ts'
---

> Auto-generated from test file: src/primitives/Abi/encoding-dynamic.test.ts
