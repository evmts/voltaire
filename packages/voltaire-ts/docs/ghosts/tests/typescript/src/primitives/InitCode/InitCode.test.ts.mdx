---
title: '[TS/JS] src/primitives/InitCode/InitCode.test.ts'
source: 'src/primitives/InitCode/InitCode.test.ts'
---

> Auto-generated from test file: src/primitives/InitCode/InitCode.test.ts
