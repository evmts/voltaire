---
title: '[TS/JS] src/primitives/Address/lessThan.test.ts'
source: 'src/primitives/Address/lessThan.test.ts'
---

> Auto-generated from test file: src/primitives/Address/lessThan.test.ts
