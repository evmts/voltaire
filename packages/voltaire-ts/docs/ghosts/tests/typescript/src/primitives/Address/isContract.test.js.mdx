---
title: '[TS/JS] src/primitives/Address/isContract.test.js'
source: 'src/primitives/Address/isContract.test.js'
---

> Auto-generated from test file: src/primitives/Address/isContract.test.js
