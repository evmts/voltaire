---
title: '[TS/JS] src/primitives/ContractSignature/ContractSignature.test.ts'
source: 'src/primitives/ContractSignature/ContractSignature.test.ts'
---

> Auto-generated from test file: src/primitives/ContractSignature/ContractSignature.test.ts
