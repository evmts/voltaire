---
title: '[TS/JS] src/primitives/Transaction/Legacy/verifySignature.test.ts'
source: 'src/primitives/Transaction/Legacy/verifySignature.test.ts'
---

> Auto-generated from test file: src/primitives/Transaction/Legacy/verifySignature.test.ts
