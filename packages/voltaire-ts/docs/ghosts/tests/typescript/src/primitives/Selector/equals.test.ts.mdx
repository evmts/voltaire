---
title: '[TS/JS] src/primitives/Selector/equals.test.ts'
source: 'src/primitives/Selector/equals.test.ts'
---

> Auto-generated from test file: src/primitives/Selector/equals.test.ts
