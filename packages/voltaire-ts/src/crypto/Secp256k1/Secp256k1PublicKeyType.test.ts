...
describe("Secp256k1PublicKeyType", () => {
	describe("type structure", () => {
		...
		it("should have length 64", () => {
			const _test: Equals<Secp256k1PublicKeyType["length"], 64> = true;
			_test;
		});
	...
	describe("type compatibility", () => {
		...
		it("should be assignable to Uint8Array", () => {
			...
			const _array: Uint8Array = publicKey;
			_array;
		});
	});
	...
	describe("type narrowing", () => {
		it("should narrow length to exactly 64", () => {
			const publicKey = {} as Secp256k1PublicKeyType;
			const _test: Equals<typeof publicKey.length, 64> = true;
			_test;
		});
	...
	describe("array operations", () => {
		...
		it("should support indexing", () => {
			const publicKey = {} as Secp256k1PublicKeyType;
			const _byte: number | undefined = publicKey[0];
			_byte;
		});
	...
	describe("type guards", () => {
		it("should work with type predicates", () => {
			...
			const _func = isSecp256k1PublicKey;
			_func;
		});
	});
});
