...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: complex comparison logic
...
// biome-ignore lint/suspicious/noExplicitAny: extending namespace for test
