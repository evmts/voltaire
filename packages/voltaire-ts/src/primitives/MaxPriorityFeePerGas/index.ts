...
export function toGwei(priorityFee: bigint | number | string): bigint {
	return _toGwei.call(from(priorityFee));
}

export function toWei(priorityFee: bigint | number | string): bigint {
	return _toWei.call(from(priorityFee));
}

export function toNumber(priorityFee: bigint | number | string): number {
	return _toNumber.call(from(priorityFee));
}

export function toBigInt(priorityFee: bigint | number | string): bigint {
	return _toBigInt.call(from(priorityFee));
}

export function equals(
	priorityFee1: bigint | number | string,
	priorityFee2: bigint | number | string,
): boolean {
