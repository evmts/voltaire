...
describe("RLP Fuzz Tests", () => {
	...
	// biome-ignore lint/suspicious/noExplicitAny: fuzz testing requires flexible types
	...
	describe("Stream Decoding Fuzz", () => {
		// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: fuzz test requires many conditions
