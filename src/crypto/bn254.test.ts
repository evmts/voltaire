  ...
  describe("Scalar multiplication", () => {
    it("should multiply by scalar", () => {
      ...
      const manual = Bn254.G1.add.call(
        Bn254.G1.add.call(Bn254.G1.add.call(Bn254.G1.add.call(gen, gen), gen), gen),
        gen
      );
    ...
    it("should exhibit distributivity", () => {
      ...
      const right = Bn254.G1.add.call(Bn254.G1.mul.call(p, 5n), Bn254.G1.mul.call(q, 5n));
      expect(Bn254.G1.equal.call(left, right)).toBe(true);
    });
  });
...
describe("Bn254.Pairing", () => {
  ...
  describe("Pairing check", () => {
    it.skip("should accept valid pairing equation", () => {
      ...
      const p2 = Bn254.G1.negate.call(Bn254.G1.mul.call(g1, Bn254.Fr.mul(a, b)));
      const q2 = g2;
