...
const testVectors = [
	...
	},
	{
		...
		input: "hello",
		expected: new Uint8Array([
			0x10, 0x8f, 0x07, 0xb8, 0x38, 0x24, 0x12, 0x61, 0x2c, 0x04, 0x8d, 0x07,
			0xd1, 0x3f, 0x81, 0x41, 0x18, 0x44, 0x5a, 0xcd,
		]),
	},
	{
...
describe.each([
	...
	describe("hash with Uint8Array input", () => {
		...
		it("single byte 0x00", () => {
			const expected = new Uint8Array([
				0xc8, 0x1b, 0x94, 0x93, 0x34, 0x20, 0x22, 0x1a, 0x7a, 0xc0, 0x04, 0xa9,
				0x02, 0x42, 0xd8, 0xb1, 0xd3, 0xe5, 0x07, 0x0d,
			]);
		...
		it("single byte 0xFF", () => {
			const expected = new Uint8Array([
				0x2c, 0x0c, 0x45, 0xd3, 0xec, 0xab, 0x80, 0xfe, 0x06, 0x0e, 0x5f, 0x1d,
				0x70, 0x57, 0xcd, 0x2f, 0x8d, 0xe5, 0xe5, 0x57,
			]);
	...
	describe("edge cases", () => {
		it("exactly 64 bytes", () => {
			const expected = new Uint8Array([
				0x9d, 0xfb, 0x7d, 0x37, 0x4a, 0xd9, 0x24, 0xf3, 0xf8, 0x8d, 0xe9, 0x62,
				0x91, 0xc3, 0x3e, 0x9a, 0xbe, 0xd5, 0x3e, 0x32,
			]);
		...
		it("exactly 128 bytes", () => {
			const expected = new Uint8Array([
				0x8d, 0xfd, 0xfb, 0x32, 0xb2, 0xed, 0x5c, 0xb4, 0x1a, 0x73, 0x47, 0x8b,
				0x4f, 0xd6, 0x0c, 0xc5, 0xb4, 0x64, 0x8b, 0x15,
			]);
