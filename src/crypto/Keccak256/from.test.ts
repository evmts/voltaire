...
describe("Keccak256 constructor pattern (from)", () => {
	...
	describe("type validation", () => {
		it("should throw for invalid input type", () => {
			expect(() => from(123 as any)).toThrow("Invalid input type");
			expect(() => from(null as any)).toThrow("Invalid input type");
			expect(() => from(undefined as any)).toThrow("Invalid input type");
			expect(() => from({} as any)).toThrow("Invalid input type");
			expect(() => from([] as any)).toThrow("Invalid input type");
		});
	});
