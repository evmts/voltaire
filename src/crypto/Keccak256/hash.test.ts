...
describe("Keccak256.hash", () => {
	describe("official test vectors", () => {
		...
		it("should hash single byte", () => {
			...
			const expected = new Uint8Array([
				0xbc, 0x36, 0x78, 0x9e, 0x78, 0x99, 0x46, 0xc9, 0x27, 0x5c, 0x6f, 0xa0,
				0x77, 0x02, 0xab, 0xc0, 0x72, 0x51, 0x43, 0x79, 0xaa, 0xac, 0x72, 0xd2,
				0x8f, 0xfd, 0x9b, 0xa0, 0x6c, 0x07, 0xa8, 0x78,
			]);
		...
		it("should hash 0xff byte", () => {
			...
			const expected = new Uint8Array([
				0x8e, 0x0c, 0xa9, 0xf0, 0xe5, 0xad, 0x2b, 0x71, 0x08, 0xb8, 0xab, 0x54,
				0x52, 0x88, 0x19, 0x56, 0x1d, 0xd9, 0x58, 0x36, 0xda, 0x87, 0xdd, 0x0e,
				0x45, 0xd6, 0x54, 0x4f, 0x72, 0x17, 0x23, 0x32,
			]);
		...
		it('should hash "The quick brown fox jumps over the lazy dog"', () => {
			...
			const expected = new Uint8Array([
				...
				0x28, 0x95, 0xdf, 0x64, 0x26, 0xf7, 0x8d, 0x84,
			]);
