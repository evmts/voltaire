/**
 * Contract Instance Type Definitions
 *
 * Typed contract abstraction for interacting with deployed smart contracts.
 *
 * @module contract/ContractType
 */

import type { Abi } from "../primitives/Abi/AbiConstructor.js";
import type { Item } from "../primitives/Abi/AbiType.js";
import type {
	Parameter,
	ParametersToPrimitiveTypes,
	ParametersToObject,
} from "../primitives/Abi/Parameter.js";
import type { FunctionType } from "../primitives/Abi/function/FunctionType.js";
import type {
	EventType,
	EncodeTopicsArgs,
