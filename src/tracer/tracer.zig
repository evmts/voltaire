...
pub const DefaultTracer = struct {
    ...
    fn executeMinimalEvmForOpcode(
        ...
        // TEMPORARY: Skip validation for synthetic opcodes to focus on regular opcodes
        // TODO: Implement proper synthetic opcode handling
        self.debug("SKIP: Synthetic opcode {s} validation temporarily disabled", .{@tagName(opcode)});
        return;
    }
