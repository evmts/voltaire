...
fn main() {
    ...
    let mut trace_file = fs::File::create("revm_erc20_trace.json").expect("Failed to create trace file");
    ...
    *evm.context.evm.env = Env {
    ...
    // Execute
    println!("\n=== Starting REVM traced execution of ERC20 deployment ===");
    println!("Trace will be written to: revm_erc20_trace.json");
    ...
    println!("\nTrace written to: revm_erc20_trace.json");
}