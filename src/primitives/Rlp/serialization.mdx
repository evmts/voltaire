...
Source: [toJSON.js:14-26](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/toJSON.js#L14-L26)
</TabItem>
<TabItem label="Usage">
```typescript
...
Source: [fromJSON.js:16-47](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/fromJSON.js#L16-L47)
</TabItem>
<TabItem label="Usage">
```typescript
import { Rlp } from '@tevm/voltaire'
