...
Source: [encode.js:38-59](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/encode.js#L38-L59)
</TabItem>
...
Source: [encodeBytes.js:32-53](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/encodeBytes.js#L32-L53)
</TabItem>
<TabItem label="Class API">
```typescript
import { Rlp } from '@tevm/voltaire'
...
Source: [encodeList.js:33-63](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/encodeList.js#L33-L63)
</TabItem>
<TabItem label="Class API">
```typescript
import { Rlp } from '@tevm/voltaire'
...
// More efficient than using generic encode()
