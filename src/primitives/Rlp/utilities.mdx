...
Source: [from.js:15-26](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/from.js#L15-L26)
</TabItem>
...
const bytes = Rlp.from(new Uint8Array([1, 2, 3]))
...
// Empty bytes
const empty = Rlp.from(new Uint8Array([]))
// => { type: 'bytes', value: Uint8Array([]) }

// Empty list
const emptyList = Rlp.from([])
// => { type: 'list', value: [] }

// Constructor also uses from internally
const rlp = new Rlp(new Uint8Array([1, 2, 3]))
// => Same as Rlp.from()
```
</TabItem>
...
const nonce = Rlp.from(new Uint8Array([0x00]))
const gasPrice = Rlp.from(new Uint8Array([0x04, 0xa8, 0x17, 0xc8]))
const gas = Rlp.from(new Uint8Array([0x52, 0x08]))

const transaction = Rlp.from([nonce, gasPrice, gas, /* ... */])
```
...
Source: [getEncodedLength.js:18-54](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/getEncodedLength.js#L18-L54)
</TabItem>
<TabItem label="Class API">
```typescript
import { Rlp } from '@tevm/voltaire'
...
Source: [flatten.js:26-45](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/flatten.js#L26-L45)
</TabItem>
<TabItem label="Class API">
```typescript
import { Rlp } from '@tevm/voltaire'
...
Source: [equals.js:15-47](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/BrandedRlp/equals.js#L15-L47)
</TabItem>
<TabItem label="Class API">
```typescript
import { Rlp } from '@tevm/voltaire'
...
function normalizeAndCompare(a: unknown, b: unknown): boolean {
  const dataA = Rlp.from(a)
  const dataB = Rlp.from(b)
