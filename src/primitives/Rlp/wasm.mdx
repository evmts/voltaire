...
Source: [Rlp.wasm.ts:13-16](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/Rlp.wasm.ts#L13-L16)
</TabItem>
<TabItem label="Usage">
```typescript
import * as RlpWasm from '@tevm/voltaire/Rlp.wasm'
...
Source: [Rlp.wasm.ts:23-28](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/Rlp.wasm.ts#L23-L28)
</TabItem>
<TabItem label="Usage">
```typescript
import * as RlpWasm from '@tevm/voltaire/Rlp.wasm'
...
Source: [Rlp.wasm.ts:36-44](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/Rlp.wasm.ts#L36-L44)
</TabItem>
<TabItem label="Usage">
```typescript
import * as RlpWasm from '@tevm/voltaire/Rlp.wasm'
...
const hex = RlpWasm.toHex(encoded)
const restored = RlpWasm.fromHex(hex)
// restored equals encoded
```

Source: [Rlp.wasm.ts:51-54](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/Rlp.wasm.ts#L51-L54)
</TabItem>
...
// With 0x prefix
const bytes = RlpWasm.fromHex("0x83010203")
// => Uint8Array([0x83, 1, 2, 3])

// Without 0x prefix
const bytes = RlpWasm.fromHex("83010203")
// => Uint8Array([0x83, 1, 2, 3])

// Decode from hex
const hex = "0x83010203"
const encoded = RlpWasm.fromHex(hex)
// Now can decode with Rlp.decode()
```

Source: [Rlp.wasm.ts:61-63](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/Rlp.wasm.ts#L61-L63)
</TabItem>
</Tabs>

## Zig Implementation

WASM module compiled from Zig source code providing maximum performance.
...
Source: [Rlp.zig:1-1489](https://github.com/evmts/primitives/blob/main/src/primitives/Rlp/Rlp.zig)
