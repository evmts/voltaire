...
const largeCode = "0x6080604052" + "60".repeat(2500) + "a264697066735822122012345678901234567890123456789012345678901234567890123456789012345678901234564736f6c63430008110033";
...
const codeWithoutMetadata =
	"0x608060405234801561001057600080fd5b00";
