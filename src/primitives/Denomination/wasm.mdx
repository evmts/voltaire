...
All WASM methods are compiled from [denomination.zig](https://github.com/evmts/tevm/blob/main/src/primitives/Denomination/denomination.zig) with `ReleaseSmall` optimization targeting minimal bundle size.
...
- **denomination.zig** - Zig source implementation
  - Location: [src/primitives/Denomination/denomination.zig](https://github.com/evmts/tevm/blob/main/src/primitives/Denomination/denomination.zig)
