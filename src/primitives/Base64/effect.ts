...
export const Base64Brand = Brand.refined<Base64Brand>(
	(s): s is string & Brand.Brand<"Base64"> =>
		typeof s === "string" && _isValid(s),
	() => Brand.error("Invalid base64 string"),
);

export const Base64UrlBrand = Brand.refined<Base64UrlBrand>(
	(s): s is string & Brand.Brand<"Base64Url"> =>
		typeof s === "string" && _isValidUrlSafe(s),
...
export class Base64Schema extends Schema.Class<Base64Schema>("Base64")({
	...
	get base64(): BrandedBase64 {
		return this.value as BrandedBase64;
	}
	get branded(): Base64Brand {
		return this.value as Base64Brand;
	}
...
export class Base64UrlSchema extends Schema.Class<Base64UrlSchema>("Base64Url")(
	...
	get base64url(): BrandedBase64Url {
		return this.value as BrandedBase64Url;
	}
	get branded(): Base64UrlBrand {
		return this.value as Base64UrlBrand;
	}
