...
- **EIP-1559**: Dynamic base fee adjusting based on block utilization
- **EIP-4844**: Exponential blob fee pricing for data availability
...
See `FeeMarket.bench.ts` for benchmarks.
