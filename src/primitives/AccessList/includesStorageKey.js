 ...
 * @param {import('../../Address/AddressType.js').AddressType.AddressType} address - Address to check
 * @param {import('../../Hash/HashType/HashType.js').HashType} storageKey - Storage key to find
