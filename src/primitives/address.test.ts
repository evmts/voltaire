...
describe("Address creation", () => {
	...
	test("fromHex - with 0x prefix", () => {
		const addr = Address.fromHex("0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266");
	...
	test("fromHex - rejects missing 0x", () => {
		expect(() =>
			Address.fromHex("a0cf798816d4b9b9866b5330eea46a18382f251e"),
		).toThrow();
	});
});
...
describe("Address validation", () => {
	test("validateChecksum - valid checksums", () => {
		expect(validateChecksum("0xA0Cf798816D4b9b9866b5330EEa46a18382f251e")).toBe(
			true,
		);
		expect(validateChecksum("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266")).toBe(
			true,
		);
		expect(validateChecksum("0x70997970C51812dc3A010C7d01b50e0d17dc79C8")).toBe(
			true,
		);
	});
...
describe("Address equality", () => {
	test("equals - same address", () => {
		const addr1 = Address.fromHex("0xa0cf798816d4b9b9866b5330eea46a18382f251e");
	...
	test("equals - different address", () => {
		const addr1 = Address.fromHex("0xa0cf798816d4b9b9866b5330eea46a18382f251e");
		const addr2 = Address.fromHex("0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266");
