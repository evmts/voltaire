 ...
 * All types namespaced under Bytecode for intuitive access.
 *
 * @example
 * ```typescript
 ...
 *
 * // Types
 * const code: Bytecode = new Uint8Array([0x60, 0x00, 0x5b]);
 *
...
export namespace Bytecode {
   ...
   * const jumpdests = Bytecode.analyzeJumpDestinations.call(code);
   * ```
   */
   ...
   * Bytecode.isValidJumpDest.call(code, 0); // true
   * ```
   */
   ...
   * Bytecode.validate.call(code); // true
   * ```
   */
   ...
   * ```typescript
   * const code = new Uint8Array([0x60, 0x01]);
   * const instructions = Bytecode.parseInstructions.call(code);
   * ```
   */
   ...
   * ```typescript
   * const creation = new Uint8Array([...constructor, ...runtime]);
   * const runtime = Bytecode.extractRuntime.call(creation, constructorLength);
   * ```
   */
   ...
   * const code1 = new Uint8Array([0x60, 0x01]);
   * const code2 = new Uint8Array([0x60, 0x01]);
   * Bytecode.equals.call(code1, code2); // true
   * ```
   */
   ...
   * ```typescript
   * const code = new Uint8Array([0x60, 0x01]);
   * Bytecode.toHex.call(code); // "0x6001"
   * ```
   */
   ...
   * ```typescript
   * const code = new Uint8Array([0x60, 0x01, 0x5b]);
   * const formatted = Bytecode.formatInstructions.call(code);
   * ```
   */
   ...
   * Bytecode.hasMetadata.call(code); // true
   * ```
   */
   ...
   * ```typescript
   * const withMeta = new Uint8Array([...bytecode, ...metadata]);
   * const without = Bytecode.stripMetadata.call(withMeta);
   * ```
   */
 ...
 *
 * Uses TypeScript declaration merging - Bytecode is both a namespace and a type.
 */
