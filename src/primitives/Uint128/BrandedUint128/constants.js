 ...
 * ```
 */
export const MIN = /** @type {import('./BrandedUint128.ts').BrandedUint128} */ (0n);
 ...
 * ```
 */
export const ZERO = /** @type {import('./BrandedUint128.ts').BrandedUint128} */ (0n);
 ...
 * ```
 */
export const ONE = /** @type {import('./BrandedUint128.ts').BrandedUint128} */ (1n);
