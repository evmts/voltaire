...
import type { BinaryTree as BinaryTreeTypeInternal, Node, StemNode, LeafNode } from "./BinaryTreeType.js";
...
export const HashInternal: (deps: Blake3Deps) => (l: Uint8Array, r: Uint8Array) => Uint8Array = _HashInternal;
export const HashStem: (deps: Blake3Deps) => (node: StemNode) => Uint8Array = _HashStem;
export const HashLeaf: (deps: Blake3Deps) => (node: LeafNode) => Uint8Array = _HashLeaf;
export const HashNode: (deps: Blake3Deps) => (node: Node) => Uint8Array = _HashNode;

// Create wrappers with auto-injected crypto
export const hashInternal: (l: Uint8Array, r: Uint8Array) => Uint8Array = HashInternal({ blake3 });
...
export const splitKey: (key: Uint8Array) => { stem: Uint8Array; idx: number } = _splitKey;
export const getStemBit: (stem: Uint8Array, index: number) => 0 | 1 = _getStemBit;
export const init: () => BinaryTreeTypeInternal = _init;
export const insert = _insert as (tree: BinaryTreeTypeInternal, key: Uint8Array, value: Uint8Array) => BinaryTreeTypeInternal;
export const get: (tree: BinaryTreeTypeInternal, key: Uint8Array) => Uint8Array | null = _get;
export const rootHash: (tree: BinaryTreeTypeInternal) => Uint8Array = _rootHash;
export const rootHashHex: (tree: BinaryTreeTypeInternal) => HexType = _rootHashHex;
