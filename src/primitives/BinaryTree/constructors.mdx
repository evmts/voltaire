...
const key = Hash('0x' + '00'.repeat(32))
const value = Hash('0x' + '00'.repeat(32))
value[0] = 0x42
...
Defined in: [primitives/BinaryTree/index.js:30-32](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/index.js#L30-L32)
...
import type { BinaryTree } from 'tevm/BrandedBinaryTree'

const tree: BinaryTree = init()
```

Defined in: [primitives/BinaryTree/BrandedBinaryTree/init.js:12-14](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/init.js#L12-L14)
...
const key1 = Hash('0x' + '00'.repeat(32))
key1[31] = 0  // subindex 0
const value1 = Hash('0x' + '00'.repeat(32))
value1[0] = 0x01
...
const key2 = Hash('0x' + '00'.repeat(32))
key2[31] = 1  // subindex 1
const value2 = Hash('0x' + '00'.repeat(32))
value2[0] = 0x02
...
const key3 = Hash('0x' + '00'.repeat(32))
key3[0] = 0xFF  // Different stem
key3[31] = 0
const value3 = Hash('0x' + '00'.repeat(32))
value3[0] = 0x03
...
const accountData = Hash('0x' + '00'.repeat(32))
