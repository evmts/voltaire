...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/insert.js:22-26](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/insert.js#L22-L26)
...
const key1 = Bytes32()
key1[31] = 0
tree = BinaryTree.insert(tree, key1, Bytes32())
console.log(tree.root.type) // 'stem'
...
key2[31] = 0
tree = BinaryTree.insert(tree, key2, Bytes32())
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/get.js:18-21](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/get.js#L18-L21)
...
```typescript
import { BinaryTree, InvalidTreeStateError } from 'tevm'
