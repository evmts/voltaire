...
- **Zero-overhead** [branded type](/getting-started/branded-types) interface structure
...
Runtime-validated tree structure. Interface brand ensures type safety with minimal runtime overhead.

Defined in: [primitives/BinaryTree/BrandedBinaryTree/BrandedBinaryTree.ts](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/BrandedBinaryTree.ts)
...
```typescript
import { init } from 'tevm/BrandedBinaryTree'
...
```typescript
import { init, insert, get } from 'tevm/BrandedBinaryTree'
...
```typescript
import { init, insert, rootHash, rootHashHex } from 'tevm/BrandedBinaryTree'
...
```typescript
import { init, insert, rootHash } from 'tevm/BrandedBinaryTree'
...
```typescript
import { init, insert, rootHashHex } from 'tevm/BrandedBinaryTree'
...
```typescript
import { BinaryTree } from 'tevm'
import { insert, rootHash } from 'tevm/BrandedBinaryTree'
...
```typescript
import { init, insert } from 'tevm/BrandedBinaryTree'
...
```typescript
import { insert, get } from 'tevm/BrandedBinaryTree'
...
import { init, insert, get, addressToKey, splitKey } from 'tevm/BrandedBinaryTree'
