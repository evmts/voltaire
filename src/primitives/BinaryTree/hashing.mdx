...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/rootHash.js:16-18](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/rootHash.js#L16-L18)
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/rootHashHex.js:16-23](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/rootHashHex.js#L16-L23)
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/hashNode.js:18-29](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/hashNode.js#L18-L29)
...
// Both zero case
const zeroLeft = Bytes32()
const zeroRight = Bytes32()
...
const leftHash = Bytes32()
const rightHash = Bytes32()

const parentHash = BinaryTree.hashInternal(leftHash, rightHash)
```
</Tab>
<Tab title="Build Tree Hash">
```typescript
import { BinaryTree } from 'tevm'
...
## `HashInternal({ blake3 })(left, right): Uint8Array`

Tree-shakeable factory with explicit blake3 dependency.

**Dependencies:**
- `blake3: (data: Uint8Array) => Uint8Array` - BLAKE3 hash function

**Example:**

```typescript
import { HashInternal } from 'tevm/BinaryTree'
import { blake3 } from '@noble/hashes/blake3'

const hashInternal = HashInternal({ blake3 })
const hash = hashInternal(leftHash, rightHash)
```

**Bundle size:** BLAKE3 only included if imported.

</Tab>

</Tabs>

Defined in: [primitives/BinaryTree/BrandedBinaryTree/hashInternal.js:19-25](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/hashInternal.js#L19-L25)
...
// Set some values
stemNode.values[0] = Bytes32()
stemNode.values[5] = Bytes32()
...
const stem = new Uint8Array(31)
const values = Array({ length: 256 }, (_, i) => {
  const v = Bytes32()
  v[0] = i
  return v
})
...
## `HashStem({ blake3 })(node): Uint8Array`
...
```typescript
import { HashStem } from 'tevm/BinaryTree'
import { blake3 } from '@noble/hashes/blake3'
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/hashStem.js:18-28](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/hashStem.js#L18-L28)
...
## `HashLeaf({ blake3 })(node): Uint8Array`
...
```typescript
import { HashLeaf } from 'tevm/BinaryTree'
import { blake3 } from '@noble/hashes/blake3'
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/hashLeaf.js:17-19](https://github.com/evmts/tevm/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/hashLeaf.js#L17-L19)
...
const key = Bytes32()
const value1 = Bytes32()
value1[0] = 0x01

const value2 = Bytes32()
value2[0] = 0x02
...
<Tip title="Hashing vs Operations">
