...
const missing = BinaryTree.get(tree3, Bytes32());
...
import { init, insert, get, rootHash } from 'tevm/BrandedBinaryTree';
...
- [Keccak256](/crypto/keccak256) - BLAKE3 hashing for merkle trees
