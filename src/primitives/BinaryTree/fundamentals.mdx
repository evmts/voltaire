...
<Info>
**Conceptual Guide** - For API reference and method documentation, see [BinaryTree API](/primitives/binarytree/index).
</Info>
...
function computeZeroHashes(depth: number): Uint8Array[] {
  const zeros: Uint8Array[] = [Bytes32()];
