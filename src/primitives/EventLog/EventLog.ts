 ...
 * All types namespaced under EventLog for intuitive access.
 *
 * @example
 * ```typescript
 ...
 *
 * // Operations
 * const matches = EventLog.matches(log, filterTopics);
...
export namespace EventLog {
   ...
   * @example
   * ```typescript
   * const topic0 = EventLog.getTopic0.call(log);
   * ```
   */
   ...
   * @example
   * ```typescript
   * const indexed = EventLog.getIndexedTopics.call(log);
   * ```
   */
   ...
   * @example
   * ```typescript
   * const matches = EventLog.matchesTopics.call(log, [topic0, null, topic2]);
   * ```
   */
   ...
   * @example
   * ```typescript
   * const matches = EventLog.matchesAddress.call(log, "0x..." as Address);
   * ```
   */
   ...
   * @example
   * ```typescript
   * const matches = EventLog.matchesFilter.call(log, filter);
   * ```
   */
   ...
   * @example
   * ```typescript
   * const filtered = EventLog.filterLogs.call(logs, filter);
   * ```
   */
   ...
   * @example
   * ```typescript
   * const sorted = EventLog.sortLogs.call(logs);
   * ```
   */
   ...
   * @example
   * ```typescript
   * if (EventLog.isRemoved.call(log)) {
   ...
   * @example
   * ```typescript
   * const cloned = EventLog.clone.call(log);
   * ```
   */
...
/**
 * EventLog type (uses TypeScript declaration merging)
 *
 * EventLog is both a namespace and a type.
 */
export type EventLog = EventLog.Data;
