...
Defined in: [primitives/EventLog/BrandedEventLog/create.js:39](https://github.com/evmts/voltaire/blob/main/src/primitives/EventLog/BrandedEventLog/create.js)
...
Defined in: [primitives/EventLog/BrandedEventLog/from.js:22](https://github.com/evmts/voltaire/blob/main/src/primitives/EventLog/BrandedEventLog/from.js)
