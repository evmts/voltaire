...
declare function getTopic0<T extends BrandedEventLog>(log: T): import("../Hash/index.js").Hash | undefined;
declare function getIndexedTopics<T extends BrandedEventLog>(log: T): readonly import("../Hash/index.js").Hash[];
declare function getSignature<T extends BrandedEventLog>(log: T): import("../Hash/index.js").Hash | undefined;
declare function getIndexed<T extends BrandedEventLog>(log: T): readonly import("../Hash/index.js").Hash[];
...
declare function filterLogs<T extends BrandedEventLog>(logs: readonly T[], filter: import("./BrandedEventLog.js").Filter): T[];
declare function filter<T extends BrandedEventLog>(logs: readonly T[], filter: import("./BrandedEventLog.js").Filter): T[];
