...
EventLog.getTopic0 = function(log) { return getTopic0(log ?? this); };
EventLog.getIndexedTopics = function(log) { return getIndexedTopics(log ?? this); };
EventLog.getSignature = function(log) { return getSignature(log ?? this); };
EventLog.getIndexed = function(log) { return getIndexed(log ?? this); };
...
EventLog.isRemoved = function(log) { return isRemoved(log ?? this); };
EventLog.wasRemoved = function(log) { return wasRemoved(log ?? this); };
EventLog.clone = function(log) { return clone(log ?? this); };
EventLog.copy = function(log) { return copy(log ?? this); };
...
EventLog.sortLogs = function(logs) { return sortLogs(logs ?? this); };
EventLog.sort = function(logs) { return sortLogs(logs ?? this); };

// Bind prototype methods - pass this as first argument
EventLog.prototype.getTopic0 = function() { return getTopic0(this); };
EventLog.prototype.getIndexedTopics = function() { return getIndexedTopics(this); };
EventLog.prototype.getSignature = function() { return getSignature(this); };
EventLog.prototype.getIndexed = function() { return getIndexed(this); };
EventLog.prototype.matchesTopics = function(filterTopics) { return matchesTopics(this, filterTopics); };
EventLog.prototype.matches = function(filterTopics) { return matchesTopics(this, filterTopics); };
EventLog.prototype.matchesAddress = function(filterAddress) { return matchesAddress(this, filterAddress); };
EventLog.prototype.matchesAddr = function(filterAddress) { return matchesAddress(this, filterAddress); };
EventLog.prototype.matchesFilter = function(filter) { return matchesFilter(this, filter); };
EventLog.prototype.matchesAll = function(filter) { return matchesFilter(this, filter); };
EventLog.prototype.isRemoved = function() { return isRemoved(this); };
EventLog.prototype.wasRemoved = function() { return wasRemoved(this); };
EventLog.prototype.clone = function() { return clone(this); };
EventLog.prototype.copy = function() { return copy(this); };
