...
results.push(
  benchmark("Transaction.format - EIP-1559", () => Transaction.format(eip1559Tx)),
);
results.push(
...
results.push(
  benchmark("Transaction.hasAccessList", () => Transaction.hasAccessList(legacyTx)),
);
results.push(
  benchmark("Transaction.getAccessList", () => Transaction.getAccessList(eip1559Tx)),
);
results.push(
...
results.push(
  benchmark("Access nonce", () => legacyTx.nonce),
);
results.push(
  benchmark("Access gasPrice", () => legacyTx.gasPrice),
);
results.push(
  benchmark("Access to address", () => legacyTx.to),
);
results.push(
  benchmark("Access value", () => legacyTx.value),
);
results.push(
  benchmark("Access data", () => legacyTx.data),
);
results.push(
  benchmark("Access signature (r)", () => legacyTx.r),
);
...
if (typeof Bun !== "undefined") {
  const resultsFile = "/Users/williamcory/primitives/src/primitives/transaction-results.json";
