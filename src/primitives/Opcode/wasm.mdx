...
Defined in: [primitives/Opcode/Opcode.wasm.ts:83](https://github.com/evmts/primitives/blob/main/src/primitives/Opcode/Opcode.wasm.ts)
...
Defined in: [primitives/Opcode/Opcode.wasm.ts:101](https://github.com/evmts/primitives/blob/main/src/primitives/Opcode/Opcode.wasm.ts)
