 ...
 */
export const Keccak256Service = Context.GenericTag<Keccak256Service>("@voltaire/Address/Keccak256");
 ...
 */
export const Secp256k1Service = Context.GenericTag<Secp256k1Service>("@voltaire/Address/Secp256k1");
 ...
 */
export const RlpEncoderService = Context.GenericTag<RlpEncoderService>("@voltaire/Address/RlpEncoder");
