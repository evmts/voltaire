...
```typescript
import { toUppercase } from 'tevm/wasm'
...
**Defined in:** [primitives/Address/Address.wasm.ts](https://github.com/evmts/tevm/blob/main/src/primitives/Address/Address.wasm.ts)
