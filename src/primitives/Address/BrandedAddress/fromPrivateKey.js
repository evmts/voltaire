 ...
 * @returns {(privateKey: import('../../../primitives/PrivateKey/PrivateKeyType.js').PrivateKeyType) => import('./BrandedAddress.js').BrandedAddress} Function that creates Address from private key
 *
 * @example
 * ```typescript
