...
describe("isValid", () => {
	...
	it("returns false for invalid length with 0x", () => {
		...
		expect(isValid("0x742d35cc6634c0532925a3b844bc9e7595f251e3ff")).toBe(false);
	});
	...
	it("returns false for invalid hex characters", () => {
		expect(isValid("0x742d35cc6634c0532925a3b844bc9e7595f251eZ")).toBe(false);
		expect(isValid("0x742d35cc6634c0532925a3b844bc9e7595f251eg")).toBe(false);
	});
