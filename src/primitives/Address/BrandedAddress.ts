...
export type BrandedAddress = Uint8Array & {
	...
	toShortHex(this: BrandedAddress, sliceLength?: number, leadingLength?: number): string;
	...
	calculateCreate2Address(this: BrandedAddress, salt: Uint8Array, initCode: Uint8Array): BrandedAddress;
};
