...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/from-public-key.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/from-public-key.ts).
</Tip>
...
**Defined in:** [primitives.h:139](https://github.com/evmts/tevm/blob/main/src/primitives.h#L139)
