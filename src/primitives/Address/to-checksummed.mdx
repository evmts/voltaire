...
<Tip>
View the complete executable example at [`playground/src/examples/primitives/address/checksum.ts`](https://github.com/roninjin10/voltaire/blob/main/playground/src/examples/primitives/address/checksum.ts).
</Tip>
...
**Defined in:** [primitives.h:115](https://github.com/evmts/tevm/blob/main/src/primitives.h#L115)
