 ...
 * @returns {(unsigned: {chainId: bigint, address: import("../../Address/AddressType.js").BrandedAddress, nonce: bigint}) => import("../../Hash/index.js").HashType} Function that hashes unsigned authorization
 */
