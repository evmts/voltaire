...
results.push(
  benchmark("isItem - invalid (partial)", () => Authorization.isItem({ chainId: 1n })),
);
results.push(
  benchmark("isUnsigned - valid", () => Authorization.isUnsigned(validUnsigned)),
);
results.push(
  benchmark("isUnsigned - invalid (null)", () => Authorization.isUnsigned(null)),
);
...
results.push(
  benchmark("format - unsigned", () => Authorization.format.call(validUnsigned)),
);
...
results.push(
  benchmark("equals - different", () => Authorization.equals.call(validAuth, auth3)),
);
