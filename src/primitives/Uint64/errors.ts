...
export class Uint64NegativeError extends IntegerUnderflowError {
	constructor(
		...
		super(message, {
			code: options.code || "UINT64_NEGATIVE",
			value: options.value,
			min: 0n,
			type: TYPE_NAME,
...
export class Uint64OverflowError extends IntegerOverflowError {
	constructor(
		...
		super(message, {
			code: options.code || "UINT64_OVERFLOW",
			value: options.value,
			max: MAX,
			type: TYPE_NAME,
			context: options.context,
...
export class Uint64InvalidLengthError extends InvalidLengthError {
	constructor(
		...
		super(message, {
			code: options.code || "UINT64_INVALID_LENGTH",
			value: options.value,
...
export class Uint64DivisionByZeroError extends InvalidRangeError {
	constructor(
		...
		super(message || "Division by zero", {
			code: options?.code || "UINT64_DIVISION_BY_ZERO",
...
export class Uint64NotIntegerError extends InvalidFormatError {
	constructor(
		...
		super(message, {
			code: options.code || "UINT64_NOT_INTEGER",
			value: options.value,
...
export class Uint64InvalidHexError extends InvalidFormatError {
	constructor(
		...
		super(message, {
			code: options.code || "UINT64_INVALID_HEX",
			value: options.value,
