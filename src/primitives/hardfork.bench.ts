...
results.push(
  benchmark("min", () => Hardfork.min(testArray)),
);
results.push(
  benchmark("max", () => Hardfork.max(testArray)),
);
...
results.push(
  benchmark("fromString - alias", () =>
    Hardfork.fromString("paris"),
  ),
);
results.push(
...
results.push(
  benchmark("fromString - invalid", () =>
    Hardfork.fromString("unknown"),
  ),
);
...
results.push(
  benchmark("toString", () =>
    Hardfork.toString(testForks.recent),
  ),
);
...
console.log("\n--- Validation ---");
results.push(
  benchmark("isValidName - valid", () =>
    Hardfork.isValidName("cancun"),
  ),
);
results.push(
  benchmark("isValidName - invalid", () =>
    Hardfork.isValidName("unknown"),
  ),
);
...
results.push(
  benchmark("hasEIP1559", () =>
    Hardfork.hasEIP1559(testForks.recent),
  ),
);
results.push(
  benchmark("hasEIP3855", () =>
    Hardfork.hasEIP3855(testForks.recent),
  ),
);
results.push(
  benchmark("hasEIP4844", () =>
    Hardfork.hasEIP4844(testForks.recent),
  ),
);
results.push(
  benchmark("hasEIP1153", () =>
    Hardfork.hasEIP1153(testForks.recent),
  ),
);
results.push(
  benchmark("isPostMerge", () =>
    Hardfork.isPostMerge(testForks.recent),
  ),
);
...
results.push(
  benchmark("isPoS.call", () =>
    Hardfork.isPoS.call(testForks.recent),
  ),
);
...
console.log("  - Comparison operations are extremely fast (simple integer comparisons)");
...
if (typeof Bun !== "undefined") {
  const resultsFile = "/Users/williamcory/primitives/src/primitives/hardfork-bench-results.json";
