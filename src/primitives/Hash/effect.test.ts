...
import { HashSchema, HashBrand, HashFromHex, HashFromUnknown } from "./effect.js";
import * as HashImpl from "./index.js";

describe("Hash Effect Schema", () => {
  const zeroHex = "0x" + "00".repeat(32);
  const oneBytes = (() => { const b = new Uint8Array(32); b[31] = 1; return b; })();
