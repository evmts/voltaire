 ...
 * All types and operations namespaced under FeeMarket.
 *
 * @example
 * ```typescript
...
export namespace FeeMarket {
   ...
   * const baseFee2 = FeeMarket.calculateBaseFee(30_000_000n, 30_000_000n, 1_000_000_000n);
   * // baseFee2 === 1_125_000_000n (12.5% increase)
   *
   * // Empty block: base fee decreases
   * const baseFee3 = FeeMarket.calculateBaseFee(0n, 30_000_000n, 1_000_000_000n);
   ...
   * const excess2 = FeeMarket.calculateExcessBlobGas(0n, 393216n); // 3 blobs
   * // excess2 === 0n
   *
   * // Above target: accumulate excess
   * const excess3 = FeeMarket.calculateExcessBlobGas(0n, 786432n); // 6 blobs
  ...
  export namespace State {
     ...
     * ```
     */
    export function next(this: FeeMarket.State): FeeMarket.State {
     ...
     */
    export function getBlobBaseFee(this: FeeMarket.State): bigint {
     ...
     */
    export function getGasTarget(this: FeeMarket.State): bigint {
     ...
     */
    export function isAboveGasTarget(this: FeeMarket.State): boolean {
     ...
     */
    export function isAboveBlobGasTarget(this: FeeMarket.State): boolean {
...
/**
 * Fee Market State type (convenience export)
 *
 * Uses TypeScript declaration merging - FeeMarket is both a namespace and can be used as a type.
 */
export type FeeMarket = FeeMarket.State;
