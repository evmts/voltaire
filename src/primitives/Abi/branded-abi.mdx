...
<Aside type="tip" title="Looking for the class API?">
For most use cases, the [class-based API](/primitives/abi/) is recommended. BrandedAbi is for advanced users who need maximum bundle size optimization and tree-shaking benefits.
</Aside>
...
Source: [BrandedAbi.ts:14-21](https://github.com/evmts/voltaire/blob/main/src/primitives/Abi/BrandedAbi/BrandedAbi.ts#L14-L21)
...
Source: [getItem.js:62-77](https://github.com/evmts/voltaire/blob/main/src/primitives/Abi/BrandedAbi/getItem.js#L62-L77)
...
Source: [format.js:21-45](https://github.com/evmts/voltaire/blob/main/src/primitives/Abi/Item.ts#L21-L45)
...
Source: [formatWithArgs.js:47-60](https://github.com/evmts/voltaire/blob/main/src/primitives/Abi/Item.ts#L47-L60)
