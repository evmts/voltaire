...
Type-safe ABI encoder/decoder supporting functions, events, errors, constructors, and all Solidity types. Provides both imperative and functional APIs with tree-shakeable exports.

## Quick Start

<Tabs>
<TabItem label="Function Encoding">
```typescript
...
const decoded = Error.decodeParams(insufficientBalance, revertData.slice(4))
// [100n, 1000n]
```
</TabItem>
<TabItem label="Direct Encoding">
```typescript
...
// Decode parameters
const decoded = decodeParameters(params, encoded)
// ["0x742d35...", 1000n, "Hello"]
```
</TabItem>
</Tabs>
...
Source: [Parameter.ts:9-41](https://github.com/evmts/primitives/blob/main/src/primitives/Abi/Parameter.ts#L9-L41)
</TabItem>
<TabItem label="AbiType">
```typescript
...
<Aside type="tip" title="What is ABI?">
The Application Binary Interface (ABI) defines how to encode/decode data when interacting with Ethereum smart contracts. It specifies the layout of function calls, event logs, errors, and data structures.

See [Solidity ABI Specification](https://docs.soliditylang.org/en/latest/abi-spec.html) for complete details.
</Aside>
...
Source: [Errors.ts:1-35](https://github.com/evmts/primitives/blob/main/src/primitives/Abi/Errors.ts#L1-L35)
...
See [BrandedAbi](/primitives/abi/branded-abi) for complete tree-shaking documentation.
