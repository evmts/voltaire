...
// Derive address
const recoveredAddress = Address.fromPublicKey(xBigInt, yBigInt);
```
...
- [Siwe.validate](./validation.mdx) - Message validation
- [Siwe.getMessageHash](./signing.mdx) - Hash generation
- [Usage Patterns](./usage-patterns.mdx) - Authentication flows
- [EIP-191](https://eips.ethereum.org/EIPS/eip-191) - Signed data standard
- [Secp256k1](../../crypto/Secp256k1/index.mdx) - Signature recovery
