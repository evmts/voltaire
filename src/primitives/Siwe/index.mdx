...
<CardGrid>
  ...
  <Card title="Parsing" icon="open-book">
...
<CardGrid stagger>
  <Card title="Address" icon="document">
    20-byte Ethereum addresses used in messages.

    [View Address →](/primitives/address)
  </Card>

  <Card title="Signature" icon="rocket">
    65-byte signatures (r + s + v) for verification.

    [View Signature →](/primitives/signature)
  </Card>

  <Card title="Hash" icon="seti:text">
    32-byte hashes from message signing.
