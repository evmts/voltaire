...
results.push(benchmark("toHex - small (unpadded)", () => Uint.toHex(smallValue, false)));
...
console.log("\n--- toString() ---");
results.push(benchmark("toString - decimal", () => Uint.toString(smallValue, 10)));
results.push(benchmark("toString - hex", () => Uint.toString(smallValue, 16)));
results.push(benchmark("toString - binary", () => Uint.toString(smallValue, 2)));
...
results.push(benchmark("plus - small", () => Uint.plus(smallValue, smallValue)));
results.push(benchmark("plus - medium", () => Uint.plus(mediumValue, mediumValue)));
results.push(benchmark("plus - large", () => Uint.plus(largeValue, largeValue)));
...
console.log("\n--- Subtraction ---");
results.push(benchmark("minus - small", () => Uint.minus(smallValue, Uint.from(50))));
results.push(benchmark("minus - medium", () => Uint.minus(mediumValue, smallValue)));
results.push(benchmark("minus - large", () => Uint.minus(largeValue, mediumValue)));
...
console.log("\n--- Multiplication ---");
results.push(benchmark("times - small", () => Uint.times(smallValue, Uint.from(2))));
results.push(benchmark("times - medium", () => Uint.times(mediumValue, Uint.from(2))));
results.push(benchmark("times - large", () => Uint.times(largeValue, Uint.from(2))));
results.push(benchmark("times - wrap", () => Uint.times(maxValue, Uint.from(2))));
...
console.log("\n--- Division ---");
results.push(benchmark("dividedBy - small", () => Uint.dividedBy(smallValue, Uint.from(10))));
results.push(benchmark("dividedBy - medium", () => Uint.dividedBy(mediumValue, Uint.from(100))));
results.push(benchmark("dividedBy - large", () => Uint.dividedBy(largeValue, Uint.from(1000))));
...
console.log("\n--- Modulo ---");
results.push(benchmark("modulo - small", () => Uint.modulo(smallValue, Uint.from(30))));
results.push(benchmark("modulo - medium", () => Uint.modulo(mediumValue, Uint.from(1000))));
...
console.log("\n--- Exponentiation ---");
results.push(benchmark("toPower - 2^8", () => Uint.toPower(Uint.from(2), Uint.from(8))));
results.push(benchmark("toPower - 10^5", () => Uint.toPower(Uint.from(10), Uint.from(5))));
...
console.log("\n--- Shift Operations ---");
results.push(benchmark("shiftLeft - 1 bit", () => Uint.shiftLeft(smallValue, Uint.ONE)));
results.push(benchmark("shiftLeft - 8 bits", () => Uint.shiftLeft(smallValue, Uint.from(8))));
results.push(benchmark("shiftRight - 1 bit", () => Uint.shiftRight(smallValue, Uint.ONE)));
results.push(benchmark("shiftRight - 8 bits", () => Uint.shiftRight(smallValue, Uint.from(8))));
...
results.push(benchmark("greaterThanOrEqual", () => Uint.greaterThanOrEqual(v2, v1)));
...
results.push(benchmark("leadingZeros - small", () => Uint.leadingZeros(smallValue)));
results.push(benchmark("leadingZeros - large", () => Uint.leadingZeros(largeValue)));
results.push(benchmark("popCount - small", () => Uint.popCount(Uint.from(0xff))));
