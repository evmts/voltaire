...
export class UintSchema extends Schema.Class<UintSchema>("Uint")({
  ...
  toBytes(): Uint8Array { return _toBytes(this.uint); }
  ...
  bitLength(): number { return _bitLength(this.uint); }
  leadingZeros(): number { return _leadingZeros(this.uint); }
  popCount(): number { return _popCount(this.uint); }
}
