...
import { method, GetBlockTransactionCountByHashRequest } from "./eth_getBlockTransactionCountByHash.js";

describe("eth_getBlockTransactionCountByHash", () => {
	describe("Request Creation", () => {
		test("creates request with block hash", () => {
			const blockHash = "0xb3b20624f8f0f86eb50dd04688409e5cea4bd02d700bf6e79e9384d47d6a5a35";
