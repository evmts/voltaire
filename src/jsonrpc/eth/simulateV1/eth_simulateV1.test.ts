...
describe('eth_simulateV1', () => {
	...
	describe('Request Construction', () => {
		...
		test('creates request with access list', () => {
			...
			expect(request.params[0].blockStateCalls[0].calls[0].accessList).toBeDefined()
		})
	...
	describe('Complex Scenarios', () => {
		...
		test('handles multi-block simulation with increasing block numbers', () => {
			...
			expect(request.params[0].blockStateCalls).toHaveLength(2)
			expect(request.params[0].blockStateCalls[0].blockOverrides?.number).toBe('0x1000000')
			expect(request.params[0].blockStateCalls[1].blockOverrides?.number).toBe('0x1000001')
		})
	})
	...
	describe('Edge Cases', () => {
		...
		test('handles maximum withdrawal count', () => {
			...
			expect(request.params[0].blockStateCalls[0].blockOverrides?.withdrawals).toHaveLength(16)
		})
	})
})
