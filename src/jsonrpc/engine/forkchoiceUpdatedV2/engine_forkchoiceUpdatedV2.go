...
const Method = "engine_forkchoiceUpdatedV2"

// Params represents the parameters for engine_forkchoiceUpdatedV2
type Params struct {
...
// Result represents the result for engine_forkchoiceUpdatedV2
//
