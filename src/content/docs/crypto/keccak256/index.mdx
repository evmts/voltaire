...
<TabItem label="Ethereum Functions">
```typescript
import { Keccak256 } from '@tevm/voltaire/crypto/keccak256';
...
const deployerAddress = new Uint8Array(20); // 20-byte address
const nonce = 5n;
...
```typescript
const deployer = Address.from('0x742d35Cc6634C0532925a3b844Bc9e7595f51e3e');
const salt = new Uint8Array(32); // or 0n as bigint
...
<Aside type="caution" title="SHA-3 vs Keccak">
