...
const badEntropy = new Uint8Array(32);
for (let i = 0; i < 32; i++) {
...
const weakEntropy = new Uint8Array(32).fill(timestamp & 0xFF);
```
...
// ✅ Valid
const validEntropy = new Uint8Array(32); // 256 bits
```
...
const constant = new Uint8Array(32).fill(0xFF);
