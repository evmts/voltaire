...
const G = { x: 1n, y: 2n };
const scalar = 0n;
const result = bn254Mul(G, scalar);
// result = (0, 0)

// Generator * 1 = Generator
const result = bn254Mul(G, 1n);
// result = G

// Generator * 2 = Doubled generator
const result = bn254Mul(G, 2n);
// result = 2*G (same as bn254Add(G, G))

// Point * group_order = Identity
const result = bn254Mul(G, groupOrder);
// result = (0, 0)
```
