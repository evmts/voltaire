...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/BrandedBinaryTree.ts](https://github.com/evmts/primitives/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/BrandedBinaryTree.ts)
