...
const newTree = BinaryTree.insert(tree, key, value)

// Original unchanged
console.log(tree.root.type) // 'empty'
console.log(newTree.root.type) // 'stem'
```
</TabItem>
<TabItem label="Multiple Inserts">
```typescript
import { BinaryTree } from '@tevm/voltaire'
...
if (tree.root.type === 'stem') {
  console.log(tree.root.values.filter(v => v !== null).length) // 10
}
```
</TabItem>
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/insert.js:22-26](https://github.com/evmts/primitives/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/insert.js#L22-L26)
...
const stem = new Uint8Array(31) // All zeros
...
const key1 = new Uint8Array(32)
key1[31] = 0
tree = BinaryTree.insert(tree, key1, new Uint8Array(32))
console.log(tree.root.type) // 'stem'
...
key2[31] = 0
tree = BinaryTree.insert(tree, key2, new Uint8Array(32))
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/get.js:18-21](https://github.com/evmts/primitives/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/get.js#L18-L21)
...
const entries = [
  { key: new Uint8Array(32), value: new Uint8Array(32) },
  { key: new Uint8Array(32), value: new Uint8Array(32) },
  // ... more entries
]
