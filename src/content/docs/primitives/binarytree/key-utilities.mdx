...
// Create keys for different subindices
const accountDataKey = baseKey.slice()
accountDataKey[31] = 0  // Subindex 0 for AccountData

const storageSlot0Key = baseKey.slice()
storageSlot0Key[31] = 1  // Subindex 1 for storage slot 0
```
</TabItem>
<TabItem label="Validation">
```typescript
import { BinaryTree, InvalidAddressLengthError } from '@tevm/voltaire'

try {
  const invalidAddress = new Uint8Array(19) // Wrong length
...
```typescript
import { addressToKey } from '@tevm/voltaire/BrandedBinaryTree'
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/addressToKey.js:17-22](https://github.com/evmts/primitives/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/addressToKey.js#L17-L22)
...
<TabItem label="Multiple Subindices">
```typescript
import { BinaryTree } from '@tevm/voltaire'
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/splitKey.js:19-25](https://github.com/evmts/primitives/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/splitKey.js#L19-L25)
...
Defined in: [primitives/BinaryTree/BrandedBinaryTree/getStemBit.js:16-23](https://github.com/evmts/primitives/blob/main/src/primitives/BinaryTree/BrandedBinaryTree/getStemBit.js#L16-L23)
...
<Aside type="tip" title="Stem vs Key">
