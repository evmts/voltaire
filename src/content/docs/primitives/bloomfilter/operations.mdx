...
Defined in: [BrandedBloomFilter/add.js:3-27](https://github.com/evmts/primitives/blob/main/src/primitives/BloomFilter/BrandedBloomFilter/add.js#L3-L27)
...
<Aside type="caution" title="In-Place Modification">
...
Defined in: [BrandedBloomFilter/merge.js:3-60](https://github.com/evmts/primitives/blob/main/src/primitives/BloomFilter/BrandedBloomFilter/merge.js#L3-L60)
