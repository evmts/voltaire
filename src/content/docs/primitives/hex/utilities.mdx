...
Defined in: [primitives/Hex/BrandedHex/size.js:14-16](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/size.js#L14-L16)
Tests: [size.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/size.test.ts)
...
Tests: [equals.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/equals.test.ts)
