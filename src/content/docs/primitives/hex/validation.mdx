...
Defined in: [primitives/Hex/BrandedHex/validate.js:17-24](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/validate.js#L17-L24)
Tests: [validate.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/validate.test.ts)
...
Defined in: [primitives/Hex/BrandedHex/isHex.js](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/isHex.js)
Tests: [isHex.test.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Hex/BrandedHex/isHex.test.ts)
