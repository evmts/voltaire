...
**Performance:** ~2-3x faster than JavaScript for large hex strings (>1KB)
...
**Performance:** ~2-3x faster than JavaScript for large arrays (>1KB)
...
- **Large hex strings** (>1KB): 2-3x faster
...
- **Small strings** (<100 bytes): WASM overhead dominates
