...
Defined in: [primitives/Chain/Chain.js:14](https://github.com/evmts/primitives/blob/main/src/primitives/Chain/Chain.js)
...
Defined in: [primitives/Chain/Chain.js:21](https://github.com/evmts/primitives/blob/main/src/primitives/Chain/Chain.js)
...
Defined in: [primitives/Chain/Chain.js:28](https://github.com/evmts/primitives/blob/main/src/primitives/Chain/Chain.js)

Delegates to: [primitives/Chain/BrandedChain/fromId.js:15](https://github.com/evmts/primitives/blob/main/src/primitives/Chain/BrandedChain/fromId.js)
...
**Tree-shaking notes:**
- `from` is a lightweight identity function (no dependencies)
- `fromId` includes chain registry lookup
- Both methods are pure functions with no crypto dependencies
