...
Defined in: [primitives/Bytecode/BrandedBytecode/toHex.js:8](https://github.com/evmts/primitives/blob/main/src/primitives/Bytecode/BrandedBytecode/toHex.js)
