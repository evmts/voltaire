...
Defined in: [primitives/Bytecode/BrandedBytecode/validate.js:23](https://github.com/evmts/voltaire/blob/main/src/primitives/Bytecode/BrandedBytecode/validate.js)
