...
Defined in: [primitives/Bytecode/BrandedBytecode/BrandedBytecode.ts](https://github.com/evmts/voltaire/blob/main/src/primitives/Bytecode/BrandedBytecode/BrandedBytecode.ts)
