...
Defined in: [primitives/Bytecode/BrandedBytecode/from.js:15](https://github.com/evmts/primitives/blob/main/src/primitives/Bytecode/BrandedBytecode/from.js)
...
Defined in: [primitives/Bytecode/BrandedBytecode/fromHex.js:8](https://github.com/evmts/primitives/blob/main/src/primitives/Bytecode/BrandedBytecode/fromHex.js)
