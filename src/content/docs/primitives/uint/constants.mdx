...
Source: [constants.ts:10-11](https://github.com/evmts/primitives/blob/main/src/primitives/Uint/BrandedUint/constants.ts#L10-L11)
...
Source: [constants.ts:14-16](https://github.com/evmts/primitives/blob/main/src/primitives/Uint/BrandedUint/constants.ts#L14-L16)
...
Source: [constants.ts:18-20](https://github.com/evmts/primitives/blob/main/src/primitives/Uint/BrandedUint/constants.ts#L18-L20)
...
Source: [constants.ts:22-24](https://github.com/evmts/primitives/blob/main/src/primitives/Uint/BrandedUint/constants.ts#L22-L24)
...
Source: [constants.ts:4-6](https://github.com/evmts/primitives/blob/main/src/primitives/Uint/BrandedUint/constants.ts#L4-L6)
...
All constants available as tree-shakeable imports:
...
// Use in operations
const sum = value.plus(ONE)
const isZero = value.equals(ZERO)
const isMax = value.equals(MAX)
```
