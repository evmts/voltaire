...
Wei is the atomic unit of Ether. All Ethereum values are ultimately represented in Wei internally. `Wei.Type` is a [branded](/primitives/branded-types) `Uint256` preventing accidental unit mixing.
...
const wei: Wei.Type = Wei.from(1_000_000_000n)
...
const wei1 = Wei.from(1_000_000_000n)              // 1 Gwei in Wei
const wei2 = Wei.from(1_000_000_000_000_000_000n)  // 1 Ether in Wei
const wei3 = Wei.from(21_000n)                     // Standard transfer gas
const wei4 = Wei.from("1000000000000000000")       // String input
const wei5 = Wei.from(42)                          // Number input
```
...
Defined in: [primitives/Denomination/Wei.ts:10](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/Wei.ts)
...
Defined in: [primitives/Denomination/Wei.ts:14](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/Wei.ts)
...
Defined in: [primitives/Denomination/Wei.ts:19](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/Wei.ts)
...
const wei = Wei.from(50_000_000_000n)  // 50 Gwei in Wei
...
Defined in: [primitives/Denomination/Wei.ts:24](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/Wei.ts)
...
// Fractional values truncate
const wei2 = Wei.from(500_000_000_000_000_000n)  // 0.5 Ether in Wei
...
Defined in: [primitives/Denomination/Wei.ts:29](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/Wei.ts)
...
Defined in: [primitives/Denomination/Wei.ts:34](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/Wei.ts)
...
const gasUsed = Uint.from(21_000n)  // Standard transfer
...
const valueEther = Ether.from(1n)  // User wants to send 1 ETH
...
// Gas costs
const TRANSFER_GAS = Wei.from(21_000n)  // Standard ETH transfer
const ERC20_TRANSFER = Wei.from(65_000n)  // Typical ERC20 transfer

// Gas prices (in Wei)
const CHEAP_GAS = Wei.from(1_000_000_000n)  // 1 Gwei
const NORMAL_GAS = Wei.from(20_000_000_000n)  // 20 Gwei
const HIGH_GAS = Wei.from(100_000_000_000n)  // 100 Gwei

// Common amounts
const ONE_ETHER = Wei.from(1_000_000_000_000_000_000n)
const HALF_ETHER = Wei.from(500_000_000_000_000_000n)
```
