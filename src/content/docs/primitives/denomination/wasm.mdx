...
All WASM methods are compiled from [denomination.zig](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/denomination.zig) with `ReleaseSmall` optimization targeting minimal bundle size.
...
Defined in: [primitives/Denomination/denomination.zig](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/denomination.zig)
...
- **denomination.zig** - Zig source implementation
  - Location: [src/primitives/Denomination/denomination.zig](https://github.com/evmts/primitives/blob/main/src/primitives/Denomination/denomination.zig)
