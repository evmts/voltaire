...
<TabItem label="Gas Price Reference">
```typescript
...
<CardGrid>
  ...
  <Card title="Gas Calculator" icon="calculator">
  ...
  <Card title="Scale Visualization" icon="open-book">
...
<CardGrid stagger>
  ...
  <Card title="GasConstants" icon="seti:text">
