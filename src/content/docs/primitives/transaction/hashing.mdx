...
Source: [hash.ts:12-27](https://github.com/evmts/primitives/blob/main/src/primitives/Transaction/hash.ts#L12-L27)
...
Source: [getSigningHash.ts:12-27](https://github.com/evmts/primitives/blob/main/src/primitives/Transaction/getSigningHash.ts#L12-L27)
