...
Source: [serialize.ts:11-26](https://github.com/evmts/primitives/blob/main/src/primitives/Transaction/serialize.ts#L11-L26)
...
Source: [deserialize.ts:12-28](https://github.com/evmts/primitives/blob/main/src/primitives/Transaction/deserialize.ts#L12-L28)
...
Source: [serialize.ts](https://github.com/evmts/primitives/blob/main/src/primitives/Transaction/serialize.ts)
