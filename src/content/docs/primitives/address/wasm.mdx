...
All WASM methods are compiled from [address.zig](https://github.com/evmts/primitives/blob/main/src/primitives/Address/address.zig) with `ReleaseSmall` optimization targeting minimal bundle size.
...
- **[Address.wasm.js](https://github.com/evmts/primitives/blob/main/src/primitives/Address/Address.wasm.js)** - JavaScript exports with WASM bindings
- **[Address.wasm.ts](https://github.com/evmts/primitives/blob/main/src/primitives/Address/Address.wasm.ts)** - TypeScript types and exports
- **[address.zig](https://github.com/evmts/primitives/blob/main/src/primitives/Address/address.zig)** - Zig source implementation
