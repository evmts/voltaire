		...
		<Card class="overflow-hidden">
			...
			<CardContent class="p-4">
				<div class="mb-4">
					...
					>
						<div class="flex items-center justify-between mb-1">
							<ProgressLabel class="text-xs text-muted-foreground">
								Gas Usage
							</ProgressLabel>
							<ProgressValueLabel class="text-xs font-medium">
				...
				<div class="grid grid-cols-3 gap-4 text-center">
					<div>
						<div class="mb-1 text-muted-foreground text-xs uppercase tracking-wider">
							Initial
						</div>
				...
				<Card class="mt-4 bg-muted/50">
					<CardContent class="p-3">
						<div class="mb-2 text-xs font-medium uppercase tracking-wider">
							Gas Efficiency Tips
						</div>
						<div class="space-y-1 text-muted-foreground text-xs">
							<div class="flex items-start gap-2">
								<Badge
									...
									class="h-5 w-5 rounded-full p-0 flex items-center justify-center"
								>
									1
								</Badge>
