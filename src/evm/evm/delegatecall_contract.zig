...
pub fn delegatecall_contract(self: *Vm, current: primitives.Address.Address, code_address: primitives.Address.Address, caller: primitives.Address.Address, value: u256, input: []const u8, gas: u64, is_static: bool) DelegatecallContractError!CallResult {
    ...
    Log.debug("VM.delegatecall_contract: Execution completed, status={}, gas_used={}, output_size={}", .{
        result.status, 
        result.gas_used,
    ...
    Log.debug("VM.delegatecall_contract: Delegatecall completed, success={}, gas_used={}, gas_left={}, output_size={}", .{
        success,
        result.gas_used, 
        result.gas_left,
