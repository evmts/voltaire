...
pub const Create2ContractError = std.mem.Allocator.Error || primitives.Address.CalculateCreate2AddressError || @import("../state/database_interface.zig").DatabaseError || ExecutionError.Error;
