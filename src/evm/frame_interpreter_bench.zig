...
fn benchmarkCreateMinimal(allocator: std.mem.Allocator) void {
    ...
    var interpreter = FrameInterpreterType.init(allocator, &bytecode, 1_000_000, ctx.db_interface, null) catch unreachable;
...
fn benchmarkCreateSmallContract(allocator: std.mem.Allocator) void {
    ...
    const FrameInterpreterType = frame_interpreter.FrameInterpreter(.{ .has_database = true });
    var interpreter = FrameInterpreterType.init(allocator, bytecode.items, 5_000_000, ctx.db_interface, null) catch unreachable;
    defer interpreter.deinit(allocator);
...
fn benchmarkCreateMediumContract(allocator: std.mem.Allocator) void {
    ...
    const FrameInterpreterType = frame_interpreter.FrameInterpreter(.{ .has_database = true });
    var interpreter = FrameInterpreterType.init(allocator, &bytecode, 10_000_000, ctx.db_interface, null) catch unreachable;
    defer interpreter.deinit(allocator);
...
fn benchmarkCreateLargeContract(allocator: std.mem.Allocator) void {
    ...
    const FrameInterpreterType = frame_interpreter.FrameInterpreter(.{ .has_database = true });
    var interpreter = FrameInterpreterType.init(allocator, &bytecode, 20_000_000, ctx.db_interface, null) catch unreachable;
    defer interpreter.deinit(allocator);
