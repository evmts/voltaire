...
pub fn Stack(comptime config: StackConfig) type {
    ...
    return struct {
        ...
        fn createDupFunction(comptime n: usize) fn(*Self) Error!void {
            return struct {
                pub fn dup_impl(self: *Self) Error!void {
        ...
        fn createSwapFunction(comptime n: usize) fn(*Self) Error!void {
            return struct {
                pub fn swap_impl(self: *Self) Error!void {
