...
const CodeAnalysis = @import("frame/code_analysis.zig").CodeAnalysis;
...
test "Frame static call restrictions" {
    ...
    var static_frame = try Frame.init(
        100_000,
        true,  // static call
        0,
        testAddress(0x1000),
        testAddress(0x2000),
        0,     // value must be 0 for static calls
        &analysis,
        &access_list,
        &journal,
        host,
    ...
    var normal_frame = try Frame.init(
        100_000,
        false, // not static
        0,
        testAddress(0x3000),
...
test "Frame CREATE context" {
    ...
    var frame = try Frame.init(
        ...
        false,
        0,
        testAddress(0xFFFF), // Contract being created
...
test "Frame DELEGATECALL context" {
    ...
    var frame = try Frame.init(
        ...
        false,
        1,
        testAddress(0x6000), // Storage context
