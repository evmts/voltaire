...
pub fn main() !void {
    ...
    try stdout.print("\n🏁 EVM vs REVM Performance Comparison\n", .{});
    try stdout.print("======================================\n\n", .{});
    try stdout.print("Comparing: EVM vs REVM (Rust reference)\n\n", .{});
    ...
    try stdout.print("Running EVM vs REVM comparison benchmarks...\n\n", .{});
    try bench.run(stdout);
    
    try stdout.print("\n✅ EVM vs REVM comparison benchmarks completed!\n", .{});
    try stdout.print("\nImplementation Analysis:\n", .{});
    try stdout.print("• EVM: New Zig implementation with frame-based execution\n", .{});
    try stdout.print("• REVM: Production Rust EVM via C wrapper\n", .{});
    try stdout.print("\nLower times indicate better performance.\n", .{});
}

test "EVM vs REVM benchmark compilation" {
