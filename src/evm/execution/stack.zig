...
// TODO: Refactor all previous fuzz tests to use proper Zig built-in fuzz testing
// Current tests use manual random iterations instead of std.testing.fuzzInput
