        ...
        pub fn getMetadata(
            ...
            const MetadataType = if (@TypeOf(opcode) == u8) {
                ...
                const MetadataType2 = switch (op) {
                    ...
                    .PUSH9, .PUSH10, .PUSH11, .PUSH12, .PUSH13, .PUSH14, .PUSH15, .PUSH16, .PUSH17, .PUSH18, .PUSH19, .PUSH20, .PUSH21, .PUSH22, .PUSH23, .PUSH24, .PUSH25, .PUSH26, .PUSH27, .PUSH28, .PUSH29, .PUSH30, .PUSH31, .PUSH32 => *const u256,
...
test "PlanMinimal memory management" {
    ...
    const bytecode = [_]u8{
        @intFromEnum(Opcode.PUSH1),    0x42,
        @intFromEnum(Opcode.JUMPDEST), @intFromEnum(Opcode.STOP),
    };
...
test "PlanMinimal all PUSH opcodes metadata extraction" {
    ...
    const bytecode = [_]u8{
        ...
        @intFromEnum(Opcode.PUSH6), 0xAA,                       0xBB, 0xCC,                      0xDD, 0xEE,
        0xFF,                       @intFromEnum(Opcode.PUSH7), 0x01, 0x02,                      0x03, 0x04,
        0x05,                       0x06,                       0x07, @intFromEnum(Opcode.STOP),
    };
