...
pub fn main() !void {
    ...
    try stdout.print("\n🏁 EVM2 vs REVM Performance Comparison\n", .{});
    try stdout.print("======================================\n\n", .{});
    try stdout.print("Comparing: EVM2 vs REVM (Rust reference)\n\n", .{});
    ...
    try stdout.print("Running EVM2 vs REVM comparison benchmarks...\n\n", .{});
    try bench.run(stdout);
    
    try stdout.print("\n✅ EVM2 vs REVM comparison benchmarks completed!\n", .{});
    try stdout.print("\nImplementation Analysis:\n", .{});
    try stdout.print("• EVM2: New Zig implementation with frame-based execution\n", .{});
    try stdout.print("• REVM: Production Rust EVM via C wrapper\n", .{});
    try stdout.print("\nLower times indicate better performance.\n", .{});
}

test "EVM2 vs REVM benchmark compilation" {
    // Test that both EVM implementations can be initialized
    const allocator = std.testing.allocator;
    
    // Test basic arithmetic (should work for both)
