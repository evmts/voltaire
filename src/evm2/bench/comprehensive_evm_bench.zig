...
fn benchmark_evm2_erc20_transfer(allocator: std.mem.Allocator) void {
    ...
    const db_interface = evm2_mod.DatabaseInterface.init(&memory_db);
    ...
    const deploy_result = vm.call(evm2_mod.Evm(.{}).CallParams{
        .create = .{
            .caller = caller,
            .value = 0,
            .init_code = bytecode,
    ...
    const call_params = evm2_mod.Evm(.{}).CallParams{
        .call = .{
            .caller = caller,
...
fn benchmark_evm2_snailtracer(allocator: std.mem.Allocator) void {
...
fn benchmark_evm2_thousand_hashes(allocator: std.mem.Allocator) void {
...
fn benchmark_evm2_stack_push_pop(allocator: std.mem.Allocator) void {
    _ = allocator;
    _ = [_]u8{
...
fn benchmark_evm2_arithmetic_sequence(allocator: std.mem.Allocator) void {
    ...
    var memory_db_copy = evm2_mod.MemoryDatabase.init(allocator);
...
fn benchmark_evm2_memory_operations(allocator: std.mem.Allocator) void {
...
pub fn main() !void {
    ...
    try bench.add("ERC20 Transfer - EVM2", benchmark_evm2_erc20_transfer, .{});
    ...
    try bench.add("Snailtracer - EVM2", benchmark_evm2_snailtracer, .{});
    ...
    try bench.add("10k Hashes - EVM2", benchmark_evm2_thousand_hashes, .{});
    ...
    // Basic operation benchmarks
    try bench.add("Stack Push/Pop - EVM2", benchmark_evm2_stack_push_pop, .{});
    ...
    try bench.add("Arithmetic Ops - EVM2", benchmark_evm2_arithmetic_sequence, .{});
    ...
    try bench.add("Memory Ops - EVM2", benchmark_evm2_memory_operations, .{});
    ...
    try stdout.print("• EVM2: New implementation with Frame-based execution\n", .{});
