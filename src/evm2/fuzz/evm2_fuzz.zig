...
const evm2 = @import("../root.zig");
const Frame = evm2.Frame;
const FrameConfig = evm2.FrameConfig;
const Bytecode = evm2.Bytecode;
const BytecodeConfig = evm2.BytecodeConfig;
const Memory = evm2.Memory;
const MemoryConfig = evm2.MemoryConfig;
const Stack = evm2.Stack;
const StackConfig = evm2.StackConfig;
const Opcode = evm2.Opcode;
const OpcodeData = evm2.OpcodeData;
